...
PluginBus.register(`+JSON.stringify(a)+");",enabled:!0,createdAt:_.dkey?_.dkey():new Date().toISOString().slice(0,10),isSkillPack:!0,skillMeta:{whenToUse:e.whenToUse,refCount:(e.refs||[]).length}};u>=0?l.plugins[u]=f:l.plugins.push(f)});var c=ur(a);return be[s]={manifest:c},t||$.show("技能包「"+(e.name||s)+"」已导入（"+(e.refs.length?e.refs.length+" 份参考":"无参考")+"）","success",3e3),c},importZip:function(e,t){if(!window.ZipKit)throw new Error("技能包解析器未加载");return Tn.parseZip(e).then(function(n){var r=Tn.normalizeSkillPack(n);return B.importSkillPack(r,t)})},importSkillMdText:function(e,t){if(!window.ZipKit)throw new Error("技能包解析器未加载");var n=Tn.parseSkillMd(e);if(!n)throw new Error("无法解析 SKILL.md");var r=n.name||"skill-pack",s={id:r,name:r,description:n.description,whenToUse:n.whenToUse,skillMd:n.body,refs:[],files:[]};return B.importSkillPack(s,t)},exportShareCode:function(e){var t=Tt().find(function(o){return o.id===e});if(!t||!t.source)return null;try{var n=new TextEncoder().encode(t.source),r="";n.forEach(function(o){r+=String.fromCharCode(o)});var s=btoa(r).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return"PBCODE1:"+s}catch{return null}},importShareCode:function(e,t){if(!e||typeof e!="string")throw new Error("无效分享码");var n=e.match(/^PBCODE1:([A-Za-z0-9\-_]+)$/);if(!n)throw new Error("不是有效的插件分享码（应以 PBCODE1: 开头）");try{for(var r=n[1].replace(/-/g,"+").replace(/_/g,"/");r.length%4;)r+="=";for(var s=atob(r),o=new Uint8Array(s.length),i=0;i<s.length;i++)o[i]=s.charCodeAt(i);var a=new TextDecoder("utf-8").decode(o);return B.importText(a,t)}catch(c){throw new Error("分享码解析失败："+(c.message||c))}},enable:function(e,t){k.update(function(r){var s=(r.plugins||[]).find(function(o){return o.id===e});s&&(s.enabled=!!t)});var n=be[e];if(n)if(t)try{ao(n.manifest),n.manifest.css&&B._injectCss(e,n.manifest.css),n.manifest.onEnable&&n.manifest.onEnable(Se(e)),n.manifest.init&&n.manifest.init(Se(e))}catch(r){je(e,"启用错误："+(r.message||r),"error")}else{Dr(e),B.unsubscribeAll(e),B._removeCss(e),B._clearEnhOf(e);try{n.manifest.onDisable&&n.manifest.onDisable(Se(e))}catch(r){je(e,"禁用错误："+(r.message||r),"error")}}},_clearEnhOf:function(e){var t=this;Object.keys(this._enh).forEach(function(n){t._enh[n]&&t._enh[n].pid===e&&t._clearEnh(n)})},remove:function(e){k.update(function(t){t.plugins=(t.plugins||[]).filter(function(n){return n.id!==e})}),Dr(e),B.unsubscribeAll(e),B._removeCss(e),B._clearEnhOf(e);try{be[e]&&be[e].manifest.onDisable&&be[e].manifest.onDisable(Se(e))}catch{}B.closePanelsOf(e),delete be[e]},byStore:Tt,handleKey:function(e){var t=e.target&&e.target.tagName||"",n=t==="INPUT"||t==="TEXTAREA"||t==="SELECT"||e.target&&e.target.isContentEditable;Object.keys(be).forEach(function(r){var s=be[r].manifest;Jt(r)&&(s.shortcuts||[]).forEach(function(o){if(!(!o||!o.key||typeof o.run!="function")){var i=o.key.toLowerCase().split("+"),a=i.indexOf("ctrl")>=0,c=i.indexOf("alt")>=0,l=i.indexOf("shift")>=0,u=i.indexOf("meta")>=0,f=i[i.length-1],d=!!e.ctrlKey===a&&!!e.altKey===c&&!!e.shiftKey===l&&!!e.metaKey===u&&String(e.key||"").toLowerCase()===f;if(d&&!(!a&&!c&&!u&&n)){e.preventDefault();try{o.run(Se(r),e)}catch(h){je(r,"快捷键错误："+(h.message||h),"error")}}}})})},bootstrap:function(){Tt().forEach(function(e){if(!(!e.enabled||!e.source))try{var t=new Function("PluginBus","window",`"use strict";
`+e.source);t(B,window)}catch(n){je(e.id,"启动重放失败："+(n.message||n),"error")}})}};window.PluginBus=B;typeof document<"u"&&document.addEventListener&&(document.addEventListener("keydown",function(e){try{B.handleKey(e)}catch{}},!0),document.addEventListener("store:change",function(e){try{B._onStoreUpdate(e&&e.detail)}catch{}}));window.Store&&window.U&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",function(){try{B.bootstrap()}catch{}}):setTimeout(function(){try{B.bootstrap()}catch{}},0));const _i="kaoyan2026_layout",Ai=900;function ql(){try{const e=localStorage.getItem(_i);return e==="phone"||e==="workbench"?e:"auto"}catch{return"auto"}}const fn=ee(ql());function Bl(){try{return window.innerWidth>=Ai}catch{return!1}}function mt(){return fn.value==="workbench"?"workbench":fn.value==="phone"?"phone":Bl()?"workbench":"phone"}function bs(e,t){try{const n=document.documentElement;t&&(n.classList.add("layout-anim"),setTimeout(()=>n.classList.remove("layout-anim"),400)),e==="workbench"?n.setAttribute("data-layout","workbench"):n.removeAttribute("data-layout")}catch{}}bs(mt(),!1);let Bn=mt();try{const e=window.matchMedia("(min-width: "+Ai+"px)"),t=()=>{if(fn.value!=="auto")return;const n=mt();n!==Bn&&(Bn=n,bs(n,!0))};e.addEventListener?e.addEventListener("change",t):e.addListener&&e.addListener(t)}catch{}function Ti(){const e=j(()=>fn.value),t=j(()=>mt()),n=j(()=>mt()==="workbench");function r(o){fn.value=o;try{localStorage.setItem(_i,o)}catch{}Bn=mt(),bs(Bn,!0)}function s(){r(mt()==="workbench"?"phone":"workbench")}return{pref:e,effective:t,isWorkbench:n,set:r,toggle:s}}let lt=null;function co(e){lt=e}function Rl(){const e={go(r){const s=window.FocusModule;if(s&&s.active){$.show("深度专注进行中，请先点「中断专注」结束再切换","warn",3500);return}Pe.push(Ye(r))},refresh(){lt&&lt()},get current(){const r=Pe.currentRoute.value;return String(r.params.id||r.name||"dashboard")}};window.App=e;const t=ts();window.Theme={get:()=>t.isNight.value?"night":"day",isNight:()=>t.isNight.value,set:r=>{t.set(r),lt&&lt()},toggle:()=>{t.toggle(),lt&&lt()}};const n=Ti();window.Layout={get:()=>n.pref.value,effective:()=>n.effective.value,isWorkbench:()=>n.isWorkbench.value,set:r=>{n.set(r)},toggle:()=>{n.toggle()}}}const Jl={hidden:""},lo=le({__name:"LegacyPage",setup(e){const t=Ur(),n=_o(),r={dashboard:"DashboardModule",scheduler:"SchedulerModule",review:"ReviewModule",photomistake:"PhotoMistakeModule",quiz:"QuizModule",essay:"EssayModule",mistakes:"MistakesModule",heatmap:"HeatmapModule",inspector:"InspectorModule",focus:"FocusModule",concept:"ConceptMapModule",sprint:"SprintModule",decision:"DecisionModule",mental:"MentalModule",reading:"ReadingModule",wordbook:"WordbookModule",polrecite:"PolReciteModule",redline:"RedlineModule",progress:"ProgressModule",plugins:"PluginCenterModule",share:"SharePlazaModule",vizai:"VizAiModule",settings:"SettingsModule"};function s(){return String(t.params.id||t.name||"dashboard")}function o(){return document.getElementById("view")}function i(){const h=o();return{v:h?h.scrollTop:0,w:window.scrollY||window.pageYOffset||0}}function a(h){const p=o();h?(p&&(p.scrollTop=h.v),window.scrollTo(0,h.w)):(p&&(p.scrollTop=0),window.scrollTo(0,0))}const c={};Da(()=>{c[s()]=i()});function l(h){const p=new Map;return h.querySelectorAll("details[open]").forEach(y=>{const m=y.querySelector("summary");if(!m)return;const g=m.textContent.trim();p.set(g,(p.get(g)||0)+1)}),p}function u(h,p){h.size&&p.querySelectorAll("details").forEach(y=>{const m=y.querySelector("summary");if(!m)return;const g=m.textContent.trim(),b=h.get(g);b&&b>0&&(y.open=!0,b===1?h.delete(g):h.set(g,b-1))})}function f(h){const p=o();if(!p)return;const y=s(),m=!!(h&&h.preserveUi),g=m?l(p):null,b=m?i():void 0,w=r[y],x=(w?window[w]:null)||d(y);if(!x||typeof x.render!="function"){n.replace("/dashboard");return}p.innerHTML="",x.render(p),p.querySelector('div[data-pg-slot="top"]')||p.insertAdjacentHTML("afterbegin",'<div data-pg-slot="top" class="pg-slot"></div>'),p.querySelector('div[data-pg-slot="bottom"]')||p.insertAdjacentHTML("beforeend",'<div data-pg-slot="bottom" class="pg-slot"></div>');try{B._onPageRendered(p,y)}catch{}m&&g&&u(g,p),p.querySelectorAll(".pbar-fill").forEach(E=>{requestAnimationFrame(()=>{E.style.width=E.getAttribute("data-w")+"%"})}),m&&b&&a(b)}$r(()=>t.fullPath,async()=>{await Ao();const h=s();f(),a(c[h])}),Lt(()=>{co(()=>f({preserveUi:!0})),f()}),qa(()=>co(null));function d(h){try{const p=B.tools();for(const m of p)if(m.id===h)return{render(g){const b=B.ctxOf?B.ctxOf(m.pid):{};if(g.innerHTML='<div class="card"><div class="card-title-row"><span class="card-title">'+(m.icon||"🧩")+" "+window.U.esc(m.title)+`</span><button class="btn btn-ghost btn-sm" onclick="App.go('__tools')">← 工具</button></div><div class="muted-sm" style="margin-bottom:8px">插件：`+window.U.esc(m.pid)+'</div></div><div class="plugin-tool-body">'+(typeof m.render=="function"&&m.render(b)||"")+"</div>",typeof m.mount=="function"){const w=g.querySelector(".plugin-tool-body");if(w)try{m.mount(w,b)}catch(x){w.innerHTML='<div class="alert alert-danger">插件渲染失败：'+window.U.esc(x.message||x)+"</div>"}}}};const y=B.maintabs();for(const m of y)if(m.id===h)return{render(g){const b=B.ctxOf?B.ctxOf(m.pid):{};try{m.render(b,g)}catch(w){g.innerHTML='<div class="alert alert-danger">插件主 tab 渲染失败：'+window.U.esc(w.message||w)+"</div>"}}}}catch{}return null}return(h,p)=>(T(),O("div",Jl))}}),uo="0.26.4",Hl=[`https://cdn.jsdelivr.net/pyodide/v${uo}/full/`,`https://registry.npmmirror.com/-/binary/pyodide/v${uo}/full/`],Q=wt({status:"idle",log:[],lastError:"",progress:{pct:0,msg:""}});function fo(e){Q.log.push(e),Q.log.length>200&&Q.log.shift()}const Gl=`
var py = null;
...
（图形已收录，可作为题目配图）`:"")+`
请继续：需要再算/画图输出 {"tool":...}；算好了只输出题目 JSON 本体。`}),a>=n){o(new Error("达到最大工具轮次仍未输出题目 JSON"));return}i(a+1)});return}if(l&&l.stem){delete l.tool,r.length&&(l.diagramImg=r[r.length-1],l.diagrams=r.slice()),s(l);return}if(a>=n){o(new Error("AI 未输出有效题目 JSON。最后输出前200字："+c.slice(0,200)));return}t.push({role:"assistant",content:c}),t.push({role:"user",content:"请严格只输出题目 JSON 本体（含 stem/type/options/answer/solution/trap 字段），不要其他内容。"}),i(a+1)}).catch(o)};i(1)})}function uu(e,t){try{if(!e||!qt())return;if(!hn()){e.innerHTML='<div class="muted-sm" style="margin-top:10px">🧪 AI 工程验算：组件未就绪（到「AI 工程台」下载扩展组件后，出题将自动附带 sympy 真实验算）。</div>';return}const n=["请验算下面这道考研题目的答案是否正确。","【题目】"+(t.stem||"（无题干）"),"【给出的答案】"+(t.answer||"（无）"),"【给出的解析】"+(t.solution||"（无）"),"要求：先用 sympy 独立重新求解/验算（不要照抄解析），再数值代入抽查，最后给出结论。"].join(`
...
本周：日均 `+_.round1(_.sum(k.weekHours())/7)+"h（目标"+_.round1((e.settings.weeklyTargetHours||50)/7)+"h），符号错误 "+k.mistakeCountWeek("sign")+" 次，数学正确率 "+(u!=null?u+"%":"未录入")+"。"}function kf(){var e=k.get(),t=_.dkey();F.configured()&&e.ai.briefAuto!==!1&&(e.dailyBrief&&e.dailyBrief.date===t||Vt||Bi())}function Bi(){Vt||F.configured()&&(Vt=!0,tn.value="",F.chatStream(bf(),wf(),function(e){tn.value=e||""}).then(function(e){Vt=!1;var t=(e||"").trim();if(t)k.update(function(n){n.dailyBrief={date:_.dkey(),content:t.slice(0,1200),generatedAt:new Date().toISOString()}}),Le().AiMemory&&Le().AiMemory.recordEvent("查看今日简报");else throw new Error("empty")}).catch(function(e){Vt=!1,tn.value="",k.update(function(t){t.dailyBrief={date:_.dkey(),failed:!0,error:e&&e.message||"生成失败"}})}))}let mr=!1;const wn=ee("auto");function xf(){var e=k.get(),t=_.dkey();F.configured()&&(e.dailyQuiz&&e.dailyQuiz.date===t||mr||(mr=!0,Ri(!1,function(){mr=!1})))}function Ri(e,t,n){if(!F.configured()){t&&t();return}var r=_.dkey(),s=n||"auto",o=s!=="auto"?s:null,i=k.get(),a=i.settings&&i.settings.examConfig||{},c=a.profName||"自控原理",l=i.weaknessProfile,u=i.mistakePhotos||[],f=u.filter(function(A){return A.painPoint&&A.painPoint.trim()}).map(function(A){return A.painPoint.trim()}).slice(-15),d=u.filter(function(A){return(A.extractedQuestion||A.note||"").trim()}).slice(-6).map(function(A){return(A.extractedQuestion||A.note).trim().slice(0,50)}),h=[];if(o){var p=X.SUBJECTS[o]&&X.SUBJECTS[o].name||o;h.push("本次请**聚焦科目「"+p+"」**出题（不要出其它科目的题）。")}l&&l.weakAreas&&l.weakAreas.length&&h.push("考生薄弱点画像关键词："+l.weakAreas.join("、")),f.length&&h.push("近期疑难点标签："+f.join("、")),d.length&&h.push(`部分错题题干样例：
- `+d.join(`
- `));var y=i.heat||{},m=o?[o]:["math","ctrl","eng","pol"],g=[];m.forEach(function(A){var P=X.TOPICS[A]||[];P.forEach(function(D){var I=y[D.id];I&&I.level!==void 0&&I.level<=1&&g.push((X.SUBJECTS[A]?X.SUBJECTS[A].name:A)+"·"+D.name+(I.level===0?"(🔴未掌握)":"(🟡薄弱)"))})}),g.length&&h.push(`热力图薄弱考点（需重点突破）：
- `+g.join(`
- `));var b=h.length?h.join(`
...
请出今日针对性练习一题。`;F.chatStream(x,E,null,null,{cache:!1}).then(function(A){var P=Sf(A);if(!P||!P.question){var D=A.replace(/```\w*\s*/g,"").replace(/```/g,"").replace(/^\s*[\{\[]/,"").replace(/[\}\]]\s*$/,"").replace(/^\s*"subject"\s*:\s*"[^"]*",?\s*/i,"").replace(/^\s*"question"\s*:\s*"/i,"").replace(/",\s*solution"\s*:.*/s,"");D=D.trim().replace(/\n+$/,""),P={subject:o||"math",question:D||A,solution:"",trap:"",diagram:""}}k.update(function(I){var R=I.dailyQuiz;R&&R.question&&(I.dailyQuizHistory=I.dailyQuizHistory||[],I.dailyQuizHistory.push(R),I.dailyQuizHistory.length>30&&(I.dailyQuizHistory=I.dailyQuizHistory.slice(-30))),I.dailyQuiz={date:r,subject:o||P.subject||"math",question:P.question||"",solution:P.solution||"",trap:P.trap||"",diagram:P.diagram||"",generatedAt:new Date().toISOString()}}),t&&t()}).catch(function(A){console.warn("[Dashboard] 每日一题生成失败:",A&&A.message),k.update(function(P){P.dailyQuiz={date:r,failed:!0,error:A&&A.message||String(A||"未知错误"),generatedAt:new Date().toISOString()}}),t&&t()})}function hr(e){var t=JSON.parse(e);if(t&&typeof t=="object"&&t.hasOwnProperty("diagram")){var n=t.diagram;t.diagram="",t=Ke.repairMangledLatex(t),t.diagram=n}else t=Ke.repairMangledLatex(t);return t}function Sf(e){var t=(e||"").trim(),n=t.match(/```(?:json)?\s*([\s\S]*?)```/);if(n)try{return hr(n[1].trim())}catch{}var r=t.indexOf("{");if(r===-1)return null;for(var s=0,o=!1,i=!1,a=-1,c=r;c<t.length;c++){var l=t.charAt(c);if(i){i=!1;continue}if(l==="\\"){i=!0;continue}if(l==='"'){o=!o;continue}if(!o){if(l==="{")s++;else if(l==="}"&&(s--,s===0)){a=c+1;break}}}if(a<=r)return null;var u=t.slice(r,a);try{return hr(u)}catch{}try{return hr(F.repairJsonSafely(u))}catch{}var f={},d=[["subject",/"subject"\s*:\s*"([^"]*)"/],["question",/"question"\s*:\s*"((?:[^"\\]|\\.)*)"/],["solution",/"solution"\s*:\s*"((?:[^"\\]|\\.)*)"/],["trap",/"trap"\s*:\s*"((?:[^"\\]|\\.)*)"/]];return d.push(["subject",/"subject"\s*:\s*(\w+)/]),d.forEach(function(h){var p=e.match(h[1]);p&&(f[h[0]]=p[1].replace(/\\n/g,`
`).replace(/\\t/g,"	"))}),f.question?Ke.repairMangledLatex(f):null}function ho(){k.update(function(e){e.dailyQuiz&&(e.dailyQuiz.revealed=!0)})}function go(e){var t=k.get().dailyQuiz;if(e)k.update(function(r){if(r.dailyQuiz&&(r.dailyQuiz.selfEval="known"),t&&t.subject&&X.TOPICS[t.subject]){var s=new Date().toISOString();(X.TOPICS[t.subject]||[]).forEach(function(o){o.tier===1&&(r.heat=r.heat||{},r.heat[o.id]={level:2,score:85,updatedAt:s})})}}),k.recomputeMathAccuracy(),Le().Toast&&Le().Toast.success("✓ 拿下。明天继续。");else{var n=(t||{}).question||"";k.update(function(r){if(r.dailyQuiz&&(r.dailyQuiz.selfEval="unknown"),r.mistakes.push({id:_.uid(),subject:r.dailyQuiz.subject||"math",type:"concept",desc:"【每日一题】未掌握："+n.slice(0,40),stem:n||"",source:"daily",dedupKey:"dq:"+_.shortDate(),date:_.shortDate(),createdAt:new Date().toISOString()}),t&&t.subject&&X.TOPICS[t.subject]){var s=new Date().toISOString();(X.TOPICS[t.subject]||[]).forEach(function(o){if(o.tier===1){r.heat=r.heat||{};var i=r.heat[o.id];r.heat[o.id]={level:0,score:i&&i.score!==void 0?Math.min(i.score,30):30,updatedAt:s}}})}}),k.recomputeMathAccuracy(),Le().AiMemory&&Le().AiMemory.recordEvent("每日一题自评「还不会」",n.slice(0,40)),Le().Copilot&&Le().Copilot.isOpen&&Le().Copilot.pushAssistant("这题还不会，已帮你记下。周末集中清账，别让它过夜。"),Le().Toast&&Le().Toast.show("已记入错题本。周末清账，别攒着。","warn")}}const _f={class:"muted-sm"},Af=["innerHTML"],Tf={class:"brief-foot"},Ef={key:1,class:"brief-body"},Of=["innerHTML"],If=["innerHTML"],Mf={key:0,class:"muted-sm brief-note"},Pf={key:1,class:"muted-sm brief-note"},Cf=le({__name:"BriefCard",setup(e){const t=_.dkey(),n=j(()=>k.get().dailyBrief),r=j(()=>F.configured()),s=j(()=>n.value&&n.value.date===t&&n.value.content),o=j(()=>n.value&&n.value.date===t&&n.value.failed),i=j(()=>F.configured()&&k.get().ai.briefAuto!==!1),a=j(()=>i.value&&!s.value&&!o.value),c=j(()=>a.value&&!tn.value),l=yf(),u=t.slice(5).replace("-","."),f=j(()=>s.value?en(n.value.content):""),d=j(()=>en(tn.value)),h=j(()=>vf(k.get()));function p(){k.update(y=>{y.dailyBrief=null}),Bi()}return(y,m)=>(T(),Fe(Xe,{icon:"📰",title:"今日简报",tint:"blue",class:"dash-brief"},{extra:pe(()=>[v("span",_f,M(K(l))+" · "+M(K(u)),1)]),default:pe(()=>[s.value?(T(),O(z,{key:0},[v("div",{class:"brief-body",innerHTML:f.value},null,8,Af),v("div",Tf,[m[0]||(m[0]=v("span",{class:"muted-sm"},"🧠 结合你的记忆与数据生成",-1)),r.value?(T(),O("button",{key:0,class:"link-btn",onClick:p},"🔄 换一版")):U("",!0)])],64)):a.value?(T(),O("div",Ef,[c.value?(T(),O(z,{key:0},[m[1]||(m[1]=v("div",{class:"skl-line"},null,-1)),m[2]||(m[2]=v("div",{class:"skl-line"},null,-1)),m[3]||(m[3]=v("div",{class:"skl-line skl-w60"},null,-1))],64)):(T(),O(z,{key:1},[v("span",{innerHTML:d.value},null,8,Of),m[4]||(m[4]=v("span",{class:"ai-cursor"},null,-1))],64))])):(T(),O(z,{key:2},[v("div",{class:"brief-body",innerHTML:h.value},null,8,If),o.value?(T(),O("div",Mf,[Y(" ⚠️ AI 简报生成失败（"+M(String(n.value.error||"").slice(0,40))+"） ",1),v("button",{class:"link-btn",onClick:p},"🔄 重试")])):r.value?U("",!0):(T(),O("div",Pf,"配置 AI 后，这里会变成真正懂你的每日简报 →"))],64))]),_:1}))}}),jf=Ve(Cf,[["__scopeId","data-v-17a6feac"]]);function Nf(e){if(!e)return{lang:"",code:""};e=String(e).trim();let t=e.match(/^```(\w*)\s*([\s\S]*?)```$/i);return t?{lang:(t[1]||"").toLowerCase(),code:t[2].trim()}:(t=e.match(/```(\w*)\s*\n([\s\S]*?)```/),t?{lang:(t[1]||"").toLowerCase(),code:t[2].trim()}:{lang:"",code:e})}function Ji(e){let t=String(e);/xmlns=/.test(t)||(t=t.replace(/<svg/i,'<svg xmlns="http://www.w3.org/2000/svg"'));let n;try{n=new DOMParser().parseFromString(t,"image/svg+xml")}catch{return null}if(!n||n.getElementsByTagName("parsererror").length)return null;const r=n.documentElement;if(!r||r.nodeName.toLowerCase()!=="svg")return null;const s=r.querySelectorAll("script, foreignObject, iframe, object, embed, link, meta");for(let i=0;i<s.length;i++)s[i].parentNode&&s[i].parentNode.removeChild(s[i]);const o=[r].concat(Array.prototype.slice.call(r.getElementsByTagName("*")));for(let i=0;i<o.length;i++){const a=o[i];for(let c=a.attributes.length-1;c>=0;c--){const l=a.attributes[c].name,u=a.attributes[c].value||"";(/^on/i.test(l)||/^(xlink:)?href$/i.test(l)&&/^\s*javascript:/i.test(u)||l.toLowerCase()==="style"&&/javascript:|expression\s*\(/i.test(u))&&a.removeAttribute(l)}}return r.getAttribute("viewBox")?(r.removeAttribute("width"),r.removeAttribute("height"),r.setAttribute("width","100%"),r.getAttribute("preserveAspectRatio")||r.setAttribute("preserveAspectRatio","xMidYMid meet")):r.getAttribute("width")||r.setAttribute("width","280"),r.setAttribute("overflow","visible"),new XMLSerializer().serializeToString(r)}function Hi(e){if(e&&typeof e=="object")return"";const t=Nf(e),n=t.code;if(!n)return"";if(t.lang==="svg"||n.toLowerCase().indexOf("<svg")>=0){const r=Ji(n);if(r)return'<div class="dgm-wrap">'+r+"</div>"}return'<div class="dgm-code"><pre class="report">'+_.esc(n)+"</pre></div>"}function Lf(e){return Hi(e)}const Gi={render:Hi,renderSync:Lf,sanitizeSvg:Ji},Df=["innerHTML"],qf=le({__name:"DiagramBlock",props:{source:{}},setup(e){const t=e,n=j(()=>Gi.render(t.source||""));return(r,s)=>(T(),O("div",{class:"diagram-block",innerHTML:n.value},null,8,Df))}}),Bf={key:0,class:"dsh-dq-cell"},Rf={class:"dq-tile-head"},Jf={class:"dq-tile-ico"},Hf={key:0,class:"dq-dot",title:"今日题还没做"},Gf={key:1,class:"dq-tile-sub st-no"},zf={key:2,class:"dq-tile-sub st-warn"},$f={key:3,class:"dq-tile-sub st-warn"},Uf=["innerHTML"],Ff={key:1,class:"dq-tile-preview dq-tile-hint"},Kf={class:"dq-week","aria-hidden":"true"},Vf={class:"dq-tools"},Qf=["value"],Wf=["disabled"],Yf={class:"dq-question"},Xf=["innerHTML"],Zf={class:"dq-section"},ep=["innerHTML"],tp={key:0,class:"dq-section"},np=["innerHTML"],rp={key:2,class:"dq-eval dq-eval-ok"},sp={key:3,class:"dq-eval dq-eval-no"},op={key:4,class:"dq-eval-row"},ip={class:"muted-sm dq-foot"},ap={class:"alert alert-warn"},cp=["disabled"],lp={key:2,class:"muted-sm"},up=le({__name:"DailyQuizCard",setup(e){const t=_.dkey(),n=j(()=>k.get().dailyQuiz),r=j(()=>n.value&&n.value.date===t&&n.value.question),s=j(()=>n.value&&n.value.date===t&&n.value.failed),o=j(()=>F.configured()),i=j(()=>!!(r.value&&!n.value.revealed&&!n.value.selfEval)),a=j(()=>r.value?X.SUBJECTS[n.value.subject]||{short:"题",color:"#666"}:null),c=j(()=>n.value?.selfEval==="known"?{t:"已会 ✓",cls:"st-ok"}:n.value?.selfEval==="unknown"?{t:"记入错题",cls:"st-no"}:n.value?.revealed?{t:"待自评",cls:"st-warn"}:{t:"待作答",cls:"st-warn"}),l=ee(!1),u=[{v:"auto",l:"🎲 自动(薄弱点)"},{v:"math",l:"📐 数学"},{v:"ctrl",l:"🎛 专业课"},{v:"eng",l:"📖 英语"},{v:"pol",l:"🏛 政治"}],f=ee(!1),d=j(()=>en(n.value?.question||"")),h=j(()=>en(n.value?.solution||"")),p=j(()=>en(n.value?.trap||"")),y=j(()=>(n.value?.generatedAt||"").slice(0,16).replace("T"," ")),m=j(()=>{const A=(k.get().dailyQuizHistory||[]).slice(-6).map((D,I)=>({k:"h"+I+(D.date||""),cls:D.selfEval==="known"?"ok":D.selfEval==="unknown"?"no":"done",today:!1})),P=n.value&&n.value.date===t?n.value.selfEval==="known"?"ok":n.value.selfEval==="unknown"?"no":n.value.revealed?"done":"open":"none";return A.push({k:"today",cls:P,today:!0}),A});function g(){l.value=!l.value}function b(){f.value||(f.value=!0,l.value=!0,Ri(!0,()=>{f.value=!1},wn.value))}function w(){Pe.push(Ye("settings"))}return(x,E)=>l.value?(T(),Fe(Xe,{key:1,icon:"📅",title:"每日一题",tint:"purple",class:"dsh-dq"},{actions:pe(()=>[v("button",{class:"link-btn",onClick:g},"收起 ▴")]),default:pe(()=>[v("div",Vf,[nt(v("select",{"onUpdate:modelValue":E[0]||(E[0]=A=>Ra(wn)?wn.value=A:null),class:"input input-sel dq-sel",title:"指定出题科目"},[(T(),O(z,null,Z(u,A=>v("option",{key:A.v,value:A.v},M(A.l),9,Qf)),64))],512),[[Ja,K(wn)]]),r.value?(T(),O("button",{key:0,class:"btn btn-ghost btn-sm dq-again",disabled:f.value,onClick:b},M(f.value?"生成中…":"🔁 换题"),9,Wf)):U("",!0)]),r.value?(T(),O(z,{key:0},[v("div",Yf,[v("b",null,"📝 "+M(a.value.short)+"题：",1),v("span",{innerHTML:d.value},null,8,Xf)]),n.value.diagram?(T(),Fe(qf,{key:0,source:n.value.diagram},null,8,["source"])):U("",!0),n.value.revealed||n.value.selfEval?(T(),O(z,{key:1},[v("div",Zf,[E[8]||(E[8]=v("b",null,"🔑 解答：",-1)),v("div",{class:"dq-sol",innerHTML:h.value},null,8,ep)]),n.value.trap?(T(),O("div",tp,[E[9]||(E[9]=v("b",null,"⚠️ 易错点：",-1)),v("div",{class:"dq-sol",innerHTML:p.value},null,8,np)])):U("",!0)],64)):U("",!0),n.value.selfEval==="known"?(T(),O("div",rp,"✓ 已自评：会了。保持这个节奏。")):n.value.selfEval==="unknown"?(T(),O("div",sp,"✗ 已自评：还不会——已记入错题本，明天简报会盯着你复习。")):n.value.revealed?(T(),O("div",op,[E[10]||(E[10]=v("span",{class:"muted-sm"},"看完解答，诚实自评：",-1)),v("button",{class:"btn btn-primary btn-sm",onClick:E[1]||(E[1]=A=>K(go)(!0))},"✓ 会了"),v("button",{class:"btn btn-ghost btn-sm",onClick:E[2]||(E[2]=A=>K(go)(!1))},"✗ 还不会")])):(T(),O(z,{key:5},[E[11]||(E[11]=v("div",{class:"dq-fold"},"🫣 解答已折叠——先拿草稿纸做一遍，再对答案。",-1)),v("button",{class:"btn btn-ghost btn-sm",onClick:E[3]||(E[3]=(...A)=>K(ho)&&K(ho)(...A))},"👀 查看解答")],64)),v("div",ip,"基于你的薄弱点生成 · "+M(y.value),1)],64)):s.value?(T(),O(z,{key:1},[v("div",ap,"⚠️ 今日一题生成失败："+M(n.value.error||"未知错误"),1),v("button",{class:"btn btn-ghost btn-sm dq-retry",disabled:f.value,onClick:b},M(f.value?"生成中…":"🔁 重试生成"),9,cp)],64)):o.value?(T(),O("div",lp,"⏳ 正在依据你的薄弱点生成今日一题…")):(T(),O(z,{key:3},[E[12]||(E[12]=v("div",{class:"alert alert-warn"},"未配置 AI，无法生成每日一题。请先在「设置」中填写 API。",-1)),v("button",{class:"btn btn-ghost btn-sm",onClick:w,style:{"margin-top":"8px"}},"去设置 →")],64))]),_:1})):(T(),O("div",Bf,[v("div",{class:"dq-tile",role:"button",tabindex:"0",title:"点击查看今日一题",onClick:g,onKeydown:Fr(g,["enter"])},[v("div",Rf,[v("span",Jf,[E[4]||(E[4]=Y("📅",-1)),i.value?(T(),O("span",Hf)):U("",!0)]),E[5]||(E[5]=v("span",{class:"dq-tile-name"},"每日一题",-1)),r.value?(T(),O("span",{key:0,class:ce(["dq-tile-sub",c.value.cls])},M(a.value.short)+" · "+M(c.value.t),3)):s.value?(T(),O("span",Gf,"生成失败 · 重试")):o.value?(T(),O("span",zf,"⏳ 生成中")):(T(),O("span",$f,"配置 AI"))]),r.value?(T(),O("div",{key:0,class:"dq-tile-preview",innerHTML:d.value},null,8,Uf)):(T(),O("div",Ff,M(s.value?"今日生成失败，点击展开可重试。":o.value?"正在依据你的薄弱点生成今日一题…":"配置 AI 后，每天自动送一道针对你弱点的题。"),1)),v("div",Kf,[(T(!0),O(z,null,Z(m.value,A=>(T(),O("span",{key:A.k,class:ce(["dq-wdot","w-"+A.cls+(A.today?" w-today":"")])},null,2))),128)),E[6]||(E[6]=v("span",{class:"dq-week-label muted-sm"},"近 7 日",-1))]),E[7]||(E[7]=v("div",{class:"dq-tile-cta"},"查看今日一题 →",-1))],32)]))}}),dp=Ve(up,[["__scopeId","data-v-f0f7a385"]]),fp={class:"now-count"},pp={class:"now-actions"},mp={class:"now-count"},hp={class:"now-title"},gp={class:"now-sub"},yp={class:"now-reason"},vp={class:"now-actions"},bp=le({__name:"NowCard",setup(e){const t=()=>window,n=j(()=>k.todayTaskStats()),r=j(()=>k.todayAllDone()),s=j(()=>{n.value;const f=t().SchedulerModule;if(!f||!f.currentPlan)return null;const d=f.currentPlan();return d&&d.sequence&&d.sequence.find(h=>!h.done)||null}),o=j(()=>s.value?X.SUBJECTS[s.value.subject]:null),i=j(()=>{const f=n.value;return f.math[0]+f.ctrl[0]+f.eng[0]+f.pol[0]}),a=j(()=>{const f=n.value;return f.math[1]+f.ctrl[1]+f.eng[1]+f.pol[1]});function c(){const f=t().TasksModule;f&&s.value?f.toggleTask(s.value.id,!0):$.show("打卡模块未就绪","warn")}function l(){Pe.push(Ye("focus"))}function u(){Pe.push(Ye("scheduler"))}return(f,d)=>r.value?(T(),Fe(Xe,{key:0,icon:"✅",title:"今日已清场",tint:"ok",class:"dsh-now dsh-now-done"},{extra:pe(()=>[v("span",fp,M(i.value)+"/"+M(a.value),1)]),default:pe(()=>[d[1]||(d[1]=v("div",{class:"now-title"},"✓ 全部任务完成",-1)),d[2]||(d[2]=v("div",{class:"now-sub"},"可以安心复盘、早点睡。明天继续。",-1)),v("div",pp,[v("button",{class:"btn btn-ghost",onClick:d[0]||(d[0]=h=>K(Pe).push(K(Ye)("review")))},"去复盘 →")])]),_:1})):s.value?(T(),Fe(Xe,{key:1,icon:"⚡",title:"现在就干这个",class:"dsh-now dsh-now-hero"},{extra:pe(()=>[v("span",mp,M(i.value)+"/"+M(a.value)+" 已完成",1)]),default:pe(()=>[v("div",hp,M(s.value.text),1),v("div",gp,[o.value?(T(),O("span",{key:0,class:"now-tag",style:We({background:o.value.color})},M(o.value.short),5)):U("",!0),v("span",yp,M(s.value.reason),1)]),v("div",vp,[v("button",{class:"now-btn-primary",onClick:c},"✓ 完成打卡"),v("button",{class:"now-btn-ghost",onClick:l},"🔒 专注"+M(s.value.subject==="math"?45:25)+"分钟",1)])]),_:1})):(T(),Fe(Xe,{key:2,icon:"🗓️",title:"今日无待办",class:"dsh-now"},{default:pe(()=>[d[3]||(d[3]=v("div",{class:"now-title"},"还没排任务",-1)),d[4]||(d[4]=v("div",{class:"now-sub"},"去排程把今天的任务排上，仪表盘才知道你现在该干嘛。",-1)),v("div",{class:"now-actions"},[v("button",{class:"btn btn-primary",onClick:u},"去排程添加")])]),_:1}))}}),wp=Ve(bp,[["__scopeId","data-v-a92668cf"]]);function Gt(e,t){return'<svg viewBox="0 0 '+e+" "+t+'" width="100%" height="'+t+'" xmlns="http://www.w3.org/2000/svg">'}function ye(e,t){return window.U&&_.themeColor?_.themeColor(e,t):t}const zi={bar(e,t){t=t||{};const n=ye("--chart-ink","#000"),r=ye("--chart-faint","#bfbfbf"),s=ye("--chart-muted","#8c8c8c"),o=ye("--chart-sub","#595959"),i=680,a=t.height||160,c=24,l=16,u=8,f=8,d=Math.max.apply(null,e.map(g=>g.value).concat([1])),h=e.length||1,p=(i-u-f)/h,y=Math.min(44,p*.55);let m=Gt(i,a);for(let g=0;g<h;g++){const b=e[g],w=Math.max(2,b.value/d*(a-c-l)),x=u+g*p+(p-y)/2,E=a-c-w,A=b.highlight?t.hiColor||n:t.color||r;m+='<rect x="'+x+'" y="'+E+'" width="'+y+'" height="'+w+'" rx="4" fill="'+A+'"><title>'+_.esc(b.label)+"："+b.value+(t.unit||"")+"</title></rect>",m+='<text x="'+(x+y/2)+'" y="'+(a-8)+'" text-anchor="middle" font-size="11" fill="'+s+'">'+_.esc(b.label)+"</text>",b.value>0&&(m+='<text x="'+(x+y/2)+'" y="'+(E-4)+'" text-anchor="middle" font-size="11" fill="'+o+'">'+b.value+"</text>")}return m+"</svg>"},donut(e,t){t=t||{};const n=ye("--chart-ink","#000"),r=ye("--chart-faint","#bfbfbf"),s=ye("--chart-muted","#8c8c8c"),o=ye("--chart-sub","#595959"),i=ye("--chart-track","#f0f0f0"),a=680,c=t.height||190,l=110,u=c/2,f=66,d=40,h=_.sum(e.map(m=>m.value));let p=Gt(a,c);if(h===0)p+='<circle cx="'+l+'" cy="'+u+'" r="'+f+'" fill="none" stroke="'+i+'" stroke-width="'+(f-d)+'"/>',p+='<text x="'+l+'" y="'+(u+5)+'" text-anchor="middle" font-size="13" fill="'+r+'">暂无数据</text>';else{let m=-Math.PI/2;e.forEach(g=>{if(g.value<=0)return;const b=g.value/h,w=m+b*Math.PI*2,x=b>.5?1:0,E=l+f*Math.cos(m),A=u+f*Math.sin(m),P=l+f*Math.cos(w),D=u+f*Math.sin(w),I=l+d*Math.cos(w),R=u+d*Math.sin(w),L=l+d*Math.cos(m),J=u+d*Math.sin(m);p+='<path d="M'+E+" "+A+" A"+f+" "+f+" 0 "+x+" 1 "+P+" "+D+" L"+I+" "+R+" A"+d+" "+d+" 0 "+x+" 0 "+L+" "+J+' Z" fill="'+g.color+'"><title>'+_.esc(g.label)+"："+g.value+"次 ("+Math.round(b*100)+"%)</title></path>",m=w}),p+='<text x="'+l+'" y="'+(u-2)+'" text-anchor="middle" font-size="22" font-weight="500" fill="'+n+'">'+h+"</text>",p+='<text x="'+l+'" y="'+(u+16)+'" text-anchor="middle" font-size="11" fill="'+s+'">总计</text>'}let y=24;return e.forEach(m=>{const g=h?Math.round(m.value/h*100):0;p+='<rect x="230" y="'+(y-10)+'" width="10" height="10" rx="2" fill="'+m.color+'"/>',p+='<text x="246" y="'+y+'" font-size="12" fill="'+n+'">'+_.esc(m.label)+"</text>",p+='<text x="660" y="'+y+'" font-size="12" text-anchor="end" fill="'+o+'">'+m.value+"次 · "+g+"%</text>",y+=24}),p+"</svg>"},line(e,t){t=t||{};const n=ye("--chart-ink","#000"),r=ye("--chart-faint","#bfbfbf"),s=ye("--chart-muted","#8c8c8c"),o=ye("--danger","#cf1322"),i=680,a=t.height||170,c=22,l=14,u=30,f=10,d=e.map(x=>x.value),h=t.min!=null?t.min:Math.min.apply(null,d.concat([0])),p=t.max!=null?t.max:Math.max.apply(null,d.concat([10])),y=e.length;if(y===0)return Gt(i,a)+'<text x="340" y="90" text-anchor="middle" fill="'+r+'" font-size="13">暂无数据</text></svg>';const m=x=>u+(y===1?(i-u-f)/2:x*(i-u-f)/(y-1)),g=x=>a-c-(x-h)/(p-h||1)*(a-c-l);let b=Gt(i,a);t.warnBelow!=null&&(b+='<line x1="'+u+'" y1="'+g(t.warnBelow)+'" x2="'+(i-f)+'" y2="'+g(t.warnBelow)+'" stroke="'+o+'" stroke-dasharray="4 4" stroke-width="1"/>',b+='<text x="'+(i-f)+'" y="'+(g(t.warnBelow)-4)+'" text-anchor="end" font-size="10" fill="'+o+'">预警线 '+t.warnBelow+"</text>");let w="";return e.forEach((x,E)=>{w+=(E===0?"M":"L")+m(E)+" "+g(x.value)}),b+='<path d="'+w+'" fill="none" stroke="'+n+'" stroke-width="2"/>',e.forEach((x,E)=>{const A=t.warnBelow!=null&&x.value<t.warnBelow;b+='<circle cx="'+m(E)+'" cy="'+g(x.value)+'" r="4" fill="'+(A?o:n)+'"><title>'+_.esc(x.label)+"："+x.value+(t.unit||"")+"</title></circle>",y<=12&&(b+='<text x="'+m(E)+'" y="'+(a-6)+'" text-anchor="middle" font-size="10" fill="'+s+'">'+_.esc(x.label)+"</text>")}),b+"</svg>"},progressBar(e,t,n){return e=_.clamp(e,0,100),'<div class="pbar" style="height:'+(n||8)+'px"><div class="pbar-fill" style="width:0%;background:'+t+'" data-w="'+e+'"></div></div>'},radar(e,t){t=t||{};const n=ye("--chart-ink","#000"),r=ye("--chart-sub","#595959"),s=ye("--chart-grid","#e8e8e8"),o=680,i=t.height||200,a=e.length||4,c=128,l=i/2,u=Math.max(40,Math.min(92,(i-24)/2-10)),f=t.color||"#2f54eb",d=g=>-Math.PI/2+2*Math.PI*g/a,h=(g,b)=>[c+b*Math.cos(d(g)),l+b*Math.sin(d(g))];let p=Gt(o,i);for(let g=1;g<=4;g++){const b=u*g/4;let w="";for(let x=0;x<=a;x++){const E=h(x%a,b);w+=(x===0?"M":"L")+E[0]+" "+E[1]}p+='<path d="'+w+' Z" fill="none" stroke="'+s+'" stroke-width="0.5"/>'}for(let g=0;g<a;g++){const[b,w]=h(g,u);p+='<line x1="'+c+'" y1="'+l+'" x2="'+b+'" y2="'+w+'" stroke="'+s+'" stroke-width="0.5"/>';const x=c+(u+22)*Math.cos(d(g)),E=l+(u+22)*Math.sin(d(g));p+='<text x="'+x+'" y="'+(E+4)+'" text-anchor="middle" font-size="12" fill="'+r+'">'+_.esc(e[g].label)+"</text>";const[A,P]=h(g,u*(_.clamp(e[g].value,0,100)/100));p+='<text x="'+A+'" y="'+(P-7)+'" text-anchor="middle" font-size="11" font-weight="500" fill="'+n+'">'+Math.round(e[g].value)+"</text>"}let y="";for(let g=0;g<=a;g++){const b=h(g%a,u*(_.clamp(e[g%a].value,0,100)/100));y+=(g===0?"M":"L")+b[0]+" "+b[1]}p+='<path d="'+y+' Z" fill="'+(t.fill||"rgba(47,84,235,0.16)")+'" stroke="'+f+'" stroke-width="1.5"/>';for(let g=0;g<a;g++){const b=h(g,u*(_.clamp(e[g].value,0,100)/100));p+='<circle cx="'+b[0]+'" cy="'+b[1]+'" r="3" fill="'+f+'"/>'}let m=24;return e.forEach(function(g,b){const w=["#185FA5","#0F6E56","#993C1D","#854F0B","#534AB7","#A32D2D","#5F5E5A","#639922"][b%8];p+='<circle cx="'+(o-108)+'" cy="'+(m-3)+'" r="4" fill="'+w+'"/>',p+='<text x="'+(o-96)+'" y="'+m+'" font-size="12" fill="'+n+'">'+_.esc(g.label)+"</text>",p+='<text x="'+(o-14)+'" y="'+m+'" text-anchor="end" font-size="12" font-weight="500" fill="'+n+'">'+Math.round(g.value)+"</text>",m+=20}),p+"</svg>"}},kp={class:"hours-line"},xp={class:"dsh-big"},Sp=["innerHTML"],_p={class:"muted-sm"},Ap=le({__name:"HoursCard",setup(e){const t=j(()=>k.weekHours()),n=j(()=>(new Date().getDay()+6)%7),r=j(()=>t.value.map((f,d)=>({label:["一","二","三","四","五","六","日"][d],value:f,highlight:d===n.value}))),s=j(()=>_.round1(_.sum(t.value))),o=j(()=>k.get().settings.weeklyTargetHours||50),i=j(()=>o.value?Math.round(s.value/o.value*100):0),{theme:a}=ts(),c=j(()=>(a.value,zi.bar(r.value,{height:110,unit:"h",hiColor:_.themeColor("--chart-ink","#000")}))),l=j(()=>k.todayHours());function u(){ke.open({title:"记录学习时长",html:'<div class="seg-row" id="hr-segs">'+[.5,1,1.5,2,3].map(f=>'<button class="seg" data-h="'+f+'">+'+f+"h</button>").join("")+'</div><div class="muted-sm">点击即累加到今天（当前 '+k.todayHours()+"h）</div>",actions:[{label:"完成",kind:"btn-primary"}]}),document.querySelectorAll("#hr-segs .seg").forEach(f=>{f.onclick=()=>{k.addHours(+f.getAttribute("data-h")),$.success("+"+f.getAttribute("data-h")+"h，今日共 "+k.todayHours()+"h")}})}return(f,d)=>(T(),Fe(Xe,{icon:"📈",title:"本周节奏",tint:"ok"},{actions:pe(()=>[v("button",{class:"link-btn",onClick:u},"+ 记录时长")]),default:pe(()=>[v("div",kp,[v("span",xp,[Y(M(s.value),1),d[0]||(d[0]=v("span",{class:"dsh-unit"},"小时",-1))]),v("span",{class:ce(["dsh-pill",i.value>=70?"dsh-pill-up":"dsh-pill-warn"])},M(i.value>=70?"↑":"↓")+" 目标 "+M(i.value)+"% ",3)]),v("div",{class:"wk-chart",innerHTML:c.value},null,8,Sp),v("div",_p,"今日 "+M(l.value)+"h · 周目标 "+M(o.value)+"h",1)]),_:1}))}}),Tp=Ve(Ap,[["__scopeId","data-v-2168edf0"]]),Ep={class:"subj4"},Op={class:"chip-name"},Ip={class:"chip-num"},Mp={key:0,class:"rvd-wrap"},Pp=["onClick"],Cp={class:"rvd-stage"},jp={class:"rvd-text"},Np=["onClick"],Lp=["onClick"],Dp={key:1},qp={class:"task-check"},Bp=["checked","onChange"],Rp={class:"seq-text"},Jp={key:2,class:"empty"},Hp=le({__name:"TasksCard",setup(e){const t=()=>window,n=j(()=>k.todayTaskStats()),r=j(()=>{const y=t().SchedulerModule;return y&&y.currentPlan&&y.currentPlan()||{sequence:[]}}),s=j(()=>r.value.sequence.slice(0,5)),o=j(()=>qi(k.get()).slice(0,5)),i=["math","ctrl","eng","pol"],a=j(()=>i.map(y=>{const m=X.SUBJECTS[y],g=n.value[y][0],b=n.value[y][1];return{k:y,short:m.short,d:g,t:b,done:b>0&&g===b,color:m.color}}));function c(y){const m=k.get().tasks.find(g=>g.id===y);return m?!!m.done:!1}function l(y,m){const g=t().TasksModule;g&&g.toggleTask(y,m)}function u(y){return(X.SUBJECTS[y]||{color:"#666"}).color}function f(y){return y.kind==="photo"?"📸":y.kind==="pol"?"📕":y.kind==="vocab"?"📚":y.kind==="reading"?"📖":"✍️"}function d(y){return y.kind==="vocab"||y.kind==="reading"}function h(y){if(y.kind==="pol"){const g=t().PolReciteModule;g&&g.grade(y.id,!0),t().AiMemory&&t().AiMemory.recordEvent("完成政治大题复习",String(y.id||"").slice(0,8)),$.success("✓ 政治大题复习完成，记忆又牢了一层");return}const m=y.kind==="photo"?"mistakePhotos":"mistakes";k.update(g=>{const b=(g[m]||[]).find(w=>w.id===y.id);b&&b.reviewPlan&&(b.reviewPlan.done||(b.reviewPlan.done={}),b.reviewPlan.done["d"+y.stage]=_.dkey())}),t().AiMemory&&t().AiMemory.recordEvent("完成到期复习","D"+y.stage+"阶段"+(y.kind==="photo"?"拍题":"错题")+"重做"),$.success("✓ 复习完成，记忆又牢了一层")}function p(y){if(y.kind==="pol"){const m=t().PolReciteModule;m&&m.openReview(y.id);return}if(y.kind==="vocab"){Pe.push(Ye("wordbook"));return}if(y.kind==="reading"){Pe.push(Ye("reading"));return}}return(y,m)=>(T(),Fe(Xe,{icon:"☑️",title:"今日任务",tint:"ok"},{actions:pe(()=>[v("button",{class:"link-btn",onClick:m[0]||(m[0]=g=>K(Pe).push(K(Ye)("scheduler")))},"完整排程 →")]),default:pe(()=>[v("div",Ep,[(T(!0),O(z,null,Z(a.value,g=>(T(),O("div",{key:g.k,class:ce(["chip mini",{"chip-done":g.done}]),style:We({"--sc":g.color})},[v("span",Op,M(g.short),1),v("span",Ip,M(g.d)+"/"+M(g.t),1)],6))),128))]),o.value.length?(T(),O("div",Mp,[m[1]||(m[1]=v("div",{class:"muted-sm rvd-cap"},"📅 今日到期复习（重做原题，勿看解析）",-1)),(T(!0),O(z,null,Z(o.value,g=>(T(),O("div",{key:g.kind+g.id,class:ce(["rvd-item",{"rvd-click":g.kind==="pol"||g.kind==="vocab"||g.kind==="reading"}]),onClick:b=>p(g)},[v("span",Cp,M(d(g)?"SRS":"D"+g.stage),1),v("span",jp,M(f(g))+" "+M(g.text),1),d(g)?(T(),O("button",{key:0,class:"btn btn-primary btn-sm",onClick:yr(b=>p(g),["stop"])},"去复习 →",8,Np)):(T(),O("button",{key:1,class:"btn btn-ghost btn-sm",onClick:yr(b=>h(g),["stop"])},"✓ 重做完成",8,Lp))],10,Pp))),128))])):U("",!0),s.value.length?(T(),O("div",Dp,[(T(!0),O(z,null,Z(s.value,g=>(T(),O("label",{key:g.id,class:ce(["seq-row",{"seq-is-done":c(g.id)}])},[v("span",qp,[v("input",{type:"checkbox",checked:c(g.id),onChange:b=>l(g.id,b.target.checked)},null,40,Bp),m[2]||(m[2]=v("span",{class:"box"},null,-1))]),v("span",Rp,M(g.text),1),v("span",{class:"seq-badge",style:We({color:u(g.subject)})},M(g.weight),5)],2))),128))])):(T(),O("div",Jp,"暂无任务"))]),_:1}))}}),Gp=Ve(Hp,[["__scopeId","data-v-b086b73c"]]),zp={class:"tiles"},$p=["onClick"],Up=["innerHTML"],Fp={key:0,class:"tile-dot"},Kp={class:"tile-name"},Vp=le({__name:"TilesCard",setup(e){const t=()=>window,n=j(()=>{const c=k.todayTaskStats();return c.math[1]+c.ctrl[1]+c.eng[1]+c.pol[1]-c.math[0]-c.ctrl[0]-c.eng[0]-c.pol[0]}),r=j(()=>qi(k.get()).length),s=j(()=>{const c=t().WordbookModule;try{return c&&c.dueCount?c.dueCount():0}catch{return 0}}),o=[{id:"scheduler",tint:"warn",badge:()=>n.value},{id:"quiz",tint:"blue"},{id:"mistakes",tint:"danger",badge:()=>r.value},{id:"wordbook",tint:"ok",badge:()=>s.value},{id:"polrecite",tint:"danger"},{id:"sprint",tint:"purple"},{id:"share",tint:"blue"},{id:"focus",tint:"ok"},{id:"essay",tint:"warn"}],i=j(()=>o.map(c=>{const l=cn[c.id]?c.id:"tools";return{go:c.id,svg:cn[l]||"",name:Xo(c.id),n:c.badge?Math.max(0,c.badge()):0,tint:c.tint}}));function a(c){Pe.push(Ye(c))}return(c,l)=>(T(),Fe(Xe,{icon:"🚀",title:"快捷入口",tint:"blue"},{extra:pe(()=>[...l[0]||(l[0]=[v("span",{class:"muted-sm"},"红点 = 有待办",-1)])]),default:pe(()=>[v("div",zp,[(T(!0),O(z,null,Z(i.value,u=>(T(),O("button",{key:u.go,class:"tile",onClick:f=>a(u.go)},[v("span",{class:ce(["tile-ico","tint-"+u.tint])},[v("span",{innerHTML:u.svg},null,8,Up),u.n>0?(T(),O("span",Fp)):U("",!0)],2),v("span",Kp,[Y(M(u.name),1),u.n>0?(T(),O(z,{key:0},[Y(" · "+M(u.n),1)],64)):U("",!0)])],8,$p))),128))])]),_:1}))}}),Qp=Ve(Vp,[["__scopeId","data-v-8644a98a"]]),Wp={key:0,class:"streak"},Yp={class:"muted-sm"},Xp={class:"cal"},Zp={class:"cal-mrow"},em={class:"cal-wd"},tm={key:0,class:"cal-cell cal-empty"},nm=["title"],rm={class:"cal-foot"},sm={class:"muted-sm"},zt=12,om=le({__name:"CalendarCard",setup(e){const t=["一","二","三","四","五","六","日"],n=j(()=>{const o=k.get(),i=new Date;i.setHours(23,59,59,999);let a=_.weekMonday(new Date);a=new Date(a.getTime()-(zt-1)*7*_.DAY_MS);const c=[];for(let l=0;l<7;l++){const u=[];for(let f=0;f<zt;f++){const d=new Date(a.getTime()+(f*7+l)*_.DAY_MS);if(d>i){u.push(null);continue}const h=_.dkey(d),p=o.studyHours[h]||0,y=(o.completions[h]||[]).length,m=p+y*.5,g=m<=0?0:m<2?1:m<4?2:m<6?3:4,b=d.getFullYear()===i.getFullYear()&&d.getMonth()===i.getMonth()&&d.getDate()===i.getDate();u.push({k:h,lv:g,isToday:b,h:p,doneN:y})}c.push(u)}return c}),r=j(()=>{let o=_.weekMonday(new Date);o=new Date(o.getTime()-(zt-1)*7*_.DAY_MS);const i=[];let a=-1;for(let c=0;c<zt;c++){const l=new Date(o.getTime()+c*7*_.DAY_MS),u=c===0||l.getMonth()!==a?l.getMonth()+1+"月":"";u&&(a=l.getMonth()),i.push(u)}return i}),s=j(()=>{const o=k.get();let i=_.weekMonday(new Date);i=new Date(i.getTime()-(zt-1)*7*_.DAY_MS);const a=new Date;a.setHours(23,59,59,999);let c=0,l=0,u=0,f=0;for(let d=0;;d++){const h=new Date(i.getTime()+d*_.DAY_MS);if(h>a)break;const p=_.dkey(h),y=o.studyHours[p]||0;y+(o.completions[p]||[]).length*.5>0?(l++,c+=y,f++,f>u&&(u=f)):f=0}return{totalH:_.round1(c),activeDays:l,best:u,streak:k.studyStreak()}});return(o,i)=>(T(),Fe(Xe,{icon:"🗓️",title:"学习日历",tint:"warn"},{extra:pe(()=>[s.value.streak>=2?(T(),O("span",Wp,"🔥 连续 "+M(s.value.streak)+" 天",1)):U("",!0),v("span",Yp,[i[0]||(i[0]=Y("近12周 ",-1)),v("b",null,M(s.value.activeDays),1),i[1]||(i[1]=Y(" 天活跃",-1))])]),default:pe(()=>[v("div",Xp,[v("div",Zp,[i[2]||(i[2]=v("span",{class:"cal-wd"},null,-1)),(T(!0),O(z,null,Z(r.value,(a,c)=>(T(),O("span",{key:"m"+c,class:"cal-mcell"},M(a),1))),128))]),(T(!0),O(z,null,Z(n.value,(a,c)=>(T(),O("div",{key:"r"+c,class:"cal-row"},[v("span",em,M(t[c]),1),(T(!0),O(z,null,Z(a,(l,u)=>(T(),O(z,{key:"c"+c+"-"+u},[l?(T(),O("span",{key:1,class:ce(["cal-cell",["cal-lv"+l.lv,{"cal-today":l.isToday}]]),title:l.k+" · "+l.h+"h · 完成"+l.doneN+"项"},null,10,nm)):(T(),O("span",tm))],64))),128))]))),128))]),v("div",rm,[i[4]||(i[4]=v("div",{class:"cal-legend"},[v("span",{class:"muted-sm"},"少"),v("span",{class:"cal-cell cal-lv0"}),v("span",{class:"cal-cell cal-lv1"}),v("span",{class:"cal-cell cal-lv2"}),v("span",{class:"cal-cell cal-lv3"}),v("span",{class:"cal-cell cal-lv4"}),v("span",{class:"muted-sm"},"多")],-1)),v("span",sm,[i[3]||(i[3]=Y("累计 ",-1)),v("b",null,M(s.value.totalH)+"h",1)])])]),_:1}))}}),im=Ve(om,[["__scopeId","data-v-d14087cc"]]),am={class:"dsh-root"},cm=["innerHTML"],lm={class:"dsh-bento"},um=le({__name:"DashboardView",setup(e){const t=j(()=>(k.get().milestones,k.get().alerts,_s.bannerHtml()));return Lt(()=>{kf(),xf()}),(n,r)=>(T(),O("div",am,[t.value?(T(),O("div",{key:0,class:"dsh-banner",innerHTML:t.value},null,8,cm)):U("",!0),ue(lf),v("div",lm,[ue(jf,{class:"dsh-span7"}),ue(dp,{class:"dsh-span5"}),ue(wp,{class:"dsh-span7"}),ue(Tp,{class:"dsh-span5"}),ue(Gp,{class:"dsh-span7"}),ue(Qp,{class:"dsh-span5"}),ue(im,{class:"dsh-span12"})])]))}}),dm=Ve(um,[["__scopeId","data-v-f21c490f"]]),fm=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",name:"dashboard",component:dm},...ln.filter(e=>e.id!=="dashboard").map(e=>({path:"/"+e.id,name:e.id,component:lo})),{path:"/tool/aitools",name:"aitools",component:id},{path:"/tool/prompt-studio",name:"prompt-studio",component:Yd},{path:"/tool/:id",name:"tool",component:lo},{path:"/:pathMatch(.*)*",redirect:"/dashboard"}],Pe=Ha({history:Ga(),routes:fm});Pe.beforeEach(()=>{const e=window.FocusModule;return e&&e.active?($.show("深度专注进行中，请先点「中断专注」结束再切换","warn",3500),!1):!0});function pm(){let e="";try{const r=B.tools();r&&r.length&&(e='<div class="muted-sm" style="margin:10px 0 4px;font-size:12px">🧩 插件工具</div><div class="tools-grid">'+r.map(s=>'<button class="tool-cell" data-tab="'+s.id+'"><span class="tool-icon">'+(s.icon||"🧩")+"</span><span>"+_.esc(s.title)+"</span></button>").join("")+"</div>")}catch{}const t=ns.map(r=>'<button class="tool-cell" data-tab="'+r.id+'"><span class="tool-icon">'+(cn[r.icon]||"🧩")+"</span><span>"+r.label+"</span></button>").join(""),n=ke.open({title:"🧰 工具箱",html:'<div class="tools-grid">'+t+"</div>"+e,actions:[{label:"关闭"}]});document.querySelectorAll(".tool-cell").forEach(r=>{r.onclick=()=>{const s=r.getAttribute("data-tab");n(),s&&Pe.push("/tool/"+s)}})}const mm={class:"bottomnav",id:"bottomnav","data-testid":"bottomnav"},hm=["data-tab","data-testid","onClick"],gm={class:"bn-icon"},ym={class:"bn-label"},vm=["data-tab","onClick"],bm={class:"bn-icon"},wm=["innerHTML"],km={class:"bn-icon"},xm={class:"bn-scroll"},Sm=["data-tab","onClick"],_m={class:"bn-icon"},Am={class:"bn-label"},Tm=["data-tab","onClick"],Em={class:"bn-icon"},Om=["innerHTML"],Im=le({__name:"BottomNav",setup(e){const t=Ur(),n=_o(),{toggle:r}=Ti(),s=j(()=>String(t.params.id||t.name||"")),o=ee([]),i=ee([]);function a(){try{o.value=B.maintabs()||[]}catch{o.value=[]}try{i.value=B.tools()||[]}catch{i.value=[]}}Lt(a);const c=j(()=>!ln.some(d=>d.id===s.value)&&!!s.value);function l(d){n.push("/"+d)}function u(d){n.push("/tool/"+d)}function f(d){return _.esc(d)}return(d,h)=>(T(),O("nav",mm,[h[6]||(h[6]=v("div",{class:"bn-brand"},[v("div",{class:"bn-brand-name"},[v("span",{class:"bn-brand-ico"},"🎯"),Y("26考研作战系统")]),v("div",{class:"bn-brand-sub"},"最适合你的工作台")],-1)),v("button",{class:"bn-layout-toggle","data-testid":"layout-toggle",title:"切回手机单列布局",onClick:h[0]||(h[0]=p=>K(r)())}," 📱 切回手机布局 "),(T(!0),O(z,null,Z(K(ln),p=>(T(),O("button",{key:p.id,class:ce(["bn-btn",{"bn-on":s.value===p.id}]),"data-tab":p.id,"data-testid":"nav-"+p.id,onClick:y=>l(p.id)},[v("span",gm,[ue(An,{name:p.icon},null,8,["name"])]),v("span",ym,M(p.label),1)],10,hm))),128)),(T(!0),O(z,null,Z(o.value,p=>(T(),O("button",{key:"plugin-"+p.id,class:ce(["bn-btn",{"bn-on":s.value===p.id}]),"data-tab":p.id,onClick:y=>u(p.id)},[v("span",bm,M(p.icon||"🧩"),1),v("span",{class:"bn-label",innerHTML:f(p.name)},null,8,wm)],10,vm))),128)),v("button",{class:ce(["bn-btn",{"bn-on":c.value}]),"data-tab":"__tools","data-testid":"nav-tools",onClick:h[1]||(h[1]=p=>K(pm)())},[v("span",km,[ue(An,{name:"tools"})]),h[4]||(h[4]=v("span",{class:"bn-label"},"工具",-1))],2),h[7]||(h[7]=v("div",{class:"bn-group"},"工具",-1)),v("div",xm,[(T(!0),O(z,null,Z(K(ns),p=>(T(),O("button",{key:"tool-"+p.id,class:ce(["bn-btn",{"bn-on":s.value===p.id}]),"data-tab":p.id,onClick:y=>u(p.id)},[v("span",_m,[ue(An,{name:p.icon},null,8,["name"])]),v("span",Am,M(p.label),1)],10,Sm))),128)),(T(!0),O(z,null,Z(i.value,p=>(T(),O("button",{key:"ptool-"+p.id,class:ce(["bn-btn",{"bn-on":s.value===p.id}]),"data-tab":p.id,onClick:y=>u(p.id)},[v("span",Em,M(p.icon||"🧩"),1),v("span",{class:"bn-label",innerHTML:f(p.title)},null,8,Om)],10,Tm))),128))]),v("div",{class:"bn-user bn-user-clickable",role:"button",tabindex:"0",title:"前往设置","data-testid":"nav-go-settings",onClick:h[2]||(h[2]=p=>u("settings")),onKeydown:h[3]||(h[3]=Fr(p=>u("settings"),["enter"]))},[...h[5]||(h[5]=[v("span",{class:"bn-user-avatar"},"岸",-1),v("span",null,[v("b",null,"上岸预定人"),Y("点击前往设置")],-1),v("span",{class:"bn-user-arrow","aria-hidden":"true"},"›",-1)])],32)]))}}),Mm={class:"app"},Pm={class:"wb-pagehead","data-testid":"pagehead"},Cm={class:"wb-pagehead-sub"},jm=["data-cols"],Nm={class:"view",id:"vue-view","data-testid":"vue-view"},Lm=le({__name:"App",setup(e){const t=Ur(),n=new Set(["aitools","dashboard","prompt-studio"]),r=j(()=>n.has(String(t.name||""))),s=j(()=>String(t.params.id||t.name||"dashboard")),o=j(()=>Xo(s.value)),i=j(()=>_.daysTo(k.get().settings.examDate)),a=j(()=>{const d=new Date;return _.dkey(d).slice(5)+" · "+["周日","周一","周二","周三","周四","周五","周六"][d.getDay()]}),c=new Set(["scheduler"]),l=j(()=>c.has(s.value)?"2":void 0);let u=null;function f(){const d=document.getElementById("view"),h=document.getElementById("vue-view"),p=r.value?h:d;p&&(p.classList.remove("view-enter"),p.offsetWidth,p.classList.add("view-enter"),u&&clearTimeout(u),u=setTimeout(()=>p.classList.remove("view-enter"),620))}return $r(()=>t.fullPath,()=>f()),Lt(()=>{f()}),(d,h)=>{const p=za("RouterView");return T(),O(z,null,[v("div",Mm,[ue($c),v("div",Pm,[v("div",null,[v("h1",null,M(o.value),1),v("div",Cm,M(a.value)+" · 距考研 "+M(i.value)+" 天",1)])]),nt(v("main",{class:"view",id:"view","data-cols":l.value},null,8,jm),[[Vs,!r.value]]),nt(v("main",Nm,[ue(p)],512),[[Vs,r.value]]),ue(Im)]),h[0]||(h[0]=v("div",{id:"toast-wrap"},null,-1))],64)}}}),ie={},$t={},Dm={run(e,t,n,r){if(r=r||{},$t[e])return $t[e];const s={id:e,label:t||e,status:"running",result:void 0,error:"",extra:r.extra||null,startedAt:new Date().toISOString(),finishedAt:""};ie[e]=s;const o=Promise.resolve().then(function(){return n()}).then(function(i){if(s.status="done",s.result=i,s.finishedAt=new Date().toISOString(),delete $t[e],r.onDone)try{r.onDone(i,s)}catch(a){console.warn("[BgTask] onDone 回调异常",a)}return window.U&&_.emit&&_.emit("bgTask:done",{id:e,label:s.label,result:i}),i},function(i){if(s.status="error",s.error=i&&i.message?i.message:String(i),s.finishedAt=new Date().toISOString(),delete $t[e],r.onError)try{r.onError(i,s)}catch(a){console.warn("[BgTask] onError 回调异常",a)}throw window.U&&_.emit&&_.emit("bgTask:error",{id:e,label:s.label,error:s.error}),i});return $t[e]=o,o.catch(function(){}),o},isRunning(e){return!!(ie[e]&&ie[e].status==="running")},get(e){return ie[e]||null},getResult(e){return ie[e]&&ie[e].status==="done"?ie[e].result:void 0},getError(e){return ie[e]&&ie[e].status==="error"?ie[e].error:""},clear(e){ie[e]&&ie[e].status!=="running"&&delete ie[e]},clearAll(){Object.keys(ie).forEach(function(e){ie[e].status!=="running"&&delete ie[e]})},list(e){return Object.keys(ie).filter(function(t){return!e||ie[t].status==="running"}).map(function(t){return ie[t]})}},qm=`# kaoyan2026 云端出卷执行器 workflow（2026-08-24；v11 增 PDF 导入资源 Gist）
