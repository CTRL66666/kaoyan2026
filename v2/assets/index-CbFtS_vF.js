...
PluginBus.register(`+JSON.stringify(a)+");",enabled:!0,createdAt:M.dkey?M.dkey():new Date().toISOString().slice(0,10),isSkillPack:!0,skillMeta:{whenToUse:t.whenToUse,refCount:(t.refs||[]).length}};p>=0?u.plugins[p]=d:u.plugins.push(d)});var l=Nn(a);return dt[r]={manifest:l},e||Q.show("技能包「"+(t.name||r)+"」已导入（"+(t.refs.length?t.refs.length+" 份参考":"无参考")+"）","success",3e3),l},importZip:function(t,e){if(!window.ZipKit)throw new Error("技能包解析器未加载");return We.parseZip(t).then(function(n){var s=We.normalizeSkillPack(n);return q.importSkillPack(s,e)})},importSkillMdText:function(t,e){if(!window.ZipKit)throw new Error("技能包解析器未加载");var n=We.parseSkillMd(t);if(!n)throw new Error("无法解析 SKILL.md");var s=n.name||"skill-pack",r={id:s,name:s,description:n.description,whenToUse:n.whenToUse,skillMd:n.body,refs:[],files:[]};return q.importSkillPack(r,e)},exportShareCode:function(t){var e=oe().find(function(o){return o.id===t});if(!e||!e.source)return null;try{var n=new TextEncoder().encode(e.source),s="";n.forEach(function(o){s+=String.fromCharCode(o)});var r=btoa(s).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return"PBCODE1:"+r}catch{return null}},importShareCode:function(t,e){if(!t||typeof t!="string")throw new Error("无效分享码");var n=t.match(/^PBCODE1:([A-Za-z0-9\-_]+)$/);if(!n)throw new Error("不是有效的插件分享码（应以 PBCODE1: 开头）");try{for(var s=n[1].replace(/-/g,"+").replace(/_/g,"/");s.length%4;)s+="=";for(var r=atob(s),o=new Uint8Array(r.length),i=0;i<r.length;i++)o[i]=r.charCodeAt(i);var a=new TextDecoder("utf-8").decode(o);return q.importText(a,e)}catch(l){throw new Error("分享码解析失败："+(l.message||l))}},_replaySource:function(t){var e=new Function("PluginBus","window",`"use strict";
`+t);e(q,window)},enable:function(t,e){if(P.update(function(r){var o=(r.plugins||[]).find(function(i){return i.id===t});o&&(o.enabled=!!e)}),e&&!dt[t]){var n=oe().find(function(r){return r.id===t});if(n&&n.source){try{q._replaySource(n.source)}catch(r){wt(t,"启用重注册失败："+(r.message||r),"error")}return}}var s=dt[t];if(!s){q.syncAugmentors();return}if(e)try{Ks(s.manifest),s.manifest.css&&q._injectCss(t,s.manifest.css),s.manifest.onEnable&&s.manifest.onEnable(vt(t)),s.manifest.init&&s.manifest.init(vt(t))}catch(r){wt(t,"启用错误："+(r.message||r),"error")}else{Hn(t),q.unsubscribeAll(t),q._removeCss(t),q._clearEnhOf(t);try{s.manifest.onDisable&&s.manifest.onDisable(vt(t))}catch(r){wt(t,"禁用错误："+(r.message||r),"error")}}q.syncAugmentors()},_clearEnhOf:function(t){var e=this;Object.keys(this._enh).forEach(function(n){e._enh[n]&&e._enh[n].pid===t&&e._clearEnh(n)})},remove:function(t){P.update(function(e){e.plugins=(e.plugins||[]).filter(function(n){return n.id!==t})}),Hn(t),q.unsubscribeAll(t),q._removeCss(t),q._clearEnhOf(t);try{dt[t]&&dt[t].manifest.onDisable&&dt[t].manifest.onDisable(vt(t))}catch{}q.closePanelsOf(t),delete dt[t],q.syncAugmentors()},byStore:oe,handleKey:function(t){var e=t.target&&t.target.tagName||"",n=e==="INPUT"||e==="TEXTAREA"||e==="SELECT"||t.target&&t.target.isContentEditable;Object.keys(dt).forEach(function(s){var r=dt[s].manifest;Ae(s)&&(r.shortcuts||[]).forEach(function(o){if(!(!o||!o.key||typeof o.run!="function")){var i=o.key.toLowerCase().split("+"),a=i.indexOf("ctrl")>=0,l=i.indexOf("alt")>=0,u=i.indexOf("shift")>=0,p=i.indexOf("meta")>=0,d=i[i.length-1],f=!!t.ctrlKey===a&&!!t.altKey===l&&!!t.shiftKey===u&&!!t.metaKey===p&&String(t.key||"").toLowerCase()===d;if(f&&!(!a&&!l&&!p&&n)){t.preventDefault();try{o.run(vt(s),t)}catch(w){wt(s,"快捷键错误："+(w.message||w),"error")}}}})})},bootstrap:function(){oe().forEach(function(t){if(!(!t.enabled||!t.source))try{q._replaySource(t.source)}catch(e){wt(t.id,"启动重放失败："+(e.message||e),"error")}});try{q.syncAugmentors()}catch{}}};window.PluginBus=q;typeof document<"u"&&document.addEventListener&&(document.addEventListener("keydown",function(t){try{q.handleKey(t)}catch{}},!0),document.addEventListener("store:change",function(t){try{q._onStoreUpdate(t&&t.detail)}catch{}}));P&&M&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",function(){try{q.bootstrap()}catch{}}):setTimeout(function(){try{q.bootstrap()}catch{}},0));const Lr="kaoyan2026_layout",Cr=900;function ia(){try{const t=localStorage.getItem(Lr);return t==="phone"||t==="workbench"?t:"auto"}catch{return"auto"}}const He=et(ia());function aa(){try{return window.innerWidth>=Cr}catch{return!1}}function ce(){return He.value==="workbench"?"workbench":He.value==="phone"?"phone":aa()?"workbench":"phone"}function as(t,e){try{const n=document.documentElement;e&&(n.classList.add("layout-anim"),setTimeout(()=>n.classList.remove("layout-anim"),400)),t==="workbench"?n.setAttribute("data-layout","workbench"):n.removeAttribute("data-layout")}catch{}}as(ce(),!1);let un=ce();try{const t=window.matchMedia("(min-width: "+Cr+"px)"),e=()=>{if(He.value!=="auto")return;const n=ce();n!==un&&(un=n,as(n,!0))};t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}function jr(){const t=C(()=>He.value),e=C(()=>ce()),n=C(()=>ce()==="workbench");function s(o){He.value=o;try{localStorage.setItem(Lr,o)}catch{}un=ce(),as(un,!0)}function r(){s(ce()==="workbench"?"phone":"workbench")}return{pref:t,effective:e,isWorkbench:n,set:s,toggle:r}}let Ft=null;function Vs(t){Ft=t}function la(){const t={go(s){const r=window.FocusModule;if(r&&r.active){Q.show("深度专注进行中，请先点「中断专注」结束再切换","warn",3500);return}kt.push(Ut(s))},refresh(){Ft&&Ft()},get current(){const s=kt.currentRoute.value;return String(s.params.id||s.name||"dashboard")}};window.App=t;const e=vn();window.Theme={get:()=>e.pref.value,current:()=>e.theme.value,isNight:()=>e.isNight.value,isMorning:()=>e.isMorning.value,set:s=>{e.set(s),Ft&&Ft()},toggle:()=>{e.toggle(),Ft&&Ft()},cycle:()=>{e.cycle(),Ft&&Ft()}};const n=jr();window.Layout={get:()=>n.pref.value,effective:()=>n.effective.value,isWorkbench:()=>n.isWorkbench.value,set:s=>{n.set(s)},toggle:()=>{n.toggle()}}}function ls(t,e){try{const n=window,s=n.__ERR_LOG__=n.__ERR_LOG__||[];s.unshift({at:new Date().toISOString(),msg:String(t||""),stack:String(e||"").slice(0,800)}),s.length>20&&(s.length=20)}catch{}}function ca(){const t=window,e=[];e.push("=== KaoYan 诊断报告 "+new Date().toISOString()+" ===");try{e.push("UA: "+navigator.userAgent)}catch{}try{const s=navigator.serviceWorker;e.push("SW: "+(s&&s.controller?String(s.controller.scriptURL).split("/").pop():"无控制页（未注册或首启）"))}catch{e.push("SW: 环境不可用")}try{e.push("IDB主存: "+(t.Store&&t.Store.isIdbPrimary?t.Store.isIdbPrimary()?"是（重数据在 IndexedDB）":"否（降级 localStorage）":"未知"))}catch{}try{let s=0;for(let r=0;r<localStorage.length;r++){const o=localStorage.key(r);s+=o.length+(localStorage.getItem(o)||"").length}e.push("localStorage: "+Math.round(s/1024)+" KB / ~5MB")}catch{}try{t.Store&&t.Store.usageBytes&&e.push("Store占用(usageBytes): "+Math.round(t.Store.usageBytes()/1024)+" KB")}catch{}try{e.push("已装插件: "+(t.PluginBus&&t.PluginBus.byStore?t.PluginBus.byStore().length:0)+" 件")}catch{}const n=Array.isArray(t.__ERR_LOG__)?t.__ERR_LOG__:[];return e.push("--- 最近错误 "+n.length+" 条 ---"),n.forEach(function(s,r){e.push("["+(r+1)+"] "+s.at+" "+s.msg),s.stack&&e.push(String(s.stack).split(`
`).slice(0,3).join(`
`))}),n.length||e.push("(无)"),e.join(`
`)}const hh=Object.freeze(Object.defineProperty({__proto__:null,buildDiagnosticsReport:ca,pushErrLog:ls},Symbol.toStringTag,{value:"Module"})),ua={hidden:""},Qs=ot({__name:"LegacyPage",setup(t){const e=Wn(),n=Xn(),s={dashboard:"DashboardModule",scheduler:"SchedulerModule",review:"ReviewModule",photomistake:"PhotoMistakeModule",quiz:"QuizModule",essay:"EssayModule",mistakes:"MistakesModule",heatmap:"HeatmapModule",inspector:"InspectorModule",focus:"FocusModule",concept:"ConceptMapModule",sprint:"SprintModule",decision:"DecisionModule",mental:"MentalModule",reading:"ReadingModule",wordbook:"WordbookModule",polrecite:"PolReciteModule",redline:"RedlineModule",progress:"ProgressModule",plugins:"PluginCenterModule",share:"SharePlazaModule",vizai:"VizAiModule",settings:"SettingsModule"};function r(){return String(e.params.id||e.name||"dashboard")}function o(){return document.getElementById("view")}function i(){const w=o();return{v:w?w.scrollTop:0,w:window.scrollY||window.pageYOffset||0}}function a(w){const v=o();w?(v&&(v.scrollTop=w.v),window.scrollTo(0,w.w)):(v&&(v.scrollTop=0),window.scrollTo(0,0))}const l={};jo(()=>{l[r()]=i()});function u(w){const v=new Map;return w.querySelectorAll("details[open]").forEach(y=>{const h=y.querySelector("summary");if(!h)return;const g=h.textContent.trim();v.set(g,(v.get(g)||0)+1)}),v}function p(w,v){w.size&&v.querySelectorAll("details").forEach(y=>{const h=y.querySelector("summary");if(!h)return;const g=h.textContent.trim(),A=w.get(g);A&&A>0&&(y.open=!0,A===1?w.delete(g):w.set(g,A-1))})}function d(w){const v=o();if(!v)return;const y=r(),h=!!(w&&w.preserveUi),g=h?u(v):null,A=h?i():void 0,L=s[y],E=(L?window[L]:null)||f(y);if(!E||typeof E.render!="function"){if(!window.__LEGACY_ALL__){v.innerHTML='<div class="card"><div class="empty">⏳ 模块加载中…（后台补齐中，片刻即好）</div></div>',window.addEventListener("legacy:rest-loaded",()=>{if(r()===y)try{d(w)}catch{}},{once:!0});return}n.replace("/dashboard");return}v.innerHTML="";try{E.render(v)}catch(I){const T=I&&(I.message||String(I))||"未知渲染错误",D=I&&I.stack?String(I.stack):"";v.innerHTML='<div class="card"><div class="card-title" style="color:var(--danger)">⚠️ 「'+M.esc(y)+'」模块加载失败</div><div class="muted-sm" style="margin:8px 0;word-break:break-all">'+M.esc(T)+"</div>"+(D?'<details style="margin-top:6px"><summary class="muted-sm" style="cursor:pointer">📄 详细堆栈（截图反馈）</summary><pre class="report" style="font-size:11px;white-space:pre-wrap;max-height:260px;overflow:auto;margin-top:6px">'+M.esc(D)+"</pre></details>":"")+'<div class="btn-row" style="margin-top:12px"><button class="btn btn-sm btn-primary" id="pgerr-reload">🔄 重试</button><button class="btn btn-sm btn-ghost" id="pgerr-home">返回作战台</button></div></div>';const O=v.querySelector("#pgerr-reload");O&&(O.onclick=()=>{try{d(w)}catch{}});const N=v.querySelector("#pgerr-home");N&&(N.onclick=()=>n.replace("/dashboard")),console.error("[LegacyPage] 模块渲染失败:",y,I),ls("[render] "+y+": "+T,D)}v.querySelector('div[data-pg-slot="top"]')||v.insertAdjacentHTML("afterbegin",'<div data-pg-slot="top" class="pg-slot"></div>'),v.querySelector('div[data-pg-slot="bottom"]')||v.insertAdjacentHTML("beforeend",'<div data-pg-slot="bottom" class="pg-slot"></div>');try{q._onPageRendered(v,y)}catch{}h&&g&&p(g,v),v.querySelectorAll(".pbar-fill").forEach(I=>{requestAnimationFrame(()=>{I.style.width=I.getAttribute("data-w")+"%"})}),h&&A&&a(A)}De(()=>e.fullPath,async()=>{await tn();const w=r();d(),a(l[w])}),he(()=>{Vs(()=>d({preserveUi:!0})),d()}),or(()=>Vs(null));function f(w){try{const v=q.tools();for(const h of v)if(h.id===w)return{render(g){const A=q.ctxOf?q.ctxOf(h.pid):{};if(g.innerHTML='<div class="card"><div class="card-title-row"><span class="card-title">'+(h.icon||"🧩")+" "+window.U.esc(h.title)+`</span><button class="btn btn-ghost btn-sm" onclick="App.go('__tools')">← 工具</button></div><div class="muted-sm" style="margin-bottom:8px">插件：`+window.U.esc(h.pid)+'</div></div><div class="plugin-tool-body">'+(typeof h.render=="function"&&h.render(A)||"")+"</div>",typeof h.mount=="function"){const L=g.querySelector(".plugin-tool-body");if(L)try{h.mount(L,A)}catch(E){L.innerHTML='<div class="alert alert-danger">插件渲染失败：'+window.U.esc(E.message||E)+"</div>"}}}};const y=q.maintabs();for(const h of y)if(h.id===w)return{render(g){const A=q.ctxOf?q.ctxOf(h.pid):{};try{h.render(A,g)}catch(L){g.innerHTML='<div class="alert alert-danger">插件主 tab 渲染失败：'+window.U.esc(L.message||L)+"</div>"}}}}catch{}return null}return(w,v)=>(b(),_("div",ua))}}),da=["innerHTML"],Cn=ot({__name:"TexText",props:{source:{}},setup(t){const e=t,n=C(()=>Ne.renderInline(e.source||""));return(s,r)=>(b(),_("span",{class:"tex-text",innerHTML:n.value},null,8,da))}}),pa={class:"card",style:{"margin-top":"24px"},"data-testid":"aitools-page"},fa={class:"card-title-row"},ha={class:"btn-row",style:{margin:"8px 0"}},ga=["disabled"],ma={key:0,style:{margin:"8px 0"},"data-testid":"dl-progress"},ya={class:"pbar",style:{height:"12px",background:"var(--surface-muted)"}},va={class:"muted-sm",style:{"margin-top":"4px","font-variant-numeric":"tabular-nums"}},ba={key:1,class:"muted-sm",style:{"white-space":"pre-wrap","font-size":"12px"},"data-testid":"dl-logs"},wa={key:2,style:{"margin-top":"14px"},class:"card-inner","data-testid":"at-res"},ka={style:{flex:"1"}},_a={class:"chip",style:{"font-size":"11px"}},Sa={class:"muted-sm",style:{width:"64px","text-align":"right"}},xa={class:"btn-row",style:{"margin-top":"8px"}},Aa=["disabled"],Ea={key:0,class:"muted-sm",style:{"white-space":"pre-wrap","font-size":"12px"},"data-testid":"at-res-logs"},Ta={style:{"margin-top":"14px"},class:"card-inner","data-testid":"at-chat"},Oa={class:"card-title-row"},Ia={style:{"max-height":"460px",overflow:"auto",margin:"6px 0"}},Ma={key:0,style:{"text-align":"right"}},Pa={class:"chip",style:{"white-space":"pre-wrap"}},Na={key:1},La=["open"],Ca={class:"muted-sm",style:{cursor:"pointer"}},ja={class:"report",style:{"font-size":"12px"}},Da={class:"report",style:{"font-size":"12px",opacity:".8"}},qa=["src"],Ra={key:1,style:{"margin-top":"4px"}},Ba={key:0,class:"muted-sm"},Ja={key:1,class:"muted-sm"},Ga={style:{display:"flex",gap:"8px","align-items":"flex-end"}},Ha=["disabled"],za={style:{"margin-top":"14px"},class:"card-inner"},$a={class:"btn-row",style:{margin:"8px 0"}},Ua=["disabled"],Fa=["open"],Ka={class:"muted-sm",style:{cursor:"pointer"}},Va={key:0,class:"report",style:{"font-size":"12px"}},Qa={key:1,class:"report",style:{"font-size":"12px",opacity:".8"}},Xa={key:2},Wa={key:0,class:"card",style:{"margin-top":"8px"},"data-testid":"at-report"},Ya={style:{"margin-top":"4px"}},Za=ot({__name:"AiToolsPage",setup(t){const e=C(()=>ve.enabled()),n=[{k:"runtime",name:"Pyodide 运行时（内核 + 标准库）",size:"≈10MB",core:!0},{k:"numpy",name:"numpy（数值计算）",size:"≈7MB",core:!0},{k:"sympy",name:"sympy（符号验算核心）",size:"≈11MB",core:!0},{k:"mpl",name:"matplotlib（精确画图）",size:"≈9MB",core:!1},{k:"font",name:"SimHei 中文字体（图内中文）",size:"≈4.7MB",core:!1},{k:"scipy",name:"scipy（数值积分/优化，按需）",size:"≈12MB",core:!1}],s=js({runtime:!1,numpy:!1,sympy:!1,mpl:!1,font:!1,scipy:!1}),r=et(!1),o=et(!1),i=et([]);async function a(){try{const R=await Yo();Object.assign(s,R),r.value=!0}catch{}}async function l(){if(!o.value){o.value=!0,i.value=[];try{await Zo(R=>{i.value.push(R)}),i.value.push("✅ 画图组件就绪——出题配图零等待")}catch(R){i.value.push("✗ "+String(R?.message||R))}finally{o.value=!1,await a()}}}De(()=>Et.status,R=>{R==="ready"&&(a(),setTimeout(()=>{a()},4e3))},{immediate:!0});const u=et([]),p=et(!1);async function d(){p.value=!0,u.value=[];try{await ve.ensureLoaded(R=>{u.value.push(R)}),u.value.push("✅ 就绪")}catch(R){u.value.push("✗ "+String(R?.message||R))}finally{p.value=!1}}function f(){ve.setEnabled(!e.value)}const w=js({stem:"",answer:"",solution:""}),v=C(()=>qs.running),y=C(()=>qs.steps),h=et(""),g=et(""),A=et(!1);async function L(){if(v.value)return;h.value="",g.value="",A.value=!1;const R=await ve.verifyAnswer(w.stem,w.answer,w.solution,{isCancelled:()=>A.value});h.value=R.finalText,g.value=R.verdict}function E(){A.value=!0}const I=ti,T=et("");let D=!1;function O(){if(I.running||!T.value.trim())return;D=!1;const R=T.value;T.value="",ei(R,()=>D),tn(()=>{const B=document.querySelector('[data-testid="at-chat"] > div:nth-child(3)');B&&(B.scrollTop=B.scrollHeight)})}function N(){D=!0}return(R,B)=>(b(),_("div",pa,[c("div",fa,[B[6]||(B[6]=c("span",{class:"card-title"},[Z("🧪 AI 工程台 "),c("span",{class:"muted-sm"},"（实验功能）")],-1)),c("span",{class:"chip",style:Vt(W(Et).status==="ready"?"color:#237804":"")},k(W(Et).status==="ready"?"组件就绪":W(Et).status==="loading"?"下载中…":W(Et).status==="error"?"组件加载失败":"组件未下载"),5)]),B[15]||(B[15]=c("div",{class:"muted-sm",style:{"margin-bottom":"8px"}},[Z(" 给 AI 增加真实工程能力：多轮调用 Python（numpy/sympy）做符号验算、数值抽查、画图。 两套方案自由选择："),c("b",null,"不启用 = 与现有完全一致"),Z("（零下载零差异）；启用后仅本页与设置页入口生效。 ")],-1)),c("div",ha,[c("button",{class:tt(["btn btn-sm",e.value?"btn-primary":"btn-ghost"]),"data-testid":"at-toggle",onClick:f},k(e.value?"✓ 已启用（点击停用）":"方案A：启用工程能力"),3),e.value?(b(),_("button",{key:0,class:"btn btn-sm btn-ghost","data-testid":"at-download",disabled:p.value||W(Et).status==="ready",onClick:d},k(W(Et).status==="ready"?"组件已就绪":p.value?"下载中…":"下载扩展组件（约10MB，仅一次）"),9,ga)):z("",!0)]),p.value?(b(),_("div",ma,[c("div",ya,[c("div",{style:Vt([{height:"100%","border-radius":"999px",transition:"width .3s",background:"linear-gradient(90deg,#2f54eb,#7aa2ff)",width:"0%"},{width:W(Et).progress.pct+"%"}])},null,4)]),c("div",va,k(W(Et).progress.pct)+"% · "+k(W(Et).progress.msg||"准备下载…"),1)])):z("",!0),u.value.length?(b(),_("div",ba,k(u.value.join(`
`)),1)):z("",!0),e.value?(b(),_("div",wa,[c("div",{class:"card-title-row"},[B[7]||(B[7]=c("span",{class:"card-title"},"📦 组件资源管理",-1)),c("button",{class:"btn btn-ghost btn-sm","data-testid":"at-res-refresh",onClick:a},"↻ 刷新状态")]),B[8]||(B[8]=c("div",{class:"muted-sm",style:{"margin-bottom":"6px"}}," 基础组件随首次下载安装；画图组件默认「首次画图时按需下载」——重度可视化用户可点「预载」提前装好，出题配图零等待。 装过即记忆：重启后自动从缓存后台恢复，无需手动操作。 ",-1)),(b(),_(H,null,X(n,$=>c("div",{key:$.k,style:{display:"flex","align-items":"center",gap:"8px",padding:"5px 0","border-bottom":"1px solid var(--line)","font-size":"12.5px"}},[c("span",ka,[Z(k($.name)+" ",1),c("span",_a,k($.core?"基础":"画图"),1)]),c("span",Sa,k($.size),1),c("span",{style:Vt([{width:"84px","text-align":"right","font-weight":"600"},s[$.k]?"color:#237804":"opacity:.55"])},k(r.value?s[$.k]?"✓ 已装载":"未装载":W(Et).status==="ready"?"查询中…":"未下载"),5)])),64)),c("div",xa,[c("button",{class:"btn btn-sm btn-primary",disabled:o.value||W(Et).status!=="ready","data-testid":"at-res-preload",onClick:l},k(o.value?"⏳ 预载中…":"🎨 预载画图组件（matplotlib + 中文字体 ≈14MB）"),9,Aa)]),i.value.length?(b(),_("div",Ea,k(i.value.join(`
`)),1)):z("",!0)])):z("",!0),e.value?(b(),_(H,{key:3},[c("div",Ta,[c("div",Oa,[B[9]||(B[9]=c("span",{class:"card-title"},"💬 工程对话（AI 自主编排工具）",-1)),c("button",{class:"btn btn-ghost btn-sm","data-testid":"at-chat-reset",onClick:B[0]||(B[0]=(...$)=>W(Rs)&&W(Rs)(...$))},"清空会话")]),B[10]||(B[10]=c("div",{class:"muted-sm",style:{"margin-bottom":"6px"}}," 像网页端 AI 平台一样问一句话，AI 连续自主调用 Python（验算/画图/数据处理）后作答。会话在本页驻留。 ",-1)),c("div",Ia,[(b(!0),_(H,null,X(W(I).items,($,V)=>(b(),_("div",{key:V,style:{margin:"8px 0"}},[$.role==="user"?(b(),_("div",Ma,[c("span",Pa,k($.text),1)])):(b(),_("div",Na,[(b(!0),_(H,null,X($.steps,(it,At)=>(b(),_("details",{key:At,style:{margin:"4px 0"},open:At===$.steps.length-1&&!$.text},[c("summary",Ca,"第 "+k(At+1)+" 次工具 · Python "+k(it.error?"❌":"✓"),1),c("pre",ja,k(it.code),1),c("pre",Da,[Z("输出："+k(it.output||"(无)"),1),it.error?(b(),_(H,{key:0},[Z(k(`
`)+"错误："+k(it.error),1)],64)):z("",!0)])],8,La))),128)),$.image?(b(),_("img",{key:0,src:$.image,style:{"max-width":"100%",border:"1px solid var(--line)","border-radius":"8px",margin:"4px 0"},alt:"AI 生成图表"},null,8,qa)):z("",!0),$.text?(b(),_("div",Ra,[ct(Cn,{source:$.text},null,8,["source"])])):z("",!0)]))]))),128)),W(I).running?(b(),_("div",Ba,"⚙️ AI 正在自主安排工具调用…（可取消）")):z("",!0),W(I).items.length?z("",!0):(b(),_("div",Ja,"试试：「帮我验证 ∫₀¹ xeˣdx 的答案是 e+1 是否正确」或「画一张标准正态分布曲线」"))]),c("div",Ga,[Qt(c("textarea",{"onUpdate:modelValue":B[1]||(B[1]=$=>T.value=$),class:"input",rows:"2",style:{flex:"1"},placeholder:"一句话交给 AI，它会自主决定是否调用 Python…（Ctrl+Enter 发送）","data-testid":"at-chat-input",onKeydown:B[2]||(B[2]=Yn(en($=>O(),["ctrl"]),["enter"]))},null,544),[[ye,T.value]]),W(I).running?(b(),_("button",{key:1,class:"btn btn-ghost",onClick:N},"取消")):(b(),_("button",{key:0,class:"btn btn-primary","data-testid":"at-chat-send",disabled:!T.value.trim(),onClick:O},"发送",8,Ha))])]),c("div",za,[B[11]||(B[11]=c("div",{class:"card-title-row"},[c("span",{class:"card-title"},"🔎 答案真实验算（sympy 独立重解 + 数值抽查）")],-1)),B[12]||(B[12]=c("label",{class:"muted-sm"},"题干",-1)),Qt(c("textarea",{"onUpdate:modelValue":B[3]||(B[3]=$=>w.stem=$),class:"input",rows:"2",placeholder:"例：计算 ∫₀¹ x·eˣ dx",style:{width:"100%"}},null,512),[[ye,w.stem]]),B[13]||(B[13]=c("label",{class:"muted-sm"},"给出的答案",-1)),Qt(c("textarea",{"onUpdate:modelValue":B[4]||(B[4]=$=>w.answer=$),class:"input",rows:"2",placeholder:"例：e − 1 ≈ 1.718",style:{width:"100%"}},null,512),[[ye,w.answer]]),B[14]||(B[14]=c("label",{class:"muted-sm"},"解析（可选）",-1)),Qt(c("textarea",{"onUpdate:modelValue":B[5]||(B[5]=$=>w.solution=$),class:"input",rows:"2",placeholder:"分部积分过程…",style:{width:"100%"}},null,512),[[ye,w.solution]]),c("div",$a,[c("button",{class:"btn btn-primary","data-testid":"at-verify",disabled:v.value||W(Et).status!=="ready",onClick:L},k(v.value?"验算中…":"⚡ 开始真实验算"),9,Ua),v.value?(b(),_("button",{key:0,class:"btn btn-ghost",onClick:E},"取消")):z("",!0)]),(b(!0),_(H,null,X(y.value,($,V)=>(b(),_("div",{key:V,style:{margin:"6px 0"}},[c("details",{open:$.type==="exec"&&V===y.value.length-1},[c("summary",Ka," 第 "+k($.round)+" 轮 · "+k($.type==="exec"?"执行 Python"+($.error?" ❌":" ✓"):"最终结论"),1),$.code?(b(),_("pre",Va,k($.code),1)):z("",!0),$.output!==void 0?(b(),_("pre",Qa,[Z("输出："+k($.output||"(无)"),1),$.error?(b(),_(H,{key:0},[Z(k(`
`)+"错误："+k($.error),1)],64)):z("",!0)])):z("",!0),$.type==="final"?(b(),_("div",Xa,[ct(Cn,{source:$.text||""},null,8,["source"])])):z("",!0)],8,Fa)]))),128)),h.value?(b(),_("div",Wa,[c("b",{style:Vt(g.value==="通过"?"color:#237804":g.value==="不通过"?"color:#cf1322":"")},k(g.value?"验算结论："+g.value:"结论"),5),c("div",Ya,[ct(Cn,{source:h.value},null,8,["source"])])])):z("",!0)])],64)):z("",!0)]))}}),tl={class:"card",style:{"margin-top":"24px"},"data-testid":"prompt-studio-page"},el={class:"card-title-row"},nl=["disabled"],sl={class:"ps-live","data-testid":"ps-live-strip"},rl={class:"chip"},ol={class:"chip"},il={class:"chip"},al={class:"chip"},ll={class:"chip"},cl={class:"chip"},ul={class:"chip"},dl={style:{display:"flex",gap:"8px","align-items":"center",margin:"10px 0","flex-wrap":"wrap"}},pl={class:"seg-row",style:{margin:"0"}},fl=["placeholder"],hl={class:"card-inner","data-testid":"ps-lanes"},gl={style:{display:"flex","align-items":"baseline",gap:"8px","flex-wrap":"wrap"}},ml={style:{"font-size":"18px"}},yl={style:{"font-size":"13.5px"}},vl={class:"muted-sm",style:{"font-size":"11px"}},bl={key:0,class:"chip chip-warn",style:{"font-size":"10px"}},wl={class:"muted-sm",style:{"font-size":"12px",margin:"3px 0"}},kl={class:"ps-facts"},_l={class:"card-inner",style:{"margin-top":"12px"},"data-testid":"ps-flow"},Sl={style:{"font-size":"20px",flex:"0 0 auto","line-height":"1.4"}},xl={style:{flex:"1","border-left":"3px solid var(--line)","padding-left":"10px"}},Al={style:{"font-size":"13px"}},El={class:"muted-sm",style:{"font-size":"12px","margin-top":"2px"}},Tl={class:"card-inner",style:{"margin-top":"12px"},"data-testid":"ps-chains"},Ol={style:{"font-size":"12.5px","min-width":"170px"}},Il={class:"chip",style:{"font-size":"11px"}},Ml={key:0,class:"muted-sm"},Pl={class:"card-inner",style:{"margin-top":"12px"},"data-testid":"ps-frag"},Nl={style:{"font-size":"13px"}},Ll={class:"muted-sm",style:{"font-size":"12px",margin:"2px 0"}},Cl={key:1,class:"card-inner","data-testid":"ps-registry-table"},jl={class:"card-title-row"},Dl={class:"muted-sm",style:{"font-size":"11px"}},ql={class:"ps-reg-group"},Rl={style:{flex:"1","min-width":"150px"}},Bl={style:{"font-size":"12.5px"}},Jl={class:"muted-sm",style:{"font-size":"10.5px","margin-left":"6px"}},Gl={class:"muted-sm",style:{"font-size":"11px"}},Hl={class:"chip",style:{"font-size":"11px",flex:"none"}},zl={class:"chip",style:{"font-size":"11px",flex:"none"}},$l={class:"chip",style:{"font-size":"11px",flex:"none"}},Ul=["onClick"],Fl={key:0,class:"empty"},Kl={class:"card-inner","data-testid":"ps-coach-flow"},Vl={style:{"font-size":"18px",flex:"0 0 auto","line-height":"1.5"}},Ql={style:{flex:"1","border-left":"3px solid var(--line)","padding-left":"10px"}},Xl={style:{"font-size":"13px"}},Wl={class:"muted-sm",style:{"font-size":"12px","margin-top":"2px"}},Yl={class:"card-inner",style:{"margin-top":"12px"}},Zl={class:"muted-sm",style:{"font-size":"12px","line-height":"2"}},tc={class:"card-inner","data-testid":"ps-aug-list"},ec={class:"card-title-row"},nc={class:"muted-sm",style:{"font-size":"11px"}},sc={style:{flex:"1","min-width":"150px"}},rc={style:{"font-size":"12.5px"}},oc={class:"muted-sm",style:{"font-size":"11px"}},ic={class:"chip",style:{"font-size":"11px"}},ac={class:"chip",style:{"font-size":"11px"}},lc={key:0,class:"empty"},cc={class:"card-inner",style:{"margin-top":"12px"},"data-testid":"ps-trace"},uc={class:"card-title-row"},dc={class:"card-title"},pc={key:0,class:"empty"},fc={class:"ps-trace-time"},hc={class:"muted-sm"},gc={key:0,class:"chip chip-think",style:{"font-size":"10px"}},mc={key:1,class:"chip",style:{"font-size":"10px"}},yc={key:2,class:"chip",style:{"font-size":"10px"}},vc={key:3,class:"muted-sm",style:{"font-size":"11px"}},bc={key:4,class:"muted-sm",style:{"font-size":"11px"}},wc={key:5,class:"chip chip-ov",style:{"font-size":"10px"}},kc={key:6,class:"chip chip-warn",style:{"font-size":"10px"}},_c={class:"card-inner","data-testid":"ps-globals"},Sc={class:"card-title-row"},xc={class:"muted-sm",style:{"font-size":"11px"}},Ac={style:{display:"flex","align-items":"center",gap:"8px","flex-wrap":"wrap"}},Ec={style:{"font-size":"13px"}},Tc={class:"chip",style:{"font-size":"11px"}},Oc={class:"muted-sm",style:{"font-size":"11px"}},Ic=["onClick"],Mc={style:{"font-size":"11.5px","white-space":"pre-wrap","max-height":"280px",overflow:"auto",margin:"6px 0 0"}},Pc={key:0,style:{"margin-top":"8px","border-top":"1px dashed var(--line)","padding-top":"6px"}},Nc={style:{flex:"0 0 auto"}},Lc={style:{flex:"0 0 118px"}},Cc={class:"muted-sm",style:{flex:"1"}},jc={key:0,class:"empty"},Dc={class:"card-inner",style:{"margin-top":"14px"},"data-testid":"ps-modules"},qc={class:"card-title-row"},Rc={class:"muted-sm",style:{"font-size":"11px"}},Bc={style:{display:"flex","align-items":"center",gap:"8px","flex-wrap":"wrap"}},Jc={style:{"font-size":"13px"}},Gc={class:"chip",style:{"font-size":"11px"}},Hc={key:0,class:"muted-sm",style:{"font-size":"11px"}},zc={class:"muted-sm",style:{"font-size":"11px"}},$c=["onClick"],Uc={key:0,style:{"font-size":"11.5px","white-space":"pre-wrap","max-height":"280px",overflow:"auto",margin:"6px 0 0"}},Fc={key:1,class:"alert alert-danger",style:{margin:"6px 0 0","font-size":"12px"}},Kc={key:2,style:{"margin-top":"8px","border-top":"1px dashed var(--line)","padding-top":"6px"}},Vc={style:{flex:"0 0 auto"}},Qc={style:{flex:"0 0 118px"}},Xc={class:"muted-sm",style:{flex:"1"}},Wc={key:0,class:"empty"},Yc=ot({__name:"PromptStudioPage",setup(t){const e=et("map"),n=et(!0),s=et(""),r=et([]),o=et([]),i=et(""),a=et(0),l=C(()=>{a.value;const F=P.get(),S=F.ai||{};let x={};try{x=K.activeApi()||{}}catch{}let G={};try{G=K.cacheStats()||{}}catch{}let U={};try{U=window.AiMemory&&window.AiMemory.stats()||{}}catch{}const nt=window.AiTools;let bt=0;try{bt=window.PluginBus&&window.PluginBus.skills&&window.PluginBus.skills().length||0}catch{}let me=0;try{const Gt=F.copilotChats||{};me=Object.keys(Gt).reduce(function(Lo,Co){return Lo+(Gt[Co]||[]).length},0)}catch{}let Ns="auto",Ls="json",Cs="unknown";try{Ns=String(S.toolProto||"auto")}catch{}try{Ls=ni()}catch{}try{Cs=x.fc===!0?"yes":x.fc===!1?"no":"unknown"}catch{}return{protoMode:Ns,protoEff:Ls,apiFc:Cs,apiName:x.name||"",apiModel:x.model||"",apiEp:String(x.endpoint||"").replace(/^https?:\/\//,"").slice(0,34),configured:!!(x.model&&x.key&&x.endpoint),apisN:(S.apis||[]).length,cacheEntries:G.entries||0,cacheHits:G.hits||0,cacheKb:G.kb||0,memFacts:U.facts||0,memPinned:U.pinned||0,memAi:U.aiFacts||0,engEnabled:!!(nt&&nt.enabled&&nt.enabled()),engReady:!!(nt&&nt.isReady&&nt.isReady()),skillsN:bt,chatsN:me,globalThink:S.thinkingMode===!0?"开":S.thinkingMode===!1?"关":"未设",globalTok:S.maxTokens||0,globalTemp:typeof S.temperature=="number"?S.temperature:null,modes:S.moduleModes||{},toks:S.moduleToks||{},temps:S.moduleTemps||{}}}),u=[{icon:"🌊",name:"本地流式（SSE）",on:!0,route:"chatJSON / chatStream / chatMessagesStream → chatStreamOnce",who:"全站绝大多数调用：出题/判卷/押题组卷/查重/格式修复/提取/教练/可视化…（注册表 43 条几乎全走这条）",facts:["body 带 stream:true + include_usage；响应头先到即算连接正常，30s 超时只管「连不上」，生成可跑几分钟（带图放宽 90s）","reasoning_content 双轨：思考流与正文分开回调（教练 💭 思考条 / 判卷思考区的数据源）","400 两级降级：先去 stream_options 再退极简非流式——不支持 SSE 的厂商自动兜底","chatJSON = 流式收完 → extractRobustJSON 六层容错提取"]},{icon:"📦",name:"本地非流式（rawChat）",on:!0,route:"AI.chat → rawChatOnce（整包 JSON 响应）",who:"仅广场一次性调用（shareAI）+ 任何请求 400 后的极简重试临时落到这条",facts:["30s 超时覆盖整个生成过程——长输出必死，这就是重任务全走流式的原因","思考决策：逐功能 moduleModes 优先，未配置才回退「显式 noThink > 全局开关 > 省略」(rawChatThinkKwArgs，2026-09-09 已修复此前忽略单模块配置的缺陷)","温度：决策链命中即发，未配置保持历史默认 0.6"]},{icon:"🧪",name:"AI 工程台（Python 工具循环）",on:C(()=>l.value.engEnabled),route:"toolsBridge 门卫 → toolChat 多轮循环；教练面板另走 newCoachSession 直连",who:"启用后 chat/chatStream/chatJSON 自动转多轮；教练/出题/验算/画图可自主调 Python",facts:['JSON 协议：模型输出 {"tool":"python_exec","code":…} → pyodide 真执行 → stdout/图表回传 → 下一轮；≤8 轮封顶','streamClass 分类器：工具轮/结构化 {"final":…} JSON 不上屏，最终回答轮流式喂 UI（思考流全程透传）',"教练 UI：打字机 + 💭 思考条 + 行级步骤卡（liveSteps 会话留存）","晚绑定 window.AiTools 防 core→extensions 循环依赖；未启用零差异","【双协议路由】工具调用方式可选 自研 JSON 协议（全兼容兜底）/ 平台原生 function calling（探测确认 .fc=true 才启用）——协议差异收口在 proto.ts 适配器，agent 循环与 UI 零协议感知；探测入口：设置 → 工程台 → 🔍探测当前接口"]},{icon:"☁️",name:"云端 runner（GitHub Actions）",on:!0,route:"CloudJob 提交 → ai-exam-runner.cjs（v31）→ secret gist 中转 → 收卷",who:"智能出卷（并行出题员/总审查/重写）、导入整卷、资料库整本提取（S0 探测→R1 书签→R2 页脚→R3/R4 目录→R4b 宫格→R5 兜底）",facts:["非流式一次性请求（自带 temperature 默认 0.7），跑在用户自己的 Actions 里，BYOK","断点续跑：每步落盘 gist status.json，崩溃从 checkpoint 恢复","收卷两段式：预览确认（逐题可修订）才入库——防幻觉的人工闸门","与本地链路完全独立：不占浏览器、可关页"]}],p=[{icon:"🚀",t:"① 模块发起",d:"chatStream / chatJSON / chatMessagesStream —— opts.ctx 自报身份（注册表见「调用注册表」页，CI 守门：新增 ctx 不注册→测试红）"},{icon:"🎛",t:"② 决策收口 normalizeOpts",d:"三链同构：单模块配置 > 调用方显式 > 全局默认 > 兜底。思考 resolveThink 五层 · maxTokens 四层 · 温度 resolveTemperature 四层（0~2，未配置=不干预）"},{icon:"🧠",t:"③ 提示词组装",d:"全局人格 / 模块指令 + 动态注入（记忆摘要 · 技能指令 · 识屏 PageCtx · 查询数据 · 用户参数）+ 共享片段（JSON_ONLY · SVG_DIAGRAM_SPEC）"},{icon:"🛠",t:"④ 传输",d:"缓存 cacheHash（命中即回，出题/教练类 cache:false 跳过）· toolsBridge 工程门卫 · withFailover 多接口故障切换 · SSE/非流式两通道"},{icon:"📥",t:"⑤ 解析与修复",d:"extractRobustJSON（围栏/括号配平/截断抢救）· repairJsonSafely · repairPipeLatex · 空正文三级降级（关思考→翻倍 token）"},{icon:"🖼",t:"⑥ 渲染终点",d:"结构化对象 → 模块状态 → 视图；文本 → Tex.renderInline → KaTeX 印刷体（.tx 1.21em 同标度兜底）→ 屏幕 main.css / 打印 txPrintCss+KaTeX 字体内嵌"}],d=[{icon:"🧠",name:"思考 resolveThink",chain:["单模块 moduleModes","显式 noThink/think","局部开关(卷 prefs/深度)","全局 thinkingMode","默认不思考"]},{icon:"📏",name:"maxTokens resolveMaxTokens",chain:["单模块 moduleToks","调用方显式","全局 s.ai.maxTokens","服务端默认"]},{icon:"🌡",name:"温度 resolveTemperature",chain:["单模块 moduleTemps","调用方显式","全局 s.ai.temperature","不干预(流式不发/非流式0.6)"]}],f=C(()=>{a.value;const F=l.value;return(K.AI_REGISTRY||[]).map(S=>{const x=[];F.modes[S.ctx]&&F.modes[S.ctx]!=="global"&&x.push("思考"+(F.modes[S.ctx]==="think"?"✓":"✗")),F.toks[S.ctx]&&x.push("tok"),typeof F.temps[S.ctx]=="number"&&x.push("temp");let G="",U="",nt="";try{G=K.resolveThink({ctx:S.ctx})?"思考":"不思考"}catch{G="?"}try{const bt=K.resolveMaxTokens({ctx:S.ctx});U=bt>0?String(bt):"默认"}catch{U="?"}try{const bt=K.resolveTemperature({ctx:S.ctx});nt=bt==null?"默认":String(bt)}catch{nt="?"}return{ctx:S.ctx,name:S.name,desc:S.desc,def:S.def==="think"?"默认思考":S.def==="noThink"?"默认不思考":"跟随全局",think:G,tok:U,temp:nt,ov:x}})}),w=C(()=>{const F=s.value.trim().toLowerCase(),S={};return f.value.forEach(x=>{if(F&&!(x.ctx+x.name+x.desc).toLowerCase().includes(F))return;const G=(K.AI_REGISTRY.find(U=>U.ctx===x.ctx)||{}).module||"其他";(S[G]=S[G]||[]).push(x)}),S}),v=C(()=>(K.AI_REGISTRY||[]).length),y=C(()=>f.value.filter(F=>F.ov.length).length),h=C(()=>{const F=l.value;return[{icon:"📥",t:"输入汇聚",d:"文本 Enter / 📷图片 / 📎附件 / 快捷问题 / 划词小牌；每条消息带最近 12 轮对话上下文"},{icon:"📍",t:"识屏 PageCtx",d:"DOM 直读当前页（≤40 条 × 400 字，超预算如实截断）：📍钉住每条都带；说「这道题/刚才」指代词自动带一次"},{icon:"🎯",t:"技能匹配 matchSkill",d:`PluginBus 技能库（当前 ${F.skillsN} 个）按触发词命中 → 技能指令注入 system；附件名也参与匹配`},{icon:"🧠",t:"systemPrompt 组装",d:`教练人格(coachProfile) + 当前专业课 + AiMemory 记忆摘要（已记住 ${F.memFacts} 条，AI 归纳 ${F.memAi}）+ 实时学习数据快照 + 动作协议（9 类接管工具）`},{icon:"🔀",t:"路由选择",d:F.engEnabled?"✅ 工程台已启用：newCoachSession 多轮 Python 循环（工具轮 JSON 屏弃、思考流+最终回答流式上屏、步骤卡留存）":"常规：agentLoop QUERY 多轮协议——教练输出 [[QUERY:]] → runQuery 本地查数据 → 回填继续（≤5 轮，无结果也逼回收口）"},{icon:"🌊",t:"流式传输",d:"SSE（cache:false 每次新鲜）；reasoning 与正文双轨回调"},{icon:"🖼",t:"渲染",d:"正文逐字打字机 + 💭 一行滚动思考条（点击展开完整思考流，会话级留存可回看）+ 动作按钮（低风险自动执行）+ 存为 Markdown"},{icon:"🧷",t:"后处理",d:"pushHistory(60 条) + 动作执行 + QUERY 结果回填历史 + reflectIfWorthy 值得才反思沉淀记忆 + 主动督学 superviseCheck（双时段节流，教练画像/全智能两档）"}]});function g(F){if(F==="*")return"全站";const S=(K.AI_REGISTRY||[]).find(x=>x.ctx===F);return S?S.module+" · "+S.name:F||"(无ctx)"}const A=C(()=>{a.value;try{return K.promptAugmentors&&K.promptAugmentors()||[]}catch{return[]}}),L=C(()=>{a.value;try{return K.traceList&&K.traceList()||[]}catch{return[]}});function E(){try{K.traceClear&&K.traceClear(),a.value++}catch{}}function I(F,S,x,G){const U=[{icon:"🧩",t:"system 组装",d:S},{icon:"🎛",t:"决策收口 normalizeOpts",d:"思考/最大token/温度三链同构：单模块 > 显式 > 全局 > 兜底",live:F},{icon:"🛠",t:"传输",d:"缓存（命中即回；出题类 cache:false 跳过）· 工具桥门卫（工程模式自动转多轮 Python）· 故障切换链（多接口 30s）· 流式 SSE"}];return G&&U.splice(3,0,{icon:"🧪",t:"沙箱执行",d:G}),U.push({icon:"📥",t:"解析与修复",d:"extractRobustJSON（代码围栏/括号配平/截断抢救）→ repairJsonSafely → repairPipeLatex"}),U.push({icon:"🖼",t:"渲染终点",d:x}),U}function T(F){try{const S=K.resolveThink({ctx:F})?"思考":"不思考",x=K.resolveMaxTokens({ctx:F}),G=K.resolveTemperature({ctx:F});return"当前生效："+S+" · maxTokens "+(x>0?x:"服务端默认")+" · 温度 "+(G??"默认")}catch{return""}}const D={"global.coach":{system:"教练人格 systemPrompt：教练画像(settings.coachProfile) + activeMajorName + memoryDigest(400)",dest:"copilot 对话底座（被 copilot 层二次组合）"},"quiz.gen":{system:"quizPrompt：出题官 + 记忆摘要(memBlock) + 考点/层级/薄弱参数 + JSON_ONLY + SVG_DIAGRAM_SPEC(按需)",dest:"quiz 对象 → formatStem → Tex.renderInline → KaTeX（作答页）",extra:"工程模式：出题前先 python_exec 算准标准答案"},"quiz.answer":{system:"JUDGE_PROMPT：阅卷官 + JSON_ONLY + 题面/作答/标准答案",dest:"判分 JSON → steps 采分点渲染（作答页/复盘）"},"copilot.review":{system:"DEEP_REVIEW_PROMPT：复盘教练 + activeMajor",dest:"全景快照(reportText 打包) → 深度复盘结构化输出"},"copilot.chat":{system:"systemPrompt：教练人格 + activeMajor + memoryDigest(500) + 实时快照 snapshot + 动作协议",dest:"copilot 气泡打字机 + 💭思考条 → renderContent → Tex/KaTeX；动作 parseActions 自动执行",extra:"技能指令 matchSkill / QUERY 数据 runQuery / 识屏 PageCtx 注入"},"word.mnemonic":{system:"mnemonicSystem：词根/联想/考研考点/搭配/易混 五件套契约",dest:"patchWord(mnemonic) → 词卡 mnemonicHtml（复习翻面）"},"word.example":{system:"exampleSystem：考研语境例句 12-20 词 + 中文翻译",dest:"patchWord(example/exampleCn) → 复习页词卡"},"word.confuse":{system:"易混词契约：3 个近形/近义/同根干扰词",dest:"patchWord(confuseList) → 看义选词干扰项（choiceHtml）"},"insp.gen":{system:"genSystem：方法卡契约（recognize/steps/pitfalls/verify）+ 考点/题面/解析",dest:"normalizePlaybook → 方法卡库 + 带练闭环"},"sprint.latexfix":{system:"LATEX_FIX_SYS：LaTeX 质检员契约——只修语法禁改内容，字段级回传（stem/options 只回传改动）",dest:"逐题勾选确认弹窗 → 覆盖 stem/options → Store 落库"}};function O(F){const S=D[F.ctx];return S&&(F.dest=S.dest,F.pipe=I(F.ctx,S.system,S.dest,S.extra)),F}const N=[{name:"JSON_ONLY",desc:"JSON 输出纪律（出题/判卷/例句/易混词/方法卡/云端 questionSystem 复用同一份）",usedBy:["quiz.gen","quiz.answer","word.example","word.confuse","insp.gen","cloud.questionSystem"]},{name:"SVG_DIAGRAM_SPEC",desc:"SVG 画图规约（配图字段单源，改一处全站生效）",usedBy:["quiz.gen","dashboard 每日一题"]},{name:"TOOL 附录",desc:"python_exec 工具声明（本地 TOOL_APPENDIX / 云端 TOOL_APPENDIX）",usedBy:["工程出题","教练/私教工具会话","云端出题/重写/审查"]},{name:"streamClass 分类器",desc:"流式期 tool/final/hold 三态（bridge.toolChat 与 agent 会话共用，JSON 轮不裸上屏）",usedBy:["工程台全站","教练工程分支"]}];async function R(){n.value=!0;try{await Promise.all([Y(()=>import("./wordbook-CRdsTi4k.js"),[],import.meta.url),Y(()=>import("./copilot-SJfDR96k.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]),import.meta.url),Y(()=>Promise.resolve().then(()=>Bf),void 0,import.meta.url)]),r.value=(K.globalPrompts()||[]).map(S=>O({name:S.name,ctx:S.id,text:String(S.text||"")}));const F=window;o.value=[{name:"单词 · 记忆口诀",ctx:"word.mnemonic",compose:"助记契约 + 示例词条参数",text:()=>F.WordbookModule.mnemonicSystem({word:"abandon",meaning:"放弃；抛弃"})},{name:"单词 · 语境例句",ctx:"word.example",compose:"例句契约 + 示例词条参数",text:()=>F.WordbookModule.exampleSystem()},{name:"单词 · 易混词干扰项",ctx:"word.confuse",compose:"易混词契约（3 个近形/近义/同根）",text:()=>F.WordbookModule.confuseSystem()},{name:"解题方法 · 方法卡 system",ctx:"insp.gen",compose:"方法卡契约 + 科目/考点/代表性题面",text:()=>F.MethodLink.genSystemPreview({subject:"math",topicName:"极限计算"})}].map(S=>{try{return O({name:S.name,ctx:S.ctx,text:String(S.text()),compose:S.compose})}catch(x){return{name:S.name,ctx:S.ctx,text:"",error:String(x.message||x)}}})}finally{n.value=!1}}he(R);function B(){a.value++,R()}function $(F){const S=s.value.trim().toLowerCase();return S?F.filter(x=>(x.name+" "+x.ctx+" "+x.text).toLowerCase().includes(S)):F}const V=C(()=>$(r.value)),it=C(()=>$(o.value));async function At(F,S){try{await navigator.clipboard.writeText(F.text),i.value=S,setTimeout(()=>{i.value===S&&(i.value="")},1500)}catch{}}function On(F){s.value=F,e.value="list"}return(F,S)=>(b(),_("div",tl,[c("div",el,[S[6]||(S[6]=c("span",{class:"card-title"},[Z("🛰 AI 层链路可视化 "),c("span",{class:"muted-sm"},"（实时求值 · 非硬编码快照）")],-1)),c("button",{class:"btn btn-ghost btn-sm","data-testid":"ps-refresh",disabled:n.value,onClick:B},"↻ 刷新实时值",8,nl)]),c("div",sl,[c("span",{class:tt(["chip",l.value.configured?"chip-ok":"chip-warn"])},"🔌 "+k(l.value.configured?(l.value.apiName||"当前接口")+" · "+l.value.apiModel:"未配置接口"),3),c("span",rl,"备用链 "+k(l.value.apisN)+" 个",1),c("span",ol,"🌐 全局思考："+k(l.value.globalThink),1),c("span",il,"📏 全局 maxTokens："+k(l.value.globalTok||"服务端默认"),1),c("span",al,"🌡 全局温度："+k(l.value.globalTemp==null?"不干预":l.value.globalTemp),1),c("span",ll,"🗂 缓存 "+k(l.value.cacheEntries)+" 条 · 命中 "+k(l.value.cacheHits)+" 次 · "+k(l.value.cacheKb)+"KB",1),c("span",cl,"🧠 记忆 "+k(l.value.memFacts)+" 条（置顶 "+k(l.value.memPinned)+"）",1),c("span",ul,"🎓 教练会话 "+k(l.value.chatsN)+" 条 · 技能 "+k(l.value.skillsN)+" 个",1),c("span",{class:tt(["chip",l.value.engEnabled?"chip-ok":""])},"🧪 工程台 "+k(l.value.engEnabled?l.value.engReady?"已启用·就绪":"已启用·未加载":"未启用"),3),c("span",{class:tt(["chip",l.value.protoEff==="fc"?"chip-ok":""]),"data-testid":"ps-proto-chip"},"🔀 工具协议："+k(l.value.protoMode==="auto"?"自动":l.value.protoMode==="fc"?"强制FC":"强制JSON")+" → 生效"+k(l.value.protoEff==="fc"?"原生FC":"JSON")+"（接口"+k(l.value.apiFc==="yes"?"支持FC✓":l.value.apiFc==="no"?"不支持FC✗":"未探测?")+"）",3)]),c("div",dl,[c("div",pl,[c("button",{class:tt(["seg",e.value==="map"?"seg-on":""]),"data-testid":"ps-tab-map",onClick:S[0]||(S[0]=x=>e.value="map")},"🗺 链路全景",2),c("button",{class:tt(["seg",e.value==="registry"?"seg-on":""]),"data-testid":"ps-tab-registry",onClick:S[1]||(S[1]=x=>e.value="registry")},"📋 调用注册表",2),c("button",{class:tt(["seg",e.value==="coach"?"seg-on":""]),"data-testid":"ps-tab-coach",onClick:S[2]||(S[2]=x=>e.value="coach")},"🎓 教练机制",2),c("button",{class:tt(["seg",e.value==="aug"?"seg-on":""]),"data-testid":"ps-tab-aug",onClick:S[3]||(S[3]=x=>e.value="aug")},"🔌 拓展与追踪",2),c("button",{class:tt(["seg",e.value==="list"?"seg-on":""]),"data-testid":"ps-tab-list",onClick:S[4]||(S[4]=x=>e.value="list")},"📜 提示词清单",2)]),Qt(c("input",{"onUpdate:modelValue":S[5]||(S[5]=x=>s.value=x),class:"input",placeholder:e.value==="registry"?"🔍 搜索 ctx / 功能名…":"🔍 搜索名称 / ctx / 提示词内容…","data-testid":"ps-q",style:{flex:"1","min-width":"180px"}},null,8,fl),[[ye,s.value]])]),e.value==="map"?(b(),_(H,{key:0},[c("div",hl,[S[8]||(S[8]=c("div",{class:"card-title"},"四条传输通道（谁走哪条、为什么）",-1)),(b(),_(H,null,X(u,(x,G)=>c("div",{key:G,class:tt(["ps-lane",{dim:x.on===!1}])},[c("div",gl,[c("span",ml,k(x.icon),1),c("b",yl,k(x.name),1),c("code",vl,k(x.route),1),x.on===!1?(b(),_("span",bl,"当前未启用")):z("",!0)]),c("div",wl,[S[7]||(S[7]=c("b",null,"谁在用：",-1)),Z(k(x.who),1)]),c("ul",kl,[(b(!0),_(H,null,X(x.facts,(U,nt)=>(b(),_("li",{key:nt},k(U),1))),128))])],2)),64))]),c("div",_l,[S[9]||(S[9]=c("div",{class:"card-title"},"一次 AI 调用的六层旅程",-1)),(b(),_(H,null,X(p,(x,G)=>c("div",{key:G,style:{display:"flex",gap:"10px","align-items":"flex-start",margin:"8px 0"}},[c("div",Sl,k(x.icon),1),c("div",xl,[c("b",Al,k(x.t),1),c("div",El,k(x.d),1)])])),64))]),c("div",Tl,[S[10]||(S[10]=c("div",{class:"card-title"},"三条决策链（同构：单模块 > 调用方显式 > 全局 > 兜底）",-1)),(b(),_(H,null,X(d,x=>c("div",{key:x.name,style:{display:"flex","align-items":"center",gap:"6px","flex-wrap":"wrap",margin:"8px 0"}},[c("b",Ol,k(x.icon)+" "+k(x.name),1),(b(!0),_(H,null,X(x.chain,(G,U)=>(b(),_(H,{key:U},[c("span",Il,k(G),1),U<x.chain.length-1?(b(),_("span",Ml,"›")):z("",!0)],64))),128))])),64)),S[11]||(S[11]=c("div",{class:"muted-sm",style:{"font-size":"11.5px"}},"逐功能的当前生效值见「📋 调用注册表」；配置入口：设置 → ⚙️ AI 参数配置中心。",-1))]),c("div",Pl,[S[12]||(S[12]=c("div",{class:"card-title"},"🧾 共享片段使用关系（单源契约，改一处全站生效）",-1)),(b(),_(H,null,X(N,x=>c("div",{key:x.name,style:{border:"1px solid var(--line)","border-radius":"8px",padding:"8px 10px",margin:"6px 0"}},[c("b",Nl,k(x.name),1),c("div",Ll,k(x.desc),1),(b(!0),_(H,null,X(x.usedBy,G=>(b(),_("span",{key:G,class:"chip",style:{"font-size":"11px",margin:"2px 4px 2px 0"}},k(G),1))),128))])),64))])],64)):e.value==="registry"?(b(),_("div",Cl,[c("div",jl,[S[13]||(S[13]=c("span",{class:"card-title"},"全量 ctx × 当前实时生效",-1)),c("span",Dl,k(v.value)+" 个注册功能 · "+k(y.value)+" 个有逐功能覆盖 · 传输默认走 🌊SSE（例外见全景页）",1)]),(b(!0),_(H,null,X(w.value,(x,G)=>(b(),_(H,{key:G},[c("div",ql,k(G),1),(b(!0),_(H,null,X(x,U=>(b(),_("div",{key:U.ctx,class:"ps-reg-row"},[c("div",Rl,[c("b",Bl,k(U.name),1),c("code",Jl,k(U.ctx),1),c("div",Gl,k(U.desc),1)]),c("span",Hl,k(U.def),1),c("span",{class:tt(["chip",U.think==="思考"?"chip-think":""]),style:{"font-size":"11px",flex:"none"}},"现·"+k(U.think),3),c("span",zl,"tok "+k(U.tok),1),c("span",$l,"温 "+k(U.temp),1),(b(!0),_(H,null,X(U.ov,nt=>(b(),_("span",{key:nt,class:"chip chip-ov",style:{"font-size":"10px",flex:"none"}},k(nt),1))),128)),c("button",{class:"btn btn-ghost btn-sm",style:{flex:"none","font-size":"11px"},onClick:nt=>On(U.ctx)},"📜",8,Ul)]))),128))],64))),128)),Object.keys(w.value).length?z("",!0):(b(),_("div",Fl,"无匹配项"))])):e.value==="coach"?(b(),_(H,{key:2},[c("div",Kl,[S[14]||(S[14]=c("div",{class:"card-title"},"教练一句话的全旅程（含工程台分支）",-1)),(b(!0),_(H,null,X(h.value,(x,G)=>(b(),_("div",{key:G,style:{display:"flex",gap:"10px","align-items":"flex-start",margin:"9px 0"}},[c("div",Vl,k(x.icon),1),c("div",Ql,[c("b",Xl,k(G+1)+". "+k(x.t),1),c("div",Wl,k(x.d),1)])]))),128))]),c("div",Yl,[S[18]||(S[18]=c("div",{class:"card-title"},"教练专属设施速查",-1)),c("div",Zl,[S[15]||(S[15]=Z(" · 记忆：",-1)),S[16]||(S[16]=c("b",null,"AiMemory",-1)),Z("（事实库 ≤120 条 / 画像 / 反思沉淀 reflectIfWorthy / 整理 memoryDigest）——当前 "+k(l.value.memFacts)+" 条",1),S[17]||(S[17]=Do("<br data-v-b4cd41a4> · 识屏：<b data-v-b4cd41a4>PageCtx</b>（DOM 直读 ≤40 条 × 400 字 + 9000 字总预算截断如实告知）+ 指代词自动附带<br data-v-b4cd41a4> · 动作：<b data-v-b4cd41a4>parseActions</b> 9 类接管工具（跳转/加任务/打卡/改排程…），低风险 auto 执行、可撤销<br data-v-b4cd41a4> · 查询：<b data-v-b4cd41a4>[[QUERY:]]</b> 协议 → runQuery 本地数据 → 回填同轮继续（agentLoop ≤5 轮）<br data-v-b4cd41a4> · 渲染：<b data-v-b4cd41a4>makeStreamView</b> 打字机 + 💭 思考条（liveThink 会话留存可回看）+ 步骤卡（liveSteps）<br data-v-b4cd41a4> · 主动：开场白（每日一次）/ 督学 superviseCheck（双时段）/ pushAssistant（关键事件关怀） ",18))])])],64)):e.value==="aug"?(b(),_(H,{key:3},[c("div",tc,[c("div",ec,[S[19]||(S[19]=c("span",{class:"card-title"}," 插件提示词拓展器（受控注入 AI system）",-1)),c("span",nc,k(A.value.length)+" 个 · 只追加不替换 · 命中 ctx 才生效 · 总追加 ≤8000 字",1)]),S[20]||(S[20]=c("div",{class:"muted-sm",style:{"font-size":"12px",margin:"4px 0 8px"}},[Z("插件在 manifest 声明 "),c("code",null,"promptAugment:[{ctx,name,build}]"),Z("， 经 "),c("b",null,"PluginBus.syncAugmentors"),Z(" 登记到 "),c("b",null,"AI.applyPromptAugments"),Z("；每次 AI 调用把命中 ctx（或 '*' 全站）的拓展段 追加到 system 尾部。禁用插件即注销。下方「调用追踪」可审计每次调用实际注入了谁。")],-1)),(b(!0),_(H,null,X(A.value,x=>(b(),_("div",{key:x.id,class:"ps-aug-row"},[c("div",sc,[c("b",rc,k(x.name),1),c("div",oc,k(x.note||"（无说明）"),1)]),c("span",ic,k(g(x.ctx)),1),c("span",ac,"来源 "+k(x.pid||"内置"),1)]))),128)),A.value.length?z("",!0):(b(),_("div",lc,"暂无插件注册提示词拓展器（导入带 promptAugment 的插件后，此处与下方追踪会实时出现注入记录）"))]),c("div",cc,[c("div",uc,[c("span",dc,"📡 全链路调用追踪（最近 "+k(L.value.length)+" 次）",1),c("button",{class:"btn btn-ghost btn-sm","data-testid":"ps-trace-clear",onClick:E},"🗑 清空")]),S[21]||(S[21]=c("div",{class:"muted-sm",style:{"font-size":"11.5px",margin:"4px 0 8px"}},"每次真实 AI 调用记一条：ctx→模块、模型、思考/温度/maxTokens 生效值、 缓存命中、耗时、被哪些插件拓展器注入（可审计）。点「↻ 刷新实时值」或任意 AI 调用后自动更新。",-1)),L.value.length?z("",!0):(b(),_("div",pc,"暂无调用记录——去任意功能触发一次 AI（出题/判卷/教练对话…）后回来看")),(b(!0),_(H,null,X(L.value,(x,G)=>(b(),_("div",{key:G,class:tt(["ps-trace-row",{err:x.error}])},[c("span",fc,k(new Date(x.at).toLocaleTimeString()),1),c("b",null,k(g(x.ctx)),1),c("span",hc,k(x.model||"—"),1),x.think?(b(),_("span",gc,"思考")):z("",!0),x.temp!=null&&x.temp!==""?(b(),_("span",mc,"温"+k(x.temp),1)):z("",!0),x.tokens?(b(),_("span",yc,"tok"+k(x.tokens),1)):z("",!0),c("span",{class:tt(["chip",x.cache==="hit"?"chip-ok":""]),style:{"font-size":"10px"}},k(x.cache==="hit"?"缓存命中":x.cache==="off"?"不缓存":x.cache==="error"?"失败":"实调"),3),x.ms?(b(),_("span",vc,k(x.ms)+"ms",1)):z("",!0),x.chars?(b(),_("span",bc,k(x.chars)+"字",1)):z("",!0),x.augmented&&x.augmented.length?(b(),_("span",wc,"＋"+k(x.augmented.length)+"插件: "+k(x.augmented.join("/")),1)):z("",!0),x.error?(b(),_("span",kc,k(x.error),1)):z("",!0)],2))),128))])],64)):n.value?z("",!0):(b(),_(H,{key:4},[c("div",_c,[c("div",Sc,[S[22]||(S[22]=c("span",{class:"card-title"},"🌐 注册表提示词",-1)),c("span",xc,"core/ai.ts 单源 + 模块自注册 · "+k(V.value.length)+" 条",1)]),(b(!0),_(H,null,X(V.value,x=>(b(),_("div",{key:x.ctx,style:{border:"1px solid var(--line)","border-radius":"8px",padding:"8px 10px",margin:"6px 0"}},[c("div",Ac,[c("b",Ec,k(x.name),1),c("span",Tc,"ctx:"+k(x.ctx),1),c("span",Oc,k(x.text.length)+" 字",1),c("button",{class:"btn btn-ghost btn-sm",style:{"margin-left":"auto"},onClick:G=>At(x,x.ctx)},k(i.value===x.ctx?"✓ 已复制":"📋 复制"),9,Ic)]),c("pre",Mc,k(x.text),1),x.pipe?(b(),_("div",Pc,[(b(!0),_(H,null,X(x.pipe,(G,U)=>(b(),_("div",{key:U,style:{display:"flex",gap:"6px","font-size":"11.5px",margin:"3px 0"}},[c("span",Nc,k(G.icon),1),c("b",Lc,k(G.t),1),c("span",Cc,k(G.live?T(G.live):G.d),1)]))),128))])):z("",!0)]))),128)),V.value.length?z("",!0):(b(),_("div",jc,"无匹配项"))]),c("div",Dc,[c("div",qc,[S[23]||(S[23]=c("span",{class:"card-title"},"🧩 模块指令层",-1)),c("span",Rc,"window 门面实时构造 · 示例参数 · "+k(it.value.length)+" 条",1)]),(b(!0),_(H,null,X(it.value,x=>(b(),_("div",{key:x.ctx,style:{border:"1px solid var(--line)","border-radius":"8px",padding:"8px 10px",margin:"6px 0"}},[c("div",Bc,[c("b",Jc,k(x.name),1),c("span",Gc,"ctx:"+k(x.ctx),1),x.compose?(b(),_("span",Hc,k(x.compose),1)):z("",!0),c("span",zc,k(x.text.length)+" 字",1),c("button",{class:"btn btn-ghost btn-sm",style:{"margin-left":"auto"},onClick:G=>At(x,x.ctx)},k(i.value===x.ctx?"✓ 已复制":"📋 复制"),9,$c)]),x.error?(b(),_("div",Fc,"求值失败："+k(x.error),1)):(b(),_("pre",Uc,k(x.text),1)),x.pipe?(b(),_("div",Kc,[(b(!0),_(H,null,X(x.pipe,(G,U)=>(b(),_("div",{key:U,style:{display:"flex",gap:"6px","font-size":"11.5px",margin:"3px 0"}},[c("span",Vc,k(G.icon),1),c("b",Qc,k(G.t),1),c("span",Xc,k(G.live?T(G.live):G.d),1)]))),128))])):z("",!0)]))),128)),it.value.length?z("",!0):(b(),_("div",Wc,"无匹配项"))])],64))]))}}),Rt=(t,e)=>{const n=t.__vccOpts||t;for(const[s,r]of e)n[s]=r;return n},Zc=Rt(Yc,[["__scopeId","data-v-b4cd41a4"]]);function tu(){const t=P.get(),e=M.dkey(),n=new Date;if((n.getMonth()+1)*100+n.getDate()>=1101&&!t.milestones.octMath&&t.alerts.lastNovPush!==e){P.update(a=>{a.alerts.lastNovPush=e}),Ot.open({title:"⚔️ 院校决策提醒",html:"<p>已到11月，「数学真题模拟≥120分」里程磊尚未勾选。</p><p><b>请立即根据数学成绩决定冲上大还是守河工大。</b>报名窗口不等人，用数据说话，不能凭感觉。</p>",actions:[{label:"去决策参谋",kind:"btn-primary",onClick:a=>{a(),window.App.go("decision")}},{label:"稍后",kind:"btn-ghost"}]});return}const r=P.usageBytes()/(5*1024*1024),o=t.meta.lastBackupReminder||"",i=o?(Date.now()-new Date(o).getTime())/M.DAY_MS:999;(r>.6||i>7)&&t.alerts.lastBakWarn!==e&&(P.update(a=>{a.alerts.lastBakWarn=e}),Q.warn("💾 已"+Math.floor(i)+"天未导出备份。数据只存在浏览器，建议立即导出（设置 → 导出JSON备份）。"))}function eu(){const t=P.get(),e=new Date,n=(e.getMonth()+1)*100+e.getDate(),s=[];return n>=1101&&!t.milestones.octMath&&s.push(`<div class="alert alert-danger">⚔️ 11月已到而数学模拟里程磊未达成：<a href="javascript:App.go('decision')">立即去决策参谋定院 →</a></div>`),P.mistakeCountWeek("sign")>3&&s.push('<div class="alert alert-warn">✍️ 本周符号错误 '+P.mistakeCountWeek("sign")+" 次 &gt; 3次：智能排程已强制插入符号专项。</div>"),s.join("")}const cs={runDailyChecks:tu,bannerHtml:eu},nu={class:"stats-row"},su={class:"stat-top"},ru={class:"stat-label"},ou={class:"stat-num"},iu={class:"stat-den"},au={class:"stat-bar"},lu={class:"stat-foot"},cu=ot({__name:"StatsRow",setup(t){const e=C(()=>P.todayTaskStats()),n=[{k:"math",ico:"📐"},{k:"ctrl",ico:"🎛"},{k:"eng",ico:"📖"},{k:"pol",ico:"🏛"}],s=C(()=>n.map(r=>{const o=Wt.SUBJECTS[r.k],[i,a]=e.value[r.k]||[0,0];return{k:r.k,ico:r.ico,short:o.short,color:o.color,d:i,t:a,done:a>0&&i===a,pct:a>0?Math.round(i/a*100):0,remain:a-i}}));return(r,o)=>(b(),_("div",nu,[(b(!0),_(H,null,X(s.value,i=>(b(),_("div",{key:i.k,class:tt(["stat-tile",{"stat-done":i.done}])},[c("div",su,[c("span",ru,k(i.short),1),c("span",{class:"stat-badge",style:Vt({background:`color-mix(in srgb, ${i.color} 14%, transparent)`,color:i.color})},k(i.ico),5)]),c("div",ou,[c("b",null,k(i.d),1),c("span",iu,"/"+k(i.t),1)]),c("div",au,[c("div",{class:"stat-bar-fill",style:Vt({width:i.pct+"%",background:i.color})},null,4)]),c("div",lu,k(i.done?"已清空 ✓":i.t===0?"今日无任务":"还差 "+i.remain+" 项"),1)],2))),128))]))}}),uu=Rt(cu,[["__scopeId","data-v-9fd1365c"]]),du={key:0,class:"dsh-head"},pu={key:1,class:"dsh-title"},fu={class:"dsh-head-extra"},hu={class:"dsh-head-actions"},gu=ot({__name:"DashCard",props:{icon:{default:""},title:{default:""},tint:{default:""},dense:{type:Boolean,default:!1}},setup(t){return(e,n)=>(b(),_("section",{class:tt(["dsh-card",{"dsh-dense":t.dense}])},[t.title||e.$slots.actions||e.$slots.extra?(b(),_("header",du,[t.icon?(b(),_("span",{key:0,class:tt(["dsh-badge",t.tint?"tint-"+t.tint:""])},k(t.icon),3)):z("",!0),t.title?(b(),_("h2",pu,k(t.title),1)):z("",!0),n[0]||(n[0]=c("span",{class:"dsh-head-spacer"},null,-1)),c("div",fu,[In(e.$slots,"extra",{},void 0)]),c("div",hu,[In(e.$slots,"actions",{},void 0)])])):z("",!0),In(e.$slots,"default",{},void 0)],2))}}),Xt=Rt(gu,[["__scopeId","data-v-06402b0e"]]),mu={class:"muted-sm"},yu=["innerHTML"],vu={class:"brief-foot"},bu={key:1,class:"brief-body"},wu=["innerHTML"],ku=["innerHTML"],_u={key:0,class:"muted-sm brief-note"},Su={key:1,class:"muted-sm brief-note"},xu=ot({__name:"BriefCard",setup(t){const e=M.dkey(),n=C(()=>P.get().dailyBrief),s=C(()=>K.configured()),r=C(()=>n.value&&n.value.date===e&&n.value.content),o=C(()=>n.value&&n.value.date===e&&n.value.failed),i=C(()=>K.configured()&&P.get().ai.briefAuto!==!1),a=C(()=>i.value&&!r.value&&!o.value),l=C(()=>a.value&&!Bs.value),u=si(),p=e.slice(5).replace("-","."),d=C(()=>r.value?Le(n.value.content):""),f=C(()=>Le(Bs.value)),w=C(()=>ri(P.get()));function v(){P.update(y=>{y.dailyBrief=null}),oi()}return(y,h)=>(b(),Ct(Xt,{icon:"📰",title:"今日简报",tint:"blue",class:"dash-brief"},{extra:ft(()=>[c("span",mu,k(W(u))+" · "+k(W(p)),1)]),default:ft(()=>[r.value?(b(),_(H,{key:0},[c("div",{class:"brief-body",innerHTML:d.value},null,8,yu),c("div",vu,[h[0]||(h[0]=c("span",{class:"muted-sm"},"🧠 结合你的记忆与数据生成",-1)),s.value?(b(),_("button",{key:0,class:"link-btn",onClick:v},"🔄 换一版")):z("",!0)])],64)):a.value?(b(),_("div",bu,[l.value?(b(),_(H,{key:0},[h[1]||(h[1]=c("div",{class:"skl-line"},null,-1)),h[2]||(h[2]=c("div",{class:"skl-line"},null,-1)),h[3]||(h[3]=c("div",{class:"skl-line skl-w60"},null,-1))],64)):(b(),_(H,{key:1},[c("span",{innerHTML:f.value},null,8,wu),h[4]||(h[4]=c("span",{class:"ai-cursor"},null,-1))],64))])):(b(),_(H,{key:2},[c("div",{class:"brief-body",innerHTML:w.value},null,8,ku),o.value?(b(),_("div",_u,[Z(" ⚠️ AI 简报生成失败（"+k(String(n.value.error||"").slice(0,40))+"） ",1),c("button",{class:"link-btn",onClick:v},"🔄 重试")])):s.value?z("",!0):(b(),_("div",Su,"配置 AI 后，这里会变成真正懂你的每日简报 →"))],64))]),_:1}))}}),Au=Rt(xu,[["__scopeId","data-v-17a6feac"]]);function Eu(t){if(!t)return{lang:"",code:""};t=String(t).trim();let e=t.match(/^```(\w*)\s*([\s\S]*?)```$/i);return e?{lang:(e[1]||"").toLowerCase(),code:e[2].trim()}:(e=t.match(/```(\w*)\s*\n([\s\S]*?)```/),e?{lang:(e[1]||"").toLowerCase(),code:e[2].trim()}:{lang:"",code:t})}function Dr(t){let e=String(t);/xmlns=/.test(e)||(e=e.replace(/<svg/i,'<svg xmlns="http://www.w3.org/2000/svg"'));let n;try{n=new DOMParser().parseFromString(e,"image/svg+xml")}catch{return null}if(!n||n.getElementsByTagName("parsererror").length)return null;const s=n.documentElement;if(!s||s.nodeName.toLowerCase()!=="svg")return null;const r=s.querySelectorAll("script, foreignObject, iframe, object, embed, link, meta");for(let i=0;i<r.length;i++)r[i].parentNode&&r[i].parentNode.removeChild(r[i]);const o=[s].concat(Array.prototype.slice.call(s.getElementsByTagName("*")));for(let i=0;i<o.length;i++){const a=o[i];for(let l=a.attributes.length-1;l>=0;l--){const u=a.attributes[l].name,p=a.attributes[l].value||"";(/^on/i.test(u)||/^(xlink:)?href$/i.test(u)&&/^\s*javascript:/i.test(p)||u.toLowerCase()==="style"&&/javascript:|expression\s*\(/i.test(p))&&a.removeAttribute(u)}}return s.getAttribute("viewBox")?(s.removeAttribute("width"),s.removeAttribute("height"),s.setAttribute("width","100%"),s.getAttribute("preserveAspectRatio")||s.setAttribute("preserveAspectRatio","xMidYMid meet")):s.getAttribute("width")||s.setAttribute("width","280"),s.setAttribute("overflow","visible"),new XMLSerializer().serializeToString(s)}function qr(t){if(t&&typeof t=="object")return"";const e=Eu(t),n=e.code;if(!n)return"";if(e.lang==="svg"||n.toLowerCase().indexOf("<svg")>=0){const s=Dr(n);if(s)return'<div class="dgm-wrap">'+s+"</div>"}return'<div class="dgm-code"><pre class="report">'+M.esc(n)+"</pre></div>"}function Tu(t){return qr(t)}const Rr={render:qr,renderSync:Tu,sanitizeSvg:Dr},Ou=["innerHTML"],Iu=ot({__name:"DiagramBlock",props:{source:{}},setup(t){const e=t,n=C(()=>Rr.render(e.source||""));return(s,r)=>(b(),_("div",{class:"diagram-block",innerHTML:n.value},null,8,Ou))}}),Mu={key:0,class:"dsh-dq-cell"},Pu={class:"dq-tile-head"},Nu={class:"dq-tile-ico"},Lu={key:0,class:"dq-dot",title:"今日题还没做"},Cu={key:1,class:"dq-tile-sub st-no"},ju={key:2,class:"dq-tile-sub st-warn"},Du={key:3,class:"dq-tile-sub st-warn"},qu=["innerHTML"],Ru={key:1,class:"dq-tile-preview dq-tile-hint"},Bu={class:"dq-week","aria-hidden":"true"},Ju={class:"dq-tools"},Gu=["value"],Hu=["disabled"],zu={class:"dq-question"},$u=["innerHTML"],Uu={class:"dq-section"},Fu=["innerHTML"],Ku={key:0,class:"dq-section"},Vu=["innerHTML"],Qu={key:2,class:"dq-eval dq-eval-ok"},Xu={key:3,class:"dq-eval dq-eval-no"},Wu={key:4,class:"dq-eval-row"},Yu={class:"muted-sm dq-foot"},Zu={class:"alert alert-warn"},td=["disabled"],ed={key:2,class:"muted-sm"},nd=ot({__name:"DailyQuizCard",setup(t){const e=M.dkey(),n=C(()=>P.get().dailyQuiz),s=C(()=>n.value&&n.value.date===e&&n.value.question),r=C(()=>n.value&&n.value.date===e&&n.value.failed),o=C(()=>K.configured()),i=C(()=>!!(s.value&&!n.value.revealed&&!n.value.selfEval)),a=C(()=>s.value?Wt.SUBJECTS[n.value.subject]||{short:"题",color:"#666"}:null),l=C(()=>n.value?.selfEval==="known"?{t:"已会 ✓",cls:"st-ok"}:n.value?.selfEval==="unknown"?{t:"记入错题",cls:"st-no"}:n.value?.revealed?{t:"待自评",cls:"st-warn"}:{t:"待作答",cls:"st-warn"}),u=et(!1),p=[{v:"auto",l:"🎲 自动(薄弱点)"},{v:"math",l:"📐 数学"},{v:"ctrl",l:"🎛 专业课"},{v:"eng",l:"📖 英语"},{v:"pol",l:"🏛 政治"}],d=et(!1),f=C(()=>Le(n.value?.question||"")),w=C(()=>Le(n.value?.solution||"")),v=C(()=>Le(n.value?.trap||"")),y=C(()=>(n.value?.generatedAt||"").slice(0,16).replace("T"," ")),h=C(()=>{const T=(P.get().dailyQuizHistory||[]).slice(-6).map((O,N)=>({k:"h"+N+(O.date||""),cls:O.selfEval==="known"?"ok":O.selfEval==="unknown"?"no":"done",today:!1})),D=n.value&&n.value.date===e?n.value.selfEval==="known"?"ok":n.value.selfEval==="unknown"?"no":n.value.revealed?"done":"open":"none";return T.push({k:"today",cls:D,today:!0}),T});function g(){u.value=!u.value}function A(){d.value||(d.value=!0,u.value=!0,ii(!0,()=>{d.value=!1},$e.value))}function L(){kt.push(Ut("settings"))}return(E,I)=>u.value?(b(),Ct(Xt,{key:1,icon:"📅",title:"每日一题",tint:"purple",class:"dsh-dq"},{actions:ft(()=>[c("button",{class:"link-btn",onClick:g},"收起 ▴")]),default:ft(()=>[c("div",Ju,[Qt(c("select",{"onUpdate:modelValue":I[0]||(I[0]=T=>qo($e)?$e.value=T:null),class:"input input-sel dq-sel",title:"指定出题科目"},[(b(),_(H,null,X(p,T=>c("option",{key:T.v,value:T.v},k(T.l),9,Gu)),64))],512),[[Ro,W($e)]]),s.value?(b(),_("button",{key:0,class:"btn btn-ghost btn-sm dq-again",disabled:d.value,onClick:A},k(d.value?"生成中…":"🔁 换题"),9,Hu)):z("",!0)]),s.value?(b(),_(H,{key:0},[c("div",zu,[c("b",null,"📝 "+k(a.value.short)+"题：",1),c("span",{innerHTML:f.value},null,8,$u)]),n.value.diagram?(b(),Ct(Iu,{key:0,source:n.value.diagram},null,8,["source"])):z("",!0),n.value.revealed||n.value.selfEval?(b(),_(H,{key:1},[c("div",Uu,[I[8]||(I[8]=c("b",null,"🔑 解答：",-1)),c("div",{class:"dq-sol",innerHTML:w.value},null,8,Fu)]),n.value.trap?(b(),_("div",Ku,[I[9]||(I[9]=c("b",null,"⚠️ 易错点：",-1)),c("div",{class:"dq-sol",innerHTML:v.value},null,8,Vu)])):z("",!0)],64)):z("",!0),n.value.selfEval==="known"?(b(),_("div",Qu,"✓ 已自评：会了。保持这个节奏。")):n.value.selfEval==="unknown"?(b(),_("div",Xu,"✗ 已自评：还不会——已记入错题本，明天简报会盯着你复习。")):n.value.revealed?(b(),_("div",Wu,[I[10]||(I[10]=c("span",{class:"muted-sm"},"看完解答，诚实自评：",-1)),c("button",{class:"btn btn-primary btn-sm",onClick:I[1]||(I[1]=T=>W(Js)(!0))},"✓ 会了"),c("button",{class:"btn btn-ghost btn-sm",onClick:I[2]||(I[2]=T=>W(Js)(!1))},"✗ 还不会")])):(b(),_(H,{key:5},[I[11]||(I[11]=c("div",{class:"dq-fold"},"🫣 解答已折叠——先拿草稿纸做一遍，再对答案。",-1)),c("button",{class:"btn btn-ghost btn-sm",onClick:I[3]||(I[3]=(...T)=>W(Gs)&&W(Gs)(...T))},"👀 查看解答")],64)),c("div",Yu,"基于你的薄弱点生成 · "+k(y.value),1)],64)):r.value?(b(),_(H,{key:1},[c("div",Zu,"⚠️ 今日一题生成失败："+k(n.value.error||"未知错误"),1),c("button",{class:"btn btn-ghost btn-sm dq-retry",disabled:d.value,onClick:A},k(d.value?"生成中…":"🔁 重试生成"),9,td)],64)):o.value?(b(),_("div",ed,"⏳ 正在依据你的薄弱点生成今日一题…")):(b(),_(H,{key:3},[I[12]||(I[12]=c("div",{class:"alert alert-warn"},"未配置 AI，无法生成每日一题。请先在「设置」中填写 API。",-1)),c("button",{class:"btn btn-ghost btn-sm",onClick:L,style:{"margin-top":"8px"}},"去设置 →")],64))]),_:1})):(b(),_("div",Mu,[c("div",{class:"dq-tile",role:"button",tabindex:"0",title:"点击查看今日一题",onClick:g,onKeydown:Yn(g,["enter"])},[c("div",Pu,[c("span",Nu,[I[4]||(I[4]=Z("📅",-1)),i.value?(b(),_("span",Lu)):z("",!0)]),I[5]||(I[5]=c("span",{class:"dq-tile-name"},"每日一题",-1)),s.value?(b(),_("span",{key:0,class:tt(["dq-tile-sub",l.value.cls])},k(a.value.short)+" · "+k(l.value.t),3)):r.value?(b(),_("span",Cu,"生成失败 · 重试")):o.value?(b(),_("span",ju,"⏳ 生成中")):(b(),_("span",Du,"配置 AI"))]),s.value?(b(),_("div",{key:0,class:"dq-tile-preview",innerHTML:f.value},null,8,qu)):(b(),_("div",Ru,k(r.value?"今日生成失败，点击展开可重试。":o.value?"正在依据你的薄弱点生成今日一题…":"配置 AI 后，每天自动送一道针对你弱点的题。"),1)),c("div",Bu,[(b(!0),_(H,null,X(h.value,T=>(b(),_("span",{key:T.k,class:tt(["dq-wdot","w-"+T.cls+(T.today?" w-today":"")])},null,2))),128)),I[6]||(I[6]=c("span",{class:"dq-week-label muted-sm"},"近 7 日",-1))]),I[7]||(I[7]=c("div",{class:"dq-tile-cta"},"查看今日一题 →",-1))],32)]))}}),sd=Rt(nd,[["__scopeId","data-v-f0f7a385"]]),rd={class:"now-count"},od={class:"now-actions"},id={class:"now-count"},ad={class:"now-title"},ld={class:"now-sub"},cd={class:"now-reason"},ud={class:"now-actions"},dd=ot({__name:"NowCard",setup(t){const e=()=>window,n=C(()=>P.todayTaskStats()),s=C(()=>P.todayAllDone()),r=C(()=>{n.value;const d=e().SchedulerModule;if(!d||!d.currentPlan)return null;const f=d.currentPlan();return f&&f.sequence&&f.sequence.find(w=>!w.done)||null}),o=C(()=>r.value?Wt.SUBJECTS[r.value.subject]:null),i=C(()=>{const d=n.value;return d.math[0]+d.ctrl[0]+d.eng[0]+d.pol[0]}),a=C(()=>{const d=n.value;return d.math[1]+d.ctrl[1]+d.eng[1]+d.pol[1]});function l(){const d=e().TasksModule;d&&r.value?d.toggleTask(r.value.id,!0):Q.show("打卡模块未就绪","warn")}function u(){kt.push(Ut("focus"))}function p(){kt.push(Ut("scheduler"))}return(d,f)=>s.value?(b(),Ct(Xt,{key:0,icon:"✅",title:"今日已清场",tint:"ok",class:"dsh-now dsh-now-done"},{extra:ft(()=>[c("span",rd,k(i.value)+"/"+k(a.value),1)]),default:ft(()=>[f[1]||(f[1]=c("div",{class:"now-title"},"✓ 全部任务完成",-1)),f[2]||(f[2]=c("div",{class:"now-sub"},"可以安心复盘、早点睡。明天继续。",-1)),c("div",od,[c("button",{class:"btn btn-ghost",onClick:f[0]||(f[0]=w=>W(kt).push(W(Ut)("review")))},"去复盘 →")])]),_:1})):r.value?(b(),Ct(Xt,{key:1,icon:"⚡",title:"现在就干这个",class:"dsh-now dsh-now-hero"},{extra:ft(()=>[c("span",id,k(i.value)+"/"+k(a.value)+" 已完成",1)]),default:ft(()=>[c("div",ad,k(r.value.text),1),c("div",ld,[o.value?(b(),_("span",{key:0,class:"now-tag",style:Vt({background:o.value.color})},k(o.value.short),5)):z("",!0),c("span",cd,k(r.value.reason),1)]),c("div",ud,[c("button",{class:"now-btn-primary",onClick:l},"✓ 完成打卡"),c("button",{class:"now-btn-ghost",onClick:u},"🔒 专注"+k(r.value.subject==="math"?45:25)+"分钟",1)])]),_:1})):(b(),Ct(Xt,{key:2,icon:"🗓️",title:"今日无待办",class:"dsh-now"},{default:ft(()=>[f[3]||(f[3]=c("div",{class:"now-title"},"还没排任务",-1)),f[4]||(f[4]=c("div",{class:"now-sub"},"去排程把今天的任务排上，仪表盘才知道你现在该干嘛。",-1)),c("div",{class:"now-actions"},[c("button",{class:"btn btn-primary",onClick:p},"去排程添加")])]),_:1}))}}),pd=Rt(dd,[["__scopeId","data-v-a92668cf"]]);function Ee(t,e){return'<svg viewBox="0 0 '+t+" "+e+'" width="100%" height="'+e+'" xmlns="http://www.w3.org/2000/svg">'}function gt(t,e){return window.U&&M.themeColor?M.themeColor(t,e):e}const Br={bar(t,e){e=e||{};const n=gt("--chart-ink","#000"),s=gt("--chart-faint","#bfbfbf"),r=gt("--chart-muted","#8c8c8c"),o=gt("--chart-sub","#595959"),i=680,a=e.height||160,l=24,u=16,p=8,d=8,f=Math.max.apply(null,t.map(g=>g.value).concat([1])),w=t.length||1,v=(i-p-d)/w,y=Math.min(44,v*.55);let h=Ee(i,a);for(let g=0;g<w;g++){const A=t[g],L=Math.max(2,A.value/f*(a-l-u)),E=p+g*v+(v-y)/2,I=a-l-L,T=A.highlight?e.hiColor||n:e.color||s;h+='<rect x="'+E+'" y="'+I+'" width="'+y+'" height="'+L+'" rx="4" fill="'+T+'"><title>'+M.esc(A.label)+"："+A.value+(e.unit||"")+"</title></rect>",h+='<text x="'+(E+y/2)+'" y="'+(a-8)+'" text-anchor="middle" font-size="11" fill="'+r+'">'+M.esc(A.label)+"</text>",A.value>0&&(h+='<text x="'+(E+y/2)+'" y="'+(I-4)+'" text-anchor="middle" font-size="11" fill="'+o+'">'+A.value+"</text>")}return h+"</svg>"},donut(t,e){e=e||{};const n=gt("--chart-ink","#000"),s=gt("--chart-faint","#bfbfbf"),r=gt("--chart-muted","#8c8c8c"),o=gt("--chart-sub","#595959"),i=gt("--chart-track","#f0f0f0"),a=680,l=e.height||190,u=110,p=l/2,d=66,f=40,w=M.sum(t.map(h=>h.value));let v=Ee(a,l);if(w===0)v+='<circle cx="'+u+'" cy="'+p+'" r="'+d+'" fill="none" stroke="'+i+'" stroke-width="'+(d-f)+'"/>',v+='<text x="'+u+'" y="'+(p+5)+'" text-anchor="middle" font-size="13" fill="'+s+'">暂无数据</text>';else{let h=-Math.PI/2;t.forEach(g=>{if(g.value<=0)return;const A=g.value/w,L=h+A*Math.PI*2,E=A>.5?1:0,I=u+d*Math.cos(h),T=p+d*Math.sin(h),D=u+d*Math.cos(L),O=p+d*Math.sin(L),N=u+f*Math.cos(L),R=p+f*Math.sin(L),B=u+f*Math.cos(h),$=p+f*Math.sin(h);v+='<path d="M'+I+" "+T+" A"+d+" "+d+" 0 "+E+" 1 "+D+" "+O+" L"+N+" "+R+" A"+f+" "+f+" 0 "+E+" 0 "+B+" "+$+' Z" fill="'+g.color+'"><title>'+M.esc(g.label)+"："+g.value+"次 ("+Math.round(A*100)+"%)</title></path>",h=L}),v+='<text x="'+u+'" y="'+(p-2)+'" text-anchor="middle" font-size="22" font-weight="500" fill="'+n+'">'+w+"</text>",v+='<text x="'+u+'" y="'+(p+16)+'" text-anchor="middle" font-size="11" fill="'+r+'">总计</text>'}let y=24;return t.forEach(h=>{const g=w?Math.round(h.value/w*100):0;v+='<rect x="230" y="'+(y-10)+'" width="10" height="10" rx="2" fill="'+h.color+'"/>',v+='<text x="246" y="'+y+'" font-size="12" fill="'+n+'">'+M.esc(h.label)+"</text>",v+='<text x="660" y="'+y+'" font-size="12" text-anchor="end" fill="'+o+'">'+h.value+"次 · "+g+"%</text>",y+=24}),v+"</svg>"},line(t,e){e=e||{};const n=gt("--chart-ink","#000"),s=gt("--chart-faint","#bfbfbf"),r=gt("--chart-muted","#8c8c8c"),o=gt("--danger","#cf1322"),i=680,a=e.height||170,l=22,u=14,p=30,d=10,f=t.map(E=>E.value),w=e.min!=null?e.min:Math.min.apply(null,f.concat([0])),v=e.max!=null?e.max:Math.max.apply(null,f.concat([10])),y=t.length;if(y===0)return Ee(i,a)+'<text x="340" y="90" text-anchor="middle" fill="'+s+'" font-size="13">暂无数据</text></svg>';const h=E=>p+(y===1?(i-p-d)/2:E*(i-p-d)/(y-1)),g=E=>a-l-(E-w)/(v-w||1)*(a-l-u);let A=Ee(i,a);e.warnBelow!=null&&(A+='<line x1="'+p+'" y1="'+g(e.warnBelow)+'" x2="'+(i-d)+'" y2="'+g(e.warnBelow)+'" stroke="'+o+'" stroke-dasharray="4 4" stroke-width="1"/>',A+='<text x="'+(i-d)+'" y="'+(g(e.warnBelow)-4)+'" text-anchor="end" font-size="10" fill="'+o+'">预警线 '+e.warnBelow+"</text>");let L="";return t.forEach((E,I)=>{L+=(I===0?"M":"L")+h(I)+" "+g(E.value)}),A+='<path d="'+L+'" fill="none" stroke="'+n+'" stroke-width="2"/>',t.forEach((E,I)=>{const T=e.warnBelow!=null&&E.value<e.warnBelow;A+='<circle cx="'+h(I)+'" cy="'+g(E.value)+'" r="4" fill="'+(T?o:n)+'"><title>'+M.esc(E.label)+"："+E.value+(e.unit||"")+"</title></circle>",y<=12&&(A+='<text x="'+h(I)+'" y="'+(a-6)+'" text-anchor="middle" font-size="10" fill="'+r+'">'+M.esc(E.label)+"</text>")}),A+"</svg>"},progressBar(t,e,n){return t=M.clamp(t,0,100),'<div class="pbar" style="height:'+(n||8)+'px"><div class="pbar-fill" style="width:0%;background:'+e+'" data-w="'+t+'"></div></div>'},radar(t,e){e=e||{};const n=gt("--chart-ink","#000"),s=gt("--chart-sub","#595959"),r=gt("--chart-grid","#e8e8e8"),o=680,i=e.height||200,a=t.length||4,l=128,u=i/2,p=Math.max(40,Math.min(92,(i-24)/2-10)),d=e.color||"#2f54eb",f=g=>-Math.PI/2+2*Math.PI*g/a,w=(g,A)=>[l+A*Math.cos(f(g)),u+A*Math.sin(f(g))];let v=Ee(o,i);for(let g=1;g<=4;g++){const A=p*g/4;let L="";for(let E=0;E<=a;E++){const I=w(E%a,A);L+=(E===0?"M":"L")+I[0]+" "+I[1]}v+='<path d="'+L+' Z" fill="none" stroke="'+r+'" stroke-width="0.5"/>'}for(let g=0;g<a;g++){const[A,L]=w(g,p);v+='<line x1="'+l+'" y1="'+u+'" x2="'+A+'" y2="'+L+'" stroke="'+r+'" stroke-width="0.5"/>';const E=l+(p+22)*Math.cos(f(g)),I=u+(p+22)*Math.sin(f(g));v+='<text x="'+E+'" y="'+(I+4)+'" text-anchor="middle" font-size="12" fill="'+s+'">'+M.esc(t[g].label)+"</text>";const[T,D]=w(g,p*(M.clamp(t[g].value,0,100)/100));v+='<text x="'+T+'" y="'+(D-7)+'" text-anchor="middle" font-size="11" font-weight="500" fill="'+n+'">'+Math.round(t[g].value)+"</text>"}let y="";for(let g=0;g<=a;g++){const A=w(g%a,p*(M.clamp(t[g%a].value,0,100)/100));y+=(g===0?"M":"L")+A[0]+" "+A[1]}v+='<path d="'+y+' Z" fill="'+(e.fill||"rgba(47,84,235,0.16)")+'" stroke="'+d+'" stroke-width="1.5"/>';for(let g=0;g<a;g++){const A=w(g,p*(M.clamp(t[g].value,0,100)/100));v+='<circle cx="'+A[0]+'" cy="'+A[1]+'" r="3" fill="'+d+'"/>'}let h=24;return t.forEach(function(g,A){const L=["#185FA5","#0F6E56","#993C1D","#854F0B","#534AB7","#A32D2D","#5F5E5A","#639922"][A%8];v+='<circle cx="'+(o-108)+'" cy="'+(h-3)+'" r="4" fill="'+L+'"/>',v+='<text x="'+(o-96)+'" y="'+h+'" font-size="12" fill="'+n+'">'+M.esc(g.label)+"</text>",v+='<text x="'+(o-14)+'" y="'+h+'" text-anchor="end" font-size="12" font-weight="500" fill="'+n+'">'+Math.round(g.value)+"</text>",h+=20}),v+"</svg>"}},fd={class:"hours-line"},hd={class:"dsh-big"},gd=["innerHTML"],md={class:"muted-sm"},yd=ot({__name:"HoursCard",setup(t){const e=C(()=>P.weekHours()),n=C(()=>(new Date().getDay()+6)%7),s=C(()=>e.value.map((d,f)=>({label:["一","二","三","四","五","六","日"][f],value:d,highlight:f===n.value}))),r=C(()=>M.round1(M.sum(e.value))),o=C(()=>P.get().settings.weeklyTargetHours||50),i=C(()=>o.value?Math.round(r.value/o.value*100):0),{theme:a}=vn(),l=C(()=>(a.value,Br.bar(s.value,{height:110,unit:"h",hiColor:M.themeColor("--chart-ink","#000")}))),u=C(()=>P.todayHours());function p(){Ot.open({title:"记录学习时长",html:'<div class="seg-row" id="hr-segs">'+[.5,1,1.5,2,3].map(d=>'<button class="seg" data-h="'+d+'">+'+d+"h</button>").join("")+'</div><div class="muted-sm">点击即累加到今天（当前 '+P.todayHours()+"h）</div>",actions:[{label:"完成",kind:"btn-primary"}]}),document.querySelectorAll("#hr-segs .seg").forEach(d=>{d.onclick=()=>{P.addHours(+d.getAttribute("data-h")),Q.success("+"+d.getAttribute("data-h")+"h，今日共 "+P.todayHours()+"h")}})}return(d,f)=>(b(),Ct(Xt,{icon:"📈",title:"本周节奏",tint:"ok"},{actions:ft(()=>[c("button",{class:"link-btn",onClick:p},"+ 记录时长")]),default:ft(()=>[c("div",fd,[c("span",hd,[Z(k(r.value),1),f[0]||(f[0]=c("span",{class:"dsh-unit"},"小时",-1))]),c("span",{class:tt(["dsh-pill",i.value>=70?"dsh-pill-up":"dsh-pill-warn"])},k(i.value>=70?"↑":"↓")+" 目标 "+k(i.value)+"% ",3)]),c("div",{class:"wk-chart",innerHTML:l.value},null,8,gd),c("div",md,"今日 "+k(u.value)+"h · 周目标 "+k(o.value)+"h",1)]),_:1}))}}),vd=Rt(yd,[["__scopeId","data-v-2168edf0"]]),bd={class:"subj4"},wd={class:"chip-name"},kd={class:"chip-num"},_d={key:0,class:"rvd-wrap"},Sd=["onClick"],xd={class:"rvd-stage"},Ad={class:"rvd-text"},Ed=["onClick"],Td=["onClick"],Od={key:1},Id={class:"task-check"},Md=["checked","onChange"],Pd={class:"seq-text"},Nd={key:2,class:"empty"},Ld=ot({__name:"TasksCard",setup(t){const e=()=>window,n=C(()=>P.todayTaskStats()),s=C(()=>{const y=e().SchedulerModule;return y&&y.currentPlan&&y.currentPlan()||{sequence:[]}}),r=C(()=>s.value.sequence.slice(0,5)),o=C(()=>ir(P.get()).slice(0,5)),i=["math","ctrl","eng","pol"],a=C(()=>i.map(y=>{const h=Wt.SUBJECTS[y],g=n.value[y][0],A=n.value[y][1];return{k:y,short:h.short,d:g,t:A,done:A>0&&g===A,color:h.color}}));function l(y){const h=P.get().tasks.find(g=>g.id===y);return h?!!h.done:!1}function u(y,h){const g=e().TasksModule;g&&g.toggleTask(y,h)}function p(y){return(Wt.SUBJECTS[y]||{color:"#666"}).color}function d(y){return y.kind==="photo"?"📸":y.kind==="pol"?"📕":y.kind==="vocab"?"📚":y.kind==="reading"?"📖":y.kind==="srs"?"⚡":"✍️"}function f(y){return y.kind==="vocab"||y.kind==="reading"||y.kind==="srs"}function w(y){if(y.kind==="pol"){const g=e().PolReciteModule;g&&g.grade(y.id,!0),e().AiMemory&&e().AiMemory.recordEvent("完成政治大题复习",String(y.id||"").slice(0,8)),Q.success("✓ 政治大题复习完成，记忆又牢了一层");return}const h=y.kind==="photo"?"mistakePhotos":"mistakes";P.update(g=>{const A=(g[h]||[]).find(L=>L.id===y.id);A&&A.reviewPlan&&(A.reviewPlan.done||(A.reviewPlan.done={}),A.reviewPlan.done["d"+y.stage]=M.dkey())}),e().AiMemory&&e().AiMemory.recordEvent("完成到期复习","D"+y.stage+"阶段"+(y.kind==="photo"?"拍题":"错题")+"重做"),Q.success("✓ 复习完成，记忆又牢了一层")}function v(y){if(y.kind==="pol"){const h=e().PolReciteModule;h&&h.openReview(y.id);return}if(y.kind==="vocab"){kt.push(Ut("wordbook"));return}if(y.kind==="reading"){kt.push(Ut("reading"));return}if(y.kind==="srs"){kt.push(Ut("mistakes")),setTimeout(()=>{try{const h=e().MistakesModule;h&&h.srsDueList&&h.srsDueList().length&&h.openDrill()}catch{}},150);return}}return(y,h)=>(b(),Ct(Xt,{icon:"☑️",title:"今日任务",tint:"ok"},{actions:ft(()=>[c("button",{class:"link-btn",onClick:h[0]||(h[0]=g=>W(kt).push(W(Ut)("scheduler")))},"完整排程 →")]),default:ft(()=>[c("div",bd,[(b(!0),_(H,null,X(a.value,g=>(b(),_("div",{key:g.k,class:tt(["chip mini",{"chip-done":g.done}]),style:Vt({"--sc":g.color})},[c("span",wd,k(g.short),1),c("span",kd,k(g.d)+"/"+k(g.t),1)],6))),128))]),o.value.length?(b(),_("div",_d,[h[1]||(h[1]=c("div",{class:"muted-sm rvd-cap"},"📅 今日到期复习（重做原题，勿看解析）",-1)),(b(!0),_(H,null,X(o.value,g=>(b(),_("div",{key:g.kind+g.id,class:tt(["rvd-item",{"rvd-click":g.kind==="pol"||g.kind==="vocab"||g.kind==="reading"}]),onClick:A=>v(g)},[c("span",xd,k(f(g)?"SRS":"D"+g.stage),1),c("span",Ad,k(d(g))+" "+k(g.text),1),f(g)?(b(),_("button",{key:0,class:"btn btn-primary btn-sm",onClick:en(A=>v(g),["stop"])},"去复习 →",8,Ed)):(b(),_("button",{key:1,class:"btn btn-ghost btn-sm",onClick:en(A=>w(g),["stop"])},"✓ 重做完成",8,Td))],10,Sd))),128))])):z("",!0),r.value.length?(b(),_("div",Od,[(b(!0),_(H,null,X(r.value,g=>(b(),_("label",{key:g.id,class:tt(["seq-row",{"seq-is-done":l(g.id)}])},[c("span",Id,[c("input",{type:"checkbox",checked:l(g.id),onChange:A=>u(g.id,A.target.checked)},null,40,Md),h[2]||(h[2]=c("span",{class:"box"},null,-1))]),c("span",Pd,k(g.text),1),c("span",{class:"seq-badge",style:Vt({color:p(g.subject)})},k(g.weight),5)],2))),128))])):(b(),_("div",Nd,"暂无任务"))]),_:1}))}}),Cd=Rt(Ld,[["__scopeId","data-v-3233740a"]]),jd={class:"tiles"},Dd=["onClick"],qd=["innerHTML"],Rd={key:0,class:"tile-dot"},Bd={class:"tile-name"},Jd=ot({__name:"TilesCard",setup(t){const e=()=>window,n=C(()=>{const l=P.todayTaskStats();return l.math[1]+l.ctrl[1]+l.eng[1]+l.pol[1]-l.math[0]-l.ctrl[0]-l.eng[0]-l.pol[0]}),s=C(()=>ir(P.get()).length),r=C(()=>{const l=e().WordbookModule;try{return l&&l.dueCount?l.dueCount():0}catch{return 0}}),o=[{id:"scheduler",tint:"warn",badge:()=>n.value},{id:"quiz",tint:"blue"},{id:"mistakes",tint:"danger",badge:()=>s.value},{id:"wordbook",tint:"ok",badge:()=>r.value},{id:"polrecite",tint:"danger"},{id:"sprint",tint:"purple"},{id:"share",tint:"blue"},{id:"focus",tint:"ok"},{id:"essay",tint:"warn"}],i=C(()=>o.map(l=>{const u=Ge[l.id]?l.id:"tools";return{go:l.id,svg:Ge[u]||"",name:ea(l.id),n:l.badge?Math.max(0,l.badge()):0,tint:l.tint}}));function a(l){kt.push(Ut(l))}return(l,u)=>(b(),Ct(Xt,{icon:"🚀",title:"快捷入口",tint:"blue"},{extra:ft(()=>[...u[0]||(u[0]=[c("span",{class:"muted-sm"},"红点 = 有待办",-1)])]),default:ft(()=>[c("div",jd,[(b(!0),_(H,null,X(i.value,p=>(b(),_("button",{key:p.go,class:"tile",onClick:d=>a(p.go)},[c("span",{class:tt(["tile-ico","tint-"+p.tint])},[c("span",{innerHTML:p.svg},null,8,qd),p.n>0?(b(),_("span",Rd)):z("",!0)],2),c("span",Bd,[Z(k(p.name),1),p.n>0?(b(),_(H,{key:0},[Z(" · "+k(p.n),1)],64)):z("",!0)])],8,Dd))),128))])]),_:1}))}}),Gd=Rt(Jd,[["__scopeId","data-v-8644a98a"]]),Hd={key:0,class:"streak"},zd={class:"muted-sm"},$d={class:"cal"},Ud={class:"cal-mrow"},Fd={class:"cal-wd"},Kd={key:0,class:"cal-cell cal-empty"},Vd=["title"],Qd={class:"cal-foot"},Xd={class:"muted-sm"},Te=12,Wd=ot({__name:"CalendarCard",setup(t){const e=["一","二","三","四","五","六","日"],n=C(()=>{const o=P.get(),i=new Date;i.setHours(23,59,59,999);let a=M.weekMonday(new Date);a=new Date(a.getTime()-(Te-1)*7*M.DAY_MS);const l=[];for(let u=0;u<7;u++){const p=[];for(let d=0;d<Te;d++){const f=new Date(a.getTime()+(d*7+u)*M.DAY_MS);if(f>i){p.push(null);continue}const w=M.dkey(f),v=o.studyHours[w]||0,y=(o.completions[w]||[]).length,h=v+y*.5,g=h<=0?0:h<2?1:h<4?2:h<6?3:4,A=f.getFullYear()===i.getFullYear()&&f.getMonth()===i.getMonth()&&f.getDate()===i.getDate();p.push({k:w,lv:g,isToday:A,h:v,doneN:y})}l.push(p)}return l}),s=C(()=>{let o=M.weekMonday(new Date);o=new Date(o.getTime()-(Te-1)*7*M.DAY_MS);const i=[];let a=-1;for(let l=0;l<Te;l++){const u=new Date(o.getTime()+l*7*M.DAY_MS),p=l===0||u.getMonth()!==a?u.getMonth()+1+"月":"";p&&(a=u.getMonth()),i.push(p)}return i}),r=C(()=>{const o=P.get();let i=M.weekMonday(new Date);i=new Date(i.getTime()-(Te-1)*7*M.DAY_MS);const a=new Date;a.setHours(23,59,59,999);let l=0,u=0,p=0,d=0;for(let f=0;;f++){const w=new Date(i.getTime()+f*M.DAY_MS);if(w>a)break;const v=M.dkey(w),y=o.studyHours[v]||0;y+(o.completions[v]||[]).length*.5>0?(u++,l+=y,d++,d>p&&(p=d)):d=0}return{totalH:M.round1(l),activeDays:u,best:p,streak:P.studyStreak()}});return(o,i)=>(b(),Ct(Xt,{icon:"🗓️",title:"学习日历",tint:"warn"},{extra:ft(()=>[r.value.streak>=2?(b(),_("span",Hd,"🔥 连续 "+k(r.value.streak)+" 天",1)):z("",!0),c("span",zd,[i[0]||(i[0]=Z("近12周 ",-1)),c("b",null,k(r.value.activeDays),1),i[1]||(i[1]=Z(" 天活跃",-1))])]),default:ft(()=>[c("div",$d,[c("div",Ud,[i[2]||(i[2]=c("span",{class:"cal-wd"},null,-1)),(b(!0),_(H,null,X(s.value,(a,l)=>(b(),_("span",{key:"m"+l,class:"cal-mcell"},k(a),1))),128))]),(b(!0),_(H,null,X(n.value,(a,l)=>(b(),_("div",{key:"r"+l,class:"cal-row"},[c("span",Fd,k(e[l]),1),(b(!0),_(H,null,X(a,(u,p)=>(b(),_(H,{key:"c"+l+"-"+p},[u?(b(),_("span",{key:1,class:tt(["cal-cell",["cal-lv"+u.lv,{"cal-today":u.isToday}]]),title:u.k+" · "+u.h+"h · 完成"+u.doneN+"项"},null,10,Vd)):(b(),_("span",Kd))],64))),128))]))),128))]),c("div",Qd,[i[4]||(i[4]=c("div",{class:"cal-legend"},[c("span",{class:"muted-sm"},"少"),c("span",{class:"cal-cell cal-lv0"}),c("span",{class:"cal-cell cal-lv1"}),c("span",{class:"cal-cell cal-lv2"}),c("span",{class:"cal-cell cal-lv3"}),c("span",{class:"cal-cell cal-lv4"}),c("span",{class:"muted-sm"},"多")],-1)),c("span",Xd,[i[3]||(i[3]=Z("累计 ",-1)),c("b",null,k(r.value.totalH)+"h",1)])])]),_:1}))}}),Yd=Rt(Wd,[["__scopeId","data-v-d14087cc"]]),Zd={class:"dsh-root"},tp=["innerHTML"],ep={class:"dsh-bento"},np=ot({__name:"DashboardView",setup(t){const e=C(()=>(P.get().milestones,P.get().alerts,cs.bannerHtml()));return he(()=>{ai(),li()}),(n,s)=>(b(),_("div",Zd,[e.value?(b(),_("div",{key:0,class:"dsh-banner",innerHTML:e.value},null,8,tp)):z("",!0),ct(uu),c("div",ep,[ct(Au,{class:"dsh-span7"}),ct(sd,{class:"dsh-span5"}),ct(pd,{class:"dsh-span7"}),ct(vd,{class:"dsh-span5"}),ct(Cd,{class:"dsh-span7"}),ct(Gd,{class:"dsh-span5"}),ct(Yd,{class:"dsh-span12"})])]))}}),sp=Rt(np,[["__scopeId","data-v-f21c490f"]]),rp=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",name:"dashboard",component:sp},...we.filter(t=>t.id!=="dashboard").map(t=>({path:"/"+t.id,name:t.id,component:Qs})),{path:"/tool/aitools",name:"aitools",component:Za},{path:"/tool/prompt-studio",name:"prompt-studio",component:Zc},{path:"/tool/:id",name:"tool",component:Qs},{path:"/:pathMatch(.*)*",redirect:"/dashboard"}],kt=Bo({history:Jo(),routes:rp});kt.beforeEach(()=>{const t=window.FocusModule;return t&&t.active?(Q.show("深度专注进行中，请先点「中断专注」结束再切换","warn",3500),!1):!0});function op(){let t="";try{const s=q.tools();s&&s.length&&(t='<div class="muted-sm" style="margin:10px 0 4px;font-size:12px">🧩 插件工具</div><div class="tools-grid">'+s.map(r=>'<button class="tool-cell" data-tab="'+r.id+'"><span class="tool-icon">'+(r.icon||"🧩")+"</span><span>"+M.esc(r.title)+"</span></button>").join("")+"</div>")}catch{}const e=bn.map(s=>'<button class="tool-cell" data-tab="'+s.id+'"><span class="tool-icon">'+(Ge[s.icon]||"🧩")+"</span><span>"+s.label+"</span></button>").join(""),n=Ot.open({title:"🧰 工具箱",html:'<div class="tools-grid">'+e+"</div>"+t,actions:[{label:"关闭"}]});document.querySelectorAll(".tool-cell").forEach(s=>{s.onclick=()=>{const r=s.getAttribute("data-tab");n(),r&&kt.push("/tool/"+r)}})}const ip={class:"bottomnav",id:"bottomnav","data-testid":"bottomnav"},ap=["data-tab","data-testid","onClick"],lp={class:"bn-icon"},cp={class:"bn-label"},up=["data-tab","onClick"],dp={class:"bn-icon"},pp=["innerHTML"],fp={class:"bn-icon"},hp={class:"bn-group bn-group-tools"},gp=["data-tab","data-tool-id","data-testid","onPointerdown","onClick"],mp={class:"bn-icon"},yp={class:"bn-label"},vp=ot({__name:"BottomNav",setup(t){const e=Wn(),n=Xn(),{toggle:s}=jr(),r=C(()=>String(e.params.id||e.name||"")),o=et([]),i=et([]);function a(){try{o.value=q.maintabs()||[]}catch{o.value=[]}try{i.value=q.tools()||[]}catch{i.value=[]}}he(a);const l=C(()=>!we.some(T=>T.id===r.value)&&!!r.value);function u(T){n.push("/"+T)}function p(T){y||n.push("/tool/"+T)}function d(T){return M.esc(T)}const f=et(Array.isArray(P.get().toolOrder)?P.get().toolOrder.slice():[]);function w(T,D){if(!D.length)return T;const O=N=>{const R=D.indexOf(N);return R<0?D.length+T.findIndex(B=>B.id===N):R};return T.slice().sort((N,R)=>O(N.id)-O(R.id))}const v=C(()=>{const T=bn.map(D=>({id:D.id,label:D.label,icon:D.icon,plugin:!1})).concat(i.value.map(D=>({id:D.id,label:D.title||D.id,icon:D.icon||"🧩",plugin:!0})));return w(T,f.value)});let y=!1;const h=et("");let g=0;function A(T,D){y=!1;const O=T.currentTarget;g=window.setTimeout(()=>{h.value=D,O.classList.add("bn-dragging");try{O.setPointerCapture(T.pointerId)}catch{}if(navigator.vibrate)try{navigator.vibrate(12)}catch{}},450)}function L(T){if(g&&!h.value&&(clearTimeout(g),g=0),!h.value)return;T.preventDefault();const N=document.elementFromPoint(T.clientX,T.clientY)?.closest("[data-tool-id]")?.dataset.toolId;if(N&&N!==h.value){const R=v.value.map(V=>V.id),B=R.indexOf(h.value),$=R.indexOf(N);B>=0&&$>=0&&(R.splice($,0,R.splice(B,1)[0]),f.value=R,y=!0)}}function E(T){g&&(clearTimeout(g),g=0),T.currentTarget?.classList.remove("bn-dragging"),h.value&&(P.update(O=>{O.toolOrder=f.value}),h.value="",setTimeout(()=>{y=!1},120))}function I(){f.value=[],P.update(T=>{T.toolOrder=[]})}return(T,D)=>(b(),_("nav",ip,[D[7]||(D[7]=c("div",{class:"bn-brand"},[c("div",{class:"bn-brand-name"},[c("span",{class:"bn-brand-ico"},"🎯"),Z("26考研作战系统")]),c("div",{class:"bn-brand-sub"},"最适合你的工作台")],-1)),c("button",{class:"bn-layout-toggle","data-testid":"layout-toggle",title:"切回手机单列布局",onClick:D[0]||(D[0]=O=>W(s)())}," 📱 切回手机布局 "),(b(!0),_(H,null,X(W(we),O=>(b(),_("button",{key:O.id,class:tt(["bn-btn",{"bn-on":r.value===O.id}]),"data-tab":O.id,"data-testid":"nav-"+O.id,onClick:N=>u(O.id)},[c("span",lp,[ct(Xe,{name:O.icon},null,8,["name"])]),c("span",cp,k(O.label),1)],10,ap))),128)),(b(!0),_(H,null,X(o.value,O=>(b(),_("button",{key:"plugin-"+O.id,class:tt(["bn-btn",{"bn-on":r.value===O.id}]),"data-tab":O.id,onClick:N=>p(O.id)},[c("span",dp,k(O.icon||"🧩"),1),c("span",{class:"bn-label",innerHTML:d(O.name)},null,8,pp)],10,up))),128)),c("button",{class:tt(["bn-btn",{"bn-on":l.value}]),"data-tab":"__tools","data-testid":"nav-tools",onClick:D[1]||(D[1]=O=>W(op)())},[c("span",fp,[ct(Xe,{name:"tools"})]),D[4]||(D[4]=c("span",{class:"bn-label"},"工具",-1))],2),c("div",hp,[D[5]||(D[5]=c("span",null,"工具",-1)),f.value.length?(b(),_("button",{key:0,class:"bn-reset-order","data-testid":"nav-reset-order",title:"恢复默认顺序",onClick:I},"↺")):z("",!0)]),c("div",{class:"bn-scroll",onPointermove:L,onPointerup:E,onPointercancel:E},[(b(!0),_(H,null,X(v.value,O=>(b(),_("button",{key:"stool-"+O.id,class:tt(["bn-btn bn-tool-item",{"bn-on":r.value===O.id,"bn-dragging":h.value===O.id}]),"data-tab":O.id,"data-tool-id":O.id,"data-testid":"nav-tool-"+O.id,onPointerdown:N=>A(N,O.id),onClick:N=>p(O.id)},[c("span",mp,[O.plugin?(b(),_(H,{key:1},[Z(k(O.icon),1)],64)):(b(),Ct(Xe,{key:0,name:O.icon||""},null,8,["name"]))]),c("span",yp,k(O.label),1)],42,gp))),128))],32),c("div",{class:"bn-user bn-user-clickable",role:"button",tabindex:"0",title:"前往设置","data-testid":"nav-go-settings",onClick:D[2]||(D[2]=O=>p("settings")),onKeydown:D[3]||(D[3]=Yn(O=>p("settings"),["enter"]))},[...D[6]||(D[6]=[c("span",{class:"bn-user-avatar"},"岸",-1),c("span",null,[c("b",null,"上岸预定人"),Z("点击前往设置")],-1),c("span",{class:"bn-user-arrow","aria-hidden":"true"},"›",-1)])],32)]))}}),bp={class:"cp-pal",role:"dialog","aria-label":"命令面板"},wp={class:"cp-pal-list"},kp={class:"cp-pal-group"},_p=["id","onClick","onMouseenter"],Sp={class:"cp-pal-ico"},xp={class:"cp-pal-title"},Ap={key:0,class:"cp-pal-sub"},Ep={key:0,class:"cp-pal-empty"},Tp=ot({__name:"CommandPalette",setup(t){const e=Xn(),n=vn(),s=et(!1),r=et(""),o=et(0),i=et(null);function a(y){s.value=!1,e.push(y)}const l=C(()=>{const y=r.value.trim().toLowerCase(),h=O=>!y||String(O||"").toLowerCase().includes(y),g=P.get(),A=O=>O+" 条",L=[...we.filter(O=>h(O.label)||h(O.id)).map(O=>({icon:"🧭",title:O.label,sub:"页面",run:()=>a("/"+O.id)})),...bn.filter(O=>h(O.label)||h(O.id)).map(O=>({icon:"🧰",title:O.label,sub:"工具",run:()=>a("/tool/"+O.id)}))];try{const O=Array.isArray(q.maintabs())?q.maintabs():[],N=Array.isArray(q.tools())?q.tools():[];L.push(...O.filter(R=>h(R.name)).map(R=>({icon:R.icon||"🧩",title:R.name,sub:"插件",run:()=>a("/"+R.id)}))),L.push(...N.filter(R=>h(R.title)).map(R=>({icon:R.icon||"🧩",title:R.title,sub:"插件工具",run:()=>a("/tool/"+R.id)})))}catch{}const E=[],I=O=>()=>{s.value=!1,e.push("/tool/photomistake").then(()=>setTimeout(()=>{try{window.PhotoMistakeModule&&window.PhotoMistakeModule.open(O)}catch{}},80))};(h("错题")||h("mistake"))&&E.push({icon:"📕",title:"错题本",sub:A((g.mistakes||[]).length)+" · 跳转后可搜",run:()=>a("/tool/mistakes")}),(h("单词")||h("vocab"))&&E.push({icon:"🔤",title:"单词",sub:A((g.vocab||[]).length),run:()=>a("/tool/wordbook")}),(h("考点")||h("热力"))&&E.push({icon:"🔥",title:"考点热力",sub:"跳转",run:()=>a("/tool/heatmap")}),(h("讲义")||h("资料库")||h("资料"))&&E.push({icon:"📚",title:"资料库",sub:A((g.studyBooks||[]).length)+" 本",run:()=>a("/tool/sprint")}),(h("任务")||h("排程"))&&E.push({icon:"🗓",title:"今日排程",sub:A((g.tasks||[]).length)+" 项",run:()=>a("/scheduler")}),(h("复习计划")||h("复习")||h("到期"))&&E.push({icon:"📅",title:"复习计划（拍题）",sub:"艾宾浩斯 · 到期直接开始复习",run:I("review")});const T=(()=>{try{const O=window.MistakesModule;return O&&O.srsDueList?O.srsDueList().length:0}catch{return 0}})();return T&&(h("到期")||h("fsrs")||h("复习"))&&E.push({icon:"⚡",title:`到期错题复习（${T} 题）`,sub:"错题本 FSRS · 直接开回忆卡",run:()=>{s.value=!1,e.push("/tool/mistakes").then(()=>setTimeout(()=>{try{const O=window.MistakesModule;O&&O.srsDueList&&O.srsDueList().length&&O.openDrill()}catch{}},150))}}),(h("薄弱")||h("画像"))&&E.push({icon:"🧠",title:"薄弱画像",sub:"打包错题 → 生成弱点补卷",run:I("weak")}),h("记忆测试")&&E.push({icon:"🎯",title:"记忆测试",sub:"AI 出选判题查遗忘",run:()=>{s.value=!1,e.push("/tool/photomistake").then(()=>setTimeout(()=>{try{window.PhotoMistakeModule&&window.PhotoMistakeModule.openMemoryQuiz()}catch{}},80))}}),(Array.isArray(g.studyBooks)?g.studyBooks:[]).filter(O=>y&&h(O.title)).slice(0,5).forEach(O=>E.push({icon:"📖",title:O.title,sub:"讲义 · 直达阅读",run:()=>{s.value=!1,e.push("/tool/sprint").then(()=>setTimeout(()=>{try{window.SprintModule&&window.SprintModule.openBook(O.id)}catch{}},80))}})),[{id:"nav",icon:"🧭",label:"导航",items:L},{id:"content",icon:"🔎",label:"内容与资料",items:E},{id:"action",icon:"⚡",label:"快捷操作",items:[{icon:"🌗",title:"切换主题（跟随系统/墨白/晨岚/星阑 循环）",sub:"快捷",run:()=>{n.cycle(),s.value=!1}},{icon:"🔒",title:"开始深度专注",sub:"快捷",run:()=>a("/focus")}]}].filter(O=>O.items.length)}),u=C(()=>l.value.flatMap(y=>y.items));De(r,()=>{o.value=0}),De(u,()=>{o.value>=u.value.length&&(o.value=0)});function p(y){const h=u.value.length;h&&(o.value=(o.value+y+h)%h,tn(()=>{const g=document.getElementById("cp-pal-item-"+o.value);g&&g.scrollIntoView({block:"nearest"})}))}function d(){const y=u.value[o.value];y&&y.run()}function f(y){s.value=y??!s.value,s.value&&(r.value="",o.value=0,tn(()=>i.value&&i.value.focus()))}function w(y){if((y.metaKey||y.ctrlKey)&&(y.key==="k"||y.key==="K")){y.preventDefault(),f();return}s.value&&(y.key==="Escape"?s.value=!1:y.key==="ArrowDown"?(y.preventDefault(),p(1)):y.key==="ArrowUp"?(y.preventDefault(),p(-1)):y.key==="Enter"&&(y.preventDefault(),d()))}function v(){window.CommandPalette={open:()=>f(!0),close:()=>f(!1)}}return he(()=>{document.addEventListener("keydown",w),v()}),or(()=>{document.removeEventListener("keydown",w)}),(y,h)=>(b(),Ct(Go,{to:"body"},[s.value?(b(),_("div",{key:0,class:"cp-pal-mask",onClick:h[1]||(h[1]=en(g=>s.value=!1,["self"]))},[c("div",bp,[Qt(c("input",{ref_key:"inputEl",ref:i,"onUpdate:modelValue":h[0]||(h[0]=g=>r.value=g),class:"cp-pal-input",placeholder:"搜索页面 / 工具 / 讲义 / 操作…（↑↓ 选择，Enter 打开，Esc 关闭）",autocomplete:"off"},null,512),[[ye,r.value]]),c("div",wp,[(b(!0),_(H,null,X(l.value,(g,A)=>(b(),_(H,{key:g.id},[c("div",kp,k(g.icon)+" "+k(g.label),1),(b(!0),_(H,null,X(g.items,(L,E)=>(b(),_("div",{key:g.id+E,id:"cp-pal-item-"+(l.value.slice(0,A).reduce((I,T)=>I+T.items.length,0)+E),class:tt(["cp-pal-item",{on:l.value.slice(0,A).reduce((I,T)=>I+T.items.length,0)+E===o.value}]),onClick:I=>L.run(),onMouseenter:I=>o.value=l.value.slice(0,A).reduce((T,D)=>T+D.items.length,0)+E},[c("span",Sp,k(L.icon),1),c("span",xp,k(L.title),1),L.sub?(b(),_("span",Ap,k(L.sub),1)):z("",!0)],42,_p))),128))],64))),128)),u.value.length?z("",!0):(b(),_("div",Ep,"没有匹配项"))])])])):z("",!0)]))}}),Op=Rt(Tp,[["__scopeId","data-v-1f592172"]]),Ip={class:"app"},Mp=["data-cols"],Pp={class:"view",id:"vue-view","data-testid":"vue-view"},zn=ot({__name:"App",setup(t){const e=Wn(),n=new Set(["aitools","dashboard","prompt-studio"]),s=C(()=>n.has(String(e.name||""))),r=C(()=>String(e.params.id||e.name||"dashboard")),o=new Set(["scheduler"]),i=C(()=>o.has(r.value)?"2":void 0);let a=null;function l(){const u=document.getElementById("view"),p=document.getElementById("vue-view"),d=s.value?p:u;d&&(d.classList.remove("view-enter"),d.offsetWidth,d.classList.add("view-enter"),a&&clearTimeout(a),a=setTimeout(()=>d.classList.remove("view-enter"),620))}return De(()=>e.fullPath,()=>l()),he(()=>{l()}),(u,p)=>{const d=Ho("RouterView");return b(),_(H,null,[c("div",Ip,[ct(Zi),Qt(c("main",{class:"view",id:"view","data-cols":i.value},null,8,Mp),[[Ds,!s.value]]),Qt(c("main",Pp,[ct(d)],512),[[Ds,s.value]]),ct(vp),ct(Op)]),p[0]||(p[0]=c("div",{id:"toast-wrap"},null,-1))],64)}}}),at={},Oe={},Np={run(t,e,n,s){if(s=s||{},Oe[t])return Oe[t];const r={id:t,label:e||t,status:"running",result:void 0,error:"",extra:s.extra||null,startedAt:new Date().toISOString(),finishedAt:""};at[t]=r;const o=Promise.resolve().then(function(){return n()}).then(function(i){if(r.status="done",r.result=i,r.finishedAt=new Date().toISOString(),delete Oe[t],s.onDone)try{s.onDone(i,r)}catch(a){console.warn("[BgTask] onDone 回调异常",a)}return window.U&&M.emit&&M.emit("bgTask:done",{id:t,label:r.label,result:i}),i},function(i){if(r.status="error",r.error=i&&i.message?i.message:String(i),r.finishedAt=new Date().toISOString(),delete Oe[t],s.onError)try{s.onError(i,r)}catch(a){console.warn("[BgTask] onError 回调异常",a)}throw window.U&&M.emit&&M.emit("bgTask:error",{id:t,label:r.label,error:r.error}),i});return Oe[t]=o,o.catch(function(){}),o},isRunning(t){return!!(at[t]&&at[t].status==="running")},get(t){return at[t]||null},getResult(t){return at[t]&&at[t].status==="done"?at[t].result:void 0},getError(t){return at[t]&&at[t].status==="error"?at[t].error:""},clear(t){at[t]&&at[t].status!=="running"&&delete at[t]},clearAll(){Object.keys(at).forEach(function(t){at[t].status!=="running"&&delete at[t]})},list(t){return Object.keys(at).filter(function(e){return!t||at[e].status==="running"}).map(function(e){return at[e]})}},Lp=`# kaoyan2026 云端出卷执行器 workflow（2026-08-24；v11 增 PDF 导入资源 Gist）
...
⑥ 不确定就给保守、通用、稳妥的做法，不要编造偏门技巧。用简体中文。`}function Nf(){var t=po();return!!(t&&t.configured&&t.configured())}function Os(t,e){return e=e||{},new Promise(function(n){if(!window.InspectorModule){n(null);return}var s=e.force?null:ze(t);if(s&&s.pb){n({pb:s.pb,created:!1,bound:s.bound});return}if(!Nf()){e.silent||window.Toast&&Q.warn("未配置 AI，无法自动建立方法卡。可到「解题方法」页手动新建。"),n(null);return}var r=po();function o(i,a){var l=r.chatJSON?r.chatJSON(Kn(t),i,null,{ctx:"insp.gen",noThink:!0}):r.chatStream(Kn(t),i,null,null,{ctx:"insp.gen",noThink:!0}).then(function(u){return r.extractRobustJSON(u||"")});l.then(function(u){var p=qt().normalizePlaybook(u,t.subject||"math");if(!p){if(!a){o(i+`
【重试注意】上次 JSON 不完整（疑似被截断）。请压缩每条字数（do≤25字/tip≤20字），确保 steps 4-7 步与全部字段一次性完整输出。严禁把裸字段名（如 "name"、"do"、"tip"）或 JSON 语法碎片（如 "]"、"steps"）当成内容输出；所有数组必须完整闭合。`,!0);return}e.silent||window.Toast&&Q.warn("AI 返回的方法卡格式不合格，已放弃入库（不会污染方法库）"),n(null);return}p.source="auto:"+(t.module||"unknown"),p.autoFp=t.fp||"",p.autoTopic=t.topicName||t.type||"",p.uses=0,Yt().update(function(d){d.playbooks=d.playbooks||[],d.playbooks.unshift(p)}),Tn(t.fp,p.id),n({pb:p,created:!0,bound:!0})}).catch(function(u){e.silent||window.Toast&&Q.warn("建立方法卡失败："+(u&&u.message||u)),n(null)})}o("请为这类题生成方法卡。",!1)})}function Tn(t,e){!t||!e||Yt().update(function(n){n.playbookLinks=n.playbookLinks||{},n.playbookLinks[t]=e})}function Lf(t){t&&Yt().update(function(e){e.playbookLinks&&delete e.playbookLinks[t]})}function vo(t,e){e=e||{};var n=e.autoCreate!==!1;return new Promise(function(s){if(!window.InspectorModule){window.Toast&&Q.warn("解题方法模块未加载"),s(null);return}var r=ze(t);if(r&&r.pb){nr(r.pb,t,e),s(r.pb);return}if(!n){qt().startGuide?qt().startGuide("",t.stem,{origin:e.origin,ctx:t}):qt().openFor({subject:t.subject,type:t.type,desc:t.topicName}),s(null);return}Os(t,{silent:!1}).then(function(o){o&&o.pb&&nr(o.pb,t,e),s(o?o.pb:null)})})}function nr(t,e,n){t&&(e.fp&&Tn(e.fp,t.id),qt().startGuide?qt().startGuide(t.id,e.stem||e.topicName,{origin:n.origin||As[e.module]||e.module||"",originTab:n.originTab||e.module||"",ctx:e}):qt().openPlaybook(t.id))}function bo(t){var e=ze(t);return e&&e.pb?(qt().openPlaybook(e.pb.id),e.pb):(qt().openFor({subject:t.subject,type:t.type,desc:t.topicName||t.stem}),null)}function Cf(t){t=t||{};var e={id:"dr"+Date.now().toString(36)+Math.random().toString(36).slice(2,6),pbId:t.pbId||"",fp:t.fp||"",subject:t.subject||"",topicId:t.topicId||"",topic:String(t.topic||"").slice(0,40),module:t.module||"",steps:t.steps||0,doneSteps:t.doneSteps||0,risk:t.risk==null?null:t.risk,ok:!!t.ok,createdAt:new Date().toISOString()};return Yt().update(function(n){n.playbookDrills=n.playbookDrills||[],n.playbookDrills.unshift(e),n.playbookDrills.length>300&&(n.playbookDrills.length=300)}),e.ok&&e.topicId?wo(e.topicId,6):e.ok&&e.topic&&jf(e.subject,e.topic,6),e}function wo(t,e){t&&Yt().update(function(n){n.heat=n.heat||{};var s=n.heat[t]||{level:0,score:null,updatedAt:""};s.score==null&&(s.score=50),s.score=Math.max(0,Math.min(100,s.score+e)),s.level=s.score>=75?2:s.score>=45?1:0,s.updatedAt=new Date().toISOString(),n.heat[t]=s,n.heatHistory||(n.heatHistory={});var r=n.heatHistory[t]||[];r.push({score:s.score,level:s.level,at:new Date().toISOString()}),r.length>30&&(r=r.slice(-30)),n.heatHistory[t]=r})}function jf(t,e,n){try{var s=window.DB&&Wt.TOPICS&&Wt.TOPICS[t]||[],r=null,o=0;s.forEach(function(i){var a=Fn(String(i.name||""),e);a>o&&(o=a,r=i)}),r&&o>.5&&wo(r.id,n)}catch{}}function ko(t){var e=Es().filter(function(s){return s.pbId===t});if(!e.length)return{n:0,ok:0,rate:0,last:""};var n=e.filter(function(s){return s.ok}).length;return{n:e.length,ok:n,rate:Math.round(n/e.length*100),last:e[0].createdAt||""}}function Df(t){var e=Es().filter(function(n){return n.fp===t});return{n:e.length,ok:e.filter(function(n){return n.ok}).length,last:e.length?e[0].createdAt:""}}var Vn={},jn=0;function qf(t){jn>400&&(Vn={},jn=0);var e="c"+jn+++Math.random().toString(36).slice(2,6);return Vn[e]=t,e}function _o(t){return t&&Vn[t]||null}function Is(t,e){if(e=e||{},!t)return"";var n=ze(t),s=n?n.pb:null,r=t.topicName||t.type||"这一类题",o=s?ko(s.id):null,i;return s?i='<span class="ml-pb-name">'+de(s.title)+'</span><span class="ml-pb-meta">'+(o&&o.n?"练过 "+o.n+" 次 · 通过率 "+o.rate+"%":"尚未实操")+(n.bound?" · 已绑定此类题":"")+"</span>":i='<span class="ml-pb-none">「'+de(r)+'」还没建立解题方法</span><span class="ml-pb-meta">建立后，同类题自动复用，带练闭环</span>','<div class="ml-panel'+(e.compact?" ml-compact":"")+'" data-ml-fp="'+de(t.fp)+'" data-ml-ctx="'+qf(t)+'"><div class="ml-head"><span class="ml-ico">🧭</span><div class="ml-right">'+i+"</div></div>"+(e.hint?'<div class="ml-hint">'+de(e.hint)+"</div>":"")+'<div class="ml-acts">'+(s?'<button class="btn btn-sm btn-primary ml-act" data-ml="practice">🎯 带我练</button><button class="btn btn-sm btn-ghost ml-act" data-ml="view">📖 看方法</button><button class="btn btn-sm btn-ghost ml-act" data-ml="swap">🔄 换一张</button>':'<button class="btn btn-sm btn-primary ml-act" data-ml="create">🧠 为这类题建立方法卡</button><button class="btn btn-sm btn-ghost ml-act" data-ml="pick">📚 从方法库挑一张</button>')+"</div></div>"}function So(t,e,n){if(n=n||{},!!t){var s=t.classList&&t.classList.contains("ml-panel")?[t]:Array.prototype.slice.call(t.querySelectorAll(".ml-panel"));s.forEach(function(r){var o=_o(r.getAttribute("data-ml-ctx"))||e;o&&xo(r,o,n)})}}function xo(t,e,n){n=n||{},t.querySelectorAll(".ml-act").forEach(function(s){s.onclick=function(){var r=s.getAttribute("data-ml");if(r==="view"){bo(e);return}if(r==="practice"){vo(e,{origin:As[e.module]||"",originTab:e.module});return}if(r==="create"){s.disabled=!0,s.textContent="⏳ 正在建立方法卡…",Os(e,{force:!0}).then(function(o){s.disabled=!1,s.textContent="🧠 为这类题建立方法卡",o&&o.pb&&(window.Toast&&Q.success("方法卡已建立："+o.pb.title+"（同类题将自动复用）"),Ms(t,e,n),n.onChange&&n.onChange(o.pb,e))});return}if(r==="swap"||r==="pick"){Ao(e,n,t);return}}})}function Ms(t,e,n){if(!(!t||!e)){var s=Is(e,n),r=document.createElement("div");r.innerHTML=s;var o=r.firstChild;o&&(xo(o,e,n),t.parentNode&&t.parentNode.replaceChild(o,t))}}function Ao(t,e,n){e=e||{};var s=yo(t,12),r=(window.InspectorModule?qt().list():[])||[],o=s.length?s:r.filter(function(a){return!t.subject||a.subject===t.subject}).map(function(a){return{pb:a,score:0}}),i='<div class="muted-sm" style="margin-bottom:8px">为「'+de(t.topicName||t.type||"这类题")+"」指定方法卡。绑定后，同类题会自动命中这张卡，不再重复询问。</div>"+(o.length?o.map(function(a){return'<div class="ml-pick-row"><div style="flex:1;min-width:0"><div style="font-size:13.5px;font-weight:600">'+de(a.pb.title)+'</div><div class="muted-sm" style="font-size:11.5px">'+(xs[a.pb.subject]||a.pb.subject)+" · "+(a.pb.steps||[]).length+" 步"+(a.score?" · 匹配度 "+a.score:"")+'</div></div><button class="btn btn-sm btn-primary ml-pick" data-id="'+de(a.pb.id)+'">绑定</button></div>'}).join(""):'<div class="empty">当前没有候选方法卡，可先「建立方法卡」。</div>');window.Modal&&Ot.open({title:"🔄 选择方法卡",html:i,actions:[{label:"取消"}]}),setTimeout(function(){document.querySelectorAll(".ml-pick").forEach(function(a){a.onclick=function(){Tn(t.fp,a.getAttribute("data-id")),window.Modal&&Ot.close&&Ot.close(),window.Toast&&Q.success("已绑定，同类题将自动使用这张卡"),n&&Ms(n,t,e),e.onChange&&e.onChange({id:a.getAttribute("data-id")},t)}})},30)}function Rf(t,e,n,s,r){if(!t)return null;var o=go(e,n,s);return t.innerHTML=Is(o,r),So(t,o,r),o}const Eo={fromQuestion:go,fingerprint:ho,match:ze,candidates:yo,scoreOf:Ts,genSystemPreview:function(t){return Kn(t||{subject:"math",topicName:"极限计算"})},ensure:Os,bind:Tn,unbind:Lf,links:fo,practice:vo,view:bo,recordDrill:Cf,drills:Es,statsOf:ko,fpStats:Df,panelHtml:Is,bindPanel:So,repaintPanel:Ms,mount:Rf,openPicker:Ao,ctxOfToken:_o,SUBJ_CN:xs,MOD_CN:As,MATCH_MIN:mo},Bf=Object.freeze(Object.defineProperty({__proto__:null,MethodLink:Eo},Symbol.toStringTag,{value:"Module"})),Ze=40,Jf=400,Gf=9e3,Hf={sprint:[[".sp-exam-card","考试题目",t=>mt(t.querySelector(".sp-exam-no"))+" "+mt(t)],[".sp-item","押题考点",t=>mt(t.querySelector(".sp-name"))+"（"+mt(t.querySelector(".sp-score"))+"）"],["#lib-reader-body > div","资料章节段",t=>mt(t)]],mistakes:[[".mis-row","错题",t=>mt(t.querySelector(".mis-desc"))||mt(t)]],photomistake:[[".pm-question","拍题题目",t=>mt(t)],[".pm-card","拍题记录",t=>mt(t)]],wordbook:[[".fc-word","当前单词卡",t=>mt(t)+" "+mt(t.parentElement?.querySelector(".fc-hint"))]],scheduler:[[".seq-row","排程任务",t=>mt(t)]],essay:[[".essay-row","作文批改记录",t=>mt(t.querySelector(".mis-desc"))||mt(t)]]};function mt(t){return(t&&t.textContent||"").replace(/\s+/g," ").trim().slice(0,Jf)}function To(t){const e=document.getElementById("view");let n=t;for(;n&&n!==e;){if(n.hidden)return!1;const s=n.style&&n.style.display;if(s==="none"||s==="hidden"||typeof n.className=="string"&&/(^|\s)cp-hide(\s|$)/.test(n.className))return!1;n=n.parentElement}return!0}const Oo=new Map;function zf(t){const e=[];return t.querySelectorAll(".card").forEach(n=>{if(e.length>=Ze||!To(n))return;const s=mt(n.querySelector(".card-title")),r=mt(n),o=(s?s+"：":"")+(r.length>90?r.slice(0,90)+"…":r);o.trim()&&e.push({kind:s||"卡片",text:o})}),e}function $f(t){const e=document.getElementById("view");if(!e)return[];const n=Oo.get(t);if(n)try{return n(e).slice(0,Ze)}catch{}const s=Hf[t];if(s){const r=[];for(const[o,i,a]of s)if(e.querySelectorAll(o).forEach(l=>{if(r.length>=Ze||!To(l))return;const u=a(l);u&&r.push({kind:i,text:u})}),r.length>=Ze)break;if(r.length)return r}return zf(e)}const Uf={dashboard:"仪表盘",scheduler:"排程",review:"复盘",photomistake:"拍题",quiz:"测验",heatmap:"热力图",inspector:"方法卡",sprint:"我的题卷",progress:"进度",decision:"决策",mental:"心态",redline:"红线",wordbook:"单词本",reading:"阅读",essay:"作文",polrecite:"政治背诵",mistakes:"错题本",concept:"概念图",focus:"专注",settings:"设置"};function Io(){const t=String(window.App?.current||"");if(!t||!document.getElementById("view"))return null;const e=$f(t);return e.length?{pageId:t,label:Uf[t]||t,entries:e}:null}function Mo(){const t=Io();if(!t)return"";const e=[];let n=0;for(let r=0;r<t.entries.length;r++){const o=r+1+". ["+t.entries[r].kind+"] "+t.entries[r].text;if(n+o.length>Gf)break;n+=o.length,e.push(o)}const s=e.length<t.entries.length?`
（本页共 `+t.entries.length+" 条，因长度上限仅列出前 "+e.length+" 条；被截断部分如需查看请让用户滚动页面或指明题号）":"";return"【当前页面·"+t.label+`（用户此刻看到的内容，DOM 直读非截图）】
`+e.join(`
`)+s+`
（用户说"这道题/这页/刚才"等指代时，即指上述条目）`}const Ff=/(这道题|这题|这个题|这道|这页|本页|当前页|上面|刚才|屏幕上|看到的|这里|哪个错|哪道题)/;function Kf(t){return Ff.test(t||"")?Mo():""}function Vf(){try{const t=window.getSelection(),e=t?String(t.toString()||"").trim():"";if(e.length<4||e.length>800)return"";if(t&&t.rangeCount){const n=t.getRangeAt(0).commonAncestorContainer,s=n.nodeType===1?n:n.parentElement;if(!s||!s.closest("#view"))return""}return e}catch{return""}}const Qf={register(t,e){Oo.set(t,e)},snapshot:Io,text:Mo,auto:Kf,selection:Vf};window.PageCtx=Qf;function Po(){const t=window;t.U=M,t.ICONS=Ge,t.Spaced=ci,t.BgTask=Np,t.Tex=Ne,t.Store=P,t.Cloud=St,t.CloudJob=rf,t.DB=Wt,t.Charts=Br,t.Diagram=Rr,t.Toast=Q,t.Modal=Ot,t.Components=Uo,t.Notify=ws,t.AI=K,t.AiMemory=Ye,t.Alerts=cs,t.Mastery=ao,t.ZipKit=We,t.PluginBus=q,t.ExamPipeline=lo,t.MethodLink=Eo,t.Plaza=ui,t.SchedulerEngine=Pf}function Xf(){const t=P.get(),e=M.dkey();if(t.meta.lastOpenDate===e)return;const n=t.meta.lastOpenDate;if(n&&n<e){const s=t.completions[n]||[];t.taskArchive[n]=t.tasks.map(o=>({subject:o.subject,text:o.text,done:o.done||s.indexOf(o.id)>=0})),t.tasks.forEach(o=>{o.done=!1});const r=Object.keys(t.taskArchive).sort();for(;r.length>60;)delete t.taskArchive[r.shift()]}P.update(s=>{s.meta.lastOpenDate=e})}function Wf(){Po();try{const e="kaoyan2026_v2_bak";if(!localStorage.getItem(e)&&localStorage.getItem("kaoyan2026_data")){localStorage.setItem(e,new Date().toISOString());const n=localStorage.getItem("kaoyan2026_data");n&&localStorage.setItem("kaoyan2026_data_bak_v2",n)}}catch{}const t=(function(){try{return St.init()}catch{return Promise.resolve()}})();Wt.syncSubjects(),Xf(),ws.ensurePermission();try{Ye.syncLocalSignals()}catch{}setTimeout(()=>{try{cs.runDailyChecks()}catch{}},800),t.then(function(){setTimeout(function(){try{const e=window.Copilot;e&&e.superviseCheck&&e.superviseCheck(),setTimeout(function(){try{e&&e.patrolDaily&&e.patrolDaily()}catch{}},2400)}catch{}try{Ye.consolidateDue()&&Ye.weeklyConsolidate()}catch{}},1200)}).catch(function(){});try{ve.restoreChat(),ve.maybeAutoLoad()}catch{}(function e(n){try{const s=window.FocusModule;if(s&&s.boot){s.boot();return}}catch{}(n||0)<40&&setTimeout(()=>e((n||0)+1),50)})(),t.then(function(){const e=window.Onboarding;e&&e.needed&&e.needed()&&e.show()}).catch(function(){});try{const e=window.Copilot;e&&e.mount&&e.mount()}catch{}}Po();const Yf=[()=>Y(()=>import("./dashboard-DbWb5FhF.js"),__vite__mapDeps([8,9,7,3,4,6,10,5]),import.meta.url),()=>Y(()=>import("./scheduler-B4eO49KP.js"),[],import.meta.url),()=>Y(()=>import("./tasks-BqMe-nc1.js"),[],import.meta.url),()=>Y(()=>import("./progress-MouM4HYd.js"),[],import.meta.url),()=>Y(()=>import("./review-DmcWgcE8.js"),[],import.meta.url),()=>Y(()=>import("./heatmap-CJtykNWz.js"),[],import.meta.url),()=>Y(()=>import("./quiz-Dli5KxSM.js"),__vite__mapDeps([11,12,7,3,4,6]),import.meta.url),()=>Y(()=>import("./inspector-BKpUpTe_.js"),[],import.meta.url),()=>Y(()=>import("./sprint-b10k7C_j.js"),__vite__mapDeps([13,14,3,4,1,2,5,6]),import.meta.url),()=>Y(()=>import("./wordbook-CRdsTi4k.js"),[],import.meta.url),()=>Y(()=>import("./tutor-Z22EhQvz.js"),[],import.meta.url),()=>Y(()=>import("./settings-B9ahw9b9.js"),__vite__mapDeps([15,14]),import.meta.url),()=>Y(()=>import("./onboarding-S8tjkBcr.js"),[],import.meta.url),()=>Y(()=>import("./copilot-SJfDR96k.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]),import.meta.url),()=>Y(()=>import("./polrecite-CifL9KS5.js"),[],import.meta.url),()=>Y(()=>import("./plugincenter-B8LSfsMq.js"),[],import.meta.url)],Zf=[()=>Y(()=>import("./mistakes-C7Vin1u7.js"),__vite__mapDeps([16,12,7,3,4,6]),import.meta.url),()=>Y(()=>import("./photomistake-BdWNfpSx.js"),[],import.meta.url)],th=[()=>Y(()=>import("./shareplaza-DoI1NgA4.js"),__vite__mapDeps([17,18,5,3,4]),import.meta.url)],eh=[()=>Y(()=>import("./redline-Dj0Zvmn_.js"),[],import.meta.url),()=>Y(()=>import("./focus-DeiM7h0a.js"),[],import.meta.url),()=>Y(()=>import("./conceptmap-CQPf2rW9.js"),[],import.meta.url),()=>Y(()=>import("./decision-Ca7lZVwo.js"),[],import.meta.url),()=>Y(()=>import("./mental-BDB5Acye.js"),[],import.meta.url),()=>Y(()=>import("./reading-C-HHs6wP.js"),[],import.meta.url),()=>Y(()=>import("./essay-B46Eb2sJ.js"),[],import.meta.url),()=>Y(()=>import("./qfinder-iu8_yhJV.js"),[],import.meta.url),()=>Y(()=>import("./vizai-WcsIuia_.js"),[],import.meta.url)],nh=[()=>Y(()=>import("./shareplaza-ext-BufKqgSu.js"),__vite__mapDeps([19,18,20,5,3,4]),import.meta.url),()=>Y(()=>import("./shareplaza-ai-DUSA_9x1.js"),__vite__mapDeps([21,18,20,5,3,4]),import.meta.url)];let Ke=null;function sr(){return Ke||(Ke=(async()=>{if(Qn.length){const t=Qn.splice(0);await Promise.all(t.map(e=>e().catch(n=>console.warn("[legacy] 关键模块重试仍失败",n))))}await Promise.all(th.map(t=>t())),await Promise.all(eh.map(t=>t())),await Promise.all(nh.map(t=>t())),window.__LEGACY_ALL__=!0;try{window.dispatchEvent(new Event("legacy:rest-loaded"))}catch{}})().catch(function(t){throw Ke=null,t})),Ke}const Qn=[];async function No(t){await Promise.all(t.map(e=>e().catch(n=>{Qn.push(e),console.warn("[legacy] 关键模块加载失败（挂载后自动重试）",n)})))}await No(Yf);await No(Zf);const rr=()=>Y(()=>import("./index-CahG0RGH.js").then(t=>t.i),__vite__mapDeps([22,7,3,4,6,10,5,12]),import.meta.url),Ps=zo(zn);Ps.use($o());Ps.use(kt);la();(function(){if(window.__ERR_OVERLAY__)return;window.__ERR_OVERLAY__=!0;function e(n,s){ls(n,s);let r=document.getElementById("g-err");r||(r=document.createElement("div"),r.id="g-err",r.style.cssText="position:fixed;left:8px;right:8px;bottom:8px;z-index:99999;background:#b42318;color:#fff;padding:10px 12px;border-radius:10px;font-size:13px;box-shadow:0 6px 24px rgba(0,0,0,.35)",document.body.appendChild(r)),r.innerHTML='<div style="display:flex;gap:8px;align-items:flex-start"><span style="flex:1;line-height:1.5">⚠️ 页面出错：'+M.esc(n)+'</span><button style="background:#fff;color:#b42318;border:0;border-radius:6px;padding:3px 8px;font-size:12px;flex:0 0 auto" data-a="copy">复制</button><button style="background:transparent;color:#fff;border:1px solid #fff;border-radius:6px;padding:3px 8px;font-size:12px;flex:0 0 auto" data-a="x">✕</button></div>'+(s?'<details style="margin-top:6px"><summary style="cursor:pointer;font-size:12px;opacity:.9">展开详情（截图发我）</summary><pre style="white-space:pre-wrap;font-size:11px;max-height:180px;overflow:auto;margin:6px 0 0">'+M.esc(s)+"</pre></details>":"");const o=r.querySelector('[data-a="copy"]'),i=r.querySelector('[data-a="x"]');o&&(o.onclick=function(){try{navigator.clipboard.writeText(n+`
`+s),this.textContent="已复制✓"}catch{}}),i&&(i.onclick=function(){r&&r.parentNode&&r.parentNode.removeChild(r)})}window.addEventListener("error",function(n){const s=n.target;if(s&&(s.tagName==="SCRIPT"||s.tagName==="LINK")){e("资源加载失败："+String(s.src||s.href||"").split("/").pop()+"（分片缺失，多为版本/缓存错配）——请强制刷新或清缓存","");return}n.message&&e(n.message,n.error&&n.error.stack||(n.filename?n.filename+":"+n.lineno:""))},!0),window.addEventListener("unhandledrejection",function(n){const s=n&&n.reason;e(s&&(s.message||String(s))||"未知异步错误",s&&s.stack||"")})})();try{if("serviceWorker"in navigator){const t=!!navigator.serviceWorker.controller;let e=!1;navigator.serviceWorker.addEventListener("controllerchange",function(){if(!t||e)return;e=!0;const n=document.createElement("div");n.style.cssText="position:fixed;left:50%;transform:translateX(-50%);bottom:60px;z-index:99998;background:#1a7f37;color:#fff;padding:10px 14px;border-radius:10px;font-size:13px;box-shadow:0 6px 24px rgba(0,0,0,.35);display:flex;gap:10px;align-items:center",n.innerHTML='🆕 已更新到新版本<button style="background:#fff;color:#1a7f37;border:0;border-radius:6px;padding:4px 10px;font-size:12px">刷新</button>',document.body.appendChild(n),n.querySelector("button").onclick=function(){location.reload()},setTimeout(function(){n.parentNode&&n.parentNode.removeChild(n)},15e3)})}}catch{}try{await Promise.race([P.hydrateHeavy(),new Promise(t=>setTimeout(t,2500))])}catch{}Wf();Ps.mount("#app");const sh=window.requestIdleCallback||function(t){return setTimeout(t,1200)};try{sh(()=>{sr().catch(function(t){console.warn("[boot] 后台模块补齐失败",t)}),rr().then(function(){try{window.App&&zn.current==="settings"&&zn.refresh()}catch{}}).catch(function(t){console.warn("[boot] 工程组件注册失败",t)})})}catch{sr().catch(()=>{}),rr().catch(()=>{})}try{typeof window.__BOOT_READY=="function"&&window.__BOOT_READY()}catch{}export{hh as d};
