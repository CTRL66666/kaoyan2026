const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./copilot--72RPtb9.js","./mdrender-Ai_OJ5CI.js","./markdown-CjcKfXm4.js","./vendor-BVCdKi1G.js","./vendor-DLVrwanO.css","./tex-DM1sK5vY.js","./utils-BjiCGh9R.js","./dashboard-BaA9FphH.js","./dashboardLogic-DsPrrRKB.js","./ai-BNcipkjW.js","./sprint-B7bO86R_.js","./index-PPVm8Dsz.js","./settings-CT0kqVIb.js","./shareplaza-BUy_JnSs.js","./share-Dp9ztnAQ.js","./shareplaza-ext-BYlyrW7i.js","./share-social-CgRhOwZQ.js","./shareplaza-ai-CtnFQRXe.js","./index-Cf9hRrum.js"])))=>i.map(i=>d[i]);
import{_ as Y}from"./index-PPVm8Dsz.js";import{g as et,h as C,i as ot,o as b,j as _,k as he,l as c,n as W,q as ct,s as Z,t as k,v as z,w as Lo,x as qe,y as rr,A as Qn,B as Xn,C as tn,D as Vt,E as tt,F as H,G as Q,H as Qt,I as ye,J as Wn,K as en,M as Cs,N as Co,O as On,Q as Ct,R as ft,S as jo,T as qo,U as Do,V as Ro,W as Bo,X as js,Y as Jo,Z as Go,$ as Ho}from"./vendor-BVCdKi1G.js";import{T as X,S as P,A as K,M as It,D as Wt,C as zo}from"./ai-BNcipkjW.js";import{U as M}from"./utils-BjiCGh9R.js";import{T as Ne}from"./tex-DM1sK5vY.js";import{r as $o,p as Uo,A as ve,c as Fo,a as Ko,l as Et,b as qs,d as Ds,e as Vo}from"./index-Cf9hRrum.js";import{g as Qo,b as Rs,r as Le,l as Xo,s as Wo,d as $e,a as Bs,c as Js,e as Yo,f as or,h as Zo,i as ti,S as ei}from"./dashboardLogic-DsPrrRKB.js";import{P as ni}from"./share-Dp9ztnAQ.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();const ir="https://api.github.com",De="kaoyan2026.json",Yn="core.json",$t="manifest.json",ar="kaoyan2026-sync",Zn="kaoyan2026-sync-bulk",ts="kaoyan2026_ghtoken",lr="kaoyan2026_cloud",Gs=1500,cr=3e5,si=[{ms:0,label:"实时",tip:"每次改动 1.5s 后推送（同步次数最多，密集操作易触发限流）"},{ms:6e4,label:"每 1 分钟",tip:"接近实时，适合双设备频繁切换"},{ms:12e4,label:"每 2 分钟",tip:"较均衡"},{ms:3e5,label:"每 5 分钟",tip:"默认推荐，大幅省同步次数"},{ms:6e5,label:"每 10 分钟",tip:"更省，跨设备看到更新稍慢"},{ms:18e5,label:"每 30 分钟",tip:"最省同步次数，适合单机为主"}],ur=6e4,dr=15e3,ri=[{ms:15e3,label:"每 15 秒",tip:"最快感知其他设备的更新（API 配额消耗最多）"},{ms:3e4,label:"每 30 秒",tip:"较快"},{ms:6e4,label:"每 1 分钟",tip:"默认推荐（ETag 命中时零流量，仅占 1 点配额）"},{ms:3e5,label:"每 5 分钟",tip:"均衡，适合不常切设备"},{ms:6e5,label:"每 10 分钟",tip:"更省配额"},{ms:18e5,label:"每 30 分钟",tip:"最省，跨设备更新感知最慢"}],oi="https://github.com/settings/tokens/new?scopes=gist&description=kaoyan2026同步",rt=["quizBank","mistakePhotos","essays","vocab","mistakes","dailyQuizHistory","mistakeDrills","playbooks"],es={quizBank:"题库",mistakePhotos:"错题照片",essays:"作文",vocab:"单词本",mistakes:"文本错题",dailyQuizHistory:"每日一题历史",mistakeDrills:"错题重练",playbooks:"解题方法卡"},yt=["copilotChats","majorData","deepReview","conceptAI","sprintData","plugins","pluginData","pluginConfig","pluginLog","share","plazaKept","studyBooks"],nn={copilotChats:"AI对话",majorData:"专业数据",deepReview:"深度复盘",conceptAI:"概念图谱AI",sprintData:"押题出卷",plugins:"插件源码",pluginData:"插件数据",pluginConfig:"插件配置",pluginLog:"插件日志",share:"星屿广场",plazaKept:"星藏包",studyBooks:"资料库"},mn=/^op-\d+-[A-Za-z0-9_-]+\.json$/,ii=/^(quizBank|mistakePhotos|essays|vocab)\.ops\.json$/,Re=8,m={enabled:!1,token:null,gistId:null,bulkGistId:null,lastPushedAt:0,lastSyncAt:0,pollTimer:null,badge:null,lastPushAttemptAt:0,badgeBaseTitle:"",pushing:!1,rateLimitBackoffUntil:0,lastTransfer:null,syncPhase:"idle",syncLog:[],pendingBulk:[]};let le=!1,ee=null,j=ai();function ai(){let t;try{t=JSON.parse(localStorage.getItem(lr))}catch{t=null}t=t||{};try{localStorage.getItem("kaoyan2026_syncKeyMigrated")?t.syncAiKey===void 0&&(t.syncAiKey=!0):(t.syncAiKey=!0,localStorage.setItem("kaoyan2026_syncKeyMigrated","1"),t.pushedHashes&&(delete t.pushedHashes.core,delete t.pushedHashes.manifest))}catch{t.syncAiKey===void 0&&(t.syncAiKey=!0)}return t.pushedHashes=t.pushedHashes||{},t.deviceId||(t.deviceId="dev-"+Math.random().toString(36).slice(2,10)),t.opCursor=t.opCursor||{},t.appliedOps=Array.isArray(t.appliedOps)?t.appliedOps:[],t.compactGen=t.compactGen||0,t.opCount=t.opCount||0,t.bulkHashes=t.bulkHashes||{},(t.pushIntervalMs===void 0||t.pushIntervalMs===null)&&(t.pushIntervalMs=cr),(t.pullIntervalMs===void 0||t.pullIntervalMs===null)&&(t.pullIntervalMs=ur),t}function Bt(){j.gistId=m.gistId,j.bulkGistId=m.bulkGistId,j.lastPushedAt=m.lastPushedAt,j.lastSyncAt=m.lastSyncAt;try{localStorage.setItem(lr,JSON.stringify(j))}catch{}}function sn(){var t=j.pushIntervalMs;return t===0?0:typeof t!="number"||!(t>0)?cr:t}function qn(){var t=j.pullIntervalMs;return typeof t!="number"||!(t>=dr)?ur:t}function li(){try{return localStorage.getItem(ts)||""}catch{return""}}function ci(){try{localStorage.setItem(ts,m.token)}catch{}}function ui(){try{localStorage.removeItem(ts)}catch{}}const di=20;function Pt(t){m.syncPhase=t,t==="idle"?ut("☁ 已同步","on"):t==="downloading"?ut("⬇ 下载中…","busy"):t==="uploading"?ut("⬆ 上传中…","busy"):t==="uploading-bulk"?ut("⬆ 上传大数据…","busy"):t==="merging"&&ut("🔄 整合中…","busy")}function rn(t,e,n,s){m.syncLog.unshift({ts:Date.now(),phase:t,durationMs:Math.round(e),detail:n||"",bytes:s||0}),m.syncLog.length>di&&m.syncLog.pop()}function Nt(t){return(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Tt(t){t=String(t??"");let e=2166136261,n=2538058380;for(let s=0;s<t.length;s++){const r=t.charCodeAt(s);e=Math.imul(e^r,16777619)>>>0,n=Math.imul(n^r,16777643)>>>0}return e=(e^t.length)>>>0,n=(n^Math.imul(t.length,31))>>>0,("00000000"+e.toString(16)).slice(-8)+("00000000"+n.toString(16)).slice(-8)}function ns(){return Date.now()<m.rateLimitBackoffUntil}function Be(t){const e=Math.min(3e4*Math.pow(2,t),3e5);m.rateLimitBackoffUntil=Date.now()+e,console.warn("[Cloud] 触发 API 限额退避，"+Math.round(e/1e3)+"秒内跳过请求")}const pi={429:1,500:1,502:1,503:1,504:1},fi={GET:1,HEAD:1,PATCH:1,PUT:1,DELETE:1},Ue=[800,2e3,4500];function hi(t){return new Promise(e=>setTimeout(e,t))}function gi(t){try{const e=t.headers&&t.headers.get?t.headers.get("X-RateLimit-Remaining"):null;return e!=null&&String(e)==="0"}catch{return!1}}function mi(t,e){return t===401?"auth":t===403?"ratelimit":t===404?"notfound":t===429?"ratelimit":t>=500?"server":"other"}function yi(t,e,n){return t==="auth"?"登录已失效或权限不足（"+e+"）：请到「设置 → 云同步」重新登录 GitHub":t==="ratelimit"?n?"已达 GitHub API 限额，稍后自动重试（可稍等片刻再手动同步）":"无权限访问该资源（"+e+"）：请检查令牌的 gist 权限":t==="notfound"?"资源不存在（"+e+"）：Gist 可能已在别处被删除":t==="network"?"网络连接失败：请检查网络后重试":t==="server"?"GitHub 服务暂时不可用（"+e+"），已自动重试":"HTTP "+e}function Fe(t,e,n,s){const r=new Error(t);return r.status=e||0,r.kind=n||"other",s&&(r.retries=s),r}function vi(t,e,n){const s=n||3e4;if(typeof AbortController>"u")return fetch(t,e);const r=new AbortController,o=setTimeout(()=>{try{r.abort()}catch{}},s);return fetch(t,Object.assign({},e,{signal:r.signal})).then(i=>(clearTimeout(o),i)).catch(i=>{clearTimeout(o);const a=i&&i.name==="AbortError",l=new Error(a?"请求超时（>"+Math.round(s/1e3)+"s）":i&&i.message||"网络错误");throw l.isNetwork=!0,l.isTimeout=!!a,l})}function bi(t){if(t&&t.timeoutMs!=null)return t.timeoutMs;const e=t&&t.body;if(!e)return 3e4;const s=(typeof e=="string"?e:JSON.stringify(e)).length;return s>=3*1024*1024?3e5:s>=1024*1024?24e4:s>=500*1024?12e4:s>=100*1024?6e4:3e4}async function _t(t,e){if(ns())throw Fe("HTTP 403（退避中，"+Math.ceil((m.rateLimitBackoffUntil-Date.now())/1e3)+"s 后恢复）",403,"ratelimit");e=e||{};const n=String(e.method||"GET").toUpperCase(),s=!!fi[n],r=e.retries===0||!s?1:e.retries||Ue.length+1,o=bi(e);let i=null;for(let a=0;a<r;a++){a>0&&await hi(Ue[a-1]||Ue[Ue.length-1]);let l=null;try{l=await vi(ir+t,{method:n,headers:(function(){const p={Authorization:"Bearer "+m.token,Accept:"application/vnd.github+json","Content-Type":"application/json"};return e.etag&&(p["If-None-Match"]=e.etag),p})(),body:e.body?JSON.stringify(e.body):void 0},o)}catch(p){if(p.status=0,p.kind="network",i=p,!s||a>=r-1)break;continue}const u=l.headers&&l.headers.get?l.headers.get("ETag"):null;if(l.status===304)return{status:304,etag:e.etag||u,data:null};if(!l.ok){const p=gi(l),d=mi(l.status),f=yi(d,l.status,p);p&&Be(0);const w=!!pi[l.status]&&s;if(i=Fe(f,l.status,d,a),!w||a>=r-1)break;continue}try{const p=await l.text();return{status:l.status,etag:u,data:p?JSON.parse(p):null}}catch(p){i=Fe("响应解析失败："+(p&&p.message||p),l.status,"parse",a);break}}throw i&&i.retries&&(i.message+="（已重试 "+i.retries+" 次）"),i||Fe("请求失败",0,"other")}async function Ht(t){if(!t)return null;if(t.truncated&&t.raw_url){const e=await fetch(t.raw_url);if(!e.ok)throw new Error("raw 拉取失败 HTTP "+e.status);return await e.text()}return t.content}async function pr(t,e){return(await _t("/gists",{method:"POST",body:{description:t,public:!1,files:e}})).data.id}async function ne(t,e){return(await _t("/gists/"+t,{method:"PATCH",body:{files:e}})).etag}function Dn(t,e){const n={};return(e||rt).forEach(s=>{n[s+".json"]={content:t[s]}}),n}async function wi(t){return await pr(Zn,Dn(t))}async function yn(){let t=1,e=null,n="",s=null,r=-1;for(;t<=10;){let o;try{o=(await _t("/gists?per_page=100&page="+t)).data}catch(i){throw i&&(i.status===403||i.status===429||i.status>=500)&&(i.transient=!0),i}if(!o||!o.length)break;for(const i of o){const a=i.files||{};if(a[$t]){const l=i.updated_at||"";(!e||l>n)&&(e=i.id,n=l)}else if(a[De]){const l=a[De].size||0;l>r&&(r=l,s=i.id)}}t++}return e||s||null}async function ki(){let t=1,e=null,n="";for(;t<=10;){let s;try{s=(await _t("/gists?per_page=100&page="+t)).data}catch(r){throw r&&(r.status===403||r.status===429||r.status>=500)&&(r.transient=!0),r}if(!s||!s.length)break;for(const r of s)if(r.description===Zn){const o=r.updated_at||"";(!e||o>n)&&(e=r.id,n=o)}t++}return e}function _i(t){typeof t.key=="string"&&(t.key=""),Array.isArray(t.apis)&&t.apis.forEach(e=>{e&&typeof e.key=="string"&&(e.key="")})}function on(t){const e=Object.assign({},t);return rt.forEach(n=>{delete e[n]}),yt.forEach(n=>{delete e[n]}),e}function Hs(){try{return window.Store&&window.Store.rev?window.Store.rev():0}catch{return 0}}const Mn=new WeakMap;function Rn(t){if(t&&Mn.has(t)){const n=Mn.get(t);if(n&&n.rev===Hs())return n.hash}const e=Tt(JSON.stringify(t||[]));try{t&&Mn.set(t,{hash:e,rev:Hs()})}catch{}return e}function Bn(t){return!t||!t.length?[]:t.map(function(e){return Object.assign({},e)})}function fr(t){return t.cloudJob&&t.cloudJob.wftoken&&(t.cloudJob=Object.assign({},t.cloudJob),delete t.cloudJob.wftoken),j.syncAiKey!==!0&&t.ai&&(t.ai=JSON.parse(JSON.stringify(t.ai)),_i(t.ai)),t}function hr(){const t=window.Store.get(),e={};for(const n in t)rt.indexOf(n)<0&&yt.indexOf(n)<0&&(e[n]=t[n]);return JSON.stringify(fr(e))}function an(t){if(t==null||typeof t!="object")try{return JSON.stringify(t)}catch{return String(t)}if(Array.isArray(t))return"["+t.map(an).join(",")+"]";const e={};for(const n in t)n.length>6&&n.slice(-6)==="Base64"||(e[n]=an(t[n]));return JSON.stringify(e)}function ss(t,e,n){const s=[],r={},o={};return(t||[]).forEach(i=>{i&&i.id!=null&&(r[i.id]=i)}),(e||[]).forEach(i=>{i&&i.id!=null&&(o[i.id]=i)}),Object.keys(o).forEach(i=>{const a=o[i];i in r?an(r[i])!==an(a)&&s.push({op:"upd",id:i,item:a}):s.push({op:"add",id:i,item:a})}),Object.keys(r).forEach(i=>{!(i in o)&&n&&n[i]&&s.push({op:"del",id:i})}),s}function gr(t,e,n){const s={};return(t||[]).forEach(r=>{r&&r.id!=null&&(s[r.id]=r)}),(e||[]).forEach(r=>{if(!(!r||r.id==null))if(r.op==="del")delete s[r.id];else{if(n&&n[r.id])return;s[r.id]=r.item}}),Object.keys(s).map(r=>s[r])}async function Si(t){if(!m.bulkGistId)return null;try{const e=await _t("/gists/"+m.bulkGistId,{etag:null});if(e.data&&e.data.files){const n=e.data.files[t+".json"];if(n){const s=await Ht(n);if(s!=null)return JSON.parse(s)}}}catch{}return null}function mr(t,e){return"op-"+(t||Date.now())+"-"+(e||"dev")+"-"+Math.random().toString(36).slice(2,7)+".json"}async function xi(t,e,n,s,r){const o={};let i=!1;for(const a of t){let l=n&&n[a]||[];if(!l.length)try{l=await Si(a)}catch{l=[]}const u=ss(l,e[a]||[],s&&s[a]||{});u.length&&(o[a]=u,i=!0)}return i?{gen:r||0,ts:Date.now(),dev:j.deviceId,ops:o}:null}function yr(t,e,n){t=t||{};const s={};return rt.forEach(r=>{s[r]=(t[r]||[]).slice()}),(e||[]).forEach(r=>{const o=r&&r.ops;o&&rt.forEach(i=>{o[i]&&o[i].length&&(s[i]=gr(s[i],o[i],n&&n[i]||{}))})}),s}function Ai(){const t=JSON.parse(window.Store.exportJSON());return fr(t)}function zs(t,e){le=!0;try{window.Store.mergeFrom(t,e||{})}finally{le=!1}window.App&&App.refresh(),window.Onboarding&&Onboarding.dismissIfNeeded&&Onboarding.dismissIfNeeded()}async function jt(t,e){if(!m.gistId){m.lastSyncAt=Date.now(),Bt();return}const n=performance.now();Pt("downloading");const s={pulled:[],pushed:[],bytes:0};let r;try{r=await _t("/gists/"+m.gistId,{etag:t?null:j.coreEtag})}catch(S){throw S&&S.status===404&&(S.deadGist=!0),S}if(r.status===304){Pt("idle"),rn("拉取",performance.now()-n,"304 无变化",0),m.lastSyncAt=Date.now(),Bt(),m.lastTransfer=s;return}j.coreEtag=r.etag;const o=r.data;if(!o||!o.files){m.lastSyncAt=Date.now(),Bt();return}const i=o.files,a=o.updated_at?new Date(o.updated_at).getTime():Date.now();if(!i[$t]&&i[De]){const S=await Ht(i[De]);if(S){s.bytes+=pt(S),s.pulled.push("整包(旧格式)");try{const x=Tt(JSON.stringify(Ai()));Tt(S)!==x&&zs(JSON.parse(S),e)}catch(x){console.error("[Cloud] 旧格式解析/合并失败",x)}}j.legacyRemote=!0,m.lastPushedAt=a,m.lastSyncAt=Date.now(),Bt(),m.lastTransfer=s;return}const l=await Ht(i[Yn]),u=await Ht(i[$t]);if(!l||!u){m.lastSyncAt=Date.now(),Bt();return}s.bytes+=pt(l)+pt(u),s.pulled.push("核心");let p,d;try{p=JSON.parse(l),d=JSON.parse(u)}catch(S){console.error("[Cloud] 核心数据解析失败",S);return}j.legacyRemote=!1,d.bulkGistId&&(m.bulkGistId=d.bulkGistId);const f=d.compactGen||0,w=Object.keys(i).filter(S=>ii.test(S)),v=Object.keys(i).filter(S=>mn.test(S)),y=w.length&&!v.length;if(y){const S={};w.forEach(x=>S[x]=null);try{await ne(m.gistId,S)}catch{}j.compactGen||(j.compactGen=1)}const h=Object.assign({},window.Store.get()),g=h.tomb||{},A=f>0&&(j.compactGen||0)>f,L=(y||A||f>(j.compactGen||0))&&!!m.bulkGistId,E={},O={};if(L){const S=await _t("/gists/"+m.bulkGistId,{etag:t?null:j.bulkEtag});if(S.status!==304&&S.data&&S.data.files){j.bulkEtag=S.etag;for(const x of rt){const G=S.data.files[x+".json"];if(G){const U=await Ht(G);U!=null&&(s.bytes+=pt(U),s.pulled.push(es[x]+"(快照)"),E[x]=JSON.parse(U))}}for(const x of yt){const G=S.data.files[x+".json"];if(G){const U=await Ht(G);U!=null&&(s.bytes+=pt(U),s.pulled.push((nn[x]||x)+"(快照)"),O[x]=JSON.parse(U))}}}j.compactGen=Math.max(j.compactGen||0,f||0,y?1:0),j.appliedOps=[],j.opCount=0}const T={};(j.appliedOps||[]).forEach(S=>T[S]=1);const q=[];for(const S of v)if(!T[S])try{const x=await Ht(i[S]);if(!x)continue;const G=JSON.parse(x);if(!G||!G.ops)continue;G.__name=S,q.push(G),s.bytes+=pt(x)}catch{}q.sort((S,x)=>(S.ts||0)-(x.ts||0)),q.length&&s.pulled.push("op×"+q.length);const I=L?E:h,N=yr(I,q,g),R=Object.assign({},p);if(rt.forEach(S=>{R[S]=S in N?N[S]:I[S]||[]}),yt.forEach(S=>{S in O&&(R[S]=O[S])}),!L&&m.bulkGistId){const S=d.heavy||{},x=window.Store.get(),G=yt.filter(U=>{const nt=S[U];return nt&&nt.hash!==Tt(JSON.stringify(x[U]||null))});if(G.length)try{const U=await _t("/gists/"+m.bulkGistId,{etag:null});if(U.data&&U.data.files)for(const nt of G){const bt=U.data.files[nt+".json"];if(bt){const me=await Ht(bt);me!=null&&(s.bytes+=pt(me),s.pulled.push(nn[nt]||nt),R[nt]=JSON.parse(me))}}}catch(U){console.warn("[Cloud] 重量级字段拉取失败",U)}}const B=Tt(JSON.stringify(on(R)))===Tt(JSON.stringify(on(Object.assign({},h)))),$=yt.some(S=>{if(S in O)return!0;const x=d.heavy&&d.heavy[S];return!x||!x.hash?!1:x.hash!==Tt(JSON.stringify(h[S]||null))}),V=!(B&&q.length===0&&!L&&!$),it=performance.now();if(Pt("merging"),V)try{zs(R,e)}catch(S){console.error("[Cloud] 合并失败",S)}q.length&&(j.appliedOps=j.appliedOps||[],q.forEach(S=>{S.__name&&j.appliedOps.indexOf(S.__name)<0&&j.appliedOps.push(S.__name)}));const At=window.Store.get();m._remoteColls={},rt.forEach(S=>{m._remoteColls[S]=Bn(At[S])});const In=performance.now()-it,F=performance.now()-n;Pt("idle"),rn("拉取",F,(s.pulled.length?s.pulled.join(","):"无变化")+" · 整合"+Math.round(In)+"ms",s.bytes),m.lastPushedAt=a,m.lastSyncAt=Date.now(),Bt(),m.lastTransfer=s}let se=0;function rs(){if(!(!m.enabled||!m.token||le)){var t=sn(),e=t>0?t:Gs,n=Date.now(),s=Math.max(m.lastPushedAt||0,m.lastPushAttemptAt||0),r=s+e;if(r<=n)r=n+Gs;else if(ee&&se&&se<=r){Jn();return}ee&&clearTimeout(ee),se=r,ee=setTimeout(Ei,Math.max(0,r-n)),Jn()}}function Ei(){if(ee=null,se=0,m.pushing){rs();return}m.lastPushAttemptAt=Date.now(),Lt().catch(t=>{console.error("[Cloud] 推送失败",t),ut("☁ 同步失败","err")})}function vr(){if(!se||m.syncPhase!=="idle")return"";var t=Math.max(0,se-Date.now()),e=t>=6e4?Math.round(t/6e4)+" 分钟":Math.max(1,Math.round(t/1e3))+" 秒";return`
⏱ 有改动待推送：约 `+e+"后自动同步（可在同步面板改为实时）"}function Jn(){m.badge&&(m.badge.title=(m.badgeBaseTitle||m.badge.title||"")+vr())}async function Lt(t){t=t||{};const e=t.bulk===!0;if(!m.enabled||!m.token||m.pushing)return;m.pushing=!0,Pt(e?"uploading-bulk":"uploading");const n=performance.now(),s={pulled:[],pushed:[],bytes:0};try{if(m.gistId&&!(Date.now()-(m.lastSyncAt||0)<15e3))try{le=!0;try{await jt(!1,{preserveLocal:!0})}finally{le=!1}}catch(R){console.warn("[Cloud] 推前校准失败，已跳过（稍后重试）",R)}const r=window.Store.get(),o=hr(),i=Tt(o),a={};rt.forEach(N=>{a[N]=Rn(r[N])});const l=j.pushedHashes||{},u=!!j.legacyRemote;let p=!1,d={};if(e||!m.bulkGistId||u||(j.opCount||0)>=Re){try{le=!0;try{await jt(!0,{preserveLocal:!0})}finally{le=!1}}catch(V){console.warn("[Cloud] 压实前合并失败，已跳过（可能丢远端新增）",V)}const N=window.Store.get();let R=!1;if(!m.bulkGistId)try{m.bulkGistId=await ki()}catch(V){V&&V.transient&&(R=!0)}const B={};rt.forEach(V=>{B[V]=JSON.stringify(N[V]||[])}),yt.forEach(V=>{B[V]=JSON.stringify(N[V]||null)});let $=null;if(m.bulkGistId){const V=rt.concat(yt).filter(it=>{const At=B[it]!=null?B[it]:"null";return Tt(At)!==(j.bulkHashes[it]||"")});if(V.length){const it={};V.forEach(At=>{it[At]=B[At]}),$=await ne(m.bulkGistId,Dn(it,V)),s.pushed.push("整包快照("+V.length+"/"+(rt.length+yt.length)+" 变化集合)"),s.bytes+=pt(JSON.stringify(it))}else s.pushed.push("整包快照(无变化,跳过)")}else R?console.warn("[Cloud] 大数据 Gist 发现遇瞬时错误，本次跳过整包上传（避免重复建）"):(m.bulkGistId=await wi(B),s.pushed.push("整包快照"),s.bytes+=pt(JSON.stringify(B)));$&&(j.bulkEtag=$),d={},(j.appliedOps||[]).forEach(V=>{mn.test(V)&&(d[V]=null)}),u&&rt.forEach(V=>d[V+".ops.json"]=null),j.compactGen=(j.compactGen||0)+1,j.appliedOps=[],j.opCount=0,j.bulkHashes=j.bulkHashes||{},rt.concat(yt).forEach(V=>{j.bulkHashes[V]=Tt(B[V]!=null?B[V]:"null")}),p=!0,m._remoteColls={},rt.forEach(V=>{m._remoteColls[V]=Bn(N[V])})}let f={};const w=rt.filter(N=>!p&&(u||a[N]!==l[N]));if(w.length&&!p){const N=await xi(w,r,m._remoteColls,r.tomb||{},j.compactGen||0);if(N){const R=mr(Date.now(),j.deviceId);f[R]={content:JSON.stringify(N)},s.bytes+=pt(JSON.stringify(N)),s.pushed.push("op:"+w.map(B=>es[B]).join("/")),j.appliedOps=j.appliedOps||[],j.appliedOps.indexOf(R)<0&&j.appliedOps.push(R),j.opCount=(j.opCount||0)+1,m._remoteColls||(m._remoteColls={}),w.forEach(B=>{m._remoteColls[B]=Bn(r[B])})}}let v=[],y={};if(!p&&m.bulkGistId&&(v=yt.filter(N=>Tt(JSON.stringify(r[N]||null))!==(l[N]||"")),v.length)){v.forEach(N=>{y[N]=JSON.stringify(r[N]||null)});try{const N=await ne(m.bulkGistId,Dn(y,v));N&&(j.bulkEtag=N)}catch(N){console.warn("[Cloud] 重量级字段上传失败",N)}v.forEach(N=>{s.pushed.push(nn[N]||N),s.bytes+=pt(y[N]||"")})}const h={};yt.forEach(N=>{h[N]=Tt(JSON.stringify(r[N]||null))});const g={ver:3,bulkGistId:m.bulkGistId,compactGen:j.compactGen||0,colls:{},heavy:{}};rt.forEach(N=>{g.colls[N]={hash:Rn(r[N]),n:(r[N]||[]).length}}),yt.forEach(N=>{g.heavy[N]={hash:h[N]}});const A=JSON.stringify(g),L=Tt(A),E=u||i!==l.core||L!==l.manifest||p,O=Object.assign({[Yn]:{content:o},[$t]:{content:A}},f);u&&(O[De]=null),p&&Object.assign(O,d||{});const T=!m.gistId||E||Object.keys(f).length||p&&d&&Object.keys(d).length;if(!m.gistId)m.gistId=await pr(ar,O),s.pushed.unshift("核心"),s.bytes+=pt(o)+pt(A);else if(T){try{const N=await ne(m.gistId,O);N&&(j.coreEtag=N)}catch(N){if(N&&(N.status===404||N.status===401)){m.gistId=null;let R=null;try{R=await yn()}catch(B){console.warn("[Cloud] 重发现 Gist 失败（不新建）",B)}if(R){m.gistId=R;try{const B=await ne(m.gistId,O);B&&(j.coreEtag=B),s.pushed.unshift("核心"),s.bytes+=pt(o)+pt(A)}catch(B){console.warn("[Cloud] 重指向后补丁失败",B)}}else console.warn("[Cloud] Gist 404 但未能重新发现，跳过本次核心写入（避免重复建）")}else throw N&&N.status===403&&Be(0),N}s.pushed.unshift("核心"),s.bytes+=pt(o)+pt(A)}j.pushedHashes=Object.assign({core:i,manifest:L},a,h),j.legacyRemote=!1;const q=Object.keys(f).length>0;m.gistId&&!ns()&&q&&jt(!1,{preserveLocal:!0}).catch(N=>{console.warn("[Cloud] 后台合并跳过",N)}),m.lastPushedAt=Date.now(),m.lastSyncAt=Date.now(),m.lastTransfer=s,m.pendingBulk=[];try{const N=window.PlazaAutoPull;N&&typeof N.onCloudSync=="function"&&N.onCloudSync()}catch{}const I=performance.now()-n;rn("推送",I,s.pushed.length?s.pushed.join(","):"无变化",s.bytes),Bt(),Pt("idle")}catch(r){console.error("[Cloud] 推送失败",r);const o=r&&r.message?r.message:""+r;Pt("idle"),ut("☁ 同步失败","err"),m.badge&&(m.badge.title="同步失败："+o),rn("推送",performance.now()-n,"失败: "+o,0),window.Toast&&X.danger("☁ 同步失败："+o)}finally{m.pushing=!1}}async function br(){m.gistId=null,j.gistId=null,j.coreEtag=null,j.bulkEtag=null,m.lastPushedAt=0;try{const t=await yn();if(t)return m.gistId=t,j.gistId=t,m.bulkGistId=j.bulkGistId||null,!0}catch(t){if(t&&t.transient)throw t;console.warn("[Cloud] 重发现 Gist 失败",t)}return!1}async function wr(){ut("☁ 同步中…","busy");try{if(!m.gistId&&j.gistId&&(m.gistId=j.gistId,m.bulkGistId=j.bulkGistId||null),!m.gistId){try{m.gistId=await yn()}catch(e){if(e&&e.transient){console.warn("[Cloud] 发现 Gist 遭遇瞬时错误，将在轮询中自愈重试",e.message),Pt("idle"),Ve();return}console.warn("[Cloud] 发现 Gist 失败",e)}m.lastPushedAt=0,j.coreEtag=null,j.bulkEtag=null}m.bulkGistId=j.bulkGistId||m.bulkGistId||null;try{await jt()}catch(e){if(e&&e.deadGist)await br()?await jt():await Lt();else throw e}if(!m.gistId)await Lt();else{var t=sn();t>0&&m.lastPushedAt>0&&Date.now()-m.lastPushedAt>=t&&(console.log("[Cloud] 开机追赶：距上次推送超一个周期，立即补推"),m.lastPushAttemptAt=Date.now(),await Lt()),rs()}Pt("idle"),Ve()}catch(e){console.error("[Cloud] 同步失败",e);const n=e&&e.message?e.message:""+e;Pt("idle"),ut("☁ 同步失败","err"),m.badge&&(m.badge.title="同步失败："+n),window.Toast&&X.danger("☁ 同步失败："+n),Ve()}}function Ve(){kr(),m.pollTimer=setInterval(async()=>{if(!ns()){if(!m.gistId&&!j.gistId){try{m.gistId=await yn()}catch(t){if(t&&t.transient)return}if(!m.gistId){await Lt();return}}try{await jt(!1,{preserveLocal:!0}),ut("☁ 已同步","on")}catch(t){if(t&&t.status===403)Be(0);else if(t&&t.deadGist)try{await br()&&(await jt(!1,{preserveLocal:!0}),ut("☁ 已同步","on"))}catch{}}}},qn())}function kr(){m.pollTimer&&(clearInterval(m.pollTimer),m.pollTimer=null)}async function Ti(){const t=li();if(!t){ut("☁ 未同步","off");return}m.token=t,m.enabled=!0,m.gistId=null,m.lastPushedAt=j.lastPushedAt||0,await wr()}async function Ii(t,e){m.token=t.trim();try{await _t("/rate_limit"),m.enabled=!0,ci(),m.gistId=null,m.lastPushedAt=j.lastPushedAt||0,be(),await wr()}catch(n){m.token=null,m.enabled=!1,ie(e,n.status===401?"令牌无效或无 gist 权限，请检查":n.message||"验证失败")}}async function _r(){kr(),ui(),m.token=null,m.enabled=!1,m.gistId=null,m.bulkGistId=null,m.rateLimitBackoffUntil=0,m.lastTransfer=null,j={syncAiKey:j.syncAiKey,pushedHashes:{},bulkHashes:{},appliedOps:[],compactGen:0,opCount:0},Bt(),ut("☁ 未同步","off")}function Sr(){if(document.getElementById("cloud-style"))return;const t=document.createElement("style");t.id="cloud-style",t.textContent=`
...
PluginBus.register(`+JSON.stringify(a)+");",enabled:!0,createdAt:M.dkey?M.dkey():new Date().toISOString().slice(0,10),isSkillPack:!0,skillMeta:{whenToUse:t.whenToUse,refCount:(t.refs||[]).length}};p>=0?u.plugins[p]=d:u.plugins.push(d)});var l=Nn(a);return dt[r]={manifest:l},e||X.show("技能包「"+(t.name||r)+"」已导入（"+(t.refs.length?t.refs.length+" 份参考":"无参考")+"）","success",3e3),l},importZip:function(t,e){if(!window.ZipKit)throw new Error("技能包解析器未加载");return We.parseZip(t).then(function(n){var s=We.normalizeSkillPack(n);return D.importSkillPack(s,e)})},importSkillMdText:function(t,e){if(!window.ZipKit)throw new Error("技能包解析器未加载");var n=We.parseSkillMd(t);if(!n)throw new Error("无法解析 SKILL.md");var s=n.name||"skill-pack",r={id:s,name:s,description:n.description,whenToUse:n.whenToUse,skillMd:n.body,refs:[],files:[]};return D.importSkillPack(r,e)},exportShareCode:function(t){var e=oe().find(function(o){return o.id===t});if(!e||!e.source)return null;try{var n=new TextEncoder().encode(e.source),s="";n.forEach(function(o){s+=String.fromCharCode(o)});var r=btoa(s).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return"PBCODE1:"+r}catch{return null}},importShareCode:function(t,e){if(!t||typeof t!="string")throw new Error("无效分享码");var n=t.match(/^PBCODE1:([A-Za-z0-9\-_]+)$/);if(!n)throw new Error("不是有效的插件分享码（应以 PBCODE1: 开头）");try{for(var s=n[1].replace(/-/g,"+").replace(/_/g,"/");s.length%4;)s+="=";for(var r=atob(s),o=new Uint8Array(r.length),i=0;i<r.length;i++)o[i]=r.charCodeAt(i);var a=new TextDecoder("utf-8").decode(o);return D.importText(a,e)}catch(l){throw new Error("分享码解析失败："+(l.message||l))}},_replaySource:function(t){var e=new Function("PluginBus","window",`"use strict";
`+t);e(D,window)},enable:function(t,e){if(P.update(function(r){var o=(r.plugins||[]).find(function(i){return i.id===t});o&&(o.enabled=!!e)}),e&&!dt[t]){var n=oe().find(function(r){return r.id===t});if(n&&n.source){try{D._replaySource(n.source)}catch(r){wt(t,"启用重注册失败："+(r.message||r),"error")}return}}var s=dt[t];if(!s){D.syncAugmentors();return}if(e)try{Fs(s.manifest),s.manifest.css&&D._injectCss(t,s.manifest.css),s.manifest.onEnable&&s.manifest.onEnable(vt(t)),s.manifest.init&&s.manifest.init(vt(t))}catch(r){wt(t,"启用错误："+(r.message||r),"error")}else{Hn(t),D.unsubscribeAll(t),D._removeCss(t),D._clearEnhOf(t);try{s.manifest.onDisable&&s.manifest.onDisable(vt(t))}catch(r){wt(t,"禁用错误："+(r.message||r),"error")}}D.syncAugmentors()},_clearEnhOf:function(t){var e=this;Object.keys(this._enh).forEach(function(n){e._enh[n]&&e._enh[n].pid===t&&e._clearEnh(n)})},remove:function(t){P.update(function(e){e.plugins=(e.plugins||[]).filter(function(n){return n.id!==t})}),Hn(t),D.unsubscribeAll(t),D._removeCss(t),D._clearEnhOf(t);try{dt[t]&&dt[t].manifest.onDisable&&dt[t].manifest.onDisable(vt(t))}catch{}D.closePanelsOf(t),delete dt[t],D.syncAugmentors()},byStore:oe,handleKey:function(t){var e=t.target&&t.target.tagName||"",n=e==="INPUT"||e==="TEXTAREA"||e==="SELECT"||t.target&&t.target.isContentEditable;Object.keys(dt).forEach(function(s){var r=dt[s].manifest;Ae(s)&&(r.shortcuts||[]).forEach(function(o){if(!(!o||!o.key||typeof o.run!="function")){var i=o.key.toLowerCase().split("+"),a=i.indexOf("ctrl")>=0,l=i.indexOf("alt")>=0,u=i.indexOf("shift")>=0,p=i.indexOf("meta")>=0,d=i[i.length-1],f=!!t.ctrlKey===a&&!!t.altKey===l&&!!t.shiftKey===u&&!!t.metaKey===p&&String(t.key||"").toLowerCase()===d;if(f&&!(!a&&!l&&!p&&n)){t.preventDefault();try{o.run(vt(s),t)}catch(w){wt(s,"快捷键错误："+(w.message||w),"error")}}}})})},bootstrap:function(){oe().forEach(function(t){if(!(!t.enabled||!t.source))try{D._replaySource(t.source)}catch(e){wt(t.id,"启动重放失败："+(e.message||e),"error")}});try{D.syncAugmentors()}catch{}}};window.PluginBus=D;typeof document<"u"&&document.addEventListener&&(document.addEventListener("keydown",function(t){try{D.handleKey(t)}catch{}},!0),document.addEventListener("store:change",function(t){try{D._onStoreUpdate(t&&t.detail)}catch{}}));P&&M&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",function(){try{D.bootstrap()}catch{}}):setTimeout(function(){try{D.bootstrap()}catch{}},0));const Nr="kaoyan2026_layout",Lr=900;function Yi(){try{const t=localStorage.getItem(Nr);return t==="phone"||t==="workbench"?t:"auto"}catch{return"auto"}}const He=et(Yi());function Zi(){try{return window.innerWidth>=Lr}catch{return!1}}function ce(){return He.value==="workbench"?"workbench":He.value==="phone"?"phone":Zi()?"workbench":"phone"}function is(t,e){try{const n=document.documentElement;e&&(n.classList.add("layout-anim"),setTimeout(()=>n.classList.remove("layout-anim"),400)),t==="workbench"?n.setAttribute("data-layout","workbench"):n.removeAttribute("data-layout")}catch{}}is(ce(),!1);let un=ce();try{const t=window.matchMedia("(min-width: "+Lr+"px)"),e=()=>{if(He.value!=="auto")return;const n=ce();n!==un&&(un=n,is(n,!0))};t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e)}catch{}function Cr(){const t=C(()=>He.value),e=C(()=>ce()),n=C(()=>ce()==="workbench");function s(o){He.value=o;try{localStorage.setItem(Nr,o)}catch{}un=ce(),is(un,!0)}function r(){s(ce()==="workbench"?"phone":"workbench")}return{pref:t,effective:e,isWorkbench:n,set:s,toggle:r}}let Ft=null;function Ks(t){Ft=t}function ta(){const t={go(s){const r=window.FocusModule;if(r&&r.active){X.show("深度专注进行中，请先点「中断专注」结束再切换","warn",3500);return}kt.push(Ut(s))},refresh(){Ft&&Ft()},get current(){const s=kt.currentRoute.value;return String(s.params.id||s.name||"dashboard")}};window.App=t;const e=vn();window.Theme={get:()=>e.pref.value,current:()=>e.theme.value,isNight:()=>e.isNight.value,isMorning:()=>e.isMorning.value,set:s=>{e.set(s),Ft&&Ft()},toggle:()=>{e.toggle(),Ft&&Ft()},cycle:()=>{e.cycle(),Ft&&Ft()}};const n=Cr();window.Layout={get:()=>n.pref.value,effective:()=>n.effective.value,isWorkbench:()=>n.isWorkbench.value,set:s=>{n.set(s)},toggle:()=>{n.toggle()}}}function as(t,e){try{const n=window,s=n.__ERR_LOG__=n.__ERR_LOG__||[];s.unshift({at:new Date().toISOString(),msg:String(t||""),stack:String(e||"").slice(0,800)}),s.length>20&&(s.length=20)}catch{}}function ea(){const t=window,e=[];e.push("=== KaoYan 诊断报告 "+new Date().toISOString()+" ===");try{e.push("UA: "+navigator.userAgent)}catch{}try{const s=navigator.serviceWorker;e.push("SW: "+(s&&s.controller?String(s.controller.scriptURL).split("/").pop():"无控制页（未注册或首启）"))}catch{e.push("SW: 环境不可用")}try{e.push("IDB主存: "+(t.Store&&t.Store.isIdbPrimary?t.Store.isIdbPrimary()?"是（重数据在 IndexedDB）":"否（降级 localStorage）":"未知"))}catch{}try{let s=0;for(let r=0;r<localStorage.length;r++){const o=localStorage.key(r);s+=o.length+(localStorage.getItem(o)||"").length}e.push("localStorage: "+Math.round(s/1024)+" KB / ~5MB")}catch{}try{t.Store&&t.Store.usageBytes&&e.push("Store占用(usageBytes): "+Math.round(t.Store.usageBytes()/1024)+" KB")}catch{}try{e.push("已装插件: "+(t.PluginBus&&t.PluginBus.byStore?t.PluginBus.byStore().length:0)+" 件")}catch{}const n=Array.isArray(t.__ERR_LOG__)?t.__ERR_LOG__:[];return e.push("--- 最近错误 "+n.length+" 条 ---"),n.forEach(function(s,r){e.push("["+(r+1)+"] "+s.at+" "+s.msg),s.stack&&e.push(String(s.stack).split(`
`).slice(0,3).join(`
`))}),n.length||e.push("(无)"),e.join(`
`)}const rh=Object.freeze(Object.defineProperty({__proto__:null,buildDiagnosticsReport:ea,pushErrLog:as},Symbol.toStringTag,{value:"Module"})),na={hidden:""},Vs=ot({__name:"LegacyPage",setup(t){const e=Xn(),n=Qn(),s={dashboard:"DashboardModule",scheduler:"SchedulerModule",review:"ReviewModule",photomistake:"PhotoMistakeModule",quiz:"QuizModule",essay:"EssayModule",mistakes:"MistakesModule",heatmap:"HeatmapModule",inspector:"InspectorModule",focus:"FocusModule",concept:"ConceptMapModule",sprint:"SprintModule",decision:"DecisionModule",mental:"MentalModule",reading:"ReadingModule",wordbook:"WordbookModule",polrecite:"PolReciteModule",redline:"RedlineModule",progress:"ProgressModule",plugins:"PluginCenterModule",share:"SharePlazaModule",vizai:"VizAiModule",settings:"SettingsModule"};function r(){return String(e.params.id||e.name||"dashboard")}function o(){return document.getElementById("view")}function i(){const w=o();return{v:w?w.scrollTop:0,w:window.scrollY||window.pageYOffset||0}}function a(w){const v=o();w?(v&&(v.scrollTop=w.v),window.scrollTo(0,w.w)):(v&&(v.scrollTop=0),window.scrollTo(0,0))}const l={};Lo(()=>{l[r()]=i()});function u(w){const v=new Map;return w.querySelectorAll("details[open]").forEach(y=>{const h=y.querySelector("summary");if(!h)return;const g=h.textContent.trim();v.set(g,(v.get(g)||0)+1)}),v}function p(w,v){w.size&&v.querySelectorAll("details").forEach(y=>{const h=y.querySelector("summary");if(!h)return;const g=h.textContent.trim(),A=w.get(g);A&&A>0&&(y.open=!0,A===1?w.delete(g):w.set(g,A-1))})}function d(w){const v=o();if(!v)return;const y=r(),h=!!(w&&w.preserveUi),g=h?u(v):null,A=h?i():void 0,L=s[y],E=(L?window[L]:null)||f(y);if(!E||typeof E.render!="function"){if(!window.__LEGACY_ALL__){v.innerHTML='<div class="card"><div class="empty">⏳ 模块加载中…（后台补齐中，片刻即好）</div></div>',window.addEventListener("legacy:rest-loaded",()=>{if(r()===y)try{d(w)}catch{}},{once:!0});return}n.replace("/dashboard");return}v.innerHTML="";try{E.render(v)}catch(O){const T=O&&(O.message||String(O))||"未知渲染错误",q=O&&O.stack?String(O.stack):"";v.innerHTML='<div class="card"><div class="card-title" style="color:var(--danger)">⚠️ 「'+M.esc(y)+'」模块加载失败</div><div class="muted-sm" style="margin:8px 0;word-break:break-all">'+M.esc(T)+"</div>"+(q?'<details style="margin-top:6px"><summary class="muted-sm" style="cursor:pointer">📄 详细堆栈（截图反馈）</summary><pre class="report" style="font-size:11px;white-space:pre-wrap;max-height:260px;overflow:auto;margin-top:6px">'+M.esc(q)+"</pre></details>":"")+'<div class="btn-row" style="margin-top:12px"><button class="btn btn-sm btn-primary" id="pgerr-reload">🔄 重试</button><button class="btn btn-sm btn-ghost" id="pgerr-home">返回作战台</button></div></div>';const I=v.querySelector("#pgerr-reload");I&&(I.onclick=()=>{try{d(w)}catch{}});const N=v.querySelector("#pgerr-home");N&&(N.onclick=()=>n.replace("/dashboard")),console.error("[LegacyPage] 模块渲染失败:",y,O),as("[render] "+y+": "+T,q)}v.querySelector('div[data-pg-slot="top"]')||v.insertAdjacentHTML("afterbegin",'<div data-pg-slot="top" class="pg-slot"></div>'),v.querySelector('div[data-pg-slot="bottom"]')||v.insertAdjacentHTML("beforeend",'<div data-pg-slot="bottom" class="pg-slot"></div>');try{D._onPageRendered(v,y)}catch{}h&&g&&p(g,v),v.querySelectorAll(".pbar-fill").forEach(O=>{requestAnimationFrame(()=>{O.style.width=O.getAttribute("data-w")+"%"})}),h&&A&&a(A)}qe(()=>e.fullPath,async()=>{await tn();const w=r();d(),a(l[w])}),he(()=>{Ks(()=>d({preserveUi:!0})),d()}),rr(()=>Ks(null));function f(w){try{const v=D.tools();for(const h of v)if(h.id===w)return{render(g){const A=D.ctxOf?D.ctxOf(h.pid):{};if(g.innerHTML='<div class="card"><div class="card-title-row"><span class="card-title">'+(h.icon||"🧩")+" "+window.U.esc(h.title)+`</span><button class="btn btn-ghost btn-sm" onclick="App.go('__tools')">← 工具</button></div><div class="muted-sm" style="margin-bottom:8px">插件：`+window.U.esc(h.pid)+'</div></div><div class="plugin-tool-body">'+(typeof h.render=="function"&&h.render(A)||"")+"</div>",typeof h.mount=="function"){const L=g.querySelector(".plugin-tool-body");if(L)try{h.mount(L,A)}catch(E){L.innerHTML='<div class="alert alert-danger">插件渲染失败：'+window.U.esc(E.message||E)+"</div>"}}}};const y=D.maintabs();for(const h of y)if(h.id===w)return{render(g){const A=D.ctxOf?D.ctxOf(h.pid):{};try{h.render(A,g)}catch(L){g.innerHTML='<div class="alert alert-danger">插件主 tab 渲染失败：'+window.U.esc(L.message||L)+"</div>"}}}}catch{}return null}return(w,v)=>(b(),_("div",na))}}),sa=["innerHTML"],Cn=ot({__name:"TexText",props:{source:{}},setup(t){const e=t,n=C(()=>Ne.renderInline(e.source||""));return(s,r)=>(b(),_("span",{class:"tex-text",innerHTML:n.value},null,8,sa))}}),ra={class:"card",style:{"margin-top":"24px"},"data-testid":"aitools-page"},oa={class:"card-title-row"},ia={class:"btn-row",style:{margin:"8px 0"}},aa=["disabled"],la={key:0,style:{margin:"8px 0"},"data-testid":"dl-progress"},ca={class:"pbar",style:{height:"12px",background:"var(--surface-muted)"}},ua={class:"muted-sm",style:{"margin-top":"4px","font-variant-numeric":"tabular-nums"}},da={key:1,class:"muted-sm",style:{"white-space":"pre-wrap","font-size":"12px"},"data-testid":"dl-logs"},pa={key:2,style:{"margin-top":"14px"},class:"card-inner","data-testid":"at-res"},fa={style:{flex:"1"}},ha={class:"chip",style:{"font-size":"11px"}},ga={class:"muted-sm",style:{width:"64px","text-align":"right"}},ma={class:"btn-row",style:{"margin-top":"8px"}},ya=["disabled"],va={key:0,class:"muted-sm",style:{"white-space":"pre-wrap","font-size":"12px"},"data-testid":"at-res-logs"},ba={style:{"margin-top":"14px"},class:"card-inner","data-testid":"at-chat"},wa={class:"card-title-row"},ka={style:{"max-height":"460px",overflow:"auto",margin:"6px 0"}},_a={key:0,style:{"text-align":"right"}},Sa={class:"chip",style:{"white-space":"pre-wrap"}},xa={key:1},Aa=["open"],Ea={class:"muted-sm",style:{cursor:"pointer"}},Ta={class:"report",style:{"font-size":"12px"}},Ia={class:"report",style:{"font-size":"12px",opacity:".8"}},Oa=["src"],Ma={key:1,style:{"margin-top":"4px"}},Pa={key:0,class:"muted-sm"},Na={key:1,class:"muted-sm"},La={style:{display:"flex",gap:"8px","align-items":"flex-end"}},Ca=["disabled"],ja={style:{"margin-top":"14px"},class:"card-inner"},qa={class:"btn-row",style:{margin:"8px 0"}},Da=["disabled"],Ra=["open"],Ba={class:"muted-sm",style:{cursor:"pointer"}},Ja={key:0,class:"report",style:{"font-size":"12px"}},Ga={key:1,class:"report",style:{"font-size":"12px",opacity:".8"}},Ha={key:2},za={key:0,class:"card",style:{"margin-top":"8px"},"data-testid":"at-report"},$a={style:{"margin-top":"4px"}},Ua=ot({__name:"AiToolsPage",setup(t){const e=C(()=>ve.enabled()),n=[{k:"runtime",name:"Pyodide 运行时（内核 + 标准库）",size:"≈10MB",core:!0},{k:"numpy",name:"numpy（数值计算）",size:"≈7MB",core:!0},{k:"sympy",name:"sympy（符号验算核心）",size:"≈11MB",core:!0},{k:"mpl",name:"matplotlib（精确画图）",size:"≈9MB",core:!1},{k:"font",name:"SimHei 中文字体（图内中文）",size:"≈4.7MB",core:!1},{k:"scipy",name:"scipy（数值积分/优化，按需）",size:"≈12MB",core:!1}],s=Cs({runtime:!1,numpy:!1,sympy:!1,mpl:!1,font:!1,scipy:!1}),r=et(!1),o=et(!1),i=et([]);async function a(){try{const R=await $o();Object.assign(s,R),r.value=!0}catch{}}async function l(){if(!o.value){o.value=!0,i.value=[];try{await Uo(R=>{i.value.push(R)}),i.value.push("✅ 画图组件就绪——出题配图零等待")}catch(R){i.value.push("✗ "+String(R?.message||R))}finally{o.value=!1,await a()}}}qe(()=>Et.status,R=>{R==="ready"&&(a(),setTimeout(()=>{a()},4e3))},{immediate:!0});const u=et([]),p=et(!1);async function d(){p.value=!0,u.value=[];try{await ve.ensureLoaded(R=>{u.value.push(R)}),u.value.push("✅ 就绪")}catch(R){u.value.push("✗ "+String(R?.message||R))}finally{p.value=!1}}function f(){ve.setEnabled(!e.value)}const w=Cs({stem:"",answer:"",solution:""}),v=C(()=>qs.running),y=C(()=>qs.steps),h=et(""),g=et(""),A=et(!1);async function L(){if(v.value)return;h.value="",g.value="",A.value=!1;const R=await ve.verifyAnswer(w.stem,w.answer,w.solution,{isCancelled:()=>A.value});h.value=R.finalText,g.value=R.verdict}function E(){A.value=!0}const O=Fo,T=et("");let q=!1;function I(){if(O.running||!T.value.trim())return;q=!1;const R=T.value;T.value="",Ko(R,()=>q),tn(()=>{const B=document.querySelector('[data-testid="at-chat"] > div:nth-child(3)');B&&(B.scrollTop=B.scrollHeight)})}function N(){q=!0}return(R,B)=>(b(),_("div",ra,[c("div",oa,[B[6]||(B[6]=c("span",{class:"card-title"},[Z("🧪 AI 工程台 "),c("span",{class:"muted-sm"},"（实验功能）")],-1)),c("span",{class:"chip",style:Vt(W(Et).status==="ready"?"color:#237804":"")},k(W(Et).status==="ready"?"组件就绪":W(Et).status==="loading"?"下载中…":W(Et).status==="error"?"组件加载失败":"组件未下载"),5)]),B[15]||(B[15]=c("div",{class:"muted-sm",style:{"margin-bottom":"8px"}},[Z(" 给 AI 增加真实工程能力：多轮调用 Python（numpy/sympy）做符号验算、数值抽查、画图。 两套方案自由选择："),c("b",null,"不启用 = 与现有完全一致"),Z("（零下载零差异）；启用后仅本页与设置页入口生效。 ")],-1)),c("div",ia,[c("button",{class:tt(["btn btn-sm",e.value?"btn-primary":"btn-ghost"]),"data-testid":"at-toggle",onClick:f},k(e.value?"✓ 已启用（点击停用）":"方案A：启用工程能力"),3),e.value?(b(),_("button",{key:0,class:"btn btn-sm btn-ghost","data-testid":"at-download",disabled:p.value||W(Et).status==="ready",onClick:d},k(W(Et).status==="ready"?"组件已就绪":p.value?"下载中…":"下载扩展组件（约10MB，仅一次）"),9,aa)):z("",!0)]),p.value?(b(),_("div",la,[c("div",ca,[c("div",{style:Vt([{height:"100%","border-radius":"999px",transition:"width .3s",background:"linear-gradient(90deg,#2f54eb,#7aa2ff)",width:"0%"},{width:W(Et).progress.pct+"%"}])},null,4)]),c("div",ua,k(W(Et).progress.pct)+"% · "+k(W(Et).progress.msg||"准备下载…"),1)])):z("",!0),u.value.length?(b(),_("div",da,k(u.value.join(`
`)),1)):z("",!0),e.value?(b(),_("div",pa,[c("div",{class:"card-title-row"},[B[7]||(B[7]=c("span",{class:"card-title"},"📦 组件资源管理",-1)),c("button",{class:"btn btn-ghost btn-sm","data-testid":"at-res-refresh",onClick:a},"↻ 刷新状态")]),B[8]||(B[8]=c("div",{class:"muted-sm",style:{"margin-bottom":"6px"}}," 基础组件随首次下载安装；画图组件默认「首次画图时按需下载」——重度可视化用户可点「预载」提前装好，出题配图零等待。 装过即记忆：重启后自动从缓存后台恢复，无需手动操作。 ",-1)),(b(),_(H,null,Q(n,$=>c("div",{key:$.k,style:{display:"flex","align-items":"center",gap:"8px",padding:"5px 0","border-bottom":"1px solid var(--line)","font-size":"12.5px"}},[c("span",fa,[Z(k($.name)+" ",1),c("span",ha,k($.core?"基础":"画图"),1)]),c("span",ga,k($.size),1),c("span",{style:Vt([{width:"84px","text-align":"right","font-weight":"600"},s[$.k]?"color:#237804":"opacity:.55"])},k(r.value?s[$.k]?"✓ 已装载":"未装载":W(Et).status==="ready"?"查询中…":"未下载"),5)])),64)),c("div",ma,[c("button",{class:"btn btn-sm btn-primary",disabled:o.value||W(Et).status!=="ready","data-testid":"at-res-preload",onClick:l},k(o.value?"⏳ 预载中…":"🎨 预载画图组件（matplotlib + 中文字体 ≈14MB）"),9,ya)]),i.value.length?(b(),_("div",va,k(i.value.join(`
`)),1)):z("",!0)])):z("",!0),e.value?(b(),_(H,{key:3},[c("div",ba,[c("div",wa,[B[9]||(B[9]=c("span",{class:"card-title"},"💬 工程对话（AI 自主编排工具）",-1)),c("button",{class:"btn btn-ghost btn-sm","data-testid":"at-chat-reset",onClick:B[0]||(B[0]=(...$)=>W(Ds)&&W(Ds)(...$))},"清空会话")]),B[10]||(B[10]=c("div",{class:"muted-sm",style:{"margin-bottom":"6px"}}," 像网页端 AI 平台一样问一句话，AI 连续自主调用 Python（验算/画图/数据处理）后作答。会话在本页驻留。 ",-1)),c("div",ka,[(b(!0),_(H,null,Q(W(O).items,($,V)=>(b(),_("div",{key:V,style:{margin:"8px 0"}},[$.role==="user"?(b(),_("div",_a,[c("span",Sa,k($.text),1)])):(b(),_("div",xa,[(b(!0),_(H,null,Q($.steps,(it,At)=>(b(),_("details",{key:At,style:{margin:"4px 0"},open:At===$.steps.length-1&&!$.text},[c("summary",Ea,"第 "+k(At+1)+" 次工具 · Python "+k(it.error?"❌":"✓"),1),c("pre",Ta,k(it.code),1),c("pre",Ia,[Z("输出："+k(it.output||"(无)"),1),it.error?(b(),_(H,{key:0},[Z(k(`
`)+"错误："+k(it.error),1)],64)):z("",!0)])],8,Aa))),128)),$.image?(b(),_("img",{key:0,src:$.image,style:{"max-width":"100%",border:"1px solid var(--line)","border-radius":"8px",margin:"4px 0"},alt:"AI 生成图表"},null,8,Oa)):z("",!0),$.text?(b(),_("div",Ma,[ct(Cn,{source:$.text},null,8,["source"])])):z("",!0)]))]))),128)),W(O).running?(b(),_("div",Pa,"⚙️ AI 正在自主安排工具调用…（可取消）")):z("",!0),W(O).items.length?z("",!0):(b(),_("div",Na,"试试：「帮我验证 ∫₀¹ xeˣdx 的答案是 e+1 是否正确」或「画一张标准正态分布曲线」"))]),c("div",La,[Qt(c("textarea",{"onUpdate:modelValue":B[1]||(B[1]=$=>T.value=$),class:"input",rows:"2",style:{flex:"1"},placeholder:"一句话交给 AI，它会自主决定是否调用 Python…（Ctrl+Enter 发送）","data-testid":"at-chat-input",onKeydown:B[2]||(B[2]=Wn(en($=>I(),["ctrl"]),["enter"]))},null,544),[[ye,T.value]]),W(O).running?(b(),_("button",{key:1,class:"btn btn-ghost",onClick:N},"取消")):(b(),_("button",{key:0,class:"btn btn-primary","data-testid":"at-chat-send",disabled:!T.value.trim(),onClick:I},"发送",8,Ca))])]),c("div",ja,[B[11]||(B[11]=c("div",{class:"card-title-row"},[c("span",{class:"card-title"},"🔎 答案真实验算（sympy 独立重解 + 数值抽查）")],-1)),B[12]||(B[12]=c("label",{class:"muted-sm"},"题干",-1)),Qt(c("textarea",{"onUpdate:modelValue":B[3]||(B[3]=$=>w.stem=$),class:"input",rows:"2",placeholder:"例：计算 ∫₀¹ x·eˣ dx",style:{width:"100%"}},null,512),[[ye,w.stem]]),B[13]||(B[13]=c("label",{class:"muted-sm"},"给出的答案",-1)),Qt(c("textarea",{"onUpdate:modelValue":B[4]||(B[4]=$=>w.answer=$),class:"input",rows:"2",placeholder:"例：e − 1 ≈ 1.718",style:{width:"100%"}},null,512),[[ye,w.answer]]),B[14]||(B[14]=c("label",{class:"muted-sm"},"解析（可选）",-1)),Qt(c("textarea",{"onUpdate:modelValue":B[5]||(B[5]=$=>w.solution=$),class:"input",rows:"2",placeholder:"分部积分过程…",style:{width:"100%"}},null,512),[[ye,w.solution]]),c("div",qa,[c("button",{class:"btn btn-primary","data-testid":"at-verify",disabled:v.value||W(Et).status!=="ready",onClick:L},k(v.value?"验算中…":"⚡ 开始真实验算"),9,Da),v.value?(b(),_("button",{key:0,class:"btn btn-ghost",onClick:E},"取消")):z("",!0)]),(b(!0),_(H,null,Q(y.value,($,V)=>(b(),_("div",{key:V,style:{margin:"6px 0"}},[c("details",{open:$.type==="exec"&&V===y.value.length-1},[c("summary",Ba," 第 "+k($.round)+" 轮 · "+k($.type==="exec"?"执行 Python"+($.error?" ❌":" ✓"):"最终结论"),1),$.code?(b(),_("pre",Ja,k($.code),1)):z("",!0),$.output!==void 0?(b(),_("pre",Ga,[Z("输出："+k($.output||"(无)"),1),$.error?(b(),_(H,{key:0},[Z(k(`
`)+"错误："+k($.error),1)],64)):z("",!0)])):z("",!0),$.type==="final"?(b(),_("div",Ha,[ct(Cn,{source:$.text||""},null,8,["source"])])):z("",!0)],8,Ra)]))),128)),h.value?(b(),_("div",za,[c("b",{style:Vt(g.value==="通过"?"color:#237804":g.value==="不通过"?"color:#cf1322":"")},k(g.value?"验算结论："+g.value:"结论"),5),c("div",$a,[ct(Cn,{source:h.value},null,8,["source"])])])):z("",!0)])],64)):z("",!0)]))}}),Fa={class:"card",style:{"margin-top":"24px"},"data-testid":"prompt-studio-page"},Ka={class:"card-title-row"},Va=["disabled"],Qa={class:"ps-live","data-testid":"ps-live-strip"},Xa={class:"chip"},Wa={class:"chip"},Ya={class:"chip"},Za={class:"chip"},tl={class:"chip"},el={class:"chip"},nl={class:"chip"},sl={style:{display:"flex",gap:"8px","align-items":"center",margin:"10px 0","flex-wrap":"wrap"}},rl={class:"seg-row",style:{margin:"0"}},ol=["placeholder"],il={class:"card-inner","data-testid":"ps-lanes"},al={style:{display:"flex","align-items":"baseline",gap:"8px","flex-wrap":"wrap"}},ll={style:{"font-size":"18px"}},cl={style:{"font-size":"13.5px"}},ul={class:"muted-sm",style:{"font-size":"11px"}},dl={key:0,class:"chip chip-warn",style:{"font-size":"10px"}},pl={class:"muted-sm",style:{"font-size":"12px",margin:"3px 0"}},fl={class:"ps-facts"},hl={class:"card-inner",style:{"margin-top":"12px"},"data-testid":"ps-flow"},gl={style:{"font-size":"20px",flex:"0 0 auto","line-height":"1.4"}},ml={style:{flex:"1","border-left":"3px solid var(--line)","padding-left":"10px"}},yl={style:{"font-size":"13px"}},vl={class:"muted-sm",style:{"font-size":"12px","margin-top":"2px"}},bl={class:"card-inner",style:{"margin-top":"12px"},"data-testid":"ps-chains"},wl={style:{"font-size":"12.5px","min-width":"170px"}},kl={class:"chip",style:{"font-size":"11px"}},_l={key:0,class:"muted-sm"},Sl={class:"card-inner",style:{"margin-top":"12px"},"data-testid":"ps-frag"},xl={style:{"font-size":"13px"}},Al={class:"muted-sm",style:{"font-size":"12px",margin:"2px 0"}},El={key:1,class:"card-inner","data-testid":"ps-registry-table"},Tl={class:"card-title-row"},Il={class:"muted-sm",style:{"font-size":"11px"}},Ol={class:"ps-reg-group"},Ml={style:{flex:"1","min-width":"150px"}},Pl={style:{"font-size":"12.5px"}},Nl={class:"muted-sm",style:{"font-size":"10.5px","margin-left":"6px"}},Ll={class:"muted-sm",style:{"font-size":"11px"}},Cl={class:"chip",style:{"font-size":"11px",flex:"none"}},jl={class:"chip",style:{"font-size":"11px",flex:"none"}},ql={class:"chip",style:{"font-size":"11px",flex:"none"}},Dl=["onClick"],Rl={key:0,class:"empty"},Bl={class:"card-inner","data-testid":"ps-coach-flow"},Jl={style:{"font-size":"18px",flex:"0 0 auto","line-height":"1.5"}},Gl={style:{flex:"1","border-left":"3px solid var(--line)","padding-left":"10px"}},Hl={style:{"font-size":"13px"}},zl={class:"muted-sm",style:{"font-size":"12px","margin-top":"2px"}},$l={class:"card-inner",style:{"margin-top":"12px"}},Ul={class:"muted-sm",style:{"font-size":"12px","line-height":"2"}},Fl={class:"card-inner","data-testid":"ps-aug-list"},Kl={class:"card-title-row"},Vl={class:"muted-sm",style:{"font-size":"11px"}},Ql={style:{flex:"1","min-width":"150px"}},Xl={style:{"font-size":"12.5px"}},Wl={class:"muted-sm",style:{"font-size":"11px"}},Yl={class:"chip",style:{"font-size":"11px"}},Zl={class:"chip",style:{"font-size":"11px"}},tc={key:0,class:"empty"},ec={class:"card-inner",style:{"margin-top":"12px"},"data-testid":"ps-trace"},nc={class:"card-title-row"},sc={class:"card-title"},rc={key:0,class:"empty"},oc={class:"ps-trace-time"},ic={class:"muted-sm"},ac={key:0,class:"chip chip-think",style:{"font-size":"10px"}},lc={key:1,class:"chip",style:{"font-size":"10px"}},cc={key:2,class:"chip",style:{"font-size":"10px"}},uc={key:3,class:"muted-sm",style:{"font-size":"11px"}},dc={key:4,class:"muted-sm",style:{"font-size":"11px"}},pc={key:5,class:"chip chip-ov",style:{"font-size":"10px"}},fc={key:6,class:"chip chip-warn",style:{"font-size":"10px"}},hc={class:"card-inner","data-testid":"ps-globals"},gc={class:"card-title-row"},mc={class:"muted-sm",style:{"font-size":"11px"}},yc={style:{display:"flex","align-items":"center",gap:"8px","flex-wrap":"wrap"}},vc={style:{"font-size":"13px"}},bc={class:"chip",style:{"font-size":"11px"}},wc={class:"muted-sm",style:{"font-size":"11px"}},kc=["onClick"],_c={style:{"font-size":"11.5px","white-space":"pre-wrap","max-height":"280px",overflow:"auto",margin:"6px 0 0"}},Sc={key:0,style:{"margin-top":"8px","border-top":"1px dashed var(--line)","padding-top":"6px"}},xc={style:{flex:"0 0 auto"}},Ac={style:{flex:"0 0 118px"}},Ec={class:"muted-sm",style:{flex:"1"}},Tc={key:0,class:"empty"},Ic={class:"card-inner",style:{"margin-top":"14px"},"data-testid":"ps-modules"},Oc={class:"card-title-row"},Mc={class:"muted-sm",style:{"font-size":"11px"}},Pc={style:{display:"flex","align-items":"center",gap:"8px","flex-wrap":"wrap"}},Nc={style:{"font-size":"13px"}},Lc={class:"chip",style:{"font-size":"11px"}},Cc={key:0,class:"muted-sm",style:{"font-size":"11px"}},jc={class:"muted-sm",style:{"font-size":"11px"}},qc=["onClick"],Dc={key:0,style:{"font-size":"11.5px","white-space":"pre-wrap","max-height":"280px",overflow:"auto",margin:"6px 0 0"}},Rc={key:1,class:"alert alert-danger",style:{margin:"6px 0 0","font-size":"12px"}},Bc={key:2,style:{"margin-top":"8px","border-top":"1px dashed var(--line)","padding-top":"6px"}},Jc={style:{flex:"0 0 auto"}},Gc={style:{flex:"0 0 118px"}},Hc={class:"muted-sm",style:{flex:"1"}},zc={key:0,class:"empty"},$c=ot({__name:"PromptStudioPage",setup(t){const e=et("map"),n=et(!0),s=et(""),r=et([]),o=et([]),i=et(""),a=et(0),l=C(()=>{a.value;const F=P.get(),S=F.ai||{};let x={};try{x=K.activeApi()||{}}catch{}let G={};try{G=K.cacheStats()||{}}catch{}let U={};try{U=window.AiMemory&&window.AiMemory.stats()||{}}catch{}const nt=window.AiTools;let bt=0;try{bt=window.PluginBus&&window.PluginBus.skills&&window.PluginBus.skills().length||0}catch{}let me=0;try{const Gt=F.copilotChats||{};me=Object.keys(Gt).reduce(function(Po,No){return Po+(Gt[No]||[]).length},0)}catch{}let Ps="auto",Ns="json",Ls="unknown";try{Ps=String(S.toolProto||"auto")}catch{}try{Ns=Vo()}catch{}try{Ls=x.fc===!0?"yes":x.fc===!1?"no":"unknown"}catch{}return{protoMode:Ps,protoEff:Ns,apiFc:Ls,apiName:x.name||"",apiModel:x.model||"",apiEp:String(x.endpoint||"").replace(/^https?:\/\//,"").slice(0,34),configured:!!(x.model&&x.key&&x.endpoint),apisN:(S.apis||[]).length,cacheEntries:G.entries||0,cacheHits:G.hits||0,cacheKb:G.kb||0,memFacts:U.facts||0,memPinned:U.pinned||0,memAi:U.aiFacts||0,engEnabled:!!(nt&&nt.enabled&&nt.enabled()),engReady:!!(nt&&nt.isReady&&nt.isReady()),skillsN:bt,chatsN:me,globalThink:S.thinkingMode===!0?"开":S.thinkingMode===!1?"关":"未设",globalTok:S.maxTokens||0,globalTemp:typeof S.temperature=="number"?S.temperature:null,modes:S.moduleModes||{},toks:S.moduleToks||{},temps:S.moduleTemps||{}}}),u=[{icon:"🌊",name:"本地流式（SSE）",on:!0,route:"chatJSON / chatStream / chatMessagesStream → chatStreamOnce",who:"全站绝大多数调用：出题/判卷/押题组卷/查重/格式修复/提取/教练/可视化…（注册表 43 条几乎全走这条）",facts:["body 带 stream:true + include_usage；响应头先到即算连接正常，30s 超时只管「连不上」，生成可跑几分钟（带图放宽 90s）","reasoning_content 双轨：思考流与正文分开回调（教练 💭 思考条 / 判卷思考区的数据源）","400 两级降级：先去 stream_options 再退极简非流式——不支持 SSE 的厂商自动兜底","chatJSON = 流式收完 → extractRobustJSON 六层容错提取"]},{icon:"📦",name:"本地非流式（rawChat）",on:!0,route:"AI.chat → rawChatOnce（整包 JSON 响应）",who:"仅广场一次性调用（shareAI）+ 任何请求 400 后的极简重试临时落到这条",facts:["30s 超时覆盖整个生成过程——长输出必死，这就是重任务全走流式的原因","思考决策：逐功能 moduleModes 优先，未配置才回退「显式 noThink > 全局开关 > 省略」(rawChatThinkKwArgs，2026-09-09 已修复此前忽略单模块配置的缺陷)","温度：决策链命中即发，未配置保持历史默认 0.6"]},{icon:"🧪",name:"AI 工程台（Python 工具循环）",on:C(()=>l.value.engEnabled),route:"toolsBridge 门卫 → toolChat 多轮循环；教练面板另走 newCoachSession 直连",who:"启用后 chat/chatStream/chatJSON 自动转多轮；教练/出题/验算/画图可自主调 Python",facts:['JSON 协议：模型输出 {"tool":"python_exec","code":…} → pyodide 真执行 → stdout/图表回传 → 下一轮；≤8 轮封顶','streamClass 分类器：工具轮/结构化 {"final":…} JSON 不上屏，最终回答轮流式喂 UI（思考流全程透传）',"教练 UI：打字机 + 💭 思考条 + 行级步骤卡（liveSteps 会话留存）","晚绑定 window.AiTools 防 core→extensions 循环依赖；未启用零差异","【双协议路由】工具调用方式可选 自研 JSON 协议（全兼容兜底）/ 平台原生 function calling（探测确认 .fc=true 才启用）——协议差异收口在 proto.ts 适配器，agent 循环与 UI 零协议感知；探测入口：设置 → 工程台 → 🔍探测当前接口"]},{icon:"☁️",name:"云端 runner（GitHub Actions）",on:!0,route:"CloudJob 提交 → ai-exam-runner.cjs（v31）→ secret gist 中转 → 收卷",who:"智能出卷（并行出题员/总审查/重写）、导入整卷、资料库整本提取（S0 探测→R1 书签→R2 页脚→R3/R4 目录→R4b 宫格→R5 兜底）",facts:["非流式一次性请求（自带 temperature 默认 0.7），跑在用户自己的 Actions 里，BYOK","断点续跑：每步落盘 gist status.json，崩溃从 checkpoint 恢复","收卷两段式：预览确认（逐题可修订）才入库——防幻觉的人工闸门","与本地链路完全独立：不占浏览器、可关页"]}],p=[{icon:"🚀",t:"① 模块发起",d:"chatStream / chatJSON / chatMessagesStream —— opts.ctx 自报身份（注册表见「调用注册表」页，CI 守门：新增 ctx 不注册→测试红）"},{icon:"🎛",t:"② 决策收口 normalizeOpts",d:"三链同构：单模块配置 > 调用方显式 > 全局默认 > 兜底。思考 resolveThink 五层 · maxTokens 四层 · 温度 resolveTemperature 四层（0~2，未配置=不干预）"},{icon:"🧠",t:"③ 提示词组装",d:"全局人格 / 模块指令 + 动态注入（记忆摘要 · 技能指令 · 识屏 PageCtx · 查询数据 · 用户参数）+ 共享片段（JSON_ONLY · SVG_DIAGRAM_SPEC）"},{icon:"🛠",t:"④ 传输",d:"缓存 cacheHash（命中即回，出题/教练类 cache:false 跳过）· toolsBridge 工程门卫 · withFailover 多接口故障切换 · SSE/非流式两通道"},{icon:"📥",t:"⑤ 解析与修复",d:"extractRobustJSON（围栏/括号配平/截断抢救）· repairJsonSafely · repairPipeLatex · 空正文三级降级（关思考→翻倍 token）"},{icon:"🖼",t:"⑥ 渲染终点",d:"结构化对象 → 模块状态 → 视图；文本 → Tex.renderInline → KaTeX 印刷体（.tx 1.21em 同标度兜底）→ 屏幕 main.css / 打印 txPrintCss+KaTeX 字体内嵌"}],d=[{icon:"🧠",name:"思考 resolveThink",chain:["单模块 moduleModes","显式 noThink/think","局部开关(卷 prefs/深度)","全局 thinkingMode","默认不思考"]},{icon:"📏",name:"maxTokens resolveMaxTokens",chain:["单模块 moduleToks","调用方显式","全局 s.ai.maxTokens","服务端默认"]},{icon:"🌡",name:"温度 resolveTemperature",chain:["单模块 moduleTemps","调用方显式","全局 s.ai.temperature","不干预(流式不发/非流式0.6)"]}],f=C(()=>{a.value;const F=l.value;return(K.AI_REGISTRY||[]).map(S=>{const x=[];F.modes[S.ctx]&&F.modes[S.ctx]!=="global"&&x.push("思考"+(F.modes[S.ctx]==="think"?"✓":"✗")),F.toks[S.ctx]&&x.push("tok"),typeof F.temps[S.ctx]=="number"&&x.push("temp");let G="",U="",nt="";try{G=K.resolveThink({ctx:S.ctx})?"思考":"不思考"}catch{G="?"}try{const bt=K.resolveMaxTokens({ctx:S.ctx});U=bt>0?String(bt):"默认"}catch{U="?"}try{const bt=K.resolveTemperature({ctx:S.ctx});nt=bt==null?"默认":String(bt)}catch{nt="?"}return{ctx:S.ctx,name:S.name,desc:S.desc,def:S.def==="think"?"默认思考":S.def==="noThink"?"默认不思考":"跟随全局",think:G,tok:U,temp:nt,ov:x}})}),w=C(()=>{const F=s.value.trim().toLowerCase(),S={};return f.value.forEach(x=>{if(F&&!(x.ctx+x.name+x.desc).toLowerCase().includes(F))return;const G=(K.AI_REGISTRY.find(U=>U.ctx===x.ctx)||{}).module||"其他";(S[G]=S[G]||[]).push(x)}),S}),v=C(()=>(K.AI_REGISTRY||[]).length),y=C(()=>f.value.filter(F=>F.ov.length).length),h=C(()=>{const F=l.value;return[{icon:"📥",t:"输入汇聚",d:"文本 Enter / 📷图片 / 📎附件 / 快捷问题 / 划词小牌；每条消息带最近 12 轮对话上下文"},{icon:"📍",t:"识屏 PageCtx",d:"DOM 直读当前页（≤40 条 × 400 字，超预算如实截断）：📍钉住每条都带；说「这道题/刚才」指代词自动带一次"},{icon:"🎯",t:"技能匹配 matchSkill",d:`PluginBus 技能库（当前 ${F.skillsN} 个）按触发词命中 → 技能指令注入 system；附件名也参与匹配`},{icon:"🧠",t:"systemPrompt 组装",d:`教练人格(coachProfile) + 当前专业课 + AiMemory 记忆摘要（已记住 ${F.memFacts} 条，AI 归纳 ${F.memAi}）+ 实时学习数据快照 + 动作协议（9 类接管工具）`},{icon:"🔀",t:"路由选择",d:F.engEnabled?"✅ 工程台已启用：newCoachSession 多轮 Python 循环（工具轮 JSON 屏弃、思考流+最终回答流式上屏、步骤卡留存）":"常规：agentLoop QUERY 多轮协议——教练输出 [[QUERY:]] → runQuery 本地查数据 → 回填继续（≤5 轮，无结果也逼回收口）"},{icon:"🌊",t:"流式传输",d:"SSE（cache:false 每次新鲜）；reasoning 与正文双轨回调"},{icon:"🖼",t:"渲染",d:"正文逐字打字机 + 💭 一行滚动思考条（点击展开完整思考流，会话级留存可回看）+ 动作按钮（低风险自动执行）+ 存为 Markdown"},{icon:"🧷",t:"后处理",d:"pushHistory(60 条) + 动作执行 + QUERY 结果回填历史 + reflectIfWorthy 值得才反思沉淀记忆 + 主动督学 superviseCheck（双时段节流，教练画像/全智能两档）"}]});function g(F){if(F==="*")return"全站";const S=(K.AI_REGISTRY||[]).find(x=>x.ctx===F);return S?S.module+" · "+S.name:F||"(无ctx)"}const A=C(()=>{a.value;try{return K.promptAugmentors&&K.promptAugmentors()||[]}catch{return[]}}),L=C(()=>{a.value;try{return K.traceList&&K.traceList()||[]}catch{return[]}});function E(){try{K.traceClear&&K.traceClear(),a.value++}catch{}}function O(F,S,x,G){const U=[{icon:"🧩",t:"system 组装",d:S},{icon:"🎛",t:"决策收口 normalizeOpts",d:"思考/最大token/温度三链同构：单模块 > 显式 > 全局 > 兜底",live:F},{icon:"🛠",t:"传输",d:"缓存（命中即回；出题类 cache:false 跳过）· 工具桥门卫（工程模式自动转多轮 Python）· 故障切换链（多接口 30s）· 流式 SSE"}];return G&&U.splice(3,0,{icon:"🧪",t:"沙箱执行",d:G}),U.push({icon:"📥",t:"解析与修复",d:"extractRobustJSON（代码围栏/括号配平/截断抢救）→ repairJsonSafely → repairPipeLatex"}),U.push({icon:"🖼",t:"渲染终点",d:x}),U}function T(F){try{const S=K.resolveThink({ctx:F})?"思考":"不思考",x=K.resolveMaxTokens({ctx:F}),G=K.resolveTemperature({ctx:F});return"当前生效："+S+" · maxTokens "+(x>0?x:"服务端默认")+" · 温度 "+(G??"默认")}catch{return""}}const q={"global.coach":{system:"教练人格 systemPrompt：教练画像(settings.coachProfile) + activeMajorName + memoryDigest(400)",dest:"copilot 对话底座（被 copilot 层二次组合）"},"quiz.gen":{system:"quizPrompt：出题官 + 记忆摘要(memBlock) + 考点/层级/薄弱参数 + JSON_ONLY + SVG_DIAGRAM_SPEC(按需)",dest:"quiz 对象 → formatStem → Tex.renderInline → KaTeX（作答页）",extra:"工程模式：出题前先 python_exec 算准标准答案"},"quiz.answer":{system:"JUDGE_PROMPT：阅卷官 + JSON_ONLY + 题面/作答/标准答案",dest:"判分 JSON → steps 采分点渲染（作答页/复盘）"},"copilot.review":{system:"DEEP_REVIEW_PROMPT：复盘教练 + activeMajor",dest:"全景快照(reportText 打包) → 深度复盘结构化输出"},"copilot.chat":{system:"systemPrompt：教练人格 + activeMajor + memoryDigest(500) + 实时快照 snapshot + 动作协议",dest:"copilot 气泡打字机 + 💭思考条 → renderContent → Tex/KaTeX；动作 parseActions 自动执行",extra:"技能指令 matchSkill / QUERY 数据 runQuery / 识屏 PageCtx 注入"},"word.mnemonic":{system:"mnemonicSystem：词根/联想/考研考点/搭配/易混 五件套契约",dest:"patchWord(mnemonic) → 词卡 mnemonicHtml（复习翻面）"},"word.example":{system:"exampleSystem：考研语境例句 12-20 词 + 中文翻译",dest:"patchWord(example/exampleCn) → 复习页词卡"},"word.confuse":{system:"易混词契约：3 个近形/近义/同根干扰词",dest:"patchWord(confuseList) → 看义选词干扰项（choiceHtml）"},"insp.gen":{system:"genSystem：方法卡契约（recognize/steps/pitfalls/verify）+ 考点/题面/解析",dest:"normalizePlaybook → 方法卡库 + 带练闭环"},"sprint.latexfix":{system:"LATEX_FIX_SYS：LaTeX 质检员契约——只修语法禁改内容，字段级回传（stem/options 只回传改动）",dest:"逐题勾选确认弹窗 → 覆盖 stem/options → Store 落库"}};function I(F){const S=q[F.ctx];return S&&(F.dest=S.dest,F.pipe=O(F.ctx,S.system,S.dest,S.extra)),F}const N=[{name:"JSON_ONLY",desc:"JSON 输出纪律（出题/判卷/例句/易混词/方法卡/云端 questionSystem 复用同一份）",usedBy:["quiz.gen","quiz.answer","word.example","word.confuse","insp.gen","cloud.questionSystem"]},{name:"SVG_DIAGRAM_SPEC",desc:"SVG 画图规约（配图字段单源，改一处全站生效）",usedBy:["quiz.gen","dashboard 每日一题"]},{name:"TOOL 附录",desc:"python_exec 工具声明（本地 TOOL_APPENDIX / 云端 TOOL_APPENDIX）",usedBy:["工程出题","教练/私教工具会话","云端出题/重写/审查"]},{name:"streamClass 分类器",desc:"流式期 tool/final/hold 三态（bridge.toolChat 与 agent 会话共用，JSON 轮不裸上屏）",usedBy:["工程台全站","教练工程分支"]}];async function R(){n.value=!0;try{await Promise.all([Y(()=>import("./wordbook-CRdsTi4k.js"),[],import.meta.url),Y(()=>import("./copilot--72RPtb9.js"),__vite__mapDeps([0,1,2,3,4,5,6]),import.meta.url),Y(()=>Promise.resolve().then(()=>Pf),void 0,import.meta.url)]),r.value=(K.globalPrompts()||[]).map(S=>I({name:S.name,ctx:S.id,text:String(S.text||"")}));const F=window;o.value=[{name:"单词 · 记忆口诀",ctx:"word.mnemonic",compose:"助记契约 + 示例词条参数",text:()=>F.WordbookModule.mnemonicSystem({word:"abandon",meaning:"放弃；抛弃"})},{name:"单词 · 语境例句",ctx:"word.example",compose:"例句契约 + 示例词条参数",text:()=>F.WordbookModule.exampleSystem()},{name:"单词 · 易混词干扰项",ctx:"word.confuse",compose:"易混词契约（3 个近形/近义/同根）",text:()=>F.WordbookModule.confuseSystem()},{name:"解题方法 · 方法卡 system",ctx:"insp.gen",compose:"方法卡契约 + 科目/考点/代表性题面",text:()=>F.MethodLink.genSystemPreview({subject:"math",topicName:"极限计算"})}].map(S=>{try{return I({name:S.name,ctx:S.ctx,text:String(S.text()),compose:S.compose})}catch(x){return{name:S.name,ctx:S.ctx,text:"",error:String(x.message||x)}}})}finally{n.value=!1}}he(R);function B(){a.value++,R()}function $(F){const S=s.value.trim().toLowerCase();return S?F.filter(x=>(x.name+" "+x.ctx+" "+x.text).toLowerCase().includes(S)):F}const V=C(()=>$(r.value)),it=C(()=>$(o.value));async function At(F,S){try{await navigator.clipboard.writeText(F.text),i.value=S,setTimeout(()=>{i.value===S&&(i.value="")},1500)}catch{}}function In(F){s.value=F,e.value="list"}return(F,S)=>(b(),_("div",Fa,[c("div",Ka,[S[6]||(S[6]=c("span",{class:"card-title"},[Z("🛰 AI 层链路可视化 "),c("span",{class:"muted-sm"},"（实时求值 · 非硬编码快照）")],-1)),c("button",{class:"btn btn-ghost btn-sm","data-testid":"ps-refresh",disabled:n.value,onClick:B},"↻ 刷新实时值",8,Va)]),c("div",Qa,[c("span",{class:tt(["chip",l.value.configured?"chip-ok":"chip-warn"])},"🔌 "+k(l.value.configured?(l.value.apiName||"当前接口")+" · "+l.value.apiModel:"未配置接口"),3),c("span",Xa,"备用链 "+k(l.value.apisN)+" 个",1),c("span",Wa,"🌐 全局思考："+k(l.value.globalThink),1),c("span",Ya,"📏 全局 maxTokens："+k(l.value.globalTok||"服务端默认"),1),c("span",Za,"🌡 全局温度："+k(l.value.globalTemp==null?"不干预":l.value.globalTemp),1),c("span",tl,"🗂 缓存 "+k(l.value.cacheEntries)+" 条 · 命中 "+k(l.value.cacheHits)+" 次 · "+k(l.value.cacheKb)+"KB",1),c("span",el,"🧠 记忆 "+k(l.value.memFacts)+" 条（置顶 "+k(l.value.memPinned)+"）",1),c("span",nl,"🎓 教练会话 "+k(l.value.chatsN)+" 条 · 技能 "+k(l.value.skillsN)+" 个",1),c("span",{class:tt(["chip",l.value.engEnabled?"chip-ok":""])},"🧪 工程台 "+k(l.value.engEnabled?l.value.engReady?"已启用·就绪":"已启用·未加载":"未启用"),3),c("span",{class:tt(["chip",l.value.protoEff==="fc"?"chip-ok":""]),"data-testid":"ps-proto-chip"},"🔀 工具协议："+k(l.value.protoMode==="auto"?"自动":l.value.protoMode==="fc"?"强制FC":"强制JSON")+" → 生效"+k(l.value.protoEff==="fc"?"原生FC":"JSON")+"（接口"+k(l.value.apiFc==="yes"?"支持FC✓":l.value.apiFc==="no"?"不支持FC✗":"未探测?")+"）",3)]),c("div",sl,[c("div",rl,[c("button",{class:tt(["seg",e.value==="map"?"seg-on":""]),"data-testid":"ps-tab-map",onClick:S[0]||(S[0]=x=>e.value="map")},"🗺 链路全景",2),c("button",{class:tt(["seg",e.value==="registry"?"seg-on":""]),"data-testid":"ps-tab-registry",onClick:S[1]||(S[1]=x=>e.value="registry")},"📋 调用注册表",2),c("button",{class:tt(["seg",e.value==="coach"?"seg-on":""]),"data-testid":"ps-tab-coach",onClick:S[2]||(S[2]=x=>e.value="coach")},"🎓 教练机制",2),c("button",{class:tt(["seg",e.value==="aug"?"seg-on":""]),"data-testid":"ps-tab-aug",onClick:S[3]||(S[3]=x=>e.value="aug")},"🔌 拓展与追踪",2),c("button",{class:tt(["seg",e.value==="list"?"seg-on":""]),"data-testid":"ps-tab-list",onClick:S[4]||(S[4]=x=>e.value="list")},"📜 提示词清单",2)]),Qt(c("input",{"onUpdate:modelValue":S[5]||(S[5]=x=>s.value=x),class:"input",placeholder:e.value==="registry"?"🔍 搜索 ctx / 功能名…":"🔍 搜索名称 / ctx / 提示词内容…","data-testid":"ps-q",style:{flex:"1","min-width":"180px"}},null,8,ol),[[ye,s.value]])]),e.value==="map"?(b(),_(H,{key:0},[c("div",il,[S[8]||(S[8]=c("div",{class:"card-title"},"四条传输通道（谁走哪条、为什么）",-1)),(b(),_(H,null,Q(u,(x,G)=>c("div",{key:G,class:tt(["ps-lane",{dim:x.on===!1}])},[c("div",al,[c("span",ll,k(x.icon),1),c("b",cl,k(x.name),1),c("code",ul,k(x.route),1),x.on===!1?(b(),_("span",dl,"当前未启用")):z("",!0)]),c("div",pl,[S[7]||(S[7]=c("b",null,"谁在用：",-1)),Z(k(x.who),1)]),c("ul",fl,[(b(!0),_(H,null,Q(x.facts,(U,nt)=>(b(),_("li",{key:nt},k(U),1))),128))])],2)),64))]),c("div",hl,[S[9]||(S[9]=c("div",{class:"card-title"},"一次 AI 调用的六层旅程",-1)),(b(),_(H,null,Q(p,(x,G)=>c("div",{key:G,style:{display:"flex",gap:"10px","align-items":"flex-start",margin:"8px 0"}},[c("div",gl,k(x.icon),1),c("div",ml,[c("b",yl,k(x.t),1),c("div",vl,k(x.d),1)])])),64))]),c("div",bl,[S[10]||(S[10]=c("div",{class:"card-title"},"三条决策链（同构：单模块 > 调用方显式 > 全局 > 兜底）",-1)),(b(),_(H,null,Q(d,x=>c("div",{key:x.name,style:{display:"flex","align-items":"center",gap:"6px","flex-wrap":"wrap",margin:"8px 0"}},[c("b",wl,k(x.icon)+" "+k(x.name),1),(b(!0),_(H,null,Q(x.chain,(G,U)=>(b(),_(H,{key:U},[c("span",kl,k(G),1),U<x.chain.length-1?(b(),_("span",_l,"›")):z("",!0)],64))),128))])),64)),S[11]||(S[11]=c("div",{class:"muted-sm",style:{"font-size":"11.5px"}},"逐功能的当前生效值见「📋 调用注册表」；配置入口：设置 → ⚙️ AI 参数配置中心。",-1))]),c("div",Sl,[S[12]||(S[12]=c("div",{class:"card-title"},"🧾 共享片段使用关系（单源契约，改一处全站生效）",-1)),(b(),_(H,null,Q(N,x=>c("div",{key:x.name,style:{border:"1px solid var(--line)","border-radius":"8px",padding:"8px 10px",margin:"6px 0"}},[c("b",xl,k(x.name),1),c("div",Al,k(x.desc),1),(b(!0),_(H,null,Q(x.usedBy,G=>(b(),_("span",{key:G,class:"chip",style:{"font-size":"11px",margin:"2px 4px 2px 0"}},k(G),1))),128))])),64))])],64)):e.value==="registry"?(b(),_("div",El,[c("div",Tl,[S[13]||(S[13]=c("span",{class:"card-title"},"全量 ctx × 当前实时生效",-1)),c("span",Il,k(v.value)+" 个注册功能 · "+k(y.value)+" 个有逐功能覆盖 · 传输默认走 🌊SSE（例外见全景页）",1)]),(b(!0),_(H,null,Q(w.value,(x,G)=>(b(),_(H,{key:G},[c("div",Ol,k(G),1),(b(!0),_(H,null,Q(x,U=>(b(),_("div",{key:U.ctx,class:"ps-reg-row"},[c("div",Ml,[c("b",Pl,k(U.name),1),c("code",Nl,k(U.ctx),1),c("div",Ll,k(U.desc),1)]),c("span",Cl,k(U.def),1),c("span",{class:tt(["chip",U.think==="思考"?"chip-think":""]),style:{"font-size":"11px",flex:"none"}},"现·"+k(U.think),3),c("span",jl,"tok "+k(U.tok),1),c("span",ql,"温 "+k(U.temp),1),(b(!0),_(H,null,Q(U.ov,nt=>(b(),_("span",{key:nt,class:"chip chip-ov",style:{"font-size":"10px",flex:"none"}},k(nt),1))),128)),c("button",{class:"btn btn-ghost btn-sm",style:{flex:"none","font-size":"11px"},onClick:nt=>In(U.ctx)},"📜",8,Dl)]))),128))],64))),128)),Object.keys(w.value).length?z("",!0):(b(),_("div",Rl,"无匹配项"))])):e.value==="coach"?(b(),_(H,{key:2},[c("div",Bl,[S[14]||(S[14]=c("div",{class:"card-title"},"教练一句话的全旅程（含工程台分支）",-1)),(b(!0),_(H,null,Q(h.value,(x,G)=>(b(),_("div",{key:G,style:{display:"flex",gap:"10px","align-items":"flex-start",margin:"9px 0"}},[c("div",Jl,k(x.icon),1),c("div",Gl,[c("b",Hl,k(G+1)+". "+k(x.t),1),c("div",zl,k(x.d),1)])]))),128))]),c("div",$l,[S[18]||(S[18]=c("div",{class:"card-title"},"教练专属设施速查",-1)),c("div",Ul,[S[15]||(S[15]=Z(" · 记忆：",-1)),S[16]||(S[16]=c("b",null,"AiMemory",-1)),Z("（事实库 ≤120 条 / 画像 / 反思沉淀 reflectIfWorthy / 整理 memoryDigest）——当前 "+k(l.value.memFacts)+" 条",1),S[17]||(S[17]=Co("<br data-v-b4cd41a4> · 识屏：<b data-v-b4cd41a4>PageCtx</b>（DOM 直读 ≤40 条 × 400 字 + 9000 字总预算截断如实告知）+ 指代词自动附带<br data-v-b4cd41a4> · 动作：<b data-v-b4cd41a4>parseActions</b> 9 类接管工具（跳转/加任务/打卡/改排程…），低风险 auto 执行、可撤销<br data-v-b4cd41a4> · 查询：<b data-v-b4cd41a4>[[QUERY:]]</b> 协议 → runQuery 本地数据 → 回填同轮继续（agentLoop ≤5 轮）<br data-v-b4cd41a4> · 渲染：<b data-v-b4cd41a4>makeStreamView</b> 打字机 + 💭 思考条（liveThink 会话留存可回看）+ 步骤卡（liveSteps）<br data-v-b4cd41a4> · 主动：开场白（每日一次）/ 督学 superviseCheck（双时段）/ pushAssistant（关键事件关怀） ",18))])])],64)):e.value==="aug"?(b(),_(H,{key:3},[c("div",Fl,[c("div",Kl,[S[19]||(S[19]=c("span",{class:"card-title"}," 插件提示词拓展器（受控注入 AI system）",-1)),c("span",Vl,k(A.value.length)+" 个 · 只追加不替换 · 命中 ctx 才生效 · 总追加 ≤8000 字",1)]),S[20]||(S[20]=c("div",{class:"muted-sm",style:{"font-size":"12px",margin:"4px 0 8px"}},[Z("插件在 manifest 声明 "),c("code",null,"promptAugment:[{ctx,name,build}]"),Z("， 经 "),c("b",null,"PluginBus.syncAugmentors"),Z(" 登记到 "),c("b",null,"AI.applyPromptAugments"),Z("；每次 AI 调用把命中 ctx（或 '*' 全站）的拓展段 追加到 system 尾部。禁用插件即注销。下方「调用追踪」可审计每次调用实际注入了谁。")],-1)),(b(!0),_(H,null,Q(A.value,x=>(b(),_("div",{key:x.id,class:"ps-aug-row"},[c("div",Ql,[c("b",Xl,k(x.name),1),c("div",Wl,k(x.note||"（无说明）"),1)]),c("span",Yl,k(g(x.ctx)),1),c("span",Zl,"来源 "+k(x.pid||"内置"),1)]))),128)),A.value.length?z("",!0):(b(),_("div",tc,"暂无插件注册提示词拓展器（导入带 promptAugment 的插件后，此处与下方追踪会实时出现注入记录）"))]),c("div",ec,[c("div",nc,[c("span",sc,"📡 全链路调用追踪（最近 "+k(L.value.length)+" 次）",1),c("button",{class:"btn btn-ghost btn-sm","data-testid":"ps-trace-clear",onClick:E},"🗑 清空")]),S[21]||(S[21]=c("div",{class:"muted-sm",style:{"font-size":"11.5px",margin:"4px 0 8px"}},"每次真实 AI 调用记一条：ctx→模块、模型、思考/温度/maxTokens 生效值、 缓存命中、耗时、被哪些插件拓展器注入（可审计）。点「↻ 刷新实时值」或任意 AI 调用后自动更新。",-1)),L.value.length?z("",!0):(b(),_("div",rc,"暂无调用记录——去任意功能触发一次 AI（出题/判卷/教练对话…）后回来看")),(b(!0),_(H,null,Q(L.value,(x,G)=>(b(),_("div",{key:G,class:tt(["ps-trace-row",{err:x.error}])},[c("span",oc,k(new Date(x.at).toLocaleTimeString()),1),c("b",null,k(g(x.ctx)),1),c("span",ic,k(x.model||"—"),1),x.think?(b(),_("span",ac,"思考")):z("",!0),x.temp!=null&&x.temp!==""?(b(),_("span",lc,"温"+k(x.temp),1)):z("",!0),x.tokens?(b(),_("span",cc,"tok"+k(x.tokens),1)):z("",!0),c("span",{class:tt(["chip",x.cache==="hit"?"chip-ok":""]),style:{"font-size":"10px"}},k(x.cache==="hit"?"缓存命中":x.cache==="off"?"不缓存":x.cache==="error"?"失败":"实调"),3),x.ms?(b(),_("span",uc,k(x.ms)+"ms",1)):z("",!0),x.chars?(b(),_("span",dc,k(x.chars)+"字",1)):z("",!0),x.augmented&&x.augmented.length?(b(),_("span",pc,"＋"+k(x.augmented.length)+"插件: "+k(x.augmented.join("/")),1)):z("",!0),x.error?(b(),_("span",fc,k(x.error),1)):z("",!0)],2))),128))])],64)):n.value?z("",!0):(b(),_(H,{key:4},[c("div",hc,[c("div",gc,[S[22]||(S[22]=c("span",{class:"card-title"},"🌐 注册表提示词",-1)),c("span",mc,"core/ai.ts 单源 + 模块自注册 · "+k(V.value.length)+" 条",1)]),(b(!0),_(H,null,Q(V.value,x=>(b(),_("div",{key:x.ctx,style:{border:"1px solid var(--line)","border-radius":"8px",padding:"8px 10px",margin:"6px 0"}},[c("div",yc,[c("b",vc,k(x.name),1),c("span",bc,"ctx:"+k(x.ctx),1),c("span",wc,k(x.text.length)+" 字",1),c("button",{class:"btn btn-ghost btn-sm",style:{"margin-left":"auto"},onClick:G=>At(x,x.ctx)},k(i.value===x.ctx?"✓ 已复制":"📋 复制"),9,kc)]),c("pre",_c,k(x.text),1),x.pipe?(b(),_("div",Sc,[(b(!0),_(H,null,Q(x.pipe,(G,U)=>(b(),_("div",{key:U,style:{display:"flex",gap:"6px","font-size":"11.5px",margin:"3px 0"}},[c("span",xc,k(G.icon),1),c("b",Ac,k(G.t),1),c("span",Ec,k(G.live?T(G.live):G.d),1)]))),128))])):z("",!0)]))),128)),V.value.length?z("",!0):(b(),_("div",Tc,"无匹配项"))]),c("div",Ic,[c("div",Oc,[S[23]||(S[23]=c("span",{class:"card-title"},"🧩 模块指令层",-1)),c("span",Mc,"window 门面实时构造 · 示例参数 · "+k(it.value.length)+" 条",1)]),(b(!0),_(H,null,Q(it.value,x=>(b(),_("div",{key:x.ctx,style:{border:"1px solid var(--line)","border-radius":"8px",padding:"8px 10px",margin:"6px 0"}},[c("div",Pc,[c("b",Nc,k(x.name),1),c("span",Lc,"ctx:"+k(x.ctx),1),x.compose?(b(),_("span",Cc,k(x.compose),1)):z("",!0),c("span",jc,k(x.text.length)+" 字",1),c("button",{class:"btn btn-ghost btn-sm",style:{"margin-left":"auto"},onClick:G=>At(x,x.ctx)},k(i.value===x.ctx?"✓ 已复制":"📋 复制"),9,qc)]),x.error?(b(),_("div",Rc,"求值失败："+k(x.error),1)):(b(),_("pre",Dc,k(x.text),1)),x.pipe?(b(),_("div",Bc,[(b(!0),_(H,null,Q(x.pipe,(G,U)=>(b(),_("div",{key:U,style:{display:"flex",gap:"6px","font-size":"11.5px",margin:"3px 0"}},[c("span",Jc,k(G.icon),1),c("b",Gc,k(G.t),1),c("span",Hc,k(G.live?T(G.live):G.d),1)]))),128))])):z("",!0)]))),128)),it.value.length?z("",!0):(b(),_("div",zc,"无匹配项"))])],64))]))}}),Rt=(t,e)=>{const n=t.__vccOpts||t;for(const[s,r]of e)n[s]=r;return n},Uc=Rt($c,[["__scopeId","data-v-b4cd41a4"]]);function Fc(){const t=P.get(),e=M.dkey(),n=new Date;if((n.getMonth()+1)*100+n.getDate()>=1101&&!t.milestones.octMath&&t.alerts.lastNovPush!==e){P.update(a=>{a.alerts.lastNovPush=e}),It.open({title:"⚔️ 院校决策提醒",html:"<p>已到11月，「数学真题模拟≥120分」里程磊尚未勾选。</p><p><b>请立即根据数学成绩决定冲上大还是守河工大。</b>报名窗口不等人，用数据说话，不能凭感觉。</p>",actions:[{label:"去决策参谋",kind:"btn-primary",onClick:a=>{a(),window.App.go("decision")}},{label:"稍后",kind:"btn-ghost"}]});return}const r=P.usageBytes()/(5*1024*1024),o=t.meta.lastBackupReminder||"",i=o?(Date.now()-new Date(o).getTime())/M.DAY_MS:999;(r>.6||i>7)&&t.alerts.lastBakWarn!==e&&(P.update(a=>{a.alerts.lastBakWarn=e}),X.warn("💾 已"+Math.floor(i)+"天未导出备份。数据只存在浏览器，建议立即导出（设置 → 导出JSON备份）。"))}function Kc(){const t=P.get(),e=new Date,n=(e.getMonth()+1)*100+e.getDate(),s=[];return n>=1101&&!t.milestones.octMath&&s.push(`<div class="alert alert-danger">⚔️ 11月已到而数学模拟里程磊未达成：<a href="javascript:App.go('decision')">立即去决策参谋定院 →</a></div>`),P.mistakeCountWeek("sign")>3&&s.push('<div class="alert alert-warn">✍️ 本周符号错误 '+P.mistakeCountWeek("sign")+" 次 &gt; 3次：智能排程已强制插入符号专项。</div>"),s.join("")}const ls={runDailyChecks:Fc,bannerHtml:Kc},Vc={class:"stats-row"},Qc={class:"stat-top"},Xc={class:"stat-label"},Wc={class:"stat-num"},Yc={class:"stat-den"},Zc={class:"stat-bar"},tu={class:"stat-foot"},eu=ot({__name:"StatsRow",setup(t){const e=C(()=>P.todayTaskStats()),n=[{k:"math",ico:"📐"},{k:"ctrl",ico:"🎛"},{k:"eng",ico:"📖"},{k:"pol",ico:"🏛"}],s=C(()=>n.map(r=>{const o=Wt.SUBJECTS[r.k],[i,a]=e.value[r.k]||[0,0];return{k:r.k,ico:r.ico,short:o.short,color:o.color,d:i,t:a,done:a>0&&i===a,pct:a>0?Math.round(i/a*100):0,remain:a-i}}));return(r,o)=>(b(),_("div",Vc,[(b(!0),_(H,null,Q(s.value,i=>(b(),_("div",{key:i.k,class:tt(["stat-tile",{"stat-done":i.done}])},[c("div",Qc,[c("span",Xc,k(i.short),1),c("span",{class:"stat-badge",style:Vt({background:`color-mix(in srgb, ${i.color} 14%, transparent)`,color:i.color})},k(i.ico),5)]),c("div",Wc,[c("b",null,k(i.d),1),c("span",Yc,"/"+k(i.t),1)]),c("div",Zc,[c("div",{class:"stat-bar-fill",style:Vt({width:i.pct+"%",background:i.color})},null,4)]),c("div",tu,k(i.done?"已清空 ✓":i.t===0?"今日无任务":"还差 "+i.remain+" 项"),1)],2))),128))]))}}),nu=Rt(eu,[["__scopeId","data-v-9fd1365c"]]),su={key:0,class:"dsh-head"},ru={key:1,class:"dsh-title"},ou={class:"dsh-head-extra"},iu={class:"dsh-head-actions"},au=ot({__name:"DashCard",props:{icon:{default:""},title:{default:""},tint:{default:""},dense:{type:Boolean,default:!1}},setup(t){return(e,n)=>(b(),_("section",{class:tt(["dsh-card",{"dsh-dense":t.dense}])},[t.title||e.$slots.actions||e.$slots.extra?(b(),_("header",su,[t.icon?(b(),_("span",{key:0,class:tt(["dsh-badge",t.tint?"tint-"+t.tint:""])},k(t.icon),3)):z("",!0),t.title?(b(),_("h2",ru,k(t.title),1)):z("",!0),n[0]||(n[0]=c("span",{class:"dsh-head-spacer"},null,-1)),c("div",ou,[On(e.$slots,"extra",{},void 0)]),c("div",iu,[On(e.$slots,"actions",{},void 0)])])):z("",!0),On(e.$slots,"default",{},void 0)],2))}}),Xt=Rt(au,[["__scopeId","data-v-06402b0e"]]),lu={class:"muted-sm"},cu=["innerHTML"],uu={class:"brief-foot"},du={key:1,class:"brief-body"},pu=["innerHTML"],fu=["innerHTML"],hu={key:0,class:"muted-sm brief-note"},gu={key:1,class:"muted-sm brief-note"},mu=ot({__name:"BriefCard",setup(t){const e=M.dkey(),n=C(()=>P.get().dailyBrief),s=C(()=>K.configured()),r=C(()=>n.value&&n.value.date===e&&n.value.content),o=C(()=>n.value&&n.value.date===e&&n.value.failed),i=C(()=>K.configured()&&P.get().ai.briefAuto!==!1),a=C(()=>i.value&&!r.value&&!o.value),l=C(()=>a.value&&!Rs.value),u=Qo(),p=e.slice(5).replace("-","."),d=C(()=>r.value?Le(n.value.content):""),f=C(()=>Le(Rs.value)),w=C(()=>Xo(P.get()));function v(){P.update(y=>{y.dailyBrief=null}),Wo()}return(y,h)=>(b(),Ct(Xt,{icon:"📰",title:"今日简报",tint:"blue",class:"dash-brief"},{extra:ft(()=>[c("span",lu,k(W(u))+" · "+k(W(p)),1)]),default:ft(()=>[r.value?(b(),_(H,{key:0},[c("div",{class:"brief-body",innerHTML:d.value},null,8,cu),c("div",uu,[h[0]||(h[0]=c("span",{class:"muted-sm"},"🧠 结合你的记忆与数据生成",-1)),s.value?(b(),_("button",{key:0,class:"link-btn",onClick:v},"🔄 换一版")):z("",!0)])],64)):a.value?(b(),_("div",du,[l.value?(b(),_(H,{key:0},[h[1]||(h[1]=c("div",{class:"skl-line"},null,-1)),h[2]||(h[2]=c("div",{class:"skl-line"},null,-1)),h[3]||(h[3]=c("div",{class:"skl-line skl-w60"},null,-1))],64)):(b(),_(H,{key:1},[c("span",{innerHTML:f.value},null,8,pu),h[4]||(h[4]=c("span",{class:"ai-cursor"},null,-1))],64))])):(b(),_(H,{key:2},[c("div",{class:"brief-body",innerHTML:w.value},null,8,fu),o.value?(b(),_("div",hu,[Z(" ⚠️ AI 简报生成失败（"+k(String(n.value.error||"").slice(0,40))+"） ",1),c("button",{class:"link-btn",onClick:v},"🔄 重试")])):s.value?z("",!0):(b(),_("div",gu,"配置 AI 后，这里会变成真正懂你的每日简报 →"))],64))]),_:1}))}}),yu=Rt(mu,[["__scopeId","data-v-17a6feac"]]);function vu(t){if(!t)return{lang:"",code:""};t=String(t).trim();let e=t.match(/^```(\w*)\s*([\s\S]*?)```$/i);return e?{lang:(e[1]||"").toLowerCase(),code:e[2].trim()}:(e=t.match(/```(\w*)\s*\n([\s\S]*?)```/),e?{lang:(e[1]||"").toLowerCase(),code:e[2].trim()}:{lang:"",code:t})}function jr(t){let e=String(t);/xmlns=/.test(e)||(e=e.replace(/<svg/i,'<svg xmlns="http://www.w3.org/2000/svg"'));let n;try{n=new DOMParser().parseFromString(e,"image/svg+xml")}catch{return null}if(!n||n.getElementsByTagName("parsererror").length)return null;const s=n.documentElement;if(!s||s.nodeName.toLowerCase()!=="svg")return null;const r=s.querySelectorAll("script, foreignObject, iframe, object, embed, link, meta");for(let i=0;i<r.length;i++)r[i].parentNode&&r[i].parentNode.removeChild(r[i]);const o=[s].concat(Array.prototype.slice.call(s.getElementsByTagName("*")));for(let i=0;i<o.length;i++){const a=o[i];for(let l=a.attributes.length-1;l>=0;l--){const u=a.attributes[l].name,p=a.attributes[l].value||"";(/^on/i.test(u)||/^(xlink:)?href$/i.test(u)&&/^\s*javascript:/i.test(p)||u.toLowerCase()==="style"&&/javascript:|expression\s*\(/i.test(p))&&a.removeAttribute(u)}}return s.getAttribute("viewBox")?(s.removeAttribute("width"),s.removeAttribute("height"),s.setAttribute("width","100%"),s.getAttribute("preserveAspectRatio")||s.setAttribute("preserveAspectRatio","xMidYMid meet")):s.getAttribute("width")||s.setAttribute("width","280"),s.setAttribute("overflow","visible"),new XMLSerializer().serializeToString(s)}function qr(t){if(t&&typeof t=="object")return"";const e=vu(t),n=e.code;if(!n)return"";if(e.lang==="svg"||n.toLowerCase().indexOf("<svg")>=0){const s=jr(n);if(s)return'<div class="dgm-wrap">'+s+"</div>"}return'<div class="dgm-code"><pre class="report">'+M.esc(n)+"</pre></div>"}function bu(t){return qr(t)}const Dr={render:qr,renderSync:bu,sanitizeSvg:jr},wu=["innerHTML"],ku=ot({__name:"DiagramBlock",props:{source:{}},setup(t){const e=t,n=C(()=>Dr.render(e.source||""));return(s,r)=>(b(),_("div",{class:"diagram-block",innerHTML:n.value},null,8,wu))}}),_u={key:0,class:"dsh-dq-cell"},Su={class:"dq-tile-head"},xu={class:"dq-tile-ico"},Au={key:0,class:"dq-dot",title:"今日题还没做"},Eu={key:1,class:"dq-tile-sub st-no"},Tu={key:2,class:"dq-tile-sub st-warn"},Iu={key:3,class:"dq-tile-sub st-warn"},Ou=["innerHTML"],Mu={key:1,class:"dq-tile-preview dq-tile-hint"},Pu={class:"dq-week","aria-hidden":"true"},Nu={class:"dq-tools"},Lu=["value"],Cu=["disabled"],ju={class:"dq-question"},qu=["innerHTML"],Du={class:"dq-section"},Ru=["innerHTML"],Bu={key:0,class:"dq-section"},Ju=["innerHTML"],Gu={key:2,class:"dq-eval dq-eval-ok"},Hu={key:3,class:"dq-eval dq-eval-no"},zu={key:4,class:"dq-eval-row"},$u={class:"muted-sm dq-foot"},Uu={class:"alert alert-warn"},Fu=["disabled"],Ku={key:2,class:"muted-sm"},Vu=ot({__name:"DailyQuizCard",setup(t){const e=M.dkey(),n=C(()=>P.get().dailyQuiz),s=C(()=>n.value&&n.value.date===e&&n.value.question),r=C(()=>n.value&&n.value.date===e&&n.value.failed),o=C(()=>K.configured()),i=C(()=>!!(s.value&&!n.value.revealed&&!n.value.selfEval)),a=C(()=>s.value?Wt.SUBJECTS[n.value.subject]||{short:"题",color:"#666"}:null),l=C(()=>n.value?.selfEval==="known"?{t:"已会 ✓",cls:"st-ok"}:n.value?.selfEval==="unknown"?{t:"记入错题",cls:"st-no"}:n.value?.revealed?{t:"待自评",cls:"st-warn"}:{t:"待作答",cls:"st-warn"}),u=et(!1),p=[{v:"auto",l:"🎲 自动(薄弱点)"},{v:"math",l:"📐 数学"},{v:"ctrl",l:"🎛 专业课"},{v:"eng",l:"📖 英语"},{v:"pol",l:"🏛 政治"}],d=et(!1),f=C(()=>Le(n.value?.question||"")),w=C(()=>Le(n.value?.solution||"")),v=C(()=>Le(n.value?.trap||"")),y=C(()=>(n.value?.generatedAt||"").slice(0,16).replace("T"," ")),h=C(()=>{const T=(P.get().dailyQuizHistory||[]).slice(-6).map((I,N)=>({k:"h"+N+(I.date||""),cls:I.selfEval==="known"?"ok":I.selfEval==="unknown"?"no":"done",today:!1})),q=n.value&&n.value.date===e?n.value.selfEval==="known"?"ok":n.value.selfEval==="unknown"?"no":n.value.revealed?"done":"open":"none";return T.push({k:"today",cls:q,today:!0}),T});function g(){u.value=!u.value}function A(){d.value||(d.value=!0,u.value=!0,Yo(!0,()=>{d.value=!1},$e.value))}function L(){kt.push(Ut("settings"))}return(E,O)=>u.value?(b(),Ct(Xt,{key:1,icon:"📅",title:"每日一题",tint:"purple",class:"dsh-dq"},{actions:ft(()=>[c("button",{class:"link-btn",onClick:g},"收起 ▴")]),default:ft(()=>[c("div",Nu,[Qt(c("select",{"onUpdate:modelValue":O[0]||(O[0]=T=>jo($e)?$e.value=T:null),class:"input input-sel dq-sel",title:"指定出题科目"},[(b(),_(H,null,Q(p,T=>c("option",{key:T.v,value:T.v},k(T.l),9,Lu)),64))],512),[[qo,W($e)]]),s.value?(b(),_("button",{key:0,class:"btn btn-ghost btn-sm dq-again",disabled:d.value,onClick:A},k(d.value?"生成中…":"🔁 换题"),9,Cu)):z("",!0)]),s.value?(b(),_(H,{key:0},[c("div",ju,[c("b",null,"📝 "+k(a.value.short)+"题：",1),c("span",{innerHTML:f.value},null,8,qu)]),n.value.diagram?(b(),Ct(ku,{key:0,source:n.value.diagram},null,8,["source"])):z("",!0),n.value.revealed||n.value.selfEval?(b(),_(H,{key:1},[c("div",Du,[O[8]||(O[8]=c("b",null,"🔑 解答：",-1)),c("div",{class:"dq-sol",innerHTML:w.value},null,8,Ru)]),n.value.trap?(b(),_("div",Bu,[O[9]||(O[9]=c("b",null,"⚠️ 易错点：",-1)),c("div",{class:"dq-sol",innerHTML:v.value},null,8,Ju)])):z("",!0)],64)):z("",!0),n.value.selfEval==="known"?(b(),_("div",Gu,"✓ 已自评：会了。保持这个节奏。")):n.value.selfEval==="unknown"?(b(),_("div",Hu,"✗ 已自评：还不会——已记入错题本，明天简报会盯着你复习。")):n.value.revealed?(b(),_("div",zu,[O[10]||(O[10]=c("span",{class:"muted-sm"},"看完解答，诚实自评：",-1)),c("button",{class:"btn btn-primary btn-sm",onClick:O[1]||(O[1]=T=>W(Bs)(!0))},"✓ 会了"),c("button",{class:"btn btn-ghost btn-sm",onClick:O[2]||(O[2]=T=>W(Bs)(!1))},"✗ 还不会")])):(b(),_(H,{key:5},[O[11]||(O[11]=c("div",{class:"dq-fold"},"🫣 解答已折叠——先拿草稿纸做一遍，再对答案。",-1)),c("button",{class:"btn btn-ghost btn-sm",onClick:O[3]||(O[3]=(...T)=>W(Js)&&W(Js)(...T))},"👀 查看解答")],64)),c("div",$u,"基于你的薄弱点生成 · "+k(y.value),1)],64)):r.value?(b(),_(H,{key:1},[c("div",Uu,"⚠️ 今日一题生成失败："+k(n.value.error||"未知错误"),1),c("button",{class:"btn btn-ghost btn-sm dq-retry",disabled:d.value,onClick:A},k(d.value?"生成中…":"🔁 重试生成"),9,Fu)],64)):o.value?(b(),_("div",Ku,"⏳ 正在依据你的薄弱点生成今日一题…")):(b(),_(H,{key:3},[O[12]||(O[12]=c("div",{class:"alert alert-warn"},"未配置 AI，无法生成每日一题。请先在「设置」中填写 API。",-1)),c("button",{class:"btn btn-ghost btn-sm",onClick:L,style:{"margin-top":"8px"}},"去设置 →")],64))]),_:1})):(b(),_("div",_u,[c("div",{class:"dq-tile",role:"button",tabindex:"0",title:"点击查看今日一题",onClick:g,onKeydown:Wn(g,["enter"])},[c("div",Su,[c("span",xu,[O[4]||(O[4]=Z("📅",-1)),i.value?(b(),_("span",Au)):z("",!0)]),O[5]||(O[5]=c("span",{class:"dq-tile-name"},"每日一题",-1)),s.value?(b(),_("span",{key:0,class:tt(["dq-tile-sub",l.value.cls])},k(a.value.short)+" · "+k(l.value.t),3)):r.value?(b(),_("span",Eu,"生成失败 · 重试")):o.value?(b(),_("span",Tu,"⏳ 生成中")):(b(),_("span",Iu,"配置 AI"))]),s.value?(b(),_("div",{key:0,class:"dq-tile-preview",innerHTML:f.value},null,8,Ou)):(b(),_("div",Mu,k(r.value?"今日生成失败，点击展开可重试。":o.value?"正在依据你的薄弱点生成今日一题…":"配置 AI 后，每天自动送一道针对你弱点的题。"),1)),c("div",Pu,[(b(!0),_(H,null,Q(h.value,T=>(b(),_("span",{key:T.k,class:tt(["dq-wdot","w-"+T.cls+(T.today?" w-today":"")])},null,2))),128)),O[6]||(O[6]=c("span",{class:"dq-week-label muted-sm"},"近 7 日",-1))]),O[7]||(O[7]=c("div",{class:"dq-tile-cta"},"查看今日一题 →",-1))],32)]))}}),Qu=Rt(Vu,[["__scopeId","data-v-f0f7a385"]]),Xu={class:"now-count"},Wu={class:"now-actions"},Yu={class:"now-count"},Zu={class:"now-title"},td={class:"now-sub"},ed={class:"now-reason"},nd={class:"now-actions"},sd=ot({__name:"NowCard",setup(t){const e=()=>window,n=C(()=>P.todayTaskStats()),s=C(()=>P.todayAllDone()),r=C(()=>{n.value;const d=e().SchedulerModule;if(!d||!d.currentPlan)return null;const f=d.currentPlan();return f&&f.sequence&&f.sequence.find(w=>!w.done)||null}),o=C(()=>r.value?Wt.SUBJECTS[r.value.subject]:null),i=C(()=>{const d=n.value;return d.math[0]+d.ctrl[0]+d.eng[0]+d.pol[0]}),a=C(()=>{const d=n.value;return d.math[1]+d.ctrl[1]+d.eng[1]+d.pol[1]});function l(){const d=e().TasksModule;d&&r.value?d.toggleTask(r.value.id,!0):X.show("打卡模块未就绪","warn")}function u(){kt.push(Ut("focus"))}function p(){kt.push(Ut("scheduler"))}return(d,f)=>s.value?(b(),Ct(Xt,{key:0,icon:"✅",title:"今日已清场",tint:"ok",class:"dsh-now dsh-now-done"},{extra:ft(()=>[c("span",Xu,k(i.value)+"/"+k(a.value),1)]),default:ft(()=>[f[1]||(f[1]=c("div",{class:"now-title"},"✓ 全部任务完成",-1)),f[2]||(f[2]=c("div",{class:"now-sub"},"可以安心复盘、早点睡。明天继续。",-1)),c("div",Wu,[c("button",{class:"btn btn-ghost",onClick:f[0]||(f[0]=w=>W(kt).push(W(Ut)("review")))},"去复盘 →")])]),_:1})):r.value?(b(),Ct(Xt,{key:1,icon:"⚡",title:"现在就干这个",class:"dsh-now dsh-now-hero"},{extra:ft(()=>[c("span",Yu,k(i.value)+"/"+k(a.value)+" 已完成",1)]),default:ft(()=>[c("div",Zu,k(r.value.text),1),c("div",td,[o.value?(b(),_("span",{key:0,class:"now-tag",style:Vt({background:o.value.color})},k(o.value.short),5)):z("",!0),c("span",ed,k(r.value.reason),1)]),c("div",nd,[c("button",{class:"now-btn-primary",onClick:l},"✓ 完成打卡"),c("button",{class:"now-btn-ghost",onClick:u},"🔒 专注"+k(r.value.subject==="math"?45:25)+"分钟",1)])]),_:1})):(b(),Ct(Xt,{key:2,icon:"🗓️",title:"今日无待办",class:"dsh-now"},{default:ft(()=>[f[3]||(f[3]=c("div",{class:"now-title"},"还没排任务",-1)),f[4]||(f[4]=c("div",{class:"now-sub"},"去排程把今天的任务排上，仪表盘才知道你现在该干嘛。",-1)),c("div",{class:"now-actions"},[c("button",{class:"btn btn-primary",onClick:p},"去排程添加")])]),_:1}))}}),rd=Rt(sd,[["__scopeId","data-v-a92668cf"]]);function Ee(t,e){return'<svg viewBox="0 0 '+t+" "+e+'" width="100%" height="'+e+'" xmlns="http://www.w3.org/2000/svg">'}function gt(t,e){return window.U&&M.themeColor?M.themeColor(t,e):e}const Rr={bar(t,e){e=e||{};const n=gt("--chart-ink","#000"),s=gt("--chart-faint","#bfbfbf"),r=gt("--chart-muted","#8c8c8c"),o=gt("--chart-sub","#595959"),i=680,a=e.height||160,l=24,u=16,p=8,d=8,f=Math.max.apply(null,t.map(g=>g.value).concat([1])),w=t.length||1,v=(i-p-d)/w,y=Math.min(44,v*.55);let h=Ee(i,a);for(let g=0;g<w;g++){const A=t[g],L=Math.max(2,A.value/f*(a-l-u)),E=p+g*v+(v-y)/2,O=a-l-L,T=A.highlight?e.hiColor||n:e.color||s;h+='<rect x="'+E+'" y="'+O+'" width="'+y+'" height="'+L+'" rx="4" fill="'+T+'"><title>'+M.esc(A.label)+"："+A.value+(e.unit||"")+"</title></rect>",h+='<text x="'+(E+y/2)+'" y="'+(a-8)+'" text-anchor="middle" font-size="11" fill="'+r+'">'+M.esc(A.label)+"</text>",A.value>0&&(h+='<text x="'+(E+y/2)+'" y="'+(O-4)+'" text-anchor="middle" font-size="11" fill="'+o+'">'+A.value+"</text>")}return h+"</svg>"},donut(t,e){e=e||{};const n=gt("--chart-ink","#000"),s=gt("--chart-faint","#bfbfbf"),r=gt("--chart-muted","#8c8c8c"),o=gt("--chart-sub","#595959"),i=gt("--chart-track","#f0f0f0"),a=680,l=e.height||190,u=110,p=l/2,d=66,f=40,w=M.sum(t.map(h=>h.value));let v=Ee(a,l);if(w===0)v+='<circle cx="'+u+'" cy="'+p+'" r="'+d+'" fill="none" stroke="'+i+'" stroke-width="'+(d-f)+'"/>',v+='<text x="'+u+'" y="'+(p+5)+'" text-anchor="middle" font-size="13" fill="'+s+'">暂无数据</text>';else{let h=-Math.PI/2;t.forEach(g=>{if(g.value<=0)return;const A=g.value/w,L=h+A*Math.PI*2,E=A>.5?1:0,O=u+d*Math.cos(h),T=p+d*Math.sin(h),q=u+d*Math.cos(L),I=p+d*Math.sin(L),N=u+f*Math.cos(L),R=p+f*Math.sin(L),B=u+f*Math.cos(h),$=p+f*Math.sin(h);v+='<path d="M'+O+" "+T+" A"+d+" "+d+" 0 "+E+" 1 "+q+" "+I+" L"+N+" "+R+" A"+f+" "+f+" 0 "+E+" 0 "+B+" "+$+' Z" fill="'+g.color+'"><title>'+M.esc(g.label)+"："+g.value+"次 ("+Math.round(A*100)+"%)</title></path>",h=L}),v+='<text x="'+u+'" y="'+(p-2)+'" text-anchor="middle" font-size="22" font-weight="500" fill="'+n+'">'+w+"</text>",v+='<text x="'+u+'" y="'+(p+16)+'" text-anchor="middle" font-size="11" fill="'+r+'">总计</text>'}let y=24;return t.forEach(h=>{const g=w?Math.round(h.value/w*100):0;v+='<rect x="230" y="'+(y-10)+'" width="10" height="10" rx="2" fill="'+h.color+'"/>',v+='<text x="246" y="'+y+'" font-size="12" fill="'+n+'">'+M.esc(h.label)+"</text>",v+='<text x="660" y="'+y+'" font-size="12" text-anchor="end" fill="'+o+'">'+h.value+"次 · "+g+"%</text>",y+=24}),v+"</svg>"},line(t,e){e=e||{};const n=gt("--chart-ink","#000"),s=gt("--chart-faint","#bfbfbf"),r=gt("--chart-muted","#8c8c8c"),o=gt("--danger","#cf1322"),i=680,a=e.height||170,l=22,u=14,p=30,d=10,f=t.map(E=>E.value),w=e.min!=null?e.min:Math.min.apply(null,f.concat([0])),v=e.max!=null?e.max:Math.max.apply(null,f.concat([10])),y=t.length;if(y===0)return Ee(i,a)+'<text x="340" y="90" text-anchor="middle" fill="'+s+'" font-size="13">暂无数据</text></svg>';const h=E=>p+(y===1?(i-p-d)/2:E*(i-p-d)/(y-1)),g=E=>a-l-(E-w)/(v-w||1)*(a-l-u);let A=Ee(i,a);e.warnBelow!=null&&(A+='<line x1="'+p+'" y1="'+g(e.warnBelow)+'" x2="'+(i-d)+'" y2="'+g(e.warnBelow)+'" stroke="'+o+'" stroke-dasharray="4 4" stroke-width="1"/>',A+='<text x="'+(i-d)+'" y="'+(g(e.warnBelow)-4)+'" text-anchor="end" font-size="10" fill="'+o+'">预警线 '+e.warnBelow+"</text>");let L="";return t.forEach((E,O)=>{L+=(O===0?"M":"L")+h(O)+" "+g(E.value)}),A+='<path d="'+L+'" fill="none" stroke="'+n+'" stroke-width="2"/>',t.forEach((E,O)=>{const T=e.warnBelow!=null&&E.value<e.warnBelow;A+='<circle cx="'+h(O)+'" cy="'+g(E.value)+'" r="4" fill="'+(T?o:n)+'"><title>'+M.esc(E.label)+"："+E.value+(e.unit||"")+"</title></circle>",y<=12&&(A+='<text x="'+h(O)+'" y="'+(a-6)+'" text-anchor="middle" font-size="10" fill="'+r+'">'+M.esc(E.label)+"</text>")}),A+"</svg>"},progressBar(t,e,n){return t=M.clamp(t,0,100),'<div class="pbar" style="height:'+(n||8)+'px"><div class="pbar-fill" style="width:0%;background:'+e+'" data-w="'+t+'"></div></div>'},radar(t,e){e=e||{};const n=gt("--chart-ink","#000"),s=gt("--chart-sub","#595959"),r=gt("--chart-grid","#e8e8e8"),o=680,i=e.height||200,a=t.length||4,l=128,u=i/2,p=Math.max(40,Math.min(92,(i-24)/2-10)),d=e.color||"#2f54eb",f=g=>-Math.PI/2+2*Math.PI*g/a,w=(g,A)=>[l+A*Math.cos(f(g)),u+A*Math.sin(f(g))];let v=Ee(o,i);for(let g=1;g<=4;g++){const A=p*g/4;let L="";for(let E=0;E<=a;E++){const O=w(E%a,A);L+=(E===0?"M":"L")+O[0]+" "+O[1]}v+='<path d="'+L+' Z" fill="none" stroke="'+r+'" stroke-width="0.5"/>'}for(let g=0;g<a;g++){const[A,L]=w(g,p);v+='<line x1="'+l+'" y1="'+u+'" x2="'+A+'" y2="'+L+'" stroke="'+r+'" stroke-width="0.5"/>';const E=l+(p+22)*Math.cos(f(g)),O=u+(p+22)*Math.sin(f(g));v+='<text x="'+E+'" y="'+(O+4)+'" text-anchor="middle" font-size="12" fill="'+s+'">'+M.esc(t[g].label)+"</text>";const[T,q]=w(g,p*(M.clamp(t[g].value,0,100)/100));v+='<text x="'+T+'" y="'+(q-7)+'" text-anchor="middle" font-size="11" font-weight="500" fill="'+n+'">'+Math.round(t[g].value)+"</text>"}let y="";for(let g=0;g<=a;g++){const A=w(g%a,p*(M.clamp(t[g%a].value,0,100)/100));y+=(g===0?"M":"L")+A[0]+" "+A[1]}v+='<path d="'+y+' Z" fill="'+(e.fill||"rgba(47,84,235,0.16)")+'" stroke="'+d+'" stroke-width="1.5"/>';for(let g=0;g<a;g++){const A=w(g,p*(M.clamp(t[g].value,0,100)/100));v+='<circle cx="'+A[0]+'" cy="'+A[1]+'" r="3" fill="'+d+'"/>'}let h=24;return t.forEach(function(g,A){const L=["#185FA5","#0F6E56","#993C1D","#854F0B","#534AB7","#A32D2D","#5F5E5A","#639922"][A%8];v+='<circle cx="'+(o-108)+'" cy="'+(h-3)+'" r="4" fill="'+L+'"/>',v+='<text x="'+(o-96)+'" y="'+h+'" font-size="12" fill="'+n+'">'+M.esc(g.label)+"</text>",v+='<text x="'+(o-14)+'" y="'+h+'" text-anchor="end" font-size="12" font-weight="500" fill="'+n+'">'+Math.round(g.value)+"</text>",h+=20}),v+"</svg>"}},od={class:"hours-line"},id={class:"dsh-big"},ad=["innerHTML"],ld={class:"muted-sm"},cd=ot({__name:"HoursCard",setup(t){const e=C(()=>P.weekHours()),n=C(()=>(new Date().getDay()+6)%7),s=C(()=>e.value.map((d,f)=>({label:["一","二","三","四","五","六","日"][f],value:d,highlight:f===n.value}))),r=C(()=>M.round1(M.sum(e.value))),o=C(()=>P.get().settings.weeklyTargetHours||50),i=C(()=>o.value?Math.round(r.value/o.value*100):0),{theme:a}=vn(),l=C(()=>(a.value,Rr.bar(s.value,{height:110,unit:"h",hiColor:M.themeColor("--chart-ink","#000")}))),u=C(()=>P.todayHours());function p(){It.open({title:"记录学习时长",html:'<div class="seg-row" id="hr-segs">'+[.5,1,1.5,2,3].map(d=>'<button class="seg" data-h="'+d+'">+'+d+"h</button>").join("")+'</div><div class="muted-sm">点击即累加到今天（当前 '+P.todayHours()+"h）</div>",actions:[{label:"完成",kind:"btn-primary"}]}),document.querySelectorAll("#hr-segs .seg").forEach(d=>{d.onclick=()=>{P.addHours(+d.getAttribute("data-h")),X.success("+"+d.getAttribute("data-h")+"h，今日共 "+P.todayHours()+"h")}})}return(d,f)=>(b(),Ct(Xt,{icon:"📈",title:"本周节奏",tint:"ok"},{actions:ft(()=>[c("button",{class:"link-btn",onClick:p},"+ 记录时长")]),default:ft(()=>[c("div",od,[c("span",id,[Z(k(r.value),1),f[0]||(f[0]=c("span",{class:"dsh-unit"},"小时",-1))]),c("span",{class:tt(["dsh-pill",i.value>=70?"dsh-pill-up":"dsh-pill-warn"])},k(i.value>=70?"↑":"↓")+" 目标 "+k(i.value)+"% ",3)]),c("div",{class:"wk-chart",innerHTML:l.value},null,8,ad),c("div",ld,"今日 "+k(u.value)+"h · 周目标 "+k(o.value)+"h",1)]),_:1}))}}),ud=Rt(cd,[["__scopeId","data-v-2168edf0"]]),dd={class:"subj4"},pd={class:"chip-name"},fd={class:"chip-num"},hd={key:0,class:"rvd-wrap"},gd=["onClick"],md={class:"rvd-stage"},yd={class:"rvd-text"},vd=["onClick"],bd=["onClick"],wd={key:1},kd={class:"task-check"},_d=["checked","onChange"],Sd={class:"seq-text"},xd={key:2,class:"empty"},Ad=ot({__name:"TasksCard",setup(t){const e=()=>window,n=C(()=>P.todayTaskStats()),s=C(()=>{const y=e().SchedulerModule;return y&&y.currentPlan&&y.currentPlan()||{sequence:[]}}),r=C(()=>s.value.sequence.slice(0,5)),o=C(()=>or(P.get()).slice(0,5)),i=["math","ctrl","eng","pol"],a=C(()=>i.map(y=>{const h=Wt.SUBJECTS[y],g=n.value[y][0],A=n.value[y][1];return{k:y,short:h.short,d:g,t:A,done:A>0&&g===A,color:h.color}}));function l(y){const h=P.get().tasks.find(g=>g.id===y);return h?!!h.done:!1}function u(y,h){const g=e().TasksModule;g&&g.toggleTask(y,h)}function p(y){return(Wt.SUBJECTS[y]||{color:"#666"}).color}function d(y){return y.kind==="photo"?"📸":y.kind==="pol"?"📕":y.kind==="vocab"?"📚":y.kind==="reading"?"📖":y.kind==="srs"?"⚡":"✍️"}function f(y){return y.kind==="vocab"||y.kind==="reading"||y.kind==="srs"}function w(y){if(y.kind==="pol"){const g=e().PolReciteModule;g&&g.grade(y.id,!0),e().AiMemory&&e().AiMemory.recordEvent("完成政治大题复习",String(y.id||"").slice(0,8)),X.success("✓ 政治大题复习完成，记忆又牢了一层");return}const h=y.kind==="photo"?"mistakePhotos":"mistakes";P.update(g=>{const A=(g[h]||[]).find(L=>L.id===y.id);A&&A.reviewPlan&&(A.reviewPlan.done||(A.reviewPlan.done={}),A.reviewPlan.done["d"+y.stage]=M.dkey())}),e().AiMemory&&e().AiMemory.recordEvent("完成到期复习","D"+y.stage+"阶段"+(y.kind==="photo"?"拍题":"错题")+"重做"),X.success("✓ 复习完成，记忆又牢了一层")}function v(y){if(y.kind==="pol"){const h=e().PolReciteModule;h&&h.openReview(y.id);return}if(y.kind==="vocab"){kt.push(Ut("wordbook"));return}if(y.kind==="reading"){kt.push(Ut("reading"));return}if(y.kind==="srs"){kt.push(Ut("mistakes")),setTimeout(()=>{try{const h=e().MistakesModule;h&&h.srsDueList&&h.srsDueList().length&&h.openDrill()}catch{}},150);return}}return(y,h)=>(b(),Ct(Xt,{icon:"☑️",title:"今日任务",tint:"ok"},{actions:ft(()=>[c("button",{class:"link-btn",onClick:h[0]||(h[0]=g=>W(kt).push(W(Ut)("scheduler")))},"完整排程 →")]),default:ft(()=>[c("div",dd,[(b(!0),_(H,null,Q(a.value,g=>(b(),_("div",{key:g.k,class:tt(["chip mini",{"chip-done":g.done}]),style:Vt({"--sc":g.color})},[c("span",pd,k(g.short),1),c("span",fd,k(g.d)+"/"+k(g.t),1)],6))),128))]),o.value.length?(b(),_("div",hd,[h[1]||(h[1]=c("div",{class:"muted-sm rvd-cap"},"📅 今日到期复习（重做原题，勿看解析）",-1)),(b(!0),_(H,null,Q(o.value,g=>(b(),_("div",{key:g.kind+g.id,class:tt(["rvd-item",{"rvd-click":g.kind==="pol"||g.kind==="vocab"||g.kind==="reading"}]),onClick:A=>v(g)},[c("span",md,k(f(g)?"SRS":"D"+g.stage),1),c("span",yd,k(d(g))+" "+k(g.text),1),f(g)?(b(),_("button",{key:0,class:"btn btn-primary btn-sm",onClick:en(A=>v(g),["stop"])},"去复习 →",8,vd)):(b(),_("button",{key:1,class:"btn btn-ghost btn-sm",onClick:en(A=>w(g),["stop"])},"✓ 重做完成",8,bd))],10,gd))),128))])):z("",!0),r.value.length?(b(),_("div",wd,[(b(!0),_(H,null,Q(r.value,g=>(b(),_("label",{key:g.id,class:tt(["seq-row",{"seq-is-done":l(g.id)}])},[c("span",kd,[c("input",{type:"checkbox",checked:l(g.id),onChange:A=>u(g.id,A.target.checked)},null,40,_d),h[2]||(h[2]=c("span",{class:"box"},null,-1))]),c("span",Sd,k(g.text),1),c("span",{class:"seq-badge",style:Vt({color:p(g.subject)})},k(g.weight),5)],2))),128))])):(b(),_("div",xd,"暂无任务"))]),_:1}))}}),Ed=Rt(Ad,[["__scopeId","data-v-3233740a"]]),Td={class:"tiles"},Id=["onClick"],Od=["innerHTML"],Md={key:0,class:"tile-dot"},Pd={class:"tile-name"},Nd=ot({__name:"TilesCard",setup(t){const e=()=>window,n=C(()=>{const l=P.todayTaskStats();return l.math[1]+l.ctrl[1]+l.eng[1]+l.pol[1]-l.math[0]-l.ctrl[0]-l.eng[0]-l.pol[0]}),s=C(()=>or(P.get()).length),r=C(()=>{const l=e().WordbookModule;try{return l&&l.dueCount?l.dueCount():0}catch{return 0}}),o=[{id:"scheduler",tint:"warn",badge:()=>n.value},{id:"quiz",tint:"blue"},{id:"mistakes",tint:"danger",badge:()=>s.value},{id:"wordbook",tint:"ok",badge:()=>r.value},{id:"polrecite",tint:"danger"},{id:"sprint",tint:"purple"},{id:"share",tint:"blue"},{id:"focus",tint:"ok"},{id:"essay",tint:"warn"}],i=C(()=>o.map(l=>{const u=Ge[l.id]?l.id:"tools";return{go:l.id,svg:Ge[u]||"",name:Ki(l.id),n:l.badge?Math.max(0,l.badge()):0,tint:l.tint}}));function a(l){kt.push(Ut(l))}return(l,u)=>(b(),Ct(Xt,{icon:"🚀",title:"快捷入口",tint:"blue"},{extra:ft(()=>[...u[0]||(u[0]=[c("span",{class:"muted-sm"},"红点 = 有待办",-1)])]),default:ft(()=>[c("div",Td,[(b(!0),_(H,null,Q(i.value,p=>(b(),_("button",{key:p.go,class:"tile",onClick:d=>a(p.go)},[c("span",{class:tt(["tile-ico","tint-"+p.tint])},[c("span",{innerHTML:p.svg},null,8,Od),p.n>0?(b(),_("span",Md)):z("",!0)],2),c("span",Pd,[Z(k(p.name),1),p.n>0?(b(),_(H,{key:0},[Z(" · "+k(p.n),1)],64)):z("",!0)])],8,Id))),128))])]),_:1}))}}),Ld=Rt(Nd,[["__scopeId","data-v-8644a98a"]]),Cd={key:0,class:"streak"},jd={class:"muted-sm"},qd={class:"cal"},Dd={class:"cal-mrow"},Rd={class:"cal-wd"},Bd={key:0,class:"cal-cell cal-empty"},Jd=["title"],Gd={class:"cal-foot"},Hd={class:"muted-sm"},Te=12,zd=ot({__name:"CalendarCard",setup(t){const e=["一","二","三","四","五","六","日"],n=C(()=>{const o=P.get(),i=new Date;i.setHours(23,59,59,999);let a=M.weekMonday(new Date);a=new Date(a.getTime()-(Te-1)*7*M.DAY_MS);const l=[];for(let u=0;u<7;u++){const p=[];for(let d=0;d<Te;d++){const f=new Date(a.getTime()+(d*7+u)*M.DAY_MS);if(f>i){p.push(null);continue}const w=M.dkey(f),v=o.studyHours[w]||0,y=(o.completions[w]||[]).length,h=v+y*.5,g=h<=0?0:h<2?1:h<4?2:h<6?3:4,A=f.getFullYear()===i.getFullYear()&&f.getMonth()===i.getMonth()&&f.getDate()===i.getDate();p.push({k:w,lv:g,isToday:A,h:v,doneN:y})}l.push(p)}return l}),s=C(()=>{let o=M.weekMonday(new Date);o=new Date(o.getTime()-(Te-1)*7*M.DAY_MS);const i=[];let a=-1;for(let l=0;l<Te;l++){const u=new Date(o.getTime()+l*7*M.DAY_MS),p=l===0||u.getMonth()!==a?u.getMonth()+1+"月":"";p&&(a=u.getMonth()),i.push(p)}return i}),r=C(()=>{const o=P.get();let i=M.weekMonday(new Date);i=new Date(i.getTime()-(Te-1)*7*M.DAY_MS);const a=new Date;a.setHours(23,59,59,999);let l=0,u=0,p=0,d=0;for(let f=0;;f++){const w=new Date(i.getTime()+f*M.DAY_MS);if(w>a)break;const v=M.dkey(w),y=o.studyHours[v]||0;y+(o.completions[v]||[]).length*.5>0?(u++,l+=y,d++,d>p&&(p=d)):d=0}return{totalH:M.round1(l),activeDays:u,best:p,streak:P.studyStreak()}});return(o,i)=>(b(),Ct(Xt,{icon:"🗓️",title:"学习日历",tint:"warn"},{extra:ft(()=>[r.value.streak>=2?(b(),_("span",Cd,"🔥 连续 "+k(r.value.streak)+" 天",1)):z("",!0),c("span",jd,[i[0]||(i[0]=Z("近12周 ",-1)),c("b",null,k(r.value.activeDays),1),i[1]||(i[1]=Z(" 天活跃",-1))])]),default:ft(()=>[c("div",qd,[c("div",Dd,[i[2]||(i[2]=c("span",{class:"cal-wd"},null,-1)),(b(!0),_(H,null,Q(s.value,(a,l)=>(b(),_("span",{key:"m"+l,class:"cal-mcell"},k(a),1))),128))]),(b(!0),_(H,null,Q(n.value,(a,l)=>(b(),_("div",{key:"r"+l,class:"cal-row"},[c("span",Rd,k(e[l]),1),(b(!0),_(H,null,Q(a,(u,p)=>(b(),_(H,{key:"c"+l+"-"+p},[u?(b(),_("span",{key:1,class:tt(["cal-cell",["cal-lv"+u.lv,{"cal-today":u.isToday}]]),title:u.k+" · "+u.h+"h · 完成"+u.doneN+"项"},null,10,Jd)):(b(),_("span",Bd))],64))),128))]))),128))]),c("div",Gd,[i[4]||(i[4]=c("div",{class:"cal-legend"},[c("span",{class:"muted-sm"},"少"),c("span",{class:"cal-cell cal-lv0"}),c("span",{class:"cal-cell cal-lv1"}),c("span",{class:"cal-cell cal-lv2"}),c("span",{class:"cal-cell cal-lv3"}),c("span",{class:"cal-cell cal-lv4"}),c("span",{class:"muted-sm"},"多")],-1)),c("span",Hd,[i[3]||(i[3]=Z("累计 ",-1)),c("b",null,k(r.value.totalH)+"h",1)])])]),_:1}))}}),$d=Rt(zd,[["__scopeId","data-v-d14087cc"]]),Ud={class:"dsh-root"},Fd=["innerHTML"],Kd={class:"dsh-bento"},Vd=ot({__name:"DashboardView",setup(t){const e=C(()=>(P.get().milestones,P.get().alerts,ls.bannerHtml()));return he(()=>{Zo(),ti()}),(n,s)=>(b(),_("div",Ud,[e.value?(b(),_("div",{key:0,class:"dsh-banner",innerHTML:e.value},null,8,Fd)):z("",!0),ct(nu),c("div",Kd,[ct(yu,{class:"dsh-span7"}),ct(Qu,{class:"dsh-span5"}),ct(rd,{class:"dsh-span7"}),ct(ud,{class:"dsh-span5"}),ct(Ed,{class:"dsh-span7"}),ct(Ld,{class:"dsh-span5"}),ct($d,{class:"dsh-span12"})])]))}}),Qd=Rt(Vd,[["__scopeId","data-v-f21c490f"]]),Xd=[{path:"/",redirect:"/dashboard"},{path:"/dashboard",name:"dashboard",component:Qd},...we.filter(t=>t.id!=="dashboard").map(t=>({path:"/"+t.id,name:t.id,component:Vs})),{path:"/tool/aitools",name:"aitools",component:Ua},{path:"/tool/prompt-studio",name:"prompt-studio",component:Uc},{path:"/tool/:id",name:"tool",component:Vs},{path:"/:pathMatch(.*)*",redirect:"/dashboard"}],kt=Do({history:Ro(),routes:Xd});kt.beforeEach(()=>{const t=window.FocusModule;return t&&t.active?(X.show("深度专注进行中，请先点「中断专注」结束再切换","warn",3500),!1):!0});function Wd(){let t="";try{const s=D.tools();s&&s.length&&(t='<div class="muted-sm" style="margin:10px 0 4px;font-size:12px">🧩 插件工具</div><div class="tools-grid">'+s.map(r=>'<button class="tool-cell" data-tab="'+r.id+'"><span class="tool-icon">'+(r.icon||"🧩")+"</span><span>"+M.esc(r.title)+"</span></button>").join("")+"</div>")}catch{}const e=bn.map(s=>'<button class="tool-cell" data-tab="'+s.id+'"><span class="tool-icon">'+(Ge[s.icon]||"🧩")+"</span><span>"+s.label+"</span></button>").join(""),n=It.open({title:"🧰 工具箱",html:'<div class="tools-grid">'+e+"</div>"+t,actions:[{label:"关闭"}]});document.querySelectorAll(".tool-cell").forEach(s=>{s.onclick=()=>{const r=s.getAttribute("data-tab");n(),r&&kt.push("/tool/"+r)}})}const Yd={class:"bottomnav",id:"bottomnav","data-testid":"bottomnav"},Zd=["data-tab","data-testid","onClick"],tp={class:"bn-icon"},ep={class:"bn-label"},np=["data-tab","onClick"],sp={class:"bn-icon"},rp=["innerHTML"],op={class:"bn-icon"},ip={class:"bn-group bn-group-tools"},ap=["data-tab","data-tool-id","data-testid","onPointerdown","onClick"],lp={class:"bn-icon"},cp={class:"bn-label"},up=ot({__name:"BottomNav",setup(t){const e=Xn(),n=Qn(),{toggle:s}=Cr(),r=C(()=>String(e.params.id||e.name||"")),o=et([]),i=et([]);function a(){try{o.value=D.maintabs()||[]}catch{o.value=[]}try{i.value=D.tools()||[]}catch{i.value=[]}}he(a);const l=C(()=>!we.some(T=>T.id===r.value)&&!!r.value);function u(T){n.push("/"+T)}function p(T){y||n.push("/tool/"+T)}function d(T){return M.esc(T)}const f=et(Array.isArray(P.get().toolOrder)?P.get().toolOrder.slice():[]);function w(T,q){if(!q.length)return T;const I=N=>{const R=q.indexOf(N);return R<0?q.length+T.findIndex(B=>B.id===N):R};return T.slice().sort((N,R)=>I(N.id)-I(R.id))}const v=C(()=>{const T=bn.map(q=>({id:q.id,label:q.label,icon:q.icon,plugin:!1})).concat(i.value.map(q=>({id:q.id,label:q.title||q.id,icon:q.icon||"🧩",plugin:!0})));return w(T,f.value)});let y=!1;const h=et("");let g=0;function A(T,q){y=!1;const I=T.currentTarget;g=window.setTimeout(()=>{h.value=q,I.classList.add("bn-dragging");try{I.setPointerCapture(T.pointerId)}catch{}if(navigator.vibrate)try{navigator.vibrate(12)}catch{}},450)}function L(T){if(g&&!h.value&&(clearTimeout(g),g=0),!h.value)return;T.preventDefault();const N=document.elementFromPoint(T.clientX,T.clientY)?.closest("[data-tool-id]")?.dataset.toolId;if(N&&N!==h.value){const R=v.value.map(V=>V.id),B=R.indexOf(h.value),$=R.indexOf(N);B>=0&&$>=0&&(R.splice($,0,R.splice(B,1)[0]),f.value=R,y=!0)}}function E(T){g&&(clearTimeout(g),g=0),T.currentTarget?.classList.remove("bn-dragging"),h.value&&(P.update(I=>{I.toolOrder=f.value}),h.value="",setTimeout(()=>{y=!1},120))}function O(){f.value=[],P.update(T=>{T.toolOrder=[]})}return(T,q)=>(b(),_("nav",Yd,[q[7]||(q[7]=c("div",{class:"bn-brand"},[c("div",{class:"bn-brand-name"},[c("span",{class:"bn-brand-ico"},"🎯"),Z("26考研作战系统")]),c("div",{class:"bn-brand-sub"},"最适合你的工作台")],-1)),c("button",{class:"bn-layout-toggle","data-testid":"layout-toggle",title:"切回手机单列布局",onClick:q[0]||(q[0]=I=>W(s)())}," 📱 切回手机布局 "),(b(!0),_(H,null,Q(W(we),I=>(b(),_("button",{key:I.id,class:tt(["bn-btn",{"bn-on":r.value===I.id}]),"data-tab":I.id,"data-testid":"nav-"+I.id,onClick:N=>u(I.id)},[c("span",tp,[ct(Xe,{name:I.icon},null,8,["name"])]),c("span",ep,k(I.label),1)],10,Zd))),128)),(b(!0),_(H,null,Q(o.value,I=>(b(),_("button",{key:"plugin-"+I.id,class:tt(["bn-btn",{"bn-on":r.value===I.id}]),"data-tab":I.id,onClick:N=>p(I.id)},[c("span",sp,k(I.icon||"🧩"),1),c("span",{class:"bn-label",innerHTML:d(I.name)},null,8,rp)],10,np))),128)),c("button",{class:tt(["bn-btn",{"bn-on":l.value}]),"data-tab":"__tools","data-testid":"nav-tools",onClick:q[1]||(q[1]=I=>W(Wd)())},[c("span",op,[ct(Xe,{name:"tools"})]),q[4]||(q[4]=c("span",{class:"bn-label"},"工具",-1))],2),c("div",ip,[q[5]||(q[5]=c("span",null,"工具",-1)),f.value.length?(b(),_("button",{key:0,class:"bn-reset-order","data-testid":"nav-reset-order",title:"恢复默认顺序",onClick:O},"↺")):z("",!0)]),c("div",{class:"bn-scroll",onPointermove:L,onPointerup:E,onPointercancel:E},[(b(!0),_(H,null,Q(v.value,I=>(b(),_("button",{key:"stool-"+I.id,class:tt(["bn-btn bn-tool-item",{"bn-on":r.value===I.id,"bn-dragging":h.value===I.id}]),"data-tab":I.id,"data-tool-id":I.id,"data-testid":"nav-tool-"+I.id,onPointerdown:N=>A(N,I.id),onClick:N=>p(I.id)},[c("span",lp,[I.plugin?(b(),_(H,{key:1},[Z(k(I.icon),1)],64)):(b(),Ct(Xe,{key:0,name:I.icon||""},null,8,["name"]))]),c("span",cp,k(I.label),1)],42,ap))),128))],32),c("div",{class:"bn-user bn-user-clickable",role:"button",tabindex:"0",title:"前往设置","data-testid":"nav-go-settings",onClick:q[2]||(q[2]=I=>p("settings")),onKeydown:q[3]||(q[3]=Wn(I=>p("settings"),["enter"]))},[...q[6]||(q[6]=[c("span",{class:"bn-user-avatar"},"岸",-1),c("span",null,[c("b",null,"上岸预定人"),Z("点击前往设置")],-1),c("span",{class:"bn-user-arrow","aria-hidden":"true"},"›",-1)])],32)]))}}),dp={class:"cp-pal",role:"dialog","aria-label":"命令面板"},pp={class:"cp-pal-list"},fp={class:"cp-pal-group"},hp=["id","onClick","onMouseenter"],gp={class:"cp-pal-ico"},mp={class:"cp-pal-title"},yp={key:0,class:"cp-pal-sub"},vp={key:0,class:"cp-pal-empty"},bp=ot({__name:"CommandPalette",setup(t){const e=Qn(),n=vn(),s=et(!1),r=et(""),o=et(0),i=et(null);function a(y){s.value=!1,e.push(y)}const l=C(()=>{const y=r.value.trim().toLowerCase(),h=I=>!y||String(I||"").toLowerCase().includes(y),g=P.get(),A=I=>I+" 条",L=[...we.filter(I=>h(I.label)||h(I.id)).map(I=>({icon:"🧭",title:I.label,sub:"页面",run:()=>a("/"+I.id)})),...bn.filter(I=>h(I.label)||h(I.id)).map(I=>({icon:"🧰",title:I.label,sub:"工具",run:()=>a("/tool/"+I.id)}))];try{const I=Array.isArray(D.maintabs())?D.maintabs():[],N=Array.isArray(D.tools())?D.tools():[];L.push(...I.filter(R=>h(R.name)).map(R=>({icon:R.icon||"🧩",title:R.name,sub:"插件",run:()=>a("/"+R.id)}))),L.push(...N.filter(R=>h(R.title)).map(R=>({icon:R.icon||"🧩",title:R.title,sub:"插件工具",run:()=>a("/tool/"+R.id)})))}catch{}const E=[],O=I=>()=>{s.value=!1,e.push("/tool/photomistake").then(()=>setTimeout(()=>{try{window.PhotoMistakeModule&&window.PhotoMistakeModule.open(I)}catch{}},80))};(h("错题")||h("mistake"))&&E.push({icon:"📕",title:"错题本",sub:A((g.mistakes||[]).length)+" · 跳转后可搜",run:()=>a("/tool/mistakes")}),(h("单词")||h("vocab"))&&E.push({icon:"🔤",title:"单词",sub:A((g.vocab||[]).length),run:()=>a("/tool/wordbook")}),(h("考点")||h("热力"))&&E.push({icon:"🔥",title:"考点热力",sub:"跳转",run:()=>a("/tool/heatmap")}),(h("讲义")||h("资料库")||h("资料"))&&E.push({icon:"📚",title:"资料库",sub:A((g.studyBooks||[]).length)+" 本",run:()=>a("/tool/sprint")}),(h("任务")||h("排程"))&&E.push({icon:"🗓",title:"今日排程",sub:A((g.tasks||[]).length)+" 项",run:()=>a("/scheduler")}),(h("复习计划")||h("复习")||h("到期"))&&E.push({icon:"📅",title:"复习计划（拍题）",sub:"艾宾浩斯 · 到期直接开始复习",run:O("review")});const T=(()=>{try{const I=window.MistakesModule;return I&&I.srsDueList?I.srsDueList().length:0}catch{return 0}})();return T&&(h("到期")||h("fsrs")||h("复习"))&&E.push({icon:"⚡",title:`到期错题复习（${T} 题）`,sub:"错题本 FSRS · 直接开回忆卡",run:()=>{s.value=!1,e.push("/tool/mistakes").then(()=>setTimeout(()=>{try{const I=window.MistakesModule;I&&I.srsDueList&&I.srsDueList().length&&I.openDrill()}catch{}},150))}}),(h("薄弱")||h("画像"))&&E.push({icon:"🧠",title:"薄弱画像",sub:"打包错题 → 生成弱点补卷",run:O("weak")}),h("记忆测试")&&E.push({icon:"🎯",title:"记忆测试",sub:"AI 出选判题查遗忘",run:()=>{s.value=!1,e.push("/tool/photomistake").then(()=>setTimeout(()=>{try{window.PhotoMistakeModule&&window.PhotoMistakeModule.openMemoryQuiz()}catch{}},80))}}),(Array.isArray(g.studyBooks)?g.studyBooks:[]).filter(I=>y&&h(I.title)).slice(0,5).forEach(I=>E.push({icon:"📖",title:I.title,sub:"讲义 · 直达阅读",run:()=>{s.value=!1,e.push("/tool/sprint").then(()=>setTimeout(()=>{try{window.SprintModule&&window.SprintModule.openBook(I.id)}catch{}},80))}})),[{id:"nav",icon:"🧭",label:"导航",items:L},{id:"content",icon:"🔎",label:"内容与资料",items:E},{id:"action",icon:"⚡",label:"快捷操作",items:[{icon:"🌗",title:"切换主题（跟随系统/墨白/晨岚/星阑 循环）",sub:"快捷",run:()=>{n.cycle(),s.value=!1}},{icon:"🔒",title:"开始深度专注",sub:"快捷",run:()=>a("/focus")}]}].filter(I=>I.items.length)}),u=C(()=>l.value.flatMap(y=>y.items));qe(r,()=>{o.value=0}),qe(u,()=>{o.value>=u.value.length&&(o.value=0)});function p(y){const h=u.value.length;h&&(o.value=(o.value+y+h)%h,tn(()=>{const g=document.getElementById("cp-pal-item-"+o.value);g&&g.scrollIntoView({block:"nearest"})}))}function d(){const y=u.value[o.value];y&&y.run()}function f(y){s.value=y??!s.value,s.value&&(r.value="",o.value=0,tn(()=>i.value&&i.value.focus()))}function w(y){if((y.metaKey||y.ctrlKey)&&(y.key==="k"||y.key==="K")){y.preventDefault(),f();return}s.value&&(y.key==="Escape"?s.value=!1:y.key==="ArrowDown"?(y.preventDefault(),p(1)):y.key==="ArrowUp"?(y.preventDefault(),p(-1)):y.key==="Enter"&&(y.preventDefault(),d()))}function v(){window.CommandPalette={open:()=>f(!0),close:()=>f(!1)}}return he(()=>{document.addEventListener("keydown",w),v()}),rr(()=>{document.removeEventListener("keydown",w)}),(y,h)=>(b(),Ct(Bo,{to:"body"},[s.value?(b(),_("div",{key:0,class:"cp-pal-mask",onClick:h[1]||(h[1]=en(g=>s.value=!1,["self"]))},[c("div",dp,[Qt(c("input",{ref_key:"inputEl",ref:i,"onUpdate:modelValue":h[0]||(h[0]=g=>r.value=g),class:"cp-pal-input",placeholder:"搜索页面 / 工具 / 讲义 / 操作…（↑↓ 选择，Enter 打开，Esc 关闭）",autocomplete:"off"},null,512),[[ye,r.value]]),c("div",pp,[(b(!0),_(H,null,Q(l.value,(g,A)=>(b(),_(H,{key:g.id},[c("div",fp,k(g.icon)+" "+k(g.label),1),(b(!0),_(H,null,Q(g.items,(L,E)=>(b(),_("div",{key:g.id+E,id:"cp-pal-item-"+(l.value.slice(0,A).reduce((O,T)=>O+T.items.length,0)+E),class:tt(["cp-pal-item",{on:l.value.slice(0,A).reduce((O,T)=>O+T.items.length,0)+E===o.value}]),onClick:O=>L.run(),onMouseenter:O=>o.value=l.value.slice(0,A).reduce((T,q)=>T+q.items.length,0)+E},[c("span",gp,k(L.icon),1),c("span",mp,k(L.title),1),L.sub?(b(),_("span",yp,k(L.sub),1)):z("",!0)],42,hp))),128))],64))),128)),u.value.length?z("",!0):(b(),_("div",vp,"没有匹配项"))])])])):z("",!0)]))}}),wp=Rt(bp,[["__scopeId","data-v-1f592172"]]),kp={class:"app"},_p=["data-cols"],Sp={class:"view",id:"vue-view","data-testid":"vue-view"},zn=ot({__name:"App",setup(t){const e=Xn(),n=new Set(["aitools","dashboard","prompt-studio"]),s=C(()=>n.has(String(e.name||""))),r=C(()=>String(e.params.id||e.name||"dashboard")),o=new Set(["scheduler"]),i=C(()=>o.has(r.value)?"2":void 0);let a=null;function l(){const u=document.getElementById("view"),p=document.getElementById("vue-view"),d=s.value?p:u;d&&(d.classList.remove("view-enter"),d.offsetWidth,d.classList.add("view-enter"),a&&clearTimeout(a),a=setTimeout(()=>d.classList.remove("view-enter"),620))}return qe(()=>e.fullPath,()=>l()),he(()=>{l()}),(u,p)=>{const d=Jo("RouterView");return b(),_(H,null,[c("div",kp,[ct(Ui),Qt(c("main",{class:"view",id:"view","data-cols":i.value},null,8,_p),[[js,!s.value]]),Qt(c("main",Sp,[ct(d)],512),[[js,s.value]]),ct(up),ct(wp)]),p[0]||(p[0]=c("div",{id:"toast-wrap"},null,-1))],64)}}}),at={},Ie={},xp={run(t,e,n,s){if(s=s||{},Ie[t])return Ie[t];const r={id:t,label:e||t,status:"running",result:void 0,error:"",extra:s.extra||null,startedAt:new Date().toISOString(),finishedAt:""};at[t]=r;const o=Promise.resolve().then(function(){return n()}).then(function(i){if(r.status="done",r.result=i,r.finishedAt=new Date().toISOString(),delete Ie[t],s.onDone)try{s.onDone(i,r)}catch(a){console.warn("[BgTask] onDone 回调异常",a)}return window.U&&M.emit&&M.emit("bgTask:done",{id:t,label:r.label,result:i}),i},function(i){if(r.status="error",r.error=i&&i.message?i.message:String(i),r.finishedAt=new Date().toISOString(),delete Ie[t],s.onError)try{s.onError(i,r)}catch(a){console.warn("[BgTask] onError 回调异常",a)}throw window.U&&M.emit&&M.emit("bgTask:error",{id:t,label:r.label,error:r.error}),i});return Ie[t]=o,o.catch(function(){}),o},isRunning(t){return!!(at[t]&&at[t].status==="running")},get(t){return at[t]||null},getResult(t){return at[t]&&at[t].status==="done"?at[t].result:void 0},getError(t){return at[t]&&at[t].status==="error"?at[t].error:""},clear(t){at[t]&&at[t].status!=="running"&&delete at[t]},clearAll(){Object.keys(at).forEach(function(t){at[t].status!=="running"&&delete at[t]})},list(t){return Object.keys(at).filter(function(e){return!t||at[e].status==="running"}).map(function(e){return at[e]})}},Ap=`# kaoyan2026 云端出卷执行器 workflow（2026-08-24；v11 增 PDF 导入资源 Gist）
...
⑥ 不确定就给保守、通用、稳妥的做法，不要编造偏门技巧。用简体中文。`}function xf(){var t=uo();return!!(t&&t.configured&&t.configured())}function Ts(t,e){return e=e||{},new Promise(function(n){if(!window.InspectorModule){n(null);return}var s=e.force?null:ze(t);if(s&&s.pb){n({pb:s.pb,created:!1,bound:s.bound});return}if(!xf()){e.silent||window.Toast&&X.warn("未配置 AI，无法自动建立方法卡。可到「解题方法」页手动新建。"),n(null);return}var r=uo();function o(i,a){var l=r.chatJSON?r.chatJSON(Kn(t),i,null,{ctx:"insp.gen",noThink:!0}):r.chatStream(Kn(t),i,null,null,{ctx:"insp.gen",noThink:!0}).then(function(u){return r.extractRobustJSON(u||"")});l.then(function(u){var p=Dt().normalizePlaybook(u,t.subject||"math");if(!p){if(!a){o(i+`
【重试注意】上次 JSON 不完整（疑似被截断）。请压缩每条字数（do≤25字/tip≤20字），确保 steps 4-7 步与全部字段一次性完整输出。严禁把裸字段名（如 "name"、"do"、"tip"）或 JSON 语法碎片（如 "]"、"steps"）当成内容输出；所有数组必须完整闭合。`,!0);return}e.silent||window.Toast&&X.warn("AI 返回的方法卡格式不合格，已放弃入库（不会污染方法库）"),n(null);return}p.source="auto:"+(t.module||"unknown"),p.autoFp=t.fp||"",p.autoTopic=t.topicName||t.type||"",p.uses=0,Yt().update(function(d){d.playbooks=d.playbooks||[],d.playbooks.unshift(p)}),Tn(t.fp,p.id),n({pb:p,created:!0,bound:!0})}).catch(function(u){e.silent||window.Toast&&X.warn("建立方法卡失败："+(u&&u.message||u)),n(null)})}o("请为这类题生成方法卡。",!1)})}function Tn(t,e){!t||!e||Yt().update(function(n){n.playbookLinks=n.playbookLinks||{},n.playbookLinks[t]=e})}function Af(t){t&&Yt().update(function(e){e.playbookLinks&&delete e.playbookLinks[t]})}function yo(t,e){e=e||{};var n=e.autoCreate!==!1;return new Promise(function(s){if(!window.InspectorModule){window.Toast&&X.warn("解题方法模块未加载"),s(null);return}var r=ze(t);if(r&&r.pb){er(r.pb,t,e),s(r.pb);return}if(!n){Dt().startGuide?Dt().startGuide("",t.stem,{origin:e.origin,ctx:t}):Dt().openFor({subject:t.subject,type:t.type,desc:t.topicName}),s(null);return}Ts(t,{silent:!1}).then(function(o){o&&o.pb&&er(o.pb,t,e),s(o?o.pb:null)})})}function er(t,e,n){t&&(e.fp&&Tn(e.fp,t.id),Dt().startGuide?Dt().startGuide(t.id,e.stem||e.topicName,{origin:n.origin||xs[e.module]||e.module||"",originTab:n.originTab||e.module||"",ctx:e}):Dt().openPlaybook(t.id))}function vo(t){var e=ze(t);return e&&e.pb?(Dt().openPlaybook(e.pb.id),e.pb):(Dt().openFor({subject:t.subject,type:t.type,desc:t.topicName||t.stem}),null)}function Ef(t){t=t||{};var e={id:"dr"+Date.now().toString(36)+Math.random().toString(36).slice(2,6),pbId:t.pbId||"",fp:t.fp||"",subject:t.subject||"",topicId:t.topicId||"",topic:String(t.topic||"").slice(0,40),module:t.module||"",steps:t.steps||0,doneSteps:t.doneSteps||0,risk:t.risk==null?null:t.risk,ok:!!t.ok,createdAt:new Date().toISOString()};return Yt().update(function(n){n.playbookDrills=n.playbookDrills||[],n.playbookDrills.unshift(e),n.playbookDrills.length>300&&(n.playbookDrills.length=300)}),e.ok&&e.topicId?bo(e.topicId,6):e.ok&&e.topic&&Tf(e.subject,e.topic,6),e}function bo(t,e){t&&Yt().update(function(n){n.heat=n.heat||{};var s=n.heat[t]||{level:0,score:null,updatedAt:""};s.score==null&&(s.score=50),s.score=Math.max(0,Math.min(100,s.score+e)),s.level=s.score>=75?2:s.score>=45?1:0,s.updatedAt=new Date().toISOString(),n.heat[t]=s,n.heatHistory||(n.heatHistory={});var r=n.heatHistory[t]||[];r.push({score:s.score,level:s.level,at:new Date().toISOString()}),r.length>30&&(r=r.slice(-30)),n.heatHistory[t]=r})}function Tf(t,e,n){try{var s=window.DB&&Wt.TOPICS&&Wt.TOPICS[t]||[],r=null,o=0;s.forEach(function(i){var a=Fn(String(i.name||""),e);a>o&&(o=a,r=i)}),r&&o>.5&&bo(r.id,n)}catch{}}function wo(t){var e=As().filter(function(s){return s.pbId===t});if(!e.length)return{n:0,ok:0,rate:0,last:""};var n=e.filter(function(s){return s.ok}).length;return{n:e.length,ok:n,rate:Math.round(n/e.length*100),last:e[0].createdAt||""}}function If(t){var e=As().filter(function(n){return n.fp===t});return{n:e.length,ok:e.filter(function(n){return n.ok}).length,last:e.length?e[0].createdAt:""}}var Vn={},jn=0;function Of(t){jn>400&&(Vn={},jn=0);var e="c"+jn+++Math.random().toString(36).slice(2,6);return Vn[e]=t,e}function ko(t){return t&&Vn[t]||null}function Is(t,e){if(e=e||{},!t)return"";var n=ze(t),s=n?n.pb:null,r=t.topicName||t.type||"这一类题",o=s?wo(s.id):null,i;return s?i='<span class="ml-pb-name">'+de(s.title)+'</span><span class="ml-pb-meta">'+(o&&o.n?"练过 "+o.n+" 次 · 通过率 "+o.rate+"%":"尚未实操")+(n.bound?" · 已绑定此类题":"")+"</span>":i='<span class="ml-pb-none">「'+de(r)+'」还没建立解题方法</span><span class="ml-pb-meta">建立后，同类题自动复用，带练闭环</span>','<div class="ml-panel'+(e.compact?" ml-compact":"")+'" data-ml-fp="'+de(t.fp)+'" data-ml-ctx="'+Of(t)+'"><div class="ml-head"><span class="ml-ico">🧭</span><div class="ml-right">'+i+"</div></div>"+(e.hint?'<div class="ml-hint">'+de(e.hint)+"</div>":"")+'<div class="ml-acts">'+(s?'<button class="btn btn-sm btn-primary ml-act" data-ml="practice">🎯 带我练</button><button class="btn btn-sm btn-ghost ml-act" data-ml="view">📖 看方法</button><button class="btn btn-sm btn-ghost ml-act" data-ml="swap">🔄 换一张</button>':'<button class="btn btn-sm btn-primary ml-act" data-ml="create">🧠 为这类题建立方法卡</button><button class="btn btn-sm btn-ghost ml-act" data-ml="pick">📚 从方法库挑一张</button>')+"</div></div>"}function _o(t,e,n){if(n=n||{},!!t){var s=t.classList&&t.classList.contains("ml-panel")?[t]:Array.prototype.slice.call(t.querySelectorAll(".ml-panel"));s.forEach(function(r){var o=ko(r.getAttribute("data-ml-ctx"))||e;o&&So(r,o,n)})}}function So(t,e,n){n=n||{},t.querySelectorAll(".ml-act").forEach(function(s){s.onclick=function(){var r=s.getAttribute("data-ml");if(r==="view"){vo(e);return}if(r==="practice"){yo(e,{origin:xs[e.module]||"",originTab:e.module});return}if(r==="create"){s.disabled=!0,s.textContent="⏳ 正在建立方法卡…",Ts(e,{force:!0}).then(function(o){s.disabled=!1,s.textContent="🧠 为这类题建立方法卡",o&&o.pb&&(window.Toast&&X.success("方法卡已建立："+o.pb.title+"（同类题将自动复用）"),Os(t,e,n),n.onChange&&n.onChange(o.pb,e))});return}if(r==="swap"||r==="pick"){xo(e,n,t);return}}})}function Os(t,e,n){if(!(!t||!e)){var s=Is(e,n),r=document.createElement("div");r.innerHTML=s;var o=r.firstChild;o&&(So(o,e,n),t.parentNode&&t.parentNode.replaceChild(o,t))}}function xo(t,e,n){e=e||{};var s=mo(t,12),r=(window.InspectorModule?Dt().list():[])||[],o=s.length?s:r.filter(function(a){return!t.subject||a.subject===t.subject}).map(function(a){return{pb:a,score:0}}),i='<div class="muted-sm" style="margin-bottom:8px">为「'+de(t.topicName||t.type||"这类题")+"」指定方法卡。绑定后，同类题会自动命中这张卡，不再重复询问。</div>"+(o.length?o.map(function(a){return'<div class="ml-pick-row"><div style="flex:1;min-width:0"><div style="font-size:13.5px;font-weight:600">'+de(a.pb.title)+'</div><div class="muted-sm" style="font-size:11.5px">'+(Ss[a.pb.subject]||a.pb.subject)+" · "+(a.pb.steps||[]).length+" 步"+(a.score?" · 匹配度 "+a.score:"")+'</div></div><button class="btn btn-sm btn-primary ml-pick" data-id="'+de(a.pb.id)+'">绑定</button></div>'}).join(""):'<div class="empty">当前没有候选方法卡，可先「建立方法卡」。</div>');window.Modal&&It.open({title:"🔄 选择方法卡",html:i,actions:[{label:"取消"}]}),setTimeout(function(){document.querySelectorAll(".ml-pick").forEach(function(a){a.onclick=function(){Tn(t.fp,a.getAttribute("data-id")),window.Modal&&It.close&&It.close(),window.Toast&&X.success("已绑定，同类题将自动使用这张卡"),n&&Os(n,t,e),e.onChange&&e.onChange({id:a.getAttribute("data-id")},t)}})},30)}function Mf(t,e,n,s,r){if(!t)return null;var o=ho(e,n,s);return t.innerHTML=Is(o,r),_o(t,o,r),o}const Ao={fromQuestion:ho,fingerprint:fo,match:ze,candidates:mo,scoreOf:Es,genSystemPreview:function(t){return Kn(t||{subject:"math",topicName:"极限计算"})},ensure:Ts,bind:Tn,unbind:Af,links:po,practice:yo,view:vo,recordDrill:Ef,drills:As,statsOf:wo,fpStats:If,panelHtml:Is,bindPanel:_o,repaintPanel:Os,mount:Mf,openPicker:xo,ctxOfToken:ko,SUBJ_CN:Ss,MOD_CN:xs,MATCH_MIN:go},Pf=Object.freeze(Object.defineProperty({__proto__:null,MethodLink:Ao},Symbol.toStringTag,{value:"Module"})),Ze=40,Nf=400,Lf=9e3,Cf={sprint:[[".sp-exam-card","考试题目",t=>mt(t.querySelector(".sp-exam-no"))+" "+mt(t)],[".sp-item","押题考点",t=>mt(t.querySelector(".sp-name"))+"（"+mt(t.querySelector(".sp-score"))+"）"],["#lib-reader-body > div","资料章节段",t=>mt(t)]],mistakes:[[".mis-row","错题",t=>mt(t.querySelector(".mis-desc"))||mt(t)]],photomistake:[[".pm-question","拍题题目",t=>mt(t)],[".pm-card","拍题记录",t=>mt(t)]],wordbook:[[".fc-word","当前单词卡",t=>mt(t)+" "+mt(t.parentElement?.querySelector(".fc-hint"))]],scheduler:[[".seq-row","排程任务",t=>mt(t)]],essay:[[".essay-row","作文批改记录",t=>mt(t.querySelector(".mis-desc"))||mt(t)]]};function mt(t){return(t&&t.textContent||"").replace(/\s+/g," ").trim().slice(0,Nf)}function Eo(t){const e=document.getElementById("view");let n=t;for(;n&&n!==e;){if(n.hidden)return!1;const s=n.style&&n.style.display;if(s==="none"||s==="hidden"||typeof n.className=="string"&&/(^|\s)cp-hide(\s|$)/.test(n.className))return!1;n=n.parentElement}return!0}const To=new Map;function jf(t){const e=[];return t.querySelectorAll(".card").forEach(n=>{if(e.length>=Ze||!Eo(n))return;const s=mt(n.querySelector(".card-title")),r=mt(n),o=(s?s+"：":"")+(r.length>90?r.slice(0,90)+"…":r);o.trim()&&e.push({kind:s||"卡片",text:o})}),e}function qf(t){const e=document.getElementById("view");if(!e)return[];const n=To.get(t);if(n)try{return n(e).slice(0,Ze)}catch{}const s=Cf[t];if(s){const r=[];for(const[o,i,a]of s)if(e.querySelectorAll(o).forEach(l=>{if(r.length>=Ze||!Eo(l))return;const u=a(l);u&&r.push({kind:i,text:u})}),r.length>=Ze)break;if(r.length)return r}return jf(e)}const Df={dashboard:"仪表盘",scheduler:"排程",review:"复盘",photomistake:"拍题",quiz:"测验",heatmap:"热力图",inspector:"方法卡",sprint:"我的题卷",progress:"进度",decision:"决策",mental:"心态",redline:"红线",wordbook:"单词本",reading:"阅读",essay:"作文",polrecite:"政治背诵",mistakes:"错题本",concept:"概念图",focus:"专注",settings:"设置"};function Io(){const t=String(window.App?.current||"");if(!t||!document.getElementById("view"))return null;const e=qf(t);return e.length?{pageId:t,label:Df[t]||t,entries:e}:null}function Oo(){const t=Io();if(!t)return"";const e=[];let n=0;for(let r=0;r<t.entries.length;r++){const o=r+1+". ["+t.entries[r].kind+"] "+t.entries[r].text;if(n+o.length>Lf)break;n+=o.length,e.push(o)}const s=e.length<t.entries.length?`
（本页共 `+t.entries.length+" 条，因长度上限仅列出前 "+e.length+" 条；被截断部分如需查看请让用户滚动页面或指明题号）":"";return"【当前页面·"+t.label+`（用户此刻看到的内容，DOM 直读非截图）】
`+e.join(`
`)+s+`
（用户说"这道题/这页/刚才"等指代时，即指上述条目）`}const Rf=/(这道题|这题|这个题|这道|这页|本页|当前页|上面|刚才|屏幕上|看到的|这里|哪个错|哪道题)/;function Bf(t){return Rf.test(t||"")?Oo():""}function Jf(){try{const t=window.getSelection(),e=t?String(t.toString()||"").trim():"";if(e.length<4||e.length>800)return"";if(t&&t.rangeCount){const n=t.getRangeAt(0).commonAncestorContainer,s=n.nodeType===1?n:n.parentElement;if(!s||!s.closest("#view"))return""}return e}catch{return""}}const Gf={register(t,e){To.set(t,e)},snapshot:Io,text:Oo,auto:Bf,selection:Jf};window.PageCtx=Gf;function Mo(){const t=window;t.U=M,t.ICONS=Ge,t.Spaced=ei,t.BgTask=xp,t.Tex=Ne,t.Store=P,t.Cloud=St,t.CloudJob=Xp,t.DB=Wt,t.Charts=Rr,t.Diagram=Dr,t.Toast=X,t.Modal=It,t.Components=zo,t.Notify=bs,t.AI=K,t.AiMemory=Ye,t.Alerts=ls,t.Mastery=io,t.ZipKit=We,t.PluginBus=D,t.ExamPipeline=ao,t.MethodLink=Ao,t.Plaza=ni,t.SchedulerEngine=Sf}function Hf(){const t=P.get(),e=M.dkey();if(t.meta.lastOpenDate===e)return;const n=t.meta.lastOpenDate;if(n&&n<e){const s=t.completions[n]||[];t.taskArchive[n]=t.tasks.map(o=>({subject:o.subject,text:o.text,done:o.done||s.indexOf(o.id)>=0})),t.tasks.forEach(o=>{o.done=!1});const r=Object.keys(t.taskArchive).sort();for(;r.length>60;)delete t.taskArchive[r.shift()]}P.update(s=>{s.meta.lastOpenDate=e})}function zf(){Mo();try{const e="kaoyan2026_v2_bak";if(!localStorage.getItem(e)&&localStorage.getItem("kaoyan2026_data")){localStorage.setItem(e,new Date().toISOString());const n=localStorage.getItem("kaoyan2026_data");n&&localStorage.setItem("kaoyan2026_data_bak_v2",n)}}catch{}const t=(function(){try{return St.init()}catch{return Promise.resolve()}})();Wt.syncSubjects(),Hf(),bs.ensurePermission();try{Ye.syncLocalSignals()}catch{}setTimeout(()=>{try{ls.runDailyChecks()}catch{}},800),t.then(function(){setTimeout(function(){try{const e=window.Copilot;e&&e.superviseCheck&&e.superviseCheck()}catch{}try{Ye.consolidateDue()&&Ye.weeklyConsolidate()}catch{}},1200)}).catch(function(){});try{ve.restoreChat(),ve.maybeAutoLoad()}catch{}(function e(n){try{const s=window.FocusModule;if(s&&s.boot){s.boot();return}}catch{}(n||0)<40&&setTimeout(()=>e((n||0)+1),50)})(),t.then(function(){const e=window.Onboarding;e&&e.needed&&e.needed()&&e.show()}).catch(function(){});try{const e=window.Copilot;e&&e.mount&&e.mount()}catch{}}Mo();const $f=[()=>Y(()=>import("./dashboard-BaA9FphH.js"),__vite__mapDeps([7,8,9,3,4,6,5]),import.meta.url),()=>Y(()=>import("./scheduler-DD9ULQJk.js"),[],import.meta.url),()=>Y(()=>import("./tasks-BqMe-nc1.js"),[],import.meta.url),()=>Y(()=>import("./progress-MouM4HYd.js"),[],import.meta.url),()=>Y(()=>import("./review-CYjXdjM-.js"),[],import.meta.url),()=>Y(()=>import("./heatmap-CJtykNWz.js"),[],import.meta.url),()=>Y(()=>import("./quiz-B9uG04SJ.js"),[],import.meta.url),()=>Y(()=>import("./inspector-BKpUpTe_.js"),[],import.meta.url),()=>Y(()=>import("./sprint-B7bO86R_.js"),__vite__mapDeps([10,11,3,4,1,2,5,6]),import.meta.url),()=>Y(()=>import("./wordbook-CRdsTi4k.js"),[],import.meta.url),()=>Y(()=>import("./tutor-Z22EhQvz.js"),[],import.meta.url),()=>Y(()=>import("./settings-CT0kqVIb.js"),__vite__mapDeps([12,11]),import.meta.url),()=>Y(()=>import("./onboarding-S8tjkBcr.js"),[],import.meta.url),()=>Y(()=>import("./copilot--72RPtb9.js"),__vite__mapDeps([0,1,2,3,4,5,6]),import.meta.url),()=>Y(()=>import("./polrecite-CifL9KS5.js"),[],import.meta.url),()=>Y(()=>import("./plugincenter-B8LSfsMq.js"),[],import.meta.url)],Uf=[()=>Y(()=>import("./mistakes-BeyJtAe_.js"),[],import.meta.url),()=>Y(()=>import("./photomistake-BdWNfpSx.js"),[],import.meta.url)],Ff=[()=>Y(()=>import("./shareplaza-BUy_JnSs.js"),__vite__mapDeps([13,14,5,3,4]),import.meta.url)],Kf=[()=>Y(()=>import("./redline-Dj0Zvmn_.js"),[],import.meta.url),()=>Y(()=>import("./focus-DeiM7h0a.js"),[],import.meta.url),()=>Y(()=>import("./conceptmap-DkvhK5Y_.js"),[],import.meta.url),()=>Y(()=>import("./decision-Ca7lZVwo.js"),[],import.meta.url),()=>Y(()=>import("./mental-BDB5Acye.js"),[],import.meta.url),()=>Y(()=>import("./reading-C2IfnIP_.js"),[],import.meta.url),()=>Y(()=>import("./essay-B46Eb2sJ.js"),[],import.meta.url),()=>Y(()=>import("./qfinder-iu8_yhJV.js"),[],import.meta.url),()=>Y(()=>import("./vizai-WcsIuia_.js"),[],import.meta.url)],Vf=[()=>Y(()=>import("./shareplaza-ext-BYlyrW7i.js"),__vite__mapDeps([15,14,16,5,3,4]),import.meta.url),()=>Y(()=>import("./shareplaza-ai-CtnFQRXe.js"),__vite__mapDeps([17,14,16,5,3,4]),import.meta.url)];let Ke=null;function nr(){return Ke||(Ke=(async()=>{await Promise.all(Ff.map(t=>t())),await Promise.all(Kf.map(t=>t())),await Promise.all(Vf.map(t=>t())),window.__LEGACY_ALL__=!0;try{window.dispatchEvent(new Event("legacy:rest-loaded"))}catch{}})().catch(function(t){throw Ke=null,t})),Ke}await Promise.all($f.map(t=>t()));await Promise.all(Uf.map(t=>t()));const sr=()=>Y(()=>import("./index-Cf9hRrum.js").then(t=>t.i),__vite__mapDeps([18,9,3,4,6,5]),import.meta.url),Ms=Go(zn);Ms.use(Ho());Ms.use(kt);ta();(function(){if(window.__ERR_OVERLAY__)return;window.__ERR_OVERLAY__=!0;function e(n,s){as(n,s);let r=document.getElementById("g-err");r||(r=document.createElement("div"),r.id="g-err",r.style.cssText="position:fixed;left:8px;right:8px;bottom:8px;z-index:99999;background:#b42318;color:#fff;padding:10px 12px;border-radius:10px;font-size:13px;box-shadow:0 6px 24px rgba(0,0,0,.35)",document.body.appendChild(r)),r.innerHTML='<div style="display:flex;gap:8px;align-items:flex-start"><span style="flex:1;line-height:1.5">⚠️ 页面出错：'+M.esc(n)+'</span><button style="background:#fff;color:#b42318;border:0;border-radius:6px;padding:3px 8px;font-size:12px;flex:0 0 auto" data-a="copy">复制</button><button style="background:transparent;color:#fff;border:1px solid #fff;border-radius:6px;padding:3px 8px;font-size:12px;flex:0 0 auto" data-a="x">✕</button></div>'+(s?'<details style="margin-top:6px"><summary style="cursor:pointer;font-size:12px;opacity:.9">展开详情（截图发我）</summary><pre style="white-space:pre-wrap;font-size:11px;max-height:180px;overflow:auto;margin:6px 0 0">'+M.esc(s)+"</pre></details>":"");const o=r.querySelector('[data-a="copy"]'),i=r.querySelector('[data-a="x"]');o&&(o.onclick=function(){try{navigator.clipboard.writeText(n+`
`+s),this.textContent="已复制✓"}catch{}}),i&&(i.onclick=function(){r&&r.parentNode&&r.parentNode.removeChild(r)})}window.addEventListener("error",function(n){const s=n.target;if(s&&(s.tagName==="SCRIPT"||s.tagName==="LINK")){e("资源加载失败："+String(s.src||s.href||"").split("/").pop()+"（分片缺失，多为版本/缓存错配）——请强制刷新或清缓存","");return}n.message&&e(n.message,n.error&&n.error.stack||(n.filename?n.filename+":"+n.lineno:""))},!0),window.addEventListener("unhandledrejection",function(n){const s=n&&n.reason;e(s&&(s.message||String(s))||"未知异步错误",s&&s.stack||"")})})();try{if("serviceWorker"in navigator){const t=!!navigator.serviceWorker.controller;let e=!1;navigator.serviceWorker.addEventListener("controllerchange",function(){if(!t||e)return;e=!0;const n=document.createElement("div");n.style.cssText="position:fixed;left:50%;transform:translateX(-50%);bottom:60px;z-index:99998;background:#1a7f37;color:#fff;padding:10px 14px;border-radius:10px;font-size:13px;box-shadow:0 6px 24px rgba(0,0,0,.35);display:flex;gap:10px;align-items:center",n.innerHTML='🆕 已更新到新版本<button style="background:#fff;color:#1a7f37;border:0;border-radius:6px;padding:4px 10px;font-size:12px">刷新</button>',document.body.appendChild(n),n.querySelector("button").onclick=function(){location.reload()},setTimeout(function(){n.parentNode&&n.parentNode.removeChild(n)},15e3)})}}catch{}try{await P.hydrateHeavy()}catch{}zf();Ms.mount("#app");const Qf=window.requestIdleCallback||function(t){return setTimeout(t,1200)};try{Qf(()=>{nr().catch(function(t){console.warn("[boot] 后台模块补齐失败",t)}),sr().then(function(){try{window.App&&zn.current==="settings"&&zn.refresh()}catch{}}).catch(function(t){console.warn("[boot] 工程组件注册失败",t)})})}catch{nr().catch(()=>{}),sr().catch(()=>{})}try{typeof window.__BOOT_READY=="function"&&window.__BOOT_READY()}catch{}export{rh as d};
