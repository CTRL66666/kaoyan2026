import{C as At,c as Pt,A as _,S as j}from"./ai-oJLo2yuu.js";import{M as Z}from"./vendor-BVCdKi1G.js";const it="0.26.4",Ct=[`https://cdn.jsdelivr.net/pyodide/v${it}/full/`,`https://registry.npmmirror.com/-/binary/pyodide/v${it}/full/`],w=Z({status:"idle",log:[],lastError:"",progress:{pct:0,msg:""}});function at(t){w.log.push(t),w.log.length>200&&w.log.shift()}const Ot=`
var py = null;
